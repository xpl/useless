...
function(a,b){return a+b}).join(" "))throw Error("_.zipWith broken");return _}();_.tests={};_.deferTest=_.withTest=function(a,b,d){d()};b(2);b(3);b(4);b(5);b(6);b(7);b(8);b(9);b(10);b(11);b(13);b(14);b(15);b(16);b(17);b(18);b(19);b(20);b(21);b(22);b(24);b(25);b(26);b(27);b(28);b(29);b(30);b(31);b(32);b(33);b(34);b(35)},function(k,m,b){var a,c;(function(){function b(a){return function(b,c,d,e){c=z(c,e,4);var f=!v(b)&&g.keys(b),h=(f||b).length,l=0<a?0:h-1;3>arguments.length&&(d=b[f?f[l]:l],l+=a);for(var n=
c,k=d;0<=l&&l<h;l+=a)var t=f?f[l]:l,k=n(k,b[t],t,b);return k}}function e(a){return function(b,c,d){c=u(c,d);d=x(b);for(var e=0<a?0:d-1;0<=e&&e<d;e+=a)if(c(b[e],e,b))return e;return-1}}function f(a,b,c){return function(d,e,f){var h=0,l=x(d);if("number"==typeof f)0<a?h=0<=f?f:Math.max(f+l,h):l=0<=f?Math.min(f+1,l):f+l+1;else if(c&&f&&l)return f=c(d,e),d[f]===e?f:-1;if(e!==e)return f=b(r.call(d,h,l),g.isNaN),0<=f?f+h:-1;for(f=0<a?h:l-1;0<=f&&f<l;f+=a)if(d[f]===e)return f;return-1}}function h(a,b){var c=
J.length,d=a.constructor,d=g.isFunction(d)&&d.prototype||q,e="constructor";for(g.has(a,e)&&!g.contains(b,e)&&b.push(e);c--;)e=J[c],e in a&&a[e]!==d[e]&&!g.contains(b,e)&&b.push(e)}var l=this,n=l._,t=Array.prototype,q=Object.prototype,p=t.push,r=t.slice,w=q.toString,Q=q.hasOwnProperty,C=Array.isArray,K=Object.keys,D=Function.prototype.bind,L=Object.create,E=function(){},g=function(a){if(a instanceof g)return a;if(!(this instanceof g))return new g(a);this._wrapped=a};"undefined"!==typeof k&&k.exports&&
(m=k.exports=g);m._=g;g.VERSION="1.8.3";var z=function(a,b,c){if(void 0===b)return a;switch(null==c?3:c){case 1:return function(c){return a.call(b,c)};case 2:return function(c,d){return a.call(b,c,d)};case 3:return function(c,d,e){return a.call(b,c,d,e)};case 4:return function(c,d,e,f){return a.call(b,c,d,e,f)}}return function(){return a.apply(b,arguments)}},u=function(a,b,c){return null==a?g.identity:g.isFunction(a)?z(a,b,c):g.isObject(a)?g.matcher(a):g.property(a)};g.iteratee=function(a,b){return u(a,
b,Infinity)};var A=function(a,b){return function(c){var d=arguments.length;if(2>d||null==c)return c;for(var e=1;e<d;e++)for(var f=arguments[e],h=a(f),g=h.length,l=0;l<g;l++){var n=h[l];b&&void 0!==c[n]||(c[n]=f[n])}return c}},M=function(a){if(!g.isObject(a))return{};if(L)return L(a);E.prototype=a;a=new E;E.prototype=null;return a},B=function(a){return function(b){return null==b?void 0:b[a]}},S=Math.pow(2,53)-1,x=B("length"),v=function(a){a=x(a);return"number"==typeof a&&0<=a&&a<=S};g.each=g.forEach=
function(a,b,c){b=z(b,c);var d;if(v(a))for(c=0,d=a.length;c<d;c++)b(a[c],c,a);else{var e=g.keys(a);c=0;for(d=e.length;c<d;c++)b(a[e[c]],e[c],a)}return a};g.map=g.collect=function(a,b,c){b=u(b,c);c=!v(a)&&g.keys(a);for(var d=(c||a).length,e=Array(d),f=0;f<d;f++){var h=c?c[f]:f;e[f]=b(a[h],h,a)}return e};g.reduce=g.foldl=g.inject=b(1);g.reduceRight=g.foldr=b(-1);g.find=g.detect=function(a,b,c){b=v(a)?g.findIndex(a,b,c):g.findKey(a,b,c);if(void 0!==b&&-1!==b)return a[b]};g.filter=g.select=function(a,
b,c){var d=[];b=u(b,c);g.each(a,function(a,c,e){b(a,c,e)&&d.push(a)});return d};g.reject=function(a,b,c){return g.filter(a,g.negate(u(b)),c)};g.every=g.all=function(a,b,c){b=u(b,c);c=!v(a)&&g.keys(a);for(var d=(c||a).length,e=0;e<d;e++){var f=c?c[e]:e;if(!b(a[f],f,a))return!1}return!0};g.some=g.any=function(a,b,c){b=u(b,c);c=!v(a)&&g.keys(a);for(var d=(c||a).length,e=0;e<d;e++){var f=c?c[e]:e;if(b(a[f],f,a))return!0}return!1};g.contains=g.includes=g.include=function(a,b,c,d){v(a)||(a=g.values(a));
if("number"!=typeof c||d)c=0;return 0<=g.indexOf(a,b,c)};g.invoke=function(a,b){var c=r.call(arguments,2),d=g.isFunction(b);return g.map(a,function(a){var e=d?b:a[b];return null==e?e:e.apply(a,c)})};g.pluck=function(a,b){return g.map(a,g.property(b))};g.where=function(a,b){return g.filter(a,g.matcher(b))};g.findWhere=function(a,b){return g.find(a,g.matcher(b))};g.max=function(a,b,c){var d=-Infinity,e=-Infinity,f;if(null==b&&null!=a){a=v(a)?a:g.values(a);for(var h=0,l=a.length;h<l;h++)c=a[h],c>d&&
(d=c)}else b=u(b,c),g.each(a,function(a,c,h){f=b(a,c,h);if(f>e||-Infinity===f&&-Infinity===d)d=a,e=f});return d};g.min=function(a,b,c){var d=Infinity,e=Infinity,f;if(null==b&&null!=a){a=v(a)?a:g.values(a);for(var h=0,l=a.length;h<l;h++)c=a[h],c<d&&(d=c)}else b=u(b,c),g.each(a,function(a,c,h){f=b(a,c,h);if(f<e||Infinity===f&&Infinity===d)d=a,e=f});return d};g.shuffle=function(a){a=v(a)?a:g.values(a);for(var b=a.length,c=Array(b),d=0,e;d<b;d++)e=g.random(0,d),e!==d&&(c[d]=c[e]),c[e]=a[d];return c};
g.sample=function(a,b,c){return null==b||c?(v(a)||(a=g.values(a)),a[g.random(a.length-1)]):g.shuffle(a).slice(0,Math.max(0,b))};g.sortBy=function(a,b,c){b=u(b,c);return g.pluck(g.map(a,function(a,c,d){return{value:a,index:c,criteria:b(a,c,d)}}).sort(function(a,b){var c=a.criteria,d=b.criteria;if(c!==d){if(c>d||void 0===c)return 1;if(c<d||void 0===d)return-1}return a.index-b.index}),"value")};var F=function(a){return function(b,c,d){var e={};c=u(c,d);g.each(b,function(d,f){var h=c(d,f,b);a(e,d,h)});
return e}};g.groupBy=F(function(a,b,c){g.has(a,c)?a[c].push(b):a[c]=[b]});g.indexBy=F(function(a,b,c){a[c]=b});g.countBy=F(function(a,b,c){g.has(a,c)?a[c]++:a[c]=1});g.toArray=function(a){return a?g.isArray(a)?r.call(a):v(a)?g.map(a,g.identity):g.values(a):[]};g.size=function(a){return null==a?0:v(a)?a.length:g.keys(a).length};g.partition=function(a,b,c){b=u(b,c);var d=[],e=[];g.each(a,function(a,c,f){(b(a,c,f)?d:e).push(a)});return[d,e]};g.first=g.head=g.take=function(a,b,c){return null==a?void 0:
null==b||c?a[0]:g.initial(a,a.length-b)};g.initial=function(a,b,c){return r.call(a,0,Math.max(0,a.length-(null==b||c?1:b)))};g.last=function(a,b,c){return null==a?void 0:null==b||c?a[a.length-1]:g.rest(a,Math.max(0,a.length-b))};g.rest=g.tail=g.drop=function(a,b,c){return r.call(a,null==b||c?1:b)};g.compact=function(a){return g.filter(a,g.identity)};var y=function(a,b,c,d){var e=[],f=0;d=d||0;for(var h=x(a);d<h;d++){var l=a[d];if(v(l)&&(g.isArray(l)||g.isArguments(l))){b||(l=y(l,b,c));var n=0,k=l.length;
...
{});var n=function(){l=!1===c.leading?0:g.now();h=null;f=a.apply(d,e);h||(d=e=null)};return function(){var k=g.now();l||!1!==c.leading||(l=k);var t=b-(k-l);d=this;e=arguments;0>=t||t>b?(h&&(clearTimeout(h),h=null),l=k,f=a.apply(d,e),h||(d=e=null)):h||!1===c.trailing||(h=setTimeout(n,t));return f}};g.debounce=function(a,b,c){var d,e,f,h,l,n=function(){var k=g.now()-h;k<b&&0<=k?d=setTimeout(n,b-k):(d=null,c||(l=a.apply(f,e),d||(f=e=null)))};return function(){f=this;e=arguments;h=g.now();var k=c&&!d;
...
[this._wrapped];p.apply(a,arguments);return I(this,c.apply(g,a))}})};g.mixin(g);g.each("pop push reverse shift sort splice unshift".split(" "),function(a){var b=t[a];g.prototype[a]=function(){var c=this._wrapped;b.apply(c,arguments);"shift"!==a&&"splice"!==a||0!==c.length||delete c[0];return I(this,c)}});g.each(["concat","join","slice"],function(a){var b=t[a];g.prototype[a]=function(){return I(this,b.apply(this._wrapped,arguments))}});g.prototype.value=function(){return this._wrapped};g.prototype.valueOf=
...
else if(_.isScalar(b))l(b,void 0,h);else{var n=d||0,k=0===n?void 0===b.length?_.keys(b):void 0:f,m=0===n?k?k.length:b.length:e;if(n>=(m||0))h();else{var p=k?k[n]:n;l(b[p],p,arguments.callee.bind(this,b,a,c,n+1,m,k))}}}});_.extend(_.cps,{map:function(b,a,c){var d=_.isArray(b)?[]:{};_.cps.each(b,2==_.numArgs(a)?function(b,c,h){a(b,function(a){d[c]=a;h()})}:function(b,c,h){a(b,c,function(a){d[c]=a;h()})},function(){c(d)})}});_.extend(_.cps,{find:function(b,a,c){var d=2!==_.numArgs(a);_.cps.each(b,function(b,
...
arguments.callee,f=a._onceBefore,h=a._onceAfter,l=a._onBefore,k=a._onAfter,t=a._intercept,a=d||this,m,p;if(f.length){m=0;for(p=f.length;m<p;m++)f[m].apply(a,arguments);f.removeAll()}m=0;for(p=l.length;m<p;m++)l[m].apply(a,arguments);f=(t.length?_.cps.compose([b].concat(t)):b).apply(a,arguments);if(k.length||h.length){l=_.asArray(arguments).concat(f);m=0;for(p=k.length;m<p;m++)k[m].apply(a,l);if(h.length)for(k=h.copy,h.removeAll(),m=0,p=k.length;m<p;m++)k[m].apply(a,l)}return f}))})})})()},function(k,
...
if(0==e)return a;e=this.sub(a).dot(d)/e;return 0>e?a:1<e?b:a.add(d.scale(e))},projectOnRay:function(a,b){var d=b.lengthSquared;return 0==d?0:this.sub(a).dot(b)/d}});$jscomp.initSymbol();"undefined"!==typeof Symbol&&($jscomp.initSymbol(),Vec2.prototype[Symbol["for"]("String.ify")]=function(){return"{"+this.x+","+this.y+"}"});Bezier={cubic:function(a,b,d,e,f){var h=a*a*a,l=a*a,k=3*(d.x-b.x),m=3*(d.y-b.y),q=3*(e.x-d.x)-k;d=3*(e.y-d.y)-m;return new Vec2((f.x-b.x-k-q)*h+q*l+k*a+b.x,(f.y-b.y-m-d)*h+d*l+
...
a.bottom||a.top?{}:{inside:!0})},classifyRay:function(a,b,d){var e=this.size.half,f,h,l,k,m,q;f=1/b.x;h=1/b.y;m=Math.sign(f);q=Math.sign(h);l=(this.x-m*e.x-a.x)*f;k=(this.y-q*e.y-a.y)*h;f*=this.x+m*e.x-a.x;e=(this.y+q*e.y-a.y)*h;if(!(l>e||k>f||(h=l>k?l:k,1<=h||0>=(f<e?f:e))))return f={time:_.clamp(h,0,1)},f.normal=l>k?new Vec2(-m,0):new Vec2(0,-q),f.delta=b.scale(f.time),f.where=a.add(f.delta),d&&(l=this.grow(-d),f.where.x>l.right?f.where.y<l.top?f=Intersect.rayCircle(a,b,l.rightTop,d):f.where.y>
...
Math.abs(6*a-3)-1)),Math.max(0,Math.min(1,2-Math.abs(6*a-2))),Math.max(0,Math.min(1,2-Math.abs(6*a-4)))]};_.RGB2CSS=function(a,b){return"rgba("+Math.round(255*a[0])+","+Math.round(255*a[1])+","+Math.round(255*a[2])+","+(void 0===b?void 0===a[3]?1:a[3]:b)+")"};_.RGB2HSL=function(a,b){var d=a[0],e=a[1],f=a[2],h=void 0===b?a[3]:b,l=Math.max(d,e,f),k=Math.min(d,e,f),m,q=(l+k)/2;if(l==k)m=k=0;else{var p=l-k,k=.5<q?p/(2-l-k):p/(l+k);switch(l){case d:m=(e-f)/p+(e<f?6:0);break;case e:m=(f-d)/p+2;break;case f:m=
(d-e)/p+4}m/=6}return void 0===h?[m,k,q]:[m,k,q,h]};_.extend(Math,function(a){return{roundTo:function(a,b){return a-a%b},round10:function(b,d){return a("round",b,d)},floor10:function(b,d){return a("floor",b,d)},ceil10:function(b,d){return a("ceil",b,d)}}}(function(a,b,d){if("undefined"===typeof d||0===+d)return Math[a](b);b=+b;d=+d;if(isNaN(b)||"number"!==typeof d||0!==d%1)return NaN;b=b.toString().split("e");b=Math[a](+(b[0]+"e"+(b[1]?+b[1]-d:-d)));b=b.toString().split("e");return+(b[0]+"e"+(b[1]?
...
JSON.stringify(l));if(!h[k]){h[k]=!0;var p=b.filter(function(a){return a[0]===l});if(k=p.length){m=m.concat(l);do{var r=p[--k][1];d(r,a.indexOf(r),m)}while(k)}f[--e]=l}}for(var e=a.length,f=Array(e),h={},l=e;l--;)h[l]||d(a[l],l,[]);return f}k.exports=m=function(a){for(var c=[],d=0,e=a.length;d<e;d++){var f=a[d];0>c.indexOf(f[0])&&c.push(f[0]);0>c.indexOf(f[1])&&c.push(f[1])}return b(c,a)};m.array=b},function(k,m){Parse={keyCodeAsString:function(b){return String.fromCharCode(96<=b&&105>=b?b-48:b)},
...
[];var c=this.cfg="object"===typeof b?b:{},d=this.constructor.$definition;this.constructor.$defaults&&(c=this.cfg=_.extend(_.cloneDeep(this.constructor.$defaults),c));this.mapMethods(function(a,b,c){if(!("$"===b||"init"===b||c&&c.$raw))return this.$(a)});_.onBefore(this,"destroy",this._beforeDestroy);_.onAfter(this,"destroy",this._afterDestroy);var e=[],f={init:!0};_.each(d,function(a,b){if(void 0!==a){if(a.$observableProperty){var d=a.subject,k=b in c?c[b]:d,m=b+"Change",p=f[m]=this[m]=_.observable();
p.context=this;p.postpones=a.$postpones;if(_.isPrototypeInstance(d)){var r=d.constructor;p.beforeWrite=function(a){return r.isTypeOf(a)?a:new r(a)}}a.$reference&&(p.trackReference=!0);_.defineProperty(this,b,{get:function(){return p.value},set:function(a){p.write.call(this,a)}});a.listeners&&_.each(a.listeners,function(a){e.push([p,a])});_.isFunction(a.$observableProperty)&&e.push([p,a.$observableProperty]);void 0!==k&&p(k)}else if(Component.isStreamDefinition(a)){var w=f[b]=this[b]=_.extend((a.$trigger?
_.trigger:a.$triggerOnce?_.triggerOnce:a.$observable?_.observable:a.$barrier?_.barrier:void 0)(a.subject),{context:this,postpones:a.$postpones});a.$reference&&(p.trackReference=!0);a.listeners&&_.each(a.listeners,function(a){e.push([w,a])});_.isFunction(a.$observable)&&e.push([w,a.$observable]);(d=c[b])&&(a.$observable&&d.isObservable?d.tie(w):e.push([w,d]))}a.$listener&&(this[b].queuedBy=[]);a.$interlocked&&(this[b]=_.interlocked(this[b]));a.$bindable&&(this[b]=_.extend(_.bindable(this[b],this),
...
function(c,e){if(d.hasOwnProperty(e)&&_.isFunction(c)){var l=b.parse(e),k=l.name&&l.name.decapitalized||e;if(l=l.how&&_["on"+l.how.capitalized]||_.intercept){var m=a[k];m&&_.isFunction(m)&&l(a,k,c);var m=a.prototype,q=m[k];q&&_.isFunction(q)&&l(m,k,c)}}});a.aspectAdded&&a.aspectAdded(d);return d}})()},function(k,m){var b=function(){Error.call(this,"timeout expired")};$jscomp.inherits(b,Error);b.captureStackTrace=Error.captureStackTrace;__=Promise.eval=function(a){var b=this,d=_.rest(arguments);return a instanceof
...
d=arguments;return new Promise(function(e,f){a.apply(b,_.asArray(d).concat(function(a,b){a&&f(a);e(b)}))})}}))})},function(k,m){$global.Channel=$extends(Promise,{constructor:function(b,a,c){this.after=[];this.state="pending";this.value=void 0;this.transducers={resolve:a&&a.resolve||function(a){return a},reject:a&&a.reject||function(a){throw a;}};if(b instanceof Function)try{b.call(this,this.$(this.resolve),this.$(this.reject))}catch(d){this.reject(d)}else void 0!==b&&this.resolve(b)},_resolve:function(b){this.state=
...
c){return c(b)})};$prototype.macroTag("channel",function(b,a,c){var d="_"+c,e=$untag(a);b[c]=Tags.modify(a,function(){return $property({get:function(){return this[d]||(this[d]=new Channel(e))},set:function(a){this[c].resolve(a)}})})})},function(k,m){Http=$singleton(Component,{$traits:[HttpMethods=$trait({get:function(b,a){return this.request("GET",b,a)},post:function(b,a){return this.request("POST",b,a)},loadFile:function(b,a){return this.request("GET",b,{responseType:"arraybuffer"})},uploadFile:function(b,
...
b){var d=N.div.html(a);d.splitSubtreeBefore(d.one("br"));return _.assert(d.innerHTML,b)}});$assertSplitAtBr("<b><br>foo</b>","<b><br>foo</b>");$assertSplitAtBr("<b>foo<br></b>","<b>foo</b><b><br></b>");$assertSplitAtBr("<b>foo<i>bar<br>baz</i>qux</b>","<b>foo<i>bar</i></b><b><i><br>baz</i>qux</b>")}}})()},function(k,m){DOMReference=$trait({domReady:$barrier(function(b){this.dom=b;this.el=jQuery(this.dom)}),afterDestroy:function(){this.dom&&(this.dom.removeFromParent(),this.el=this.dom=void 0);this.domReady.reset()}});
