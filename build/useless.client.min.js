...
function(b,a){return isNaN(b)&&isNaN(a)?NaN:isNaN(b)?a:isNaN(a)?b:Math.max(b,a)};_.notZero=function(b){return 0!==b};_.propertyOf=function(b){return function(a){return b[a]}};_.oneOf=$restArg(function(){return _.propertyOf(_.index(_.asArray(arguments)))})},function(l,m){_.isTypeOf=function(b,a){return a instanceof b};_.isPrototypeInstance=function(b){return b&&b.constructor&&_.isPrototypeConstructor(b.constructor)};_.isPrototypeConstructor=function(b){return b&&void 0!==b.$definition||!1};_.coerceToNaN=
...
isNonemptyString:function(b){return"string"===typeof b&&0<b.length},coerceToObject:function(b){return _.isStrictlyObject(b)?b:{}},coerceToEmpty:function(b){if(_.isArray(b))return[];if(_.isStrictlyObject(b))return{}},coerceToUndefined:function(b){return void 0===b||null===b||b===Math.NaN||""===b||_.isPOD(b)&&(_.isEmptyObject(b)||0===b.length)?void 0:b}})},function(l,m){_.hasStdlib=!0;_.throwsError=_.higherOrder(_.throwError=function(b){throw b instanceof Error?b:Error(b);});_["throws"]=_.higherOrder(_["throw"]=
...
e.value));return d};_.mapsWith=_.higherOrder(_.mapWith=_.flip2(_.map2));_.pluck2=function(b,a){return _.map2(b,_.property(a))};_.mixin({scatter:function(b,a){var c=void 0;_.map2(b,function(b,e){a(b,e,function(a,b){2>arguments.length?(c=c||[]).push(a):(c=c||{})[b]=a})});return c}});_.obj=function(b){var a=void 0;b(function(b,d){(a=a||{})[d]=b});return a};_.arr=function(b){var a=void 0;b(function(b){(a=a||[]).push(2>arguments.length?b:_.asArray(arguments))});return a};_.mapKeys=function(b,a){return _.isArrayLike(b)?
_.map(b,_.tails2(_.mapKeys,a)):_.isStrictlyObject(b)?_.object(_.map(_.pairs(b),function(b){return[a(b[0]),_.mapKeys(b[1],a)]})):b};_.mapMap=_.hyperOperator(_.unary,_.map2);_.hyperMap=function(b,a){return _.hyperOperator(_.unary,function(b,d){return a(b)||_.map2(b,d)})(b,_.identity)};_.pairs2=function(b){return _.scatter(b,function(a,b,d){d([b,a])})};_.reject2=function(b,a){return _.filter2(b,_.not(a))};_.filter2=function(b,a){if(_.isArrayLike(b)){for(var c=[],d=0,e=b.length;d<e;d++){var f=b[d],h=
a(f,d);!0===h?c.push(f):!1!==h&&c.push(h)}return c}if(_.isStrictlyObject(b))return c={},_.each(Object.keys(b),function(d){var e=b[d],f=a(e,d);!0===f?c[d]=e:!1!==f&&(c[d]=f)}),c;h=a(b);if(!0===h)return b;if(!1!==h)return h};_.filterFilter=_.hyperOperator(_.unary,_.filter2);_.hyperFilter=function(b,a){return _.hyperOperator(_.unary,function(b,d){var e=a(b);return!0===e&&_.filter2(b,d)||e})(b,_.identity)};_.hyperReject=function(b,a){return _.hyperFilter(b,function(b){b=a(b);return _.isBoolean(b)?!b:
b})};_.each2=function(b,a){if(_.isArrayLike(b))for(var c=0,d=b.length;c<d;c++)a(b[c],c,d);else if(_.isStrictlyObject(b))for(var e=Object.keys(b),f,c=0,d=e.length;c<d;c++)a(b[f=e[c]],f,d);else a(b,void 0,1)};_.reduce2=function(b,a,c){var d=3>arguments.length,e=b,f=a,h=c;d&&(e=void 0,f=b,h=a);_.each2(f,function(a,b){e=d?a:h(e,a);d=!1});return e};_.reduceReduce=function(b,a,c){var d=b,e=a,f=c;3>arguments.length&&(d={},e=b,f=a);return _.hyperOperator(_.binary,_.reduce2,_.goDeeperAlwaysIfPossible)(d,e,
f)};_.concat=function(b,a){var c,d;1===arguments.length?(c=b[0],d=_.rest(b)):(c=b,d=_.rest(arguments));return _.isArrayLike(c)?c.concat.apply(c,d):_.reduce2(c,d,function(a,b){return _.isObject(a)&&_.isObject(b)?_.extend({},a,b):a+b})};_.mixin({zipSetsWith:function(b,a){return _.reduce(_.rest(b),function(b,d){_.each(_.union(d&&Array.from(d.values())||[],b&&Array.from(b.values())||[]),function(e){var f=a(b&&b.has(e)?e:void 0,d&&d.has(e)?e:void 0);void 0===f?b["delete"](e):b.add(f)});return b},new Set(b[0]))},
zipObjectsWith:function(b,a){return _.reduce(_.rest(b),function(b,d){_.each(_.union(_.keys(d),_.keys(b)),function(e){var f=a(b&&b[e],d&&d[e]);void 0===f?delete b[e]:b[e]=f});return b},_.clone(b[0]))},zip2:function(b,a){var c=2===arguments.length?b:_.initial(arguments),d=2===arguments.length?a:_.last(arguments);return _.isArrayLike(c)&&0!==c.length?_.isArrayLike(c[0])?_.zipWith(c,d):c[0]instanceof Set?_.zipSetsWith(c,d):_.isStrictlyObject(c[0])?_.zipObjectsWith(c,d):_.reduce2(c,d):c}});_.mixin({zipZip:_.hyperOperator(_.binary,
_.zip2)});_.extend=$restArg(_.extend);_.extended=$restArg(function(){return _.extend.apply(this,[{}].concat(_.asArray(arguments)))});_.extendWith=_.flip(_.extend);_.extendsWith=_.flip(_.partial(_.partial,_.flip(_.extend)));_.extendedDeep=_.tails3(_.zipZip,function(b,a){return void 0===a?b:a});_.extend2=$restArg(function(b){return _.extend(b,_.reduceRight(arguments,function(a,b){return _.object(_.map(_.union(_.keys(b),_.keys(a)),function(d){var e=b[d];return[d,d in a?"object"===typeof e?_.extend(e,
a[d]):a[d]:e]}))},{}))});_.find2=function(b,a){if(_.isArrayLike(b))for(var c=0,d=b.length;c<d;c++){var e=a(b[c],c,b);if("boolean"!==typeof e)return e;if(!0===e)return b[c]}else if(_.isStrictlyObject(b))for(var c=0,f=Object.keys(b),d=f.length;c<d;c++){var h=f[c],e=a(b[h],h,b);if("boolean"!==typeof e)return e;if(!0===e)return b[h]}};_.findFind=function(b,a){return _.hyperOperator(_.unary,function(b,d){if(_.isArrayLike(b))for(var e=0,f=b.length;e<f;e++){var h=d(b[e]);if("boolean"!==typeof h)return h;
if(!0===h)return b[e]}else if(_.isStrictlyObject(b))for(var e=0,k=Object.keys(b),f=k.length;e<f;e++){var n=k[e],h=d(b[n]);if("boolean"!==typeof h)return h;if(!0===h)return b[n]}h=a(b);return"boolean"!==typeof h?h:!0===h?b:!1})(b,a)};_.nonempty=function(b){return _.filter2(b,_.isNonempty)};_.extend(_,{clone:function(b){return b instanceof Set?new Set(b):_.isObject(b)?_.isArray(b)?b.slice():_.extend({},b):b},cloneDeep:_.tails2(_.mapMap,function(b){return _.isStrictlyObject(b)&&!_.isPrototypeInstance(b)?
...
b(this.subject);return this.subject instanceof Tags?a.assign(this.subject,Tags.get(this)):this},extend:function(b){return b instanceof Tags?a.assign(this,Tags.get(b)):this}});a.assign(Tags,{omit:$restArg(function(a,b){if(a instanceof Tags){var c=_.index(_.rest(arguments)),h=_.pick(a,function(a,b){return"$"===b[0]&&!(b in c)});return _.isEmptyObject(h)?a.subject:new Tags(a.subject,h)}return a}),clone:function(a,b){return a instanceof Tags?a.clone(b):b||a},extend:function(a,b){return a instanceof Tags?
a.clone().extend(b):b instanceof Tags?Tags.wrap(a).extend(b):a},get:function(a){return a instanceof Tags?_.pick(a,function(a,b){return"$"===b[0]}):{}},each:function(a,b){a instanceof Tags&&_.each(a,function(a,c){"$"===c[0]&&b(c.slice(1))})},hasSubject:function(a){return a instanceof Tags&&"subject"in a},matches:function(a){return function(b){return b&&void 0!==b["$"+a]}},unwrapAll:function(a){return _.map2(a,Tags.unwrap)},unwrap:function(a){return a instanceof Tags?a.subject:a},wrap:function(a){return a instanceof
Tags?a:0===arguments.length?new Tags:new Tags(a)},modify:function(a,b){return a instanceof Tags?a.clone().modify(b):b(a)},map:function(a,b){return Tags.modify(a,function(a){return _.map2(a,function(a,c){return Tags.modify(a,function(d){return b(d,c,a instanceof Tags?a:void 0)})})})},add:function(a,b,c){return Tags.wrap.apply(null,_.rest(arguments,1)).add(a,c)},all:new Set,isDefined:function(a){return Tags.all.has(a)},define:function(b,c){Tags.all.add(b);c=_.isFunction(c)&&c||_.identity;var f="$"+
b;$global[f]=c(function(a,c){return 2>arguments.length?Tags.add(b,a):Tags.add(b,c,a)});return a.assign($global[f],{matches:Tags.matches(b),is:function(a){return a instanceof Tags&&f in a||!1},isNot:function(a){return!(a instanceof Tags&&f in a)||!1},unwrap:function(a){return!0===$atom.matches(a)?Tags.unwrap(a):a}})}});$global.$untag=Tags.unwrap;["constant","get","once","async","atom"].forEach(Tags.define);$jscomp.initSymbol();if("undefined"!==typeof Symbol){var c=b(12);$jscomp.initSymbol();Tags.prototype[Symbol["for"]("String.ify")]=
function(a){if(a.json)return a.goDeeper($untag(this));var b=Tags.get(this),f=_.reduce(b,function(b,c,e){return _.isBoolean(c)?e+" ("+b:e+" ("+a.goDeeper(c,{pretty:!1})+", "+b},"");return c(f,a.goDeeper($untag(this)))+")".repeats(_.keys(b).length)}}},function(l,m){l.exports=function(b,a){var c=Array.isArray(a),d=c?a:a.split("\n"),e=b.replace(/[^\s]/g," "),d=d.map(function(a,c){return 0===c?b+a:e+a});return c?d:d.join("\n")}},function(l,m){_.hasTypeMatch=!0;Tags.define("required");Tags.define("atom");
$global["const"]("$any",_.identity);(function(){_.isMeta=function(a){return a===$any||!0===$atom.is(a)||!0===$required.is(a)};var b=function(a,b,c){var d=Tags.unwrapAll(_.filter2(a,$required.matches));a=_.nonempty(_.zip2(Tags.unwrapAll(a),b,c));if(_.isEmpty(d))return a;c=_.nonempty(_.zip2(d,b,c));return _.values2(d).length===_.values2(c).length?a:_.coerceToEmpty(b)},a=_.hyperOperator(_.binary,function(a,c,d){var k=Tags.unwrap(a);if(_.isArray(k)){if(_.isArray(c))return b(_.times(c.length,_.constant(k[0])),
c,d)}else if(_.isStrictlyObject(k)&&k["*"]){if(_.isStrictlyObject(c))return b(_.extend(_.map2(c,_.constant(k["*"])),_.omit(k,"*")),c,d)}else return b(a,c,d)}),c=function(a,b){var c=Tags.unwrap(a);return c===$any||void 0===c&&void 0===b||_.isFunction(c)&&(_.isPrototypeConstructor(c)?_.isTypeOf(c,b):!0===c(b))||typeof b===c||b===c};_.mismatches=function(b,c,d){return a(c,d,function(a,c){return b(a,c)?void 0:a})};_.omitMismatches=function(b,c,d){return a(c,d,function(a,c){return b(a,c)?c:void 0})};_.typeMismatches=
_.partial(_.mismatches,c);_.omitTypeMismatches=_.partial(_.omitMismatches,c);_.valueMismatches=_.partial(_.mismatches,function(a,b){return a===$any||b===$any||a===b});var d=function(a){if(_.isArray(a))return _.nonempty([_.reduce(_.rest(a),function(a,b){return _.undiff(a,b)},_.first(a)||void 0)]);if(_.isStrictlyObject(a)){var b=_.pairs(a),b=_.map(_.reduce(_.rest(b),function(a,b){return _.undiff(a,b)},_.first(b)||[void 0,void 0]),_.nonempty);return _.isEmpty(b)||_.isEmpty(b[1])?a:_.object([[b[0]||"*",
b[1]]])}return a};_.decideType=function(a){return _.hyperOperator(_.unary,function(a,b){return a&&a.constructor&&a.constructor.$definition?a.constructor:d(_.map2(a,b))})(a,function(a){return _.isPrototypeInstance(a)?a.constructor:_.isEmptyArray(a)?a:typeof a})}})()},function(l,m){_.cps=function(){return _.cps.sequence.apply(null,arguments)};_.cps.apply=function(b,a,c,d){c=_.asArray(c);var e=_.numArgs(b)-1,f=c[e];c[e]=function(){d.call(this,arguments,f)};return b.apply(a,c)};_.extend(_.cps,{each:function(b,
a,c,d,e,f){var h=c||_.noop,k=function(c,d,e){2===_.numArgs(a)?a(c,e,h,b):a(c,d,e,h,b)};if(_.isEmpty(b))h();else if(_.isScalar(b))k(b,void 0,h);else{var n=d||0,p=0===n?void 0===b.length?_.keys(b):void 0:f,l=0===n?p?p.length:b.length:e;if(n>=(l||0))h();else{var m=p?p[n]:n;k(b[m],m,arguments.callee.bind(this,b,a,c,n+1,l,p))}}}});_.extend(_.cps,{map:function(b,a,c){var d=_.isArray(b)?[]:{};_.cps.each(b,2==_.numArgs(a)?function(b,c,h){a(b,function(a){d[c]=a;h()})}:function(b,c,h){a(b,c,function(a){d[c]=
a;h()})},function(){c(d)})}});_.extend(_.cps,{find:function(b,a,c){var d=2!==_.numArgs(a);_.cps.each(b,function(b,c,h,k){var n=function(a){!1===a?h():k(!0===a?b:a,c)};d?a(b,c,n):a(b,n)},c)}});_.extend(_.cps,{memoize:function(b){return _.barrier?_.cps._betterMemoize(b):_.cps._poorMemoize(b)},_poorMemoize:function(b){var a={};return function(c,d){c in a?d(a[c]):b.call(this,c,function(b){d(a[c]=b)})}},_betterMemoize:function(b){var a={};switch(_.numArgs(b)){case 1:return function(c){a.already||b.call(this,
...
_.cps.trySequence=function(b,a,c){_.reduceRight(b,function(b,e){return function(f){if(_.isTypeOf(Error,f))return(c||a)(f);try{return e.apply(this,_.asArray(arguments).concat(b))}catch(h){return(c||a)(h)}}},a)()}},function(l,m){["method","property","flipped","forceOverride"].forEach(Tags.define);$extensionMethods=function(b,a){_.each(a,function(a,d){var e=Tags.unwrap(a);d in _||(_[d]=_[d]||e);if(a.$method||!a.$property&&!_.oneArg(e)){if(a.$property)throw Error("$extensionMethods: crazy input, unable to match");
d in b.prototype&&!a.$forceOverride||(b.prototype[d]=_.asMethod(a.$flipped?_.flip(e):e))}else d in b.prototype&&!a.$forceOverride||_.defineHiddenProperty(b.prototype,d,function(){return e(this)})})}},function(l,m){$extensionMethods(Function,{$:$method(_.partial),$$:$method(_.tails),bind:_.bind,partial:_.partial,calls:_.bind,tails:_.tails,tails2:_.tails2,tails3:_.tails3,applies:_.applies,compose:_.compose,then:_.then,flip:_.flip,"with":_.flipN,flip2:_.flip2,flip3:_.flip3,asFreeFunction:_.asFreeFunction,
...
or:_.or,and:_.and,not:_.not,"new":_.higherOrder(_["new"]),each:function(b,a){return _.each2(a,b)},map:function(b,a){return _.map2(a,b)},oneShot:function(b){var a=!1;return function(){if(!a)return a=!0,b.apply(this,arguments)}},memoized:_.memoize,throttled:_.throttle,debounced:function(b,a,c){var d,e,f,h,k,n=function(){var p=Date.now()-d;p<a&&0<p?e=setTimeout(n,a-p):(e=null,c||(f=b.apply(k,h),e||(k=h=null)))},p=function(){k=this;h=arguments;d=Date.now();var p=c&&!e;e||(e=setTimeout(n,a));p&&(f=b.apply(k,
...
_.dashesToCamelCase=function(b){return b.replace(/(-.)/g,function(a){return a[1].uppercase})};_.loDashesToCamelCase=function(b){return b.replace(/(_.)/g,function(a){return a[1].uppercase})}},function(l,m){(function(){var b=["onceBefore","onceAfter","onBefore","onAfter","intercept"],a=function(a,d){if("function"!==typeof a)throw Error("method should be a function");return _.extend({},a,{_bindable:!0,impl:a,_wrapped:a,context:d,off:function(a){_.each(b,function(b){a?this["_"+b].remove(a):this["_"+b].removeAll()},
this);return this}},_.object(_.map(b,function(a){var b="_"+a,c=0<=a.indexOf("once");return[a,function(a){if(!_.isBindable(this))throw Error("wrong this");var d=this[b];(!c||0>d.indexOf(a))&&this[b].push(a);return this}]})),_.object(_.map(b,function(a){return["_"+a,[]]})))};_.extend(_,_.mapObject(_.invert(b),function(a){return function(b,e,f){var h=b[e];b=_.isBindable(h)?h:b[e]=_.bindable(h);return b[a].call(b,f)}}.flip2),{unbind:function(a,b,e){(a=a[b])&&a.off&&a.off(e)},isBindable:function(a){return a&&
a._bindable?!0:!1},bindable:_.extendWith({hooks:b,hooksShort:["onceBefore","onceAfter","before","after","intercept"]},function(b,d){return _.withSameArgs(b,_.extendWith(a(b,d),function(){var a=arguments.callee,f=a._onceBefore,h=a._onceAfter,k=a._onBefore,n=a._onAfter,p=a._intercept,a=d||this,l,m;if(f.length){l=0;for(m=f.length;l<m;l++)f[l].apply(a,arguments);f.removeAll()}l=0;for(m=k.length;l<m;l++)k[l].apply(a,arguments);f=(p.length?_.cps.compose([b].concat(p)):b).apply(a,arguments);if(n.length||
h.length){k=_.asArray(arguments).concat(f);l=0;for(m=n.length;l<m;l++)n[l].apply(a,k);if(h.length)for(n=h.copy,h.removeAll(),l=0,m=n.length;l<m;l++)n[l].apply(a,k)}return f}))})})})()},function(l,m){_.extend(_,{gatherChanges:function(b){var a=_.isArray(b)?b:_.initial(arguments),c=_.last(arguments),d=function(b){c.apply(this,_.pluck(a,"value"))};_.each(a,function(a){a(d)})},allTriggered:function(b,a){var c=[];0<b.length?_.each(b,function(d){d(function(){c=_.union(c,[d]);a&&c.length===b.length&&(a(),
a=void 0)})}):a()},observableRef:function(b){return _.extend(_.observable.apply(this,arguments),{trackReference:!0})},observable:function(b){var a=_.stream({isObservable:!0,hasValue:0<arguments.length,value:_.isFunction(b)?void 0:b,read:function(b){return function(d){a.hasValue&&d.call(this,a.value);b.call(this,d)}},write:function(b){return function(d){a.beforeWrite&&(d=a.beforeWrite(d));if(!a.hasValue||(a.trackReference?a.value!==d:!_.isEqual(a.value,d))){var e=a.value,f=a.hasValue;a.hasValue=!0;
a.value=d;f?b.call(this,!1,a.value,e):b.call(this,!1,a.value)}}}});arguments.length&&a.apply(this,arguments);return _.extend(a,{force:function(b){a.hasValue=!1;a(b||a.value)},then:function(b){var d=_.observable();d.beforeWrite=b;a(function(a){d.write(a)});return d},toggle:function(){return a(!a.value)},tie:function(b){a(b);b(a);return a},item:function(b){var d=a.itemObservables||(a.itemObservables={}),e=d[b];e||(e=d[b]=_.observable((a.value&&a.value)[b]),e(function(d){(a.value&&a.value[d])!==d&&((a.value||
(a.value={}))[b]=d,a.force())}),a(function(a){e.write(a[b])}));return e},when:function(b,d){var e=_.isFunction(b)?b:_.equals(b),f=!1;a(function(b){e(b)&&!f&&(f=!0,a.off(arguments.callee),d.apply(this,arguments))})}})},barrier:function(b){var a=void 0;_.isFunction(b)&&(a=b,b=void 0);var c=_.stream({already:void 0!==b,value:b,reset:function(){c.already=!1;delete c.value},write:function(a){return function(b){c.already||(c.already=!0,c.value=b);a.call(this,!0,c.value)}},read:function(a){return function(b){c.already?
...
off:function(b,a){b.queue&&(1===arguments.length?b.queue.off():b.queue.off(a));b.queuedBy&&(_.each(b.queuedBy,function(a){a.remove(b)}),delete b.queuedBy)},stream:function(b){b=b||{};var a=_.extend([],{off:function(a){this.length&&(0===arguments.length?(_.each(this,function(a){a.queuedBy.remove(this)},this),this.removeAll()):a.queuedBy&&(a.queuedBy.remove(this),this.remove(a)))}}),c=void 0,d=b.write(function(b,d){var e=_.rest(arguments),n=c.context||this,l=a.copy;b&&a.off();c.commitingReads=!0;for(var m=
...
arguments)}})}});_.observable.map=function(b,a){a=a||_.identity;var c=_.isArray(b)?Array(b.length):{},d=_.observable(c);_.each(b,function(b,f){b(function(b){c[f]=a(b,f);d.force(c)})});return d};_.observable.all=_.observable.map},function(l,m){_.hasOOP=!0;_("property static final alias memoized private builtin hidden testArguments".split(" ")).each(Tags.define);$prototype=function(b,a){return $prototype.impl.compile.apply($prototype.impl,1<arguments.length?_.asArray(arguments).reverse():arguments)};
...
","+this.y+"}"});Bezier={cubic:function(a,b,d,e,f){var h=a*a*a,k=a*a,n=3*(d.x-b.x),l=3*(d.y-b.y),m=3*(e.x-d.x)-n;d=3*(e.y-d.y)-l;return new Vec2((f.x-b.x-n-m)*h+m*k+n*a+b.x,(f.y-b.y-l-d)*h+d*k+l*a+b.y)},cubic1D:function(a,b,d,e,f){return Bezier.cubic(a,Vec2.zero,new Vec2(b,d),new Vec2(e,f),Vec2.one).y},make:{cubic:function(a,b,d,e){return function(f){return Bezier.cubic(f,a,b,d,e)}},cubic1D:function(a,b,d,e){return function(f){return Bezier.cubic1D(f,a,b,d,e)}}}};BBox=$prototype({$static:{zero:$property(function(){return new BBox(0,
...
_.extend(a.x>this.right?{right:!0}:{},a.x<this.left?{left:!0}:{},a.y>this.bottom?{bottom:!0}:{},a.y<this.top?{top:!0}:{});return _.extend(a,a.left||a.right||a.bottom||a.top?{}:{inside:!0})},classifyRay:function(a,b,d){var e=this.size.half,f,h,k,n,l,m;f=1/b.x;h=1/b.y;l=Math.sign(f);m=Math.sign(h);k=(this.x-l*e.x-a.x)*f;n=(this.y-m*e.y-a.y)*h;f*=this.x+l*e.x-a.x;e=(this.y+m*e.y-a.y)*h;if(!(k>e||n>f||(h=k>n?k:n,1<=h||0>=(f<e?f:e))))return f={time:_.clamp(h,0,1)},f.normal=k>n?new Vec2(-l,0):new Vec2(0,
-m),f.delta=b.scale(f.time),f.where=a.add(f.delta),d&&(k=this.grow(-d),f.where.x>k.right?f.where.y<k.top?f=Intersect.rayCircle(a,b,k.rightTop,d):f.where.y>k.bottom&&(f=Intersect.rayCircle(a,b,k.rightBottom,d)):f.where.x<k.left&&(f.where.y<k.top?f=Intersect.rayCircle(a,b,k.leftTop,d):f.where.y>k.bottom&&(f=Intersect.rayCircle(a,b,k.leftBottom,d))),f&&f.insideOut&&(f.where=a)),f},nearestPointTo:function(a,b){var d=b||0,e=new Vec2(this.left,this.top),f=new Vec2(this.right,this.top),h=new Vec2(this.right,
this.bottom),k=new Vec2(this.left,this.bottom),d=[a.projectOnLineSegment(e.add(d,0),f.add(-d,0)),a.projectOnLineSegment(f.add(0,d),h.add(0,-d)),a.projectOnLineSegment(h.add(-d,0),k.add(d,0)),a.projectOnLineSegment(k.add(0,-d),e.add(0,d)),a.projectOnCircle(e.add(d,d),d),a.projectOnCircle(f.add(-d,d),d),a.projectOnCircle(h.add(-d,-d),d),a.projectOnCircle(k.add(d,-d),d)];return _.min(d,function(b){return a.sub(b).length})},xywh:$property(function(){return{x:this.x,y:this.y,width:this.width,height:this.height}}),
...
a[1],d=a[2];a=_.hue2RGB(a[0]);b*=1-Math.abs(2*d-1);return[(a[0]-.5)*b+d,(a[1]-.5)*b+d,(a[2]-.5)*b+d]};_.hue2RGB=function(a){return[Math.max(0,Math.min(1,Math.abs(6*a-3)-1)),Math.max(0,Math.min(1,2-Math.abs(6*a-2))),Math.max(0,Math.min(1,2-Math.abs(6*a-4)))]};_.RGB2CSS=function(a,b){return"rgba("+Math.round(255*a[0])+","+Math.round(255*a[1])+","+Math.round(255*a[2])+","+(void 0===b?void 0===a[3]?1:a[3]:b)+")"};_.RGB2HSL=function(a,b){var d=a[0],e=a[1],f=a[2],h=void 0===b?a[3]:b,k=Math.max(d,e,f),l=
Math.min(d,e,f),p,m=(k+l)/2;if(k==l)p=l=0;else{var q=k-l,l=.5<m?q/(2-k-l):q/(k+l);switch(k){case d:p=(e-f)/q+(e<f?6:0);break;case e:p=(f-d)/q+2;break;case f:p=(d-e)/q+4}p/=6}return void 0===h?[p,l,m]:[p,l,m,h]};_.extend(Math,function(a){return{roundTo:function(a,b){return a-a%b},round10:function(b,d){return a("round",b,d)},floor10:function(b,d){return a("floor",b,d)},ceil10:function(b,d){return a("ceil",b,d)}}}(function(a,b,d){if("undefined"===typeof d||0===+d)return Math[a](b);b=+b;d=+d;if(isNaN(b)||
"number"!==typeof d||0!==d%1)return NaN;b=b.toString().split("e");b=Math[a](+(b[0]+"e"+(b[1]?+b[1]-d:-d)));b=b.toString().split("e");return+(b[0]+"e"+(b[1]?+b[1]+d:d))}));(function(){var a=b(23);Array.prototype.topoSort=function(){return a(this)}})();Array.prototype.topoMerge=function(){for(var a=[],b=0,d=this.length;b<d;b++)for(var e=this[b],f=0,h=e.length-1;f<h;f++)a.push([e[f],e[f+1]]);return a.topoSort()};DAG=function(a){this.cfg=a||{};this.nodes=a.nodes||_.noop};DAG.prototype.each=function(a,
b,d,e){e=e||new Set;if(!e.has(a)){e.add(a);var f=this,h=this.nodes(a)||[];!0!==b.call(this,a,{nodes:h,prev:d,visited:e})&&h.forEach(function(d){f.each(d,b,a,e)})}return e};DAG.prototype.edges=function(a){var b=[];this.each(a,function(a,e){e.nodes.concat(a).reduce(function(a,d){b.push([a,d]);return d})});return b};DAG.prototype.sortedSubgraphOf=function(a){return this.edges(a).topoSort().remove(a)};DAG.sortedSubgraphOf=function(a,b){return(new DAG(b)).sortedSubgraphOf(a)}},function(l,m){function b(a,
b){function d(k,l,m){if(0<=m.indexOf(k))throw Error("Cyclic dependency: "+JSON.stringify(k));if(!~a.indexOf(k))throw Error("Found unknown node. Make sure to provided all involved nodes. Unknown node: "+JSON.stringify(k));if(!h[l]){h[l]=!0;var q=b.filter(function(a){return a[0]===k});if(l=q.length){m=m.concat(k);do{var r=q[--l][1];d(r,a.indexOf(r),m)}while(l)}f[--e]=k}}for(var e=a.length,f=Array(e),h={},k=e;k--;)h[k]||d(a[k],k,[]);return f}l.exports=m=function(a){for(var c=[],d=0,e=a.length;d<e;d++){var f=
...
isNaN(a)?0:isNaN(b)?-1:isNaN(a)?1:b<a?-1:b>a?1:0},generic:function(b,a){return b||a?b?a?b<a?-1:b>a?1:0:1:-1:0},inverse:function(b){return function(a,c){return-b(a,c)}},field:function(b,a,c){return function(d,e){return a(d[b],e[b])*c}}}},function(l,m){Lock=$prototype({acquire:function(b){this.wait(this.$(function(){this.waitQueue||(this.waitQueue=[]);b()}))},acquired:function(){return void 0!==this.waitQueue},wait:function(b){this.acquired()?this.waitQueue.push(b):b()},release:function(){if(this.waitQueue.length){var b=
...
var e=[],f={init:!0};_.each(d,function(a,b){if(void 0!==a){if(a.$observableProperty){var d=a.subject,l=b in c?c[b]:d,m=b+"Change",q=f[m]=this[m]=_.observable();q.context=this;q.postpones=a.$postpones;if(_.isPrototypeInstance(d)){var r=d.constructor;q.beforeWrite=function(a){return r.isTypeOf(a)?a:new r(a)}}a.$reference&&(q.trackReference=!0);_.defineProperty(this,b,{get:function(){return q.value},set:function(a){q.write.call(this,a)}});a.listeners&&_.each(a.listeners,function(a){e.push([q,a])});_.isFunction(a.$observableProperty)&&
e.push([q,a.$observableProperty]);void 0!==l&&q(l)}else if(Component.isStreamDefinition(a)){var v=f[b]=this[b]=_.extend((a.$trigger?_.trigger:a.$triggerOnce?_.triggerOnce:a.$observable?_.observable:a.$barrier?_.barrier:void 0)(a.subject),{context:this,postpones:a.$postpones});a.$reference&&(q.trackReference=!0);a.listeners&&_.each(a.listeners,function(a){e.push([v,a])});_.isFunction(a.$observable)&&e.push([v,a.$observable]);(d=c[b])&&(a.$observable&&d.isObservable?d.tie(v):e.push([v,d]))}a.$listener&&
...
b){a&&e(a);d(b)}))})}}))})},function(l,m){$global.Channel=$extends(Promise,{constructor:function(b,a,c){this.after=[];this.state="pending";this.value=void 0;this.transducers={resolve:a&&a.resolve||function(a){return a},reject:a&&a.reject||function(a){throw a;}};if(b instanceof Function)try{b.call(this,this.$(this.resolve),this.$(this.reject))}catch(d){this.reject(d)}else void 0!==b&&this.resolve(b)},_resolve:function(b){this.state="resolved";this.value=b;this.after.forEach(function(a){return a.resolve(b)})},
...
"X-File-Name":Parse.fileName(a.name||"file").transliterate||"file","X-File-Size":a.size,"X-File-Type":a.type}},c))}})],request:function(b,a,c){var d=c||{},e=void 0;c=new Promise(function(c,h){if($platform.Browser){var k=new XMLHttpRequest;k.open(b,(d.protocol||d.hostname||d.port?(d.protocol||window.location.protocol)+"//"+(d.hostname||window.location.hostname)+":"+(d.port||window.location.port):"")+a,!0);d.responseType&&(k.responseType=d.responseType);_.each(d.headers,function(a,b){k.setRequestHeader(b,
a)});d.progress&&(k.onprogress=Http.progressCallbackWithSimulation(d.progress));k.onreadystatechange=function(){if(4===k.readyState){d.progress&&d.progress(1);var a="arraybuffer"===k.responseType?k.response:k.responseText;200===k.status?c(a):h(_.extend(Error(k.statusText),{httpResponse:a,httpStatus:k.status}))}};e=function(){k.abort();h("aborted")};d.data?k.send(d.data):k.send()}else h("not implemented")});return _.extend(c,{abort:e})},progressCallbackWithSimulation:function(b){var a=0;b(0);return function(c){c.lengthComputable?
