...
a(b[c],c,b);if("boolean"!==typeof e)return e;if(!0===e)return b[c]}else if(_.isStrictlyObject(b))for(var c=0,f=Object.keys(b),d=f.length;c<d;c++){var h=f[c],e=a(b[h],h,b);if("boolean"!==typeof e)return e;if(!0===e)return b[h]}};_.findFind=function(b,a){return _.hyperOperator(_.unary,function(b,d){if(_.isArrayLike(b))for(var e=0,f=b.length;e<f;e++){var h=d(b[e]);if("boolean"!==typeof h)return h;if(!0===h)return b[e]}else if(_.isStrictlyObject(b))for(var e=0,k=Object.keys(b),f=k.length;e<f;e++){var n=
k[e],h=d(b[n]);if("boolean"!==typeof h)return h;if(!0===h)return b[n]}h=a(b);return"boolean"!==typeof h?h:!0===h?b:!1})(b,a)};_.nonempty=function(b){return _.filter2(b,_.isNonempty)};_.extend(_,{clone:function(b){return b instanceof Set?new Set(b):_.isObject(b)?_.isArray(b)?b.slice():_.extend({},b):b},cloneDeep:_.tails2(_.mapMap,function(b){return _.isStrictlyObject(b)&&!_.isPrototypeInstance(b)?_.clone(b):b})});_.hyperMatch=_.hyperOperator(_.binary,function(b,a,c){return _.coerceToUndefined(_.nonempty(_.zip2(b,
...
{matches:Tags.matches(b),is:function(a){return a instanceof Tags&&f in a||!1},isNot:function(a){return!(a instanceof Tags&&f in a)||!1},unwrap:function(a){return!0===$atom.matches(a)?Tags.unwrap(a):a}})}});$global.$untag=Tags.unwrap;["constant","get","once","async","atom"].forEach(Tags.define);$jscomp.initSymbol();if("undefined"!==typeof Symbol){var c=b(12);$jscomp.initSymbol();Tags.prototype[Symbol["for"]("String.ify")]=function(a){if(a.json)return a.goDeeper($untag(this));var b=Tags.get(this),f=
_.reduce(b,function(b,c,e){return _.isBoolean(c)?e+" ("+b:e+" ("+a.goDeeper(c,{pretty:!1})+", "+b},"");return c(f,a.goDeeper($untag(this)))+")".repeats(_.keys(b).length)}}},function(l,m){l.exports=function(b,a){var c=Array.isArray(a),d=c?a:a.split("\n"),e=b.replace(/[^\s]/g," "),d=d.map(function(a,c){return 0===c?b+a:e+a});return c?d:d.join("\n")}},function(l,m){_.hasTypeMatch=!0;Tags.define("required");Tags.define("atom");$global["const"]("$any",_.identity);(function(){_.isMeta=function(a){return a===
$any||!0===$atom.is(a)||!0===$required.is(a)};var b=function(a,b,c){var d=Tags.unwrapAll(_.filter2(a,$required.matches));a=_.nonempty(_.zip2(Tags.unwrapAll(a),b,c));if(_.isEmpty(d))return a;c=_.nonempty(_.zip2(d,b,c));return _.values2(d).length===_.values2(c).length?a:_.coerceToEmpty(b)},a=_.hyperOperator(_.binary,function(a,c,d){var k=Tags.unwrap(a);if(_.isArray(k)){if(_.isArray(c))return b(_.times(c.length,_.constant(k[0])),c,d)}else if(_.isStrictlyObject(k)&&k["*"]){if(_.isStrictlyObject(c))return b(_.extend(_.map2(c,
...
function(a){return a[0]+"-"+a[1].lowercase})};_.camelCaseToLoDashes=function(b){return b.replace(/[a-z][A-Z]/g,function(a){return a[0]+"_"+a[1].lowercase})};_.dashesToCamelCase=function(b){return b.replace(/(-.)/g,function(a){return a[1].uppercase})};_.loDashesToCamelCase=function(b){return b.replace(/(_.)/g,function(a){return a[1].uppercase})}},function(l,m){(function(){var b=["onceBefore","onceAfter","onBefore","onAfter","intercept"],a=function(a,d){if("function"!==typeof a)throw Error("method should be a function");
...
b=_.isBindable(h)?h:b[e]=_.bindable(h);return b[a].call(b,f)}}.flip2),{unbind:function(a,b,e){(a=a[b])&&a.off&&a.off(e)},isBindable:function(a){return a&&a._bindable?!0:!1},bindable:_.extendWith({hooks:b,hooksShort:["onceBefore","onceAfter","before","after","intercept"]},function(b,d){return _.withSameArgs(b,_.extendWith(a(b,d),function(){var a=arguments.callee,f=a._onceBefore,h=a._onceAfter,k=a._onBefore,n=a._onAfter,p=a._intercept,a=d||this,l,m;if(f.length){l=0;for(m=f.length;l<m;l++)f[l].apply(a,
arguments);f.removeAll()}l=0;for(m=k.length;l<m;l++)k[l].apply(a,arguments);f=(p.length?_.cps.compose([b].concat(p)):b).apply(a,arguments);if(n.length||h.length){k=_.asArray(arguments).concat(f);l=0;for(m=n.length;l<m;l++)n[l].apply(a,k);if(h.length)for(n=h.copy,h.removeAll(),l=0,m=n.length;l<m;l++)n[l].apply(a,k)}return f}))})})})()},function(l,m){_.extend(_,{gatherChanges:function(b){var a=_.isArray(b)?b:_.initial(arguments),c=_.last(arguments),d=function(b){c.apply(this,_.pluck(a,"value"))};_.each(a,
...
d?0:this.sub(a).dot(b)/d}});$jscomp.initSymbol();"undefined"!==typeof Symbol&&($jscomp.initSymbol(),Vec2.prototype[Symbol["for"]("String.ify")]=function(){return"{"+this.x+","+this.y+"}"});Bezier={cubic:function(a,b,d,e,f){var h=a*a*a,k=a*a,n=3*(d.x-b.x),l=3*(d.y-b.y),m=3*(e.x-d.x)-n;d=3*(e.y-d.y)-l;return new Vec2((f.x-b.x-n-m)*h+m*k+n*a+b.x,(f.y-b.y-l-d)*h+d*k+l*a+b.y)},cubic1D:function(a,b,d,e,f){return Bezier.cubic(a,Vec2.zero,new Vec2(b,d),new Vec2(e,f),Vec2.one).y},make:{cubic:function(a,b,
...
b);d=Math.min(a.y,d);e=Math.max(a.x,e);f=Math.max(a.y,f)});return BBox.fromLTRB(b,d,e,f)}},constructor:function(a,b,d,e){4==arguments.length?(this.x=a,this.y=b,this.width=d,this.height=e):_.extend(this,a)},classifyPoint:function(a){a=_.extend(a.x>this.right?{right:!0}:{},a.x<this.left?{left:!0}:{},a.y>this.bottom?{bottom:!0}:{},a.y<this.top?{top:!0}:{});return _.extend(a,a.left||a.right||a.bottom||a.top?{}:{inside:!0})},classifyRay:function(a,b,d){var e=this.size.half,f,h,k,n,l,m;f=1/b.x;h=1/b.y;
l=Math.sign(f);m=Math.sign(h);k=(this.x-l*e.x-a.x)*f;n=(this.y-m*e.y-a.y)*h;f*=this.x+l*e.x-a.x;e=(this.y+m*e.y-a.y)*h;if(!(k>e||n>f||(h=k>n?k:n,1<=h||0>=(f<e?f:e))))return f={time:_.clamp(h,0,1)},f.normal=k>n?new Vec2(-l,0):new Vec2(0,-m),f.delta=b.scale(f.time),f.where=a.add(f.delta),d&&(k=this.grow(-d),f.where.x>k.right?f.where.y<k.top?f=Intersect.rayCircle(a,b,k.rightTop,d):f.where.y>k.bottom&&(f=Intersect.rayCircle(a,b,k.rightBottom,d)):f.where.x<k.left&&(f.where.y<k.top?f=Intersect.rayCircle(a,
b,k.leftTop,d):f.where.y>k.bottom&&(f=Intersect.rayCircle(a,b,k.leftBottom,d))),f&&f.insideOut&&(f.where=a)),f},nearestPointTo:function(a,b){var d=b||0,e=new Vec2(this.left,this.top),f=new Vec2(this.right,this.top),h=new Vec2(this.right,this.bottom),k=new Vec2(this.left,this.bottom),d=[a.projectOnLineSegment(e.add(d,0),f.add(-d,0)),a.projectOnLineSegment(f.add(0,d),h.add(0,-d)),a.projectOnLineSegment(h.add(-d,0),k.add(d,0)),a.projectOnLineSegment(k.add(0,-d),e.add(0,d)),a.projectOnCircle(e.add(d,
d),d),a.projectOnCircle(f.add(-d,d),d),a.projectOnCircle(h.add(-d,-d),d),a.projectOnCircle(k.add(d,-d),d)];return _.min(d,function(b){return a.sub(b).length})},xywh:$property(function(){return{x:this.x,y:this.y,width:this.width,height:this.height}}),ltwh:$property(function(){return{left:this.left,top:this.top,width:this.width,height:this.height}}),union:function(a){return BBox.fromLTRB(Math.min(this.left,a.left),Math.min(this.top,a.top),Math.max(this.right,a.right),Math.max(this.bottom,a.bottom))},
...
function(a,b){return"rgba("+Math.round(255*a[0])+","+Math.round(255*a[1])+","+Math.round(255*a[2])+","+(void 0===b?void 0===a[3]?1:a[3]:b)+")"};_.RGB2HSL=function(a,b){var d=a[0],e=a[1],f=a[2],h=void 0===b?a[3]:b,k=Math.max(d,e,f),l=Math.min(d,e,f),p,m=(k+l)/2;if(k==l)p=l=0;else{var q=k-l,l=.5<m?q/(2-k-l):q/(k+l);switch(k){case d:p=(e-f)/q+(e<f?6:0);break;case e:p=(f-d)/q+2;break;case f:p=(d-e)/q+4}p/=6}return void 0===h?[p,l,m]:[p,l,m,h]};_.extend(Math,function(a){return{roundTo:function(a,b){return a-
a%b},round10:function(b,d){return a("round",b,d)},floor10:function(b,d){return a("floor",b,d)},ceil10:function(b,d){return a("ceil",b,d)}}}(function(a,b,d){if("undefined"===typeof d||0===+d)return Math[a](b);b=+b;d=+d;if(isNaN(b)||"number"!==typeof d||0!==d%1)return NaN;b=b.toString().split("e");b=Math[a](+(b[0]+"e"+(b[1]?+b[1]-d:-d)));b=b.toString().split("e");return+(b[0]+"e"+(b[1]?+b[1]+d:d))}));(function(){var a=b(23);Array.prototype.topoSort=function(){return a(this)}})();Array.prototype.topoMerge=
...
d]);return d})});return b};DAG.prototype.sortedSubgraphOf=function(a){return this.edges(a).topoSort().remove(a)};DAG.sortedSubgraphOf=function(a,b){return(new DAG(b)).sortedSubgraphOf(a)}},function(l,m){function b(a,b){function d(k,l,m){if(0<=m.indexOf(k))throw Error("Cyclic dependency: "+JSON.stringify(k));if(!~a.indexOf(k))throw Error("Found unknown node. Make sure to provided all involved nodes. Unknown node: "+JSON.stringify(k));if(!h[l]){h[l]=!0;var q=b.filter(function(a){return a[0]===k});if(l=
q.length){m=m.concat(k);do{var r=q[--l][1];d(r,a.indexOf(r),m)}while(l)}f[--e]=k}}for(var e=a.length,f=Array(e),h={},k=e;k--;)h[k]||d(a[k],k,[]);return f}l.exports=m=function(a){for(var c=[],d=0,e=a.length;d<e;d++){var f=a[d];0>c.indexOf(f[0])&&c.push(f[0]);0>c.indexOf(f[1])&&c.push(f[1])}return b(c,a)};m.array=b},function(l,m){Parse={keyCodeAsString:function(b){return String.fromCharCode(96<=b&&105>=b?b-48:b)},fileName:function(b){return _.first(_.last(b.split(/\\|\//)).split("."))}}},function(l,
m){Sort={Ascending:1,Descending:-1,strings:function(b,a){b=$.trim(b).toLowerCase();a=$.trim(a).toLowerCase();return 0==b.length&&0<a.length?1:0<b.length&&0==a.length?-1:b==a?0:b<a?-1:1},numbers:function(b,a){return isNaN(b)&&isNaN(a)?0:isNaN(b)?-1:isNaN(a)?1:b<a?-1:b>a?1:0},generic:function(b,a){return b||a?b?a?b<a?-1:b>a?1:0:1:-1:0},inverse:function(b){return function(a,c){return-b(a,c)}},field:function(b,a,c){return function(d,e){return a(d[b],e[b])*c}}}},function(l,m){Lock=$prototype({acquire:function(b){this.wait(this.$(function(){this.waitQueue||
...
e(b)})})})})};$global.$scope=function(b){var a=void 0;return _.argumentPrependingWrapper(Tags.unwrap(b),function(b){var d={when:void 0};(a=a||[]).push(d);b(function(b){if(d.when)throw Error("$scope: release called twice");for(d.when=b;a&&a.last&&a.last.when;)b=a.last.when,(a=_.initial(a)).isEmpty&&(a=void 0),b()})})};$platform.NodeJS&&(l.exports=_)},function(l,m){$global.$component=function(b){return $extends(Component,b)};_("extendable trigger triggerOnce barrier bindable memoize interlocked memoizeCPS debounce throttle overrideThis listener postpones reference raw binds observes".split(" ")).each(Tags.define);
...
function(b){b=$untag(b);if(_.isFunction(b)){var c="_"+a[0];(f[c]||(f[c]=[])).push(b)}})});b[d]=$bindable({hooks:f},Tags.clone(c))}},this);return b}},isStreamDefinition:$static(function(b){return _.isObject(b)&&(b.$trigger||b.$triggerOnce||b.$barrier||b.$observable||b.$observableProperty)}),mapMethods:function(){var b=_.last(arguments),a=1===arguments.length?_.constant(!0):arguments[0],c;for(c in this){var d=this.constructor.$definition[c];if(!d||!d.$property){var e=this[c];_.isFunction(e)&&!_.isPrototypeConstructor(e)&&
a(d)&&(this[c]=b.call(this,e,c,d)||e)}}},enumMethods:function(b,a){2===arguments.length?this.mapMethods(b,a.returns(void 0)):this.mapMethods(b.returns(void 0))},constructor:$final(function(b,a){this.parent_=void 0;this.children_=[];var c=this.cfg="object"===typeof b?b:{},d=this.constructor.$definition;this.constructor.$defaults&&(c=this.cfg=_.extend(_.cloneDeep(this.constructor.$defaults),c));this.mapMethods(function(a,b,c){if(!("$"===b||"init"===b||c&&c.$raw))return this.$(a)});_.onBefore(this,"destroy",
this._beforeDestroy);_.onAfter(this,"destroy",this._afterDestroy);var e=[],f={init:!0};_.each(d,function(a,b){if(void 0!==a){if(a.$observableProperty){var d=a.subject,l=b in c?c[b]:d,m=b+"Change",q=f[m]=this[m]=_.observable();q.context=this;q.postpones=a.$postpones;if(_.isPrototypeInstance(d)){var r=d.constructor;q.beforeWrite=function(a){return r.isTypeOf(a)?a:new r(a)}}a.$reference&&(q.trackReference=!0);_.defineProperty(this,b,{get:function(){return q.value},set:function(a){q.write.call(this,a)}});
a.listeners&&_.each(a.listeners,function(a){e.push([q,a])});_.isFunction(a.$observableProperty)&&e.push([q,a.$observableProperty]);void 0!==l&&q(l)}else if(Component.isStreamDefinition(a)){var v=f[b]=this[b]=_.extend((a.$trigger?_.trigger:a.$triggerOnce?_.triggerOnce:a.$observable?_.observable:a.$barrier?_.barrier:void 0)(a.subject),{context:this,postpones:a.$postpones});a.$reference&&(q.trackReference=!0);a.listeners&&_.each(a.listeners,function(a){e.push([v,a])});_.isFunction(a.$observable)&&e.push([v,
a.$observable]);(d=c[b])&&(a.$observable&&d.isObservable?d.tie(v):e.push([v,d]))}a.$listener&&(this[b].queuedBy=[]);a.$interlocked&&(this[b]=_.interlocked(this[b]));a.$bindable&&(this[b]=_.extend(_.bindable(this[b],this),_.map2(a.$bindable.hooks||{},_.mapsWith(this.$.bind(this).arity1))));a.$debounce&&(d=this[b],l=_.coerceToObject(a.$debounce),this[b]=d.debounced(l.wait||500,l.immediate));a.$throttle&&(d=this[b],l=_.coerceToObject(a.$throttle),this[b]=_.throttle(d,l.wait||500,l));a.$memoize?this[b]=
...
function(b){return new Promise(function(d,e){_.cps.each(b,function(b,c,d){Promise.coerce(a(b,c)).then(d)["catch"](e)},d)})})};__.seq=function(b){return _.reduce2(b,__.then)};__.all=function(b){return Promise.all(_.map(b,__))};__.race=function(b){return Promise.race(_.map(b,__))};$mixin(Function,{promisifyAll:$static(function(b,a){a=a||{};var c=a.except||_.noop;c instanceof Array&&(c=c.asSet.matches);var d={},e;for(e in b){var f=b[e];f instanceof Function?(f=f.bind(b),d[e]=c(e)?f:f.promisify):d[e]=
f}return d}),promisify:$hidden($property(function(){var b=this;return function(){var a=this,c=arguments;return new Promise(function(d,e){b.apply(a,_.asArray(c).concat(function(a,b){a&&e(a);d(b)}))})}}))})},function(l,m){$global.Channel=$extends(Promise,{constructor:function(b,a,c){this.after=[];this.state="pending";this.value=void 0;this.transducers={resolve:a&&a.resolve||function(a){return a},reject:a&&a.reject||function(a){throw a;}};if(b instanceof Function)try{b.call(this,this.$(this.resolve),
...
function(b){return new Channel(function(a){return a(b)})};Channel.reject=function(b){return new Channel(function(a,c){return c(b)})};$prototype.macroTag("channel",function(b,a,c){var d="_"+c,e=$untag(a);b[c]=Tags.modify(a,function(){return $property({get:function(){return this[d]||(this[d]=new Channel(e))},set:function(a){this[c].resolve(a)}})})})},function(l,m){Http=$singleton(Component,{$traits:[HttpMethods=$trait({get:function(b,a){return this.request("GET",b,a)},post:function(b,a){return this.request("POST",
b,a)},loadFile:function(b,a){return this.request("GET",b,{responseType:"arraybuffer"})},uploadFile:function(b,a,c){return this.post(b,_.extend2({data:a,headers:{"Content-Type":"binary/octet-stream","X-File-Name":Parse.fileName(a.name||"file").transliterate||"file","X-File-Size":a.size,"X-File-Type":a.type}},c))}})],request:function(b,a,c){var d=c||{},e=void 0;c=new Promise(function(c,h){if($platform.Browser){var k=new XMLHttpRequest;k.open(b,(d.protocol||d.hostname||d.port?(d.protocol||window.location.protocol)+
"//"+(d.hostname||window.location.hostname)+":"+(d.port||window.location.port):"")+a,!0);d.responseType&&(k.responseType=d.responseType);_.each(d.headers,function(a,b){k.setRequestHeader(b,a)});d.progress&&(k.onprogress=Http.progressCallbackWithSimulation(d.progress));k.onreadystatechange=function(){if(4===k.readyState){d.progress&&d.progress(1);var a="arraybuffer"===k.responseType?k.response:k.responseText;200===k.status?c(a):h(_.extend(Error(k.statusText),{httpResponse:a,httpStatus:k.status}))}};
e=function(){k.abort();h("aborted")};d.data?k.send(d.data):k.send()}else h("not implemented")});return _.extend(c,{abort:e})},progressCallbackWithSimulation:function(b){var a=0;b(0);return function(c){c.lengthComputable?b(c.loaded/c.total):b(a=1<(a+=.1)?0:a)}}});JSONAPI=$singleton(Component,{$traits:[HttpMethods],request:function(b,a,c){c=_.extend2({headers:{"Cache-Control":"no-cache","Content-Type":"application/json; charset=utf-8"}},c);c.what&&(c.data=JSON.stringify(c.what));var d=_.hasReflection&&
...
_.barrier());_.tests.NodePlus={"tree splitting":function(){Testosterone.defineAssertions({assertSplitAtBr:function(a,b){var d=N.div.html(a);d.splitSubtreeBefore(d.one("br"));return _.assert(d.innerHTML,b)}});$assertSplitAtBr("<b><br>foo</b>","<b><br>foo</b>");$assertSplitAtBr("<b>foo<br></b>","<b>foo</b><b><br></b>");$assertSplitAtBr("<b>foo<i>bar<br>baz</i>qux</b>","<b>foo<i>bar</i></b><b><i><br>baz</i>qux</b>")}}})()},function(l,m){DOMReference=$trait({domReady:$barrier(function(b){this.dom=b;this.el=
