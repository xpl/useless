...
c=function(){return this}();try{c=c||Function("return this")()||(0,eval)("this")}catch(a){"object"===typeof window&&(c=window)}m.exports=c},function(m,n,c){m.exports=function(){var a=c(34),b=Function.bind.call(Function.call,Array.prototype.reduce),d=Function.bind.call(Function.call,Object.prototype.propertyIsEnumerable),h=Function.bind.call(Function.call,Array.prototype.concat);Object.values||(Object.values=function(c){return b(a(c),function(a,b){return h(a,"string"===typeof b&&d(c,b)?[c[b]]:[])},
[])});Object.entries||(Object.entries=function(c){return b(a(c),function(a,b){return h(a,"string"===typeof b&&d(c,b)?[[b,c[b]]]:[])},[])});return Object}()},function(m,n,c){(function(a){("undefined"===typeof window?a:window).Base64={_keyStr:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",encode:function(a){var d="",c,f,e,k,p,l,w=0;for(a=Base64._utf8_encode(a);w<a.length;)c=a.charCodeAt(w++),f=a.charCodeAt(w++),e=a.charCodeAt(w++),k=c>>2,c=(c&3)<<4|f>>4,p=(f&15)<<2|e>>6,l=e&63,
isNaN(f)?p=l=64:isNaN(e)&&(l=64),d=d+Base64._keyStr.charAt(k)+Base64._keyStr.charAt(c)+Base64._keyStr.charAt(p)+Base64._keyStr.charAt(l);return d},decode:function(a){var d="",c,f,e,k,p,l=0;for(a=a.replace(/[^A-Za-z0-9\+\/\=]/g,"");l<a.length;)c=Base64._keyStr.indexOf(a.charAt(l++)),f=Base64._keyStr.indexOf(a.charAt(l++)),k=Base64._keyStr.indexOf(a.charAt(l++)),p=Base64._keyStr.indexOf(a.charAt(l++)),c=c<<2|f>>4,f=(f&15)<<4|k>>2,e=(k&3)<<6|p,d+=String.fromCharCode(c),64!=k&&(d+=String.fromCharCode(f)),
...
d){return a+d}).join(" "))throw Error("_.zipWith broken");},function(m,n){_.cps=function(){return _.cps.sequence.apply(null,arguments)};_.cps.apply=function(c,a,b,d){b=_.asArray(b);var h=_.numArgs(c)-1,f=b[h];b[h]=function(){d.call(this,arguments,f)};return c.apply(a,b)};_.extend(_.cps,{each:function a(b,d,h,f,e,k){var p=h||_.noop,l=function(a,h,f){2===_.numArgs(d)?d(a,f,p,b):d(a,h,f,p,b)};if(_.isEmpty(b))p();else if(_.isScalar(b))l(b,void 0,p);else if(f=f||0,k=0===f?void 0===b.length?_.keys(b):void 0:
k,e=0===f?k?k.length:b.length:e,f>=(e||0))p();else{var w=k?k[f]:f;l(b[w],w,a.bind(this,b,d,h,f+1,e,k))}}});_.extend(_.cps,{map:function(a,b,d){var h=_.isArray(a)?[]:{};_.cps.each(a,2==_.numArgs(b)?function(d,a,k){b(d,function(d){h[a]=d;k()})}:function(d,a,k){b(d,a,function(d){h[a]=d;k()})},function(){d(h)})}});_.extend(_.cps,{find:function(a,b,d){var h=2!==_.numArgs(b);_.cps.each(a,function(d,a,k,p){var l=function(b){!1===b?k():p(!0===b?d:b,a)};h?b(d,a,l):b(d,l)},d)}});_.extend(_.cps,{memoize:function(a){return _.barrier?
_.cps._betterMemoize(a):_.cps._poorMemoize(a)},_poorMemoize:function(a){var b={};return function(d,h){d in b?h(b[d]):a.call(this,d,function(a){h(b[d]=a)})}},_betterMemoize:function(a){var b={};switch(_.numArgs(a)){case 1:return function(d){b.already||a.call(this,b=_.barrier());b(d)};case 2:return b={},function(d,h){d in b||a.call(this,d,b[d]=_.barrier());b[d](h)};default:throw Error("_.cps.memoize: unsupported number of arguments");}}});(function(){var a=function d(a,f,e,k,p){!a||p>=(a.length||0)?
e(k):f(k,a[p],function(k){d(a,f,e,k,p+1)})};_.cps.reduce=function(d,h,f,e){4>arguments.length?a(d,h,f,d[0],1):a(d,h,f,e,0)}})();_.extend(_.cps,{noop:$restArg(function(){return _.last(arguments).call(this)}),identity:$restArg(function(){var a=_.initial(arguments),b=_.last(arguments);if(b)return b.apply(this,a)}),constant:$restArg(function(){var a=arguments;return function(){return _.last(arguments).apply(this,a)}})});_.cps.arity0=function(a){return function(){a.call(this,_.last(arguments))}};_.cps.arity1=
...
_.isArray(a)&&a||_.asArray(arguments);return _.reduceRight(b,function(d,a){return function(){return a.apply(this,_.asArray(arguments).concat(d))}},_.cps.identity)});_.cps.compose=$restArg(function(a){var b=_.isArray(a)&&a||_.asArray(arguments);return _.cps.sequence(b.slice().reverse())});_.cps.trySequence=function(a,b,d){_.reduceRight(a,function(a,f){return function(e){if(_.isTypeOf(Error,e))return(d||b)(e);try{return f.apply(this,_.asArray(arguments).concat(a))}catch(k){return(d||b)(k)}}},b)()}},
...
"rejected"===this.state&&b.reject(this.value);return b},"catch":function(c){return this.then(void 0,c)}});Channel.all=function(c){return new Channel(function(a){var b=new Set,d=Array(c.length);c.forEach(function(c,f){c.then(function(c){d[f]=c;b.length===d.length?a(d):b.add(f)})})})};Channel.resolve=function(c){return new Channel(function(a){return a(c)})};Channel.reject=function(c){return new Channel(function(a,b){return b(c)})};$prototype.macroTag("channel",function(c,a,b){var d="_"+b,h=$untag(a);
c[b]=Tags.modify(a,function(){return $property({get:function(){return this[d]||(this[d]=new Channel(h))},set:function(d){this[b].resolve(d)}})})})},function(m,n){$jscomp.initSymbol();$jscomp.initSymbol();$jscomp.initSymbolIterator();var c="function"===typeof Symbol&&"symbol"===typeof Symbol.iterator?function(a){return typeof a}:function(a){$jscomp.initSymbol();$jscomp.initSymbol();return a&&"function"===typeof Symbol&&a.constructor===Symbol?"symbol":typeof a};_.hasOOP=!0;_("property static final alias memoized private builtin hidden testArguments".split(" ")).each(Tags.define);
...
a||{}).constructor},convertPropertyAccessors:function(a){var b=!0,d=!1,c=void 0;try{$jscomp.initSymbol();$jscomp.initSymbolIterator();for(var f=Object.getOwnPropertyNames(a)[Symbol.iterator](),e;!(b=(e=f.next()).done);b=!0){var k=e.value,p=Object.getOwnPropertyDescriptor(a,k);(p.get instanceof Function||p.set instanceof Function)&&Object.defineProperty(a,k,{value:$property(p)})}}catch(l){d=!0,c=l}finally{try{!b&&f["return"]&&f["return"]()}finally{if(d)throw c;}}return a},flatten:function(a){var b=
...
b?void 0:!0===b?[d,a]:[b,a]})},d)};__.each=function(a,b){return __.then(a,function(d){return new Promise(function(a,c){_.cps.each(d,function(d,a,h){Promise.coerce(b(d,a)).then(h)["catch"](c)},a)})})};__.seq=function(a){return _.reduce2(a,__.then)};__.all=function(a){return Promise.all(_.map(a,__))};__.race=function(a){return Promise.race(_.map(a,__))};$mixin(Function,{promisifyAll:$static(function(a,b){b=b||{};var d=b.except||_.noop;d instanceof Array&&(d=d.asSet.matches);var c={},f;for(f in a){var e=
...
b){return-c(a,b)}},field:function(c,a,b){return function(d,h){return a(d[c],h[c])*b}}}},function(m,n){$jscomp.initSymbol();$jscomp.initSymbol();$jscomp.initSymbolIterator();var c="function"===typeof Symbol&&"symbol"===typeof Symbol.iterator?function(a){return typeof a}:function(a){$jscomp.initSymbol();$jscomp.initSymbol();return a&&"function"===typeof Symbol&&a.constructor===Symbol?"symbol":typeof a};$global.$component=function(a){return $extends(Component,a)};_("extendable trigger triggerOnce barrier bindable memoize interlocked memoizeCPS debounce throttle overrideThis listener postpones reference raw binds observes".split(" ")).each(Tags.define);
...
Error("invalid $traits value");(c=c.$definition[a])&&(d=_.extendedDeep($untag(c),d))});return d}))});return b}},mergeTraitsMembers:function(a,b){var d={},c={},f={},e=$untag(a.$macroTags),k=_.pluck(b,"$definition").concat(_.clone(a));_.each(k,function(b){_.each(e&&this.applyMacroTags(e,_.extend(_.clone(b),{constructor:a.constructor}))||b,function(b,e){$builtin.isNot(b)&&$builtin.isNot(a[e])&&"constructor"!==e&&($bindable.is(b)&&(c[e]=b),Component.isStreamDefinition(b)&&(f[e]=b),(d[e]||(d[e]=[])).push(b),
...
u);if(c.length)for(l=c.copy,c.removeAll(),q=0,r=l.length;q<r;q++)l[q].apply(n,u)}return a}))})})})()},function(m,n){_.extend(_,{gatherChanges:function(){for(var c=arguments.length,a=Array(c),b=0;b<c;b++)a[b]=arguments[b];var d=_.isArray(a[0])?a[0]:_.initial(a),h=_.last(a),f=function(a){h.apply(this,_.pluck(d,"value"))};_.each(d,function(d){d(f)})},allTriggered:function(c,a){var b=[];0<c.length?_.each(c,function(d){d(function(){b=_.union(b,[d]);a&&b.length===c.length&&(a(),a=void 0)})}):a()},observableRef:function(){for(var c=
...
b:!_.isEqual(d.value,b))){var c=d.value,k=d.hasValue;d.hasValue=!0;d.value=b;k?a.call(this,!1,d.value,c):a.call(this,!1,d.value)}}}});a.length&&d.apply(this,a);return _.extend(d,{force:function(a){d.hasValue=!1;d(a||d.value)},then:function(a){var b=_.observable();b.beforeWrite=a;d(function(d){b.write(d)});return b},toggle:function(){return d(!d.value)},tie:function(a){d(a);a(d);return d},item:function(a){var b=d.itemObservables||(d.itemObservables={}),c=b[a];c||(c=b[a]=_.observable((d.value&&d.value)[a]),
c(function(b){(d.value&&d.value[b])!==b&&((d.value||(d.value={}))[a]=b,d.force())}),d(function(d){c.write(d[a])}));return c},when:function(a,b){var c=_.isFunction(a)?a:_.equals(a),k=!1;d(function l(){for(var a=arguments.length,h=Array(a),m=0;m<a;m++)h[m]=arguments[m];c(h[0])&&!k&&(k=!0,d.off(l),b.apply(this,h))})}})},barrier:function(c){var a=void 0;_.isFunction(c)&&(a=c,c=void 0);var b=_.stream({already:void 0!==c,value:c,reset:function(){b.already=!1;delete b.value},write:function(d){return function(a){b.already||
...
0>=arguments.length?void 0:arguments[0];this.length&&(0===arguments.length?(_.each(this,function(a){a.queuedBy.remove(this)},this),this.removeAll()):a.queuedBy&&(a.queuedBy.remove(this),this.remove(a)))}}),d=void 0,h=c.write(function(a){var c=d.context||this,f=b.copy;a&&b.off();d.commitingReads=!0;for(var h=arguments.length,m=Array(1<h?h-1:0),n=1;n<h;n++)m[n-1]=arguments[n];h=0;for(n=f.length;h<n;h++)(d.postpones?f[h].postponed:f[h]).apply(c,m);delete d.commitingReads}),f=c.read(function(a){0>b.indexOf(a)&&
(a.queuedBy?a.queuedBy.push(b):a.queuedBy=[b],b.push(a))});return d=_.extend($restArg(function k(){for(var a=arguments.length,d=Array(a),b=0;b<a;b++)d[b]=arguments[b];a=d[0];_.isFunction(a)?f.call(this,a):h.apply(this,d);return k}),c,{queue:b,once:function(a){_.find(b,function(d){return d.onceWrapped_===a})||f(_.extend(function l(b){_.off(d,l);a(b)},{onceWrapped_:a}))},off:_.off.asMethod,read:f,write:h,postpone:function(){for(var b=arguments.length,c=Array(b),f=0;f<b;f++)c[f]=arguments[f];a.postponed.apply(d.context,
...
{httpResponse:a,httpStatus:l.status}))}};e=function(){l.abort();h("aborted")};f.data?l.send(f.data):l.send()}else h("not implemented")});return _.extend(c,{abort:e})},progressCallbackWithSimulation:function(a){var d=0;a(0);return function(c){c.lengthComputable?a(c.loaded/c.total):a(d=1<(d+=.1)?0:d)}}});$global.JSONAPI=$singleton(Component,{$traits:[HttpMethods],request:function(b,d,h){h=_.extend2({headers:{"Cache-Control":"no-cache","Content-Type":"application/json; charset=utf-8"}},h);h.what&&(h.data=
JSON.stringify(h.what));var f=_.hasReflection&&new StackTracey;return Http.request(b,"/api/"+d,h)["finally"](function(a,d){if(d)return JSON.parse(d);if(a){if(a.httpResponse)return JSON.parse(a.httpResponse);throw a;}throw Error("empty response");}).then(function(d){if(d.success)return d.value;if(d.parsedStack){$jscomp.initSymbol();$jscomp.initSymbol();var b="undefined"!==typeof Symbol?Symbol["for"]("StackTracey"):"__StackTracey",h=d.parsedStack.map(function(d){return a.assign(d,{file:"/api/source/"+
d.file})}).concat(f||[]);throw a.assign(Error("SERVER: "+d.error),c({remote:!0},b,h));}throw Error(d.error);})}})},function(m,n){$extensionMethods(Array,{each:_.each,map:_.map,fold:_.reduce2,reduce:_.reduce,reduceRight:_.reduceRight,zip:_.zipWith,groupBy:_.groupBy,indexBy:_.indexBy,find:_.find,findWhere:$method(_.findWhere),filter:_.filter,reject:$method(_.reject),flat:_.flatten.tails2(!0),object:_.fromPairs,shuffle:_.shuffle,nonempty:_.nonempty,pluck:$method(_.pluck),without:$method(_.without),join:function(c){return $forceOverride(function(a,
...
or:_.or,and:_.and,not:_.not,"new":_.higherOrder(_["new"]),each:function(c,a){return _.each2(a,c)},map:function(c,a){return _.map2(a,c)},oneShot:function(c){var a=!1;return function(){if(!a)return a=!0,c.apply(this,arguments)}},memoized:_.memoize,throttled:_.throttle,debounced:function(c,a,b){var d,h,f,e,k,p=function E(){var p=Date.now()-d;p<a&&0<p?h=setTimeout(E,a-p):(h=null,b||(f=c.apply(k,e),h||(k=e=null)))},l=function(){k=this;e=arguments;d=Date.now();var l=b&&!h;h||(h=setTimeout(p,a));l&&(f=c.apply(k,
e),k=e=null);return f};l.cancel=function(){h&&(clearTimeout(h),h=null)};l.callImmediately=function(){l.cancel();c.apply(k,e)};return l},postpone:$method(function(c){c.postponed.apply(null,arguments)}),postponed:function(c){return function(){var a=!c._postponed;c._postponed=_.asArray(arguments);c._postponedThis=this;a&&_.delay(function(){var a=c._postponed,d=c._postponedThis;c._postponed=void 0;c._postponedThis=void 0;c.apply(d,a)})}},delay:_.delay,delayed:function(c,a){return function(){var b=arguments,
d=this;_.delay(function(){c.apply(d,b)},a)}}});$extensionMethods(Function,{catch_:function(c,a,b,d){return c.catches(a,b)()},catches:function(c,a,b,d){var h=arguments.length;a=1<h?_.coerceToFunction(a):_.identity;b=2<h?_.coerceToFunction(b):_.identity;d=3<h?_.coerceToFunction(d):_.identity;return function(){var f=void 0,h=!1;try{f=c.apply(this,arguments)}catch(k){f=a(k),h=!0}h||(f=b(f));return d(f)}}})},function(m,n){$extensionMethods(String,{quote:_.quote,concatPath:function(c,a){var b="/"===c[c.length-
...
bytes:function(c){for(var a=new Uint8Array(c.length),b=0;b<c.length;++b)a[b]=c.charCodeAt(b);return a},hash:function(c){var a=0,b,d,h;if(0===c.length)return a;b=0;for(h=c.length;b<h;b++)d=c.charCodeAt(b),a=(a<<5)-a+d,a|=0;return a},transliterate:function(){var c=_.extend({"\u0430":"a","\u0431":"b","\u0432":"v","\u0433":"g","\u0434":"d","\u0435":"e","\u0451":"yo","\u0436":"zh","\u0437":"z","\u0438":"i","\u0439":"y","\u043a":"k","\u043b":"l","\u043c":"m","\u043d":"n","\u043e":"o","\u043f":"p","\u0440":"r",
"\u0441":"s","\u0442":"t","\u0443":"u","\u0444":"ph","\u0445":"h","\u0446":"ts","\u0447":"ch","\u0448":"sh","\u0449":"sch","\u044c":"","\u044a":"","\u044b":"y","\u044d":"e","\u044e":"yu","\u044f":"ya"},_.fromPairs(_.map("_-1234567890qwertyuiopasdfghjklzxcvbnm",function(a){return[a,a]})));return function(a){var b="";a=(a||"").toLowerCase();for(var d=0,h=a.length;d<h;d++)b+=c[a[d]]||"";return b}}()});_.extend(String,{randomHex:function(c){void 0===c&&(c=_.random(1,32));for(var a="",b=0;b<c;b++)a+=Math.floor(16*
...
function(m,n){["method","property","flipped","forceOverride"].forEach(Tags.define);$global.$extensionMethods=function(c,a){_.each(a,function(a,d){var h=Tags.unwrap(a);d in _||(_[d]=_[d]||h);if(a.$method||!a.$property&&!_.oneArg(h)){if(a.$property)throw Error("$extensionMethods: crazy input, unable to match");d in c.prototype&&!a.$forceOverride||(c.prototype[d]=_.asMethod(a.$flipped?_.flip(h):h))}else d in c.prototype&&!a.$forceOverride||_.defineHiddenProperty(c.prototype,d,function(){return h(this)})})}},
...
2,a.x,a.y)},fromSize:function(a,b){return b?new BBox(-a/2,-b/2,a,b):new BBox(-a.x/2,-a.y/2,a.x,a.y)},fromPoints:function(a){var b=Number.MAX_VALUE,c=Number.MAX_VALUE,e=Number.MIN_VALUE,k=Number.MIN_VALUE;_.each(a,function(a){b=Math.min(a.x,b);c=Math.min(a.y,c);e=Math.max(a.x,e);k=Math.max(a.y,k)});return BBox.fromLTRB(b,c,e,k)}},constructor:function(a,b,c,e){4==arguments.length?(this.x=a,this.y=b,this.width=c,this.height=e):_.extend(this,a)},classifyPoint:function(a){a=_.extend(a.x>this.right?{right:!0}:
{},a.x<this.left?{left:!0}:{},a.y>this.bottom?{bottom:!0}:{},a.y<this.top?{top:!0}:{});return _.extend(a,a.left||a.right||a.bottom||a.top?{}:{inside:!0})},classifyRay:function(a,b,c){var e=this.size.half,k,p,l,m,n,q;k=1/b.x;p=1/b.y;n=Math.sign(k);q=Math.sign(p);l=(this.x-n*e.x-a.x)*k;m=(this.y-q*e.y-a.y)*p;k*=this.x+n*e.x-a.x;e=(this.y+q*e.y-a.y)*p;if(!(l>e||m>k||(p=l>m?l:m,1<=p||0>=(k<e?k:e))))return k={time:_.clamp(p,0,1)},k.normal=l>m?new Vec2(-n,0):new Vec2(0,-q),k.delta=b.scale(k.time),k.where=
a.add(k.delta),c&&(l=this.grow(-c),k.where.x>l.right?k.where.y<l.top?k=Intersect.rayCircle(a,b,l.rightTop,c):k.where.y>l.bottom&&(k=Intersect.rayCircle(a,b,l.rightBottom,c)):k.where.x<l.left&&(k.where.y<l.top?k=Intersect.rayCircle(a,b,l.leftTop,c):k.where.y>l.bottom&&(k=Intersect.rayCircle(a,b,l.leftBottom,c))),k&&k.insideOut&&(k.where=a)),k},nearestPointTo:function(a,b){var c=b||0,e=new Vec2(this.left,this.top),k=new Vec2(this.right,this.top),p=new Vec2(this.right,this.bottom),l=new Vec2(this.left,
this.bottom),c=[a.projectOnLineSegment(e.add(c,0),k.add(-c,0)),a.projectOnLineSegment(k.add(0,c),p.add(0,-c)),a.projectOnLineSegment(p.add(-c,0),l.add(c,0)),a.projectOnLineSegment(l.add(0,-c),e.add(0,c)),a.projectOnCircle(e.add(c,c),c),a.projectOnCircle(k.add(-c,c),c),a.projectOnCircle(p.add(-c,-c),c),a.projectOnCircle(l.add(c,-c),c)];return _.min(c,function(b){return a.sub(b).length})},xywh:$property(function(){return{x:this.x,y:this.y,width:this.width,height:this.height}}),ltwh:$property(function(){return{left:this.left,
...
_.call=function(c,a){for(var b=arguments.length,d=Array(2<b?b-2:0),h=2;h<b;h++)d[h-2]=arguments[h];return c.apply(a,d)};_.arity=function(c,a){return function(){for(var b=arguments.length,d=Array(b),h=0;h<b;h++)d[h]=arguments[h];return a.apply(this,d.slice(0,c))}};_.arity0=function(c){return function(){return c.call(this)}};_.arity1=function(c){return function(a){return c.call(this,a)}};_.arity2=function(c){return function(a,b){return c.call(this,a,b)}};_.arity3=function(c){return function(a,b,d){return c.call(this,
...
function(){return a.apply(this,_.asArray(arguments).concat(c))})}});_.argumentAppendingWrapper=function(c,a){return _.withSameArgs(c,function(){var b=this,d=_.asArray(arguments);return a(function(){return c.apply(b,d.concat(_.asArray(arguments)))})})};_.argumentPrependingWrapper=function(c,a){return _.withSameArgs(c,function(){var b=this,d=_.asArray(arguments);return a(function(){return c.apply(b,_.asArray(arguments).concat(d))})})};_["new"]=$restArg(function(c,a,b,d,h){switch(arguments.length){case 1:return new c;
case 2:return new c(a);case 3:return new c(a,b);case 4:return new c(a,b,d);case 5:return new c(a,b,d,h);default:_.notImplemented()}});_.flipN=function(c){return $restArg(function(){return c.apply(this,_.asArray(arguments).reverse())})};_.flip=function(c){if(_.restArg(c))return _.flipN(c);switch(_.numArgs(c)){case 0:case 1:return c;case 2:return _.flip2(c);case 3:return _.flip3(c);default:throw Error("flip: unsupported arity");}};_.flip2=function(c){return function(a,b){return c.call(this,b,a)}};_.flip3=
function(c){return function(a,b,d){return c.call(this,d,b,a)}};_.or=function(c,a){return function(){return c.apply(this,arguments)||a.apply(this,arguments)}};_.and=function(c,a){return function(){return c.apply(this,arguments)&&a.apply(this,arguments)}};_.not=function(c){return function(){return!c.apply(this,arguments)}};_.extend(_,{Y:function(c){var a=c(function(){return a.apply(this,arguments)});return a}});(function(){_.hyperOperator=function(c,a,b,d){var h=_.arityFn(c)||_.identity,f=(b||_.goDeeperWhenFirstArgumentIsGood)(c,
d||_.isNonTrivial);return function(){var b=_.last(arguments);return _.Y(function(c){var d=_.tails(a,h(c));return function(){return(f(arguments)?d:b).apply(this,arguments)}}).apply(this,_.initial(arguments))}};_.goDeeperWhenFirstArgumentIsGood=function(c,a){return function(b){return 0<b.length?a(b[0]):!1}};_.goDeeperAlwaysIfPossible=function(c,a){return 0===c?_.constant(!1):1===c?function(b){return a(b[0])}:2===c?function(b){return a(b[0])||a(b[1])}:function(b){return _.some(_.asArray(b),a)}};_.goDeeperOnlyWhenNessesary=
...
c};_.evals=function(c){var a=arguments;return function(b){return _.isFunction(b)?b.apply(this,a):b}};_.method=function(c){for(var a=arguments.length,b=Array(1<a?a-1:0),d=1;d<a;d++)b[d-1]=arguments[d];return function(a){return a[c].apply(a,b)}};_.asFreeFunction=function(c){return function(a){for(var b=arguments.length,d=Array(1<b?b-1:0),h=1;h<b;h++)d[h-1]=arguments[h];return c.apply(a,d)}};_.asMethod=function(c){return function(){return c.apply(void 0,[this].concat(_.asArray(arguments)))}};_.once=
function(c){var a=!1;return function(){if(!a)return a=!0,c.apply(this,arguments)}};_.withTimeout=function(c,a,b){var d=!1,h=setTimeout(function(){d=!0;c.expired&&c.expired(b)},c.maxTime);a(function(){d||(clearTimeout(h),b&&b.apply(this,arguments))})};_.sequence=function(c){var a=_.isArray(c)?c:_.asArray(arguments),b=a.length;return 0===b?_.identity:function(c){for(var h=0;h<b;h++)c=a[h].call(this,c);return c}};_.seq=_.sequence;_.then=function(c,a){return function(b){var d=c.apply(this,arguments);
...
Tags?a.assign(this,Tags.get(b)):this}});a.assign(Tags,{omit:$restArg(function(a){if(a instanceof Tags){for(var b=arguments.length,c=Array(1<b?b-1:0),e=1;e<b;e++)c[e-1]=arguments[e];var k=_.index(c),b=_.pick(a,function(a,b){return"$"===b[0]&&!(b in k)});return _.isEmptyObject(b)?a.subject:new Tags(a.subject,b)}return a}),clone:function(a,b){return a instanceof Tags?a.clone(b):b||a},extend:function(a,b){return a instanceof Tags?a.clone().extend(b):b instanceof Tags?Tags.wrap(a).extend(b):a},get:function(a){return a instanceof
...
function(a){throw a;});_.overrideThis=_.throwsError("override this");_.notImplemented=_.throwsError("not implemented");_.mixin({values2:function(a){return _.isArrayLike(a)?a:_.isStrictlyObject(a)?_.values(a):_.isEmpty(a)?[]:[a]}});_.mixin({map2:function(a,b,c){return _.isArrayLike(a)?_.map(a,b,c):a instanceof Set?_.mapSet(a,b,c):_.isStrictlyObject(a)?_.mapValues(a,b,c):b.call(c,a)}});_.mapSet=function(a,b,c){var e=new Set,k=!0,p=!1,l=void 0;try{$jscomp.initSymbol();$jscomp.initSymbolIterator();for(var m=
a[Symbol.iterator](),n;!(k=(n=m.next()).done);k=!0)e.add(b.call(c,n.value))}catch(q){p=!0,l=q}finally{try{!k&&m["return"]&&m["return"]()}finally{if(p)throw l;}}return e};_.mapsWith=_.higherOrder(_.mapWith=_.flip2(_.map2));_.pluck2=function(a,b){return _.map2(a,_.property(b))};_.mixin({scatter:function(a,b){var c=void 0;_.map2(a,function(a,d){b(a,d,function(a,b){2>arguments.length?(c=c||[]).push(a):(c=c||{})[b]=a})});return c}});_.obj=function(a){var b=void 0;a(function(a,c){(b=b||{})[c]=a});return b};
...
_.reduceRight(arguments,function(b,c){return _.fromPairs(_.map(_.union(_.keys(c),_.keys(b)),function(d){var k=c[d];return[d,d in b?"object"===("undefined"===typeof k?"undefined":a(k))?_.extend(k,b[d]):b[d]:k]}))},{}))});_.find2=function(a,b){if(_.isArrayLike(a))for(var c=0,e=a.length;c<e;c++){var k=b(a[c],c,a);if("boolean"!==typeof k)return k;if(!0===k)return a[c]}else if(_.isStrictlyObject(a))for(var c=0,p=Object.keys(a),e=p.length;c<e;c++){var l=p[c],k=b(a[l],l,a);if("boolean"!==typeof k)return k;
if(!0===k)return a[l]}};_.findFind=function(a,b){return _.hyperOperator(_.unary,function(a,c){if(_.isArrayLike(a))for(var d=0,p=a.length;d<p;d++){var l=c(a[d]);if("boolean"!==typeof l)return l;if(!0===l)return a[d]}else if(_.isStrictlyObject(a))for(var d=0,m=Object.keys(a),p=m.length;d<p;d++){var n=m[d],l=c(a[n]);if("boolean"!==typeof l)return l;if(!0===l)return a[n]}l=b(a);return"boolean"!==typeof l?l:!0===l?a:!1})(a,b)};_.nonempty=function(a){return _.filter2(a,_.isNonempty)};_.extend(_,{clone:function(a){return a instanceof
...
_.undiff=_.tails3(_.hyperMatch,function(a,b){return $atom.unwrap(a)===$atom.unwrap(b)||a===$any||b===$any?b:void 0});_.extend(_,{index:function(a){for(var b={},c=0,e=a.length;c<e;c++)b[a[c]]=!0;return b}});_.quote=function(a,b){var c=b||"",e=Math.floor(c.length/2+c.length%2),k=c.slice(0,e),c=c.slice(e)||k;return k+a+c};_.quoteWith=_.flip2(_.quote);_.quotesWith=_.higherOrder(_.quoteWith);_.partition2=function(a,b){return _.pluck(_.partition3(a,b),"items")};_.partition3=function(a,b){var c=a||[],e=
[],k={label:void 0,items:[c.first]};_.each(c,function(a){var c=b(a);k.label!=c&&k.items.length?e.push(k={label:c,items:[a]}):k.items.push(a)});return k.length&&e.push(k),e};(function(){var a=function(a){var b={};_.each(a,function(a,c){b[a]=b[a]||[];b[a].push(c)});return b};_.longestCommonSubstring=function(a,b){var c=_.indexOfLongestCommonSubstring(a,b);return c.length?a.substr(c.a,c.length):void 0};_.indexOfLongestCommonSubstring=function(b,c){var e={a:0,b:0,length:0},k=a(b),p=[];_.each(c,function(a,
...
append:$alias("appendChildren"),appendChildren:function(a,b){for(var c=void 0===b?_.coerceToArray(a):arguments,h=0,f=c.length;h<f;h++){var e=c[h];this.appendChild(_.isString(e)?document.createTextNode(e):e)}return this},removeChildren:function(a){a=_.coerceToArray(a);for(var b=0,c=a.length;b<c;b++)this.removeChild(a[b]);return this},removeAllChildren:function(){return this.removeChildren(this.childNodesArray)},walkTree:function(a,b){b=1===arguments.length?a:b;for(var c,h=document.createTreeWalker(this,
a&&a.what||NodeFilter.SHOW_ALL,a&&a.filter||null,a&&a.entityReferenceExpansion||null);c=h.nextNode();)b(c)},firstInnermostChild:$callableAsMethod($property(function(a){for(;a&&a.firstChild;)a=a.firstChild;return a})),unwrapChildren:$callableAsFreeFunction(function(){this.insertAfterMe(this.childNodesArray);var a=this.parentNode;a.removeChild(this);return a}),prevSiblings:$property(function(){for(var a=[],b=this.previousSibling;b;)a.push(b),b=b.previousSibling;return a.reversed}),nextNextSibling:$property(function(){return this.nextSibling&&
...
0,window.innerWidth||document.documentElement.clientWidth,window.innerHeight||document.documentElement.clientHeight)}});document.on("DOMContentLoaded",document.ready=_.barrier())},function(m,n){m.exports=function(c,a){var b=Array.isArray(a),d=b?a:a.split("\n"),h=c.replace(/[^\s]/g," "),d=d.map(function(a,b){return 0===b?c+a:h+a});return b?d:d.join("\n")}},function(m,n){m.exports="object"===typeof Reflect&&"function"===typeof Reflect.ownKeys?Reflect.ownKeys:"function"===typeof Object.getOwnPropertySymbols?
function(c){return Object.getOwnPropertyNames(c).concat(Object.getOwnPropertySymbols(c))}:Object.getOwnPropertyNames},function(m,n){function c(a,b){function c(k,l,m){if(0<=m.indexOf(k))throw Error("Cyclic dependency: "+JSON.stringify(k));if(!~a.indexOf(k))throw Error("Found unknown node. Make sure to provided all involved nodes. Unknown node: "+JSON.stringify(k));if(!e[l]){e[l]=!0;var n=b.filter(function(a){return a[0]===k});if(l=n.length){m=m.concat(k);do{var q=n[--l][1];c(q,a.indexOf(q),m)}while(l)}f[--h]=
k}}for(var h=a.length,f=Array(h),e={},k=h;k--;)e[k]||c(a[k],k,[]);return f}m.exports=n=function(a){for(var b=[],d=0,h=a.length;d<h;d++){var f=a[d];0>b.indexOf(f[0])&&b.push(f[0]);0>b.indexOf(f[1])&&b.push(f[1])}return c(b,a)};n.array=c},function(m,n,c){var a,b;(function(){function c(a){return function(b,c,d,e){c=A(c,e,4);var f=!v(b)&&g.keys(b),k=(f||b).length,h=0<a?0:k-1;3>arguments.length&&(d=b[f?f[h]:h],h+=a);for(var l=c,m=d;0<=h&&h<k;h+=a)var n=f?f[h]:h,m=l(m,b[n],n,b);return m}}function h(a){return function(b,
c,d){c=t(c,d);d=y(b);for(var g=0<a?0:d-1;0<=g&&g<d;g+=a)if(c(b[g],g,b))return g;return-1}}function f(a,b,c){return function(d,e,f){var k=0,h=y(d);if("number"==typeof f)0<a?k=0<=f?f:Math.max(f+h,k):h=0<=f?Math.min(f+1,h):f+h+1;else if(c&&f&&h)return f=c(d,e),d[f]===e?f:-1;if(e!==e)return f=b(q.call(d,k,h),g.isNaN),0<=f?f+k:-1;for(f=0<a?k:h-1;0<=f&&f<h;f+=a)if(d[f]===e)return f;return-1}}function e(a,b){var c=L.length,d=a.constructor,d=g.isFunction(d)&&d.prototype||w,e="constructor";for(g.has(a,e)&&
!g.contains(b,e)&&b.push(e);c--;)e=L[c],e in a&&a[e]!==d[e]&&!g.contains(b,e)&&b.push(e)}var k=this,p=k._,l=Array.prototype,w=Object.prototype,E=l.push,q=l.slice,r=w.toString,u=w.hasOwnProperty,D=Array.isArray,M=Object.keys,F=Function.prototype.bind,O=Object.create,G=function(){},g=function(a){if(a instanceof g)return a;if(!(this instanceof g))return new g(a);this._wrapped=a};"undefined"!==typeof m&&m.exports&&(n=m.exports=g);n._=g;g.VERSION="1.8.3";var A=function(a,b,c){if(void 0===b)return a;switch(null==
...
for(var g=1;g<d;g++)for(var e=arguments[g],f=a(e),k=f.length,h=0;h<k;h++){var l=f[h];b&&void 0!==c[l]||(c[l]=e[l])}return c}},P=function(a){if(!g.isObject(a))return{};if(O)return O(a);G.prototype=a;a=new G;G.prototype=null;return a},C=function(a){return function(b){return null==b?void 0:b[a]}},T=Math.pow(2,53)-1,y=C("length"),v=function(a){a=y(a);return"number"==typeof a&&0<=a&&a<=T};g.each=g.forEach=function(a,b,c){b=A(b,c);var d;if(v(a))for(c=0,d=a.length;c<d;c++)b(a[c],c,a);else{var e=g.keys(a);
...
"undefined"===typeof window?a:window;a.$uselessFile="useless.client.js";a._=m.exports=c(3);_.tests={};_.deferTest=_.withTest=function(a,c,h){h()};c(2);c(25);c(21);c(23);c(22);c(28);c(27);c(26);c(24);c(29);c(4);c(19);c(17);c(16);c(18);c(13);c(14);c(6);c(20);c(7);c(10);c(12);c(11);c(9);c(8);c(5);c(15);c(32);c(30);c(31)}).call(n,c(0))}]);
