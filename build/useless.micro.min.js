...
_.find2=function(a,b){if(_.isArray(a))for(var c=0,d=a.length;c<d;c++){var e=b(a[c],c,a);if("boolean"!==typeof e)return e;if(!0===e)return a[c]}else if(_.isStrictlyObject(a))for(var c=0,g=Object.keys(a),d=g.length;c<d;c++){var f=g[c],e=b(a[f],f,a);if("boolean"!==typeof e)return e;if(!0===e)return a[f]}};
...
_.partition3=function(a,b){var c=[],d={label:void 0,items:[a.first]};_.each(a,function(a){var g=b(a);d.label!=g&&d.items.length?c.push(d={label:g,items:[a]}):d.items.push(a)});return d.length&&c.push(d),c};
...
_.sortBy(a.next||[],b.sort):a.next||[];return[a].concat(f(_.reduce(c,function(a,b){if(a===b)return a;if(g(b,a))return b.next.push(a),b;a.next.push(b);return a})))};return _.rest(_.pluck(f(e({},c)),"item"))};
(function(){var a=function(a){var c={};_.each(a,function(a,b){c[a]=c[a]||[];c[a].push(b)});return c};_.longestCommonSubstring=function(a,c){var d=_.indexOfLongestCommonSubstring(a,c);return d.length?a.substr(d.a,d.length):void 0};_.indexOfLongestCommonSubstring=function(b,c){var d={a:0,b:0,length:0},e=a(b),g=[];_.each(c,function(a,b){var c,l=[];_.each(e[a]||[],function(a){c=(a&&g[a-1]||0)+1;c>d.length&&(d.length=c,d.a=a-c+1,d.b=b-c+1);l[a]=c});g=l});return d}})();
...
a.limitedTo(e.pure?Number.MAX_SAFE_INTEGER:40));if(_.isTypeOf(Tags,a))return _.reduce(Tags.get(a),function(a,d,e){return _.isBoolean(d)?e+" "+a.quote("()"):e+" ("+_.stringifyImpl(d,b,c,0,{pretty:!1})+", "+a+")"},_.stringifyImpl($untag(a),b,c,d+1,e));if(!e.pure&&_.hasOOP&&_.isPrototypeInstance(a)&&$prototype.defines(a.constructor,"toString"))return a.toString();if(!_.isObject(a)||"undefined"!==typeof $atom&&$atom.is(a))return _.isDecimal(a)&&0<e.precision?_.toFixed(a,e.precision):a+"";if(g=_.find2(_.builtInTypes,
function(b,c){return $global[c]&&a instanceof $global[c]&&c+" "+_.stringifyOneLine(_.omitTypeMismatches(b,a))||!1}))return g;var f=_.isArray(a),g=e.pretty||!1;if("browser"===_.platform().engine){if(_.isTypeOf(Element,a))return(a.tagName.lowercase+(a.id&&"#"+a.id||"")+(a.className&&"."+a.className||"")).quote("<>");if(_.isTypeOf(Text,a))return"@"+a.wholeText.limitedTo(20)}if(a.toJSON)return _.quoteWith('"',a.toJSON());if(!e.pure&&(d>(e.maxDepth||5)||f&&a.length>(e.maxArrayLength||30)))return f?"<array["+
a.length+"]>":"<object>";var h=b.concat([a]);c.push(a);var k=_.pairs(a),l=_.stringifyImpl.tails2(h,c,d+1,e),n=e.json?'""':"";if(g){k=_.values(a);d=_.alignStringsRight(_.keys(a).map(_.quotesWith(n).then(_.appends(": "))));e=k.map(l);var g=e.map(function(a,b){return"["===a[0]||"{"===a[0]?3:_.isString(k[b])?1:0}),m=_.max(g);e=[g,e].zip(function(a,b){return" ".repeats(m-a)+b});d=f?e:[d,e].zip(_.bullet);d=_.bullet(f?"[ ":"{ ",d.join(",\n"));e=d.split("\n");return d+(" ".repeats(_.max(e.map(_.count))-_.count(e.last))+
(f?" ]":" }"))}return _.quoteWith(f?"[]":"{  }",_.joinWith(", ",_.map(k,function(a){return(f?"":a[0].quote(n)+": ")+l(a[1])})))};_.toFixed=function(a,b){return a&&a.toFixed&&a.toFixed(b)||void 0};_.toFixed2=function(a){return _.toFixed(a,2)};_.toFixed3=function(a){return _.toFixed(a,3)};_.cps=function(){return _.cps.sequence.apply(null,arguments)};_.cps.apply=function(a,b,c,d){c=_.asArray(c);var e=_.numArgs(a)-1,g=c[e];c[e]=function(){d.call(this,arguments,g)};return a.apply(b,c)};
...
_.cps.trySequence=function(a,b,c){_.reduceRight(a,function(a,e){return function(g){if(_.isTypeOf(Error,g))return(c||b)(g);try{return e.apply(this,_.asArray(arguments).concat(a))}catch(f){return(c||b)(f)}}},b)()};_(["method","property","flipped","forceOverride"]).each(_.defineTagKeyword);
...
k=b._onAfter,l=b._intercept,b=d||this,n,m=void 0;if(g.length){n=0;for(m=g.length;n<m;n++)g[n].apply(b,arguments);g.removeAll()}n=0;for(m=h.length;n<m;n++)h[n].apply(b,arguments);g=(l.length?_.cps.compose([a].concat(l)):a).apply(b,arguments);if(k.length||f.length){h=_.asArray(arguments).concat(g);n=0;for(m=k.length;n<m;n++)k[n].apply(b,h);if(f.length)for(k=f.copy,f.removeAll(),n=0,m=k.length;n<m;n++)k[n].apply(b,h)}return g}))})})})();
...
a.__membersByName;_.each(a.__bindables,function(c,d){var e=_.filter2(_.bindable.hooks,function(a,c){var e=b[_.bindable.hooksShort[c]+d.capitalized];return e?[a,e]:!1});if(e.length){var g={};_.each(e,function(a){_.each(a[1],function(b){b=$untag(b);if(_.isFunction(b)){var c="_"+a[0];(g[c]||(g[c]=[])).push(b)}})});a[d]=$bindable({hooks:g},Tags.clone(c))}},this);return a}},isStreamDefinition:$static(function(a){return _.isObject(a)&&(a.$trigger||a.$triggerOnce||a.$barrier||a.$observable||a.$observableProperty)}),
...
__.reject=function(a){return Promise.reject(a)};__.rejects=function(a){return function(){return Promise.reject(a)}};__.safe=function(a){return function(){try{return Promise.resolve(a.apply(this,arguments))}catch(b){return Promise.reject(b)}}};__.map=__.safe(function(a,b){if(_.isStrictlyObject(a)){var c=_.coerceToEmpty(a),d=[];_.each2(a,function(a,g){d.push(__.identity(b(a,g)).then(function(a){c[g]=a}))});return __.all(d).then(_.constant(c))}return b(a)});__.then=function(a,b){return __.identity(a).then(_.coerceToFunction(b))};
...
c);return new Promise(function(c,g){if(Platform.Browser){var f=new XMLHttpRequest;f.open(a,b,!0);d.responseType&&(f.responseType=d.responseType);_.each(d.headers,function(a,b){f.setRequestHeader(b,a)});d.progress&&(f.onprogress=Http.progressCallbackWithSimulation(d.progress));f.onreadystatechange=function(){4===f.readyState&&(d.progress&&d.progress(1),200===f.status?c("arraybuffer"===f.responseType?f.response:f.responseText):g(f.statusText))};d.data?f.send(d.data):f.send()}else g("not implemented")})},
