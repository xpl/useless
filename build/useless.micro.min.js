...
a);if(_.isTypeOf(Tags,a))return _.reduce(Tags.get(a),function(a,d,e){return _.isBoolean(d)?e+" "+a.quote("()"):e+" ("+_.stringifyImpl(d,b,c,0,{pretty:!1})+", "+a+")"},_.stringifyImpl($untag(a),b,c,d+1,e));if(!e.pure&&_.hasOOP&&_.isPrototypeInstance(a)&&$prototype.defines(a.constructor,"toString"))return a.toString();if(!_.isObject(a)||"undefined"!==typeof $atom&&$atom.is(a))return _.isDecimal(a)&&0<e.precision?_.toFixed(a,e.precision):a+"";var f=_.isArray(a),g=e.pretty||!1;if("browser"===_.platform().engine){if(_.isTypeOf(Element,
a))return"<"+a.tagName.lowercase+">";if(_.isTypeOf(Text,a))return"@"+a.wholeText}if(a.toJSON)return _.quoteWith('"',a.toJSON());if(!e.pure&&(d>(e.maxDepth||5)||f&&a.length>(e.maxArrayLength||30)))return f?"<array["+a.length+"]>":"<object>";var h=b.concat([a]);c.push(a);var k=_.pairs(a),n=_.stringifyImpl.tails2(h,c,d+1,e);if(g){k=_.values(a);a=_.alignStringsRight(_.keys(a).map(_.appends(": ")));d=k.map(n);e=d.map(function(a,b){return"["===a[0]||"{"===a[0]?3:_.isString(k[b])?1:0});var l=_.max(e);d=
[e,d].zip(function(a,b){return" ".repeats(l-a)+b});a=f?d:[a,d].zip(_.bullet);a=_.bullet(f?"[ ":"{ ",a.join(",\n"));d=a.split("\n");return a+(" ".repeats(_.max(d.map(_.count))-_.count(d.last))+(f?" ]":" }"))}return _.quoteWith(f?"[]":"{  }",_.joinWith(", ",_.map(k,function(a){return(f?"":a[0]+": ")+n(a[1])})))};_.toFixed=function(a,b){return a&&a.toFixed&&a.toFixed(b)||void 0};_.toFixed2=function(a){return _.toFixed(a,2)};_.toFixed3=function(a){return _.toFixed(a,3)};_.hasStdlib=!0;
...
_.mixin({reject2:function(a,b){return _.filter2(a,_.not(b))},filter2:function(a,b){if(_.isArray(a)){for(var c=[],d=0,e=a.length;d<e;d++){var g=a[d],f=b(g,d);!0===f?c.push(g):!1!==f&&c.push(f)}return c}if(_.isStrictlyObject(a))return c={},_.each(Object.keys(a),function(d){var e=a[d],f=b(e,d);!0===f?c[d]=e:!1!==f&&(c[d]=f)}),c;f=b(a);if(!0===f)return a;if(!1!==f)return f}});_.mixin({filterFilter:_.hyperOperator(_.unary,_.filter2)});
...
e,g,a)||b)})});return b}},evalPrototypeSpecificMacros:function(a){return function(b){if(!b.isTraitOf){var c=$untag(b.$macroTags||a&&a.$definition&&a.$definition.$macroTags);c&&_.each(b,function(a,e){_.each(c,function(c,f){a=b[e];_.keyword(f)in a&&(b[e]=c(b,a,e)||a)})})}return b}},generateCustomCompilerImpl:function(a){return function(b){b.$impl?(b.$impl.__proto__=a&&a.$impl||this,b.$impl=$static($builtin($property(b.$impl)))):a&&a.$impl&&(b.$impl=$static($builtin($property(a.$impl))));return b}},
...
[])).push(a)})});_.each(c,function(b,d){var f=_.find(b,Component.isStreamDefinition);if(f){var h=a[d]=Tags.clone(f);h.listeners=[];_.each(b,function(a){a!==f&&h.listeners.push(a)})}else a[d]||(a[d]=c[d][0])});a.__bindables=d;a.__members=c},mergeBindables:function(a){var b=a.__members;_.each(a.__bindables,function(c,d){var e=_.filter2(_.bindable.hooks,function(a,c){var e=b[_.bindable.hooksShort[c]+d.capitalized];return e?[a,e]:!1});if(e.length){var g={};_.each(e,function(a){_.each(a[1],function(b){b=
$untag(b);if(_.isFunction(b)){var c="_"+a[0];(g[c]||(g[c]=[])).push(b)}})});a[d]=$bindable({hooks:g},Tags.clone(a[d]))}});return a}},isStreamDefinition:$static(function(a){return _.isObject(a)&&(a.$trigger||a.$triggerOnce||a.$barrier||a.$observable||a.$observableProperty)}),mapMethods:function(){var a=_.last(arguments),b=1===arguments.length?_.constant(!0):arguments[0],c;for(c in this){var d=this.constructor.$definition[c];if(!d||!d.$property){var e=this[c];_.isFunction(e)&&!_.isPrototypeConstructor(e)&&
