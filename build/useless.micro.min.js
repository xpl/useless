...
_.stringifyImpl=function(a,b,c,d,e,g){if(a===$global)return"$global";var f=e.formatter&&e.formatter(a);if(f)return f;if(0<=b.indexOf(a))return e.pure?void 0:"<cyclic>";if(0<=c.indexOf(a))return e.pure?void 0:"<ref:"+c.indexOf(a)+">";if(void 0===a)return"undefined";if(null===a)return"null";if(_.isFunction(a))return e.pure?a.toString():_.isPrototypeConstructor(a)?"<prototype>":"<function>";if("string"===typeof a)return _.quoteWith('"',a);if(_.isObject(a)&&$atom.isNot(a)){var h=_.isArray(a),f=e.pretty||
!1;if(a.toJSON)return _.quoteWith('"',a.toJSON());if(!e.pure&&(d>(e.maxDepth||5)||h&&a.length>(e.maxArrayLength||30)))return h?"<array["+a.length+"]>":"<object>";var k=b.concat([a]);c.push(a);b=_.pairs(a);var m=!f||2>b.length,l=g+1,n=m?"":"\t".repeats(l);if(f&&!h){var p=_.reduce(_.map(_.keys(a),_.count),_.largest,0);b=_.map(b,function(a){return[a[0],a[1]," ".repeats(p-a[0].length)]})}return _.quoteWith(h?m?"[]":"[\n  ]":m?"{  }":"{\n  }",_.joinWith(m?", ":",\n",_.map(b,function(a){return n+(h?"":
...
_.extend(_.cps,{each:function(a,b,c,d,e,g){var f=arguments.callee,h=d||0,k=0===h?void 0===a.length?_.keys(a):void 0:g,m=0===h?k?k.length:a.length:e;if(!a||h>=(m||0))c&&c();else{var l=k?k[h]:h;b(a[l],l,function(){f(a,b,c,h+1,m,k)},a)}}});_.extend(_.cps,{map:function(a,b,c){var d=_.isArray(a)?[]:{};_.cps.each(a,function(a,c,f){b(a,c,function(a){d[c]=a;f()})},function(){c(d)})}});
...
write:function(a){return function(d){b.beforeWrite&&(d=b.beforeWrite(d));if(!b.hasValue||(b.trackReference?b.value!==d:!_.isEqual(b.value,d))){var e=b.value,g=b.hasValue;b.hasValue=!0;b.value=d;g?a.call(this,!1,b.value,e):a.call(this,!1,b.value)}}}});arguments.length&&b.apply(this,arguments);return _.extend(b,{force:function(a){b.hasValue=!1;b(a||b.value)},when:function(a,d){b.readWith(function(e){a(e)&&(b.off(arguments.callee),d(e))})},readWith:function(a){this.hasValue?a.call(this.context,this.value):
...
arguments)}),off:function(a){a.queue&&a.queue.off();a.queuedBy&&(_.each(a.queuedBy,function(b){b.remove(a)}),delete a.queuedBy)},stream:function(a){a=a||{};var b=!1,c=_.extend([],{off:function(a){this.length&&(0===arguments.length?(_.each(this,function(a){a.queuedBy.remove(this)},this),this.removeAll()):(a.queuedBy.remove(this),this.remove(a)))}}),d=void 0,e=a.write(function(a,b){var e=_.rest(arguments),g=c.copy,l=d.context;a&&c.off();_.each(g,function(a){a.apply(this,e)},l||this)}),g=a.read(function(a){0>
c.indexOf(a)&&(a.queuedBy?a.queuedBy.push(c):a.queuedBy=[c],c.push(a))});a=$restArg(function(){b||(b=!0,_.delay(_.applies(e,d,arguments).arity0.then(function(){b=!1})))});return d=_.extend($restArg(function(a){_.isFunction(a)?g.call(this,a):b||e.apply(this,arguments);return arguments.callee}),{queue:c,off:_.off.asMethod,postpone:a,read:g,write:e})}});_.clamp=function(a,b,c){return Math.max(b,Math.min(c,a))};_.lerp=function(a,b,c){return b+(c-b)*a};
...
c.hasClass("inner")&&c.parent().siblings().children().removeClass("active")),d.multi||d.multiByDefault?d.selectionChanged(c.parent().children(".active")):d.selectionChanged(c.hasClass("active")?c:a()),b.preventDefault();return!1},{disableTouch:d.touchClick?!1:!0})},transform:function(a){return this.css("-webkit-transform",(a.translate?"translate("+a.translate.x+"px,"+a.translate.y+"px) ":"")+(a.rotate?"rotate("+a.rotate+"rad) ":"")+(a.scale?"scale("+a.scale.x+","+a.scale.y+")":""))},disappear:function(b){return b?
this.addClass("disappear").on("transitionend",function(){a(this).remove()}):this.remove()},outerExtent:function(){return new Vec2(this.outerWidth(),this.outerHeight())},extent:function(){return new Vec2(this.width(),this.height())},innerExtent:function(){return new Vec2(this.innerWidth(),this.innerHeight())},outerBBox:function(){return BBox.fromLTWH(_.extend(this.offset(),this.outerExtent()))},leftTop:function(){return new Vec2.fromLT(this.offset())},offsetInParent:function(){return Vec2.fromLeftTop(this.offset()).sub(Vec2.fromLeftTop(this.parent().offset()))},
