...
f);return _.extend(this,{cancel:this.$(function(){this.off(Platform.touch?"touchstart":"mousedown",f)})})}}(),transform:function(a){return this.css("-webkit-transform",(a.translate?"translate("+a.translate.x+"px,"+a.translate.y+"px) ":"")+(a.rotate?"rotate("+a.rotate+"rad) ":"")+(a.scale?"scale("+a.scale.x+","+a.scale.y+")":""))},translate:function(a){return this.attr("transform","translate("+a.x+","+a.y+")")},transformMatrix:function(a){a=a.components;return this.attr("transform","matrix("+a[0][0]+
