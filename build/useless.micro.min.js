...
Date.now();200>e-b&&a.apply(this,arguments);b=e})}return this.dblclick(a)},nodoubletapzoom:function(){return a(this).bind("touchstart",function(b){var d=b.timeStamp,e=a(this).data("lastTouch")||d,e=d-e,g=b.originalEvent.touches.length;a(this).data("lastTouch",d);!e||500<e||1<g||(b.preventDefault(),a(b.target).trigger("click"))})}})}(jQuery);
