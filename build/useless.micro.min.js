...
function(b,c){return $global[c]&&a instanceof $global[c]&&c+" "+_.stringifyOneLine(_.omitTypeMismatches(b,a))||!1}))return g;a instanceof Set&&(a=a.items);var f=_.isArray(a),g=e.pretty||!1;if($platform.Browser){if(_.isTypeOf(Element,a))return(a.tagName.lowercase+(a.id&&"#"+a.id||"")+(a.className&&"."+a.className||"")).quote("<>");if(_.isTypeOf(Text,a))return"@"+a.wholeText.limitedTo(20)}if(a.toJSON)return _.quoteWith('"',a.toJSON());if(!e.pure&&(d>(e.maxDepth||5)||f&&a.length>(e.maxArrayLength||30)))return f?
...
_.count(e.last))+(f?" ]":" }"))}return _.quoteWith(f?"[]":"{  }",_.joinWith(", ",_.map(k,function(a){return(f?"":a[0].quote(n)+": ")+l(a[1])})))};_.toFixed=function(a,b){return a&&a.toFixed&&a.toFixed(b)||void 0};_.toFixed2=function(a){return _.toFixed(a,2)};_.toFixed3=function(a){return _.toFixed(a,3)};_.cps=function(){return _.cps.sequence.apply(null,arguments)};_.cps.apply=function(a,b,c,d){c=_.asArray(c);var e=_.numArgs(a)-1,g=c[e];c[e]=function(){d.call(this,arguments,g)};return a.apply(b,c)};
