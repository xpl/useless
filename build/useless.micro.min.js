...
_.findFind=function(a,b){return _.hyperOperator(_.unary,function(a,d){if(_.isArrayLike(a))for(var e=0,f=a.length;e<f;e++){var g=d(a[e]);if("boolean"!==typeof g)return g;if(!0===g)return a[e]}else if(_.isStrictlyObject(a))for(var e=0,h=Object.keys(a),f=h.length;e<f;e++){var l=h[e],g=d(a[l]);if("boolean"!==typeof g)return g;if(!0===g)return a[l]}g=b(a);return"boolean"!==typeof g?g:!0===g?a:!1})(a,b)};_.nonempty=function(a){return _.filter2(a,_.isNonempty)};
...
60)))return g?"<array["+a.length+"]>":"<object>";var h=b.concat([a]);c.push(a);var l=_.pairs(a),k=_.stringifyImpl.tails2(h,c,d+1,e),m=e.json?'""':"";if(f){l=_.values(a);d=_.alignStringsRight(_.keys(a).map(_.quotesWith(m).then(_.appends(": "))));e=l.map(k);var f=e.map(function(a,b){return"["===a[0]||"{"===a[0]?3:_.isString(l[b])?1:0}),n=_.max(f);e=[f,e].zip(function(a,b){return" ".repeats(n-a)+b});d=g?e:[d,e].zip(_.bullet);d=_.bullet(g?"[ ":"{ ",d.join(",\n"));e=d.split("\n");return d+(" ".repeats(_.max(e.map(_.count))-
_.count(e.last))+(g?" ]":" }"))}return _.quoteWith(g?"[]":"{  }",_.joinWith(", ",_.map(l,function(a){return(g?"":a[0].quote(m)+": ")+k(a[1])})))};_.toFixed=function(a,b){return a&&a.toFixed&&a.toFixed(b)||void 0};_.toFixed2=function(a){return _.toFixed(a,2)};_.toFixed3=function(a){return _.toFixed(a,3)};
...
_.extend(_.cps,{each:function(a,b,c,d,e,f){var g=c||_.noop,h=function(c,d,e){2===_.numArgs(b)?b(c,e,g,a):b(c,d,e,g,a)};if(_.isEmpty(a))g();else if(_.isScalar(a))h(a,void 0,g);else{var l=d||0,k=0===l?void 0===a.length?_.keys(a):void 0:f,m=0===l?k?k.length:a.length:e;if(l>=(m||0))g();else{var n=k?k[l]:l;h(a[n],n,arguments.callee.bind(this,a,b,c,l+1,m,k))}}}});
_.extend(_.cps,{map:function(a,b,c){var d=_.isArray(a)?[]:{};_.cps.each(a,2==_.numArgs(b)?function(a,c,g){b(a,function(a){d[c]=a;g()})}:function(a,c,g){b(a,c,function(a){d[c]=a;g()})},function(){c(d)})}});_.extend(_.cps,{find:function(a,b,c){var d=2!==_.numArgs(b);_.cps.each(a,function(a,c,g,h){var l=function(b){!1===b?g():h(!0===b?a:b,c)};d?b(a,c,l):b(a,l)},c)}});
...
throttled:_.throttle,debounced:function(a,b,c){var d,e,f,g,h,l=function(){var k=Date.now()-d;k<b&&0<k?e=setTimeout(l,b-k):(e=null,c||(f=a.apply(h,g),e||(h=g=null)))},k=function(){h=this;g=arguments;d=Date.now();var k=c&&!e;e||(e=setTimeout(l,b));k&&(f=a.apply(h,g),h=g=null);return f};k.cancel=function(){e&&(clearTimeout(e),e=null)};k.callImmediately=function(){k.cancel();a.apply(h,g)};return k},postpone:$method(function(a){a.postponed.apply(null,arguments)}),postponed:function(a){return function(){var b=
...
arguments.callee,f=b._onceBefore,g=b._onceAfter,h=b._onBefore,l=b._onAfter,k=b._intercept,b=d||this,m,n;if(f.length){m=0;for(n=f.length;m<n;m++)f[m].apply(b,arguments);f.removeAll()}m=0;for(n=h.length;m<n;m++)h[m].apply(b,arguments);f=(k.length?_.cps.compose([a].concat(k)):a).apply(b,arguments);if(l.length||g.length){h=_.asArray(arguments).concat(f);m=0;for(n=l.length;m<n;m++)l[m].apply(b,h);if(g.length)for(l=g.copy,g.removeAll(),m=0,n=l.length;m<n;m++)l[m].apply(b,h)}return f}))})})})();
...
a.queue.off():a.queue.off(b));a.queuedBy&&(_.each(a.queuedBy,function(b){b.remove(a)}),delete a.queuedBy)},stream:function(a){a=a||{};var b=_.extend([],{off:function(a){this.length&&(0===arguments.length?(_.each(this,function(a){a.queuedBy.remove(this)},this),this.removeAll()):a.queuedBy&&(a.queuedBy.remove(this),this.remove(a)))}}),c=void 0,d=a.write(function(a,d){var e=_.rest(arguments),l=c.context||this,k=b.copy;a&&b.off();c.commitingReads=!0;for(var m=0,n=k.length;m<n;m++)(c.postpones?k[m].postponed:
k[m]).apply(l,e);delete c.commitingReads}),e=a.read(function(a){0>b.indexOf(a)&&(a.queuedBy?a.queuedBy.push(b):a.queuedBy=[b],b.push(a))});return c=_.extend($restArg(function(a){_.isFunction(a)?e.call(this,a):d.apply(this,arguments);return arguments.callee}),a,{queue:b,once:function(a){_.find(b,function(b){return b.onceWrapped_===a})||e(_.extend(function(b){_.off(c,arguments.callee);a(b)},{onceWrapped_:a}))},off:_.off.asMethod,read:e,write:d,postpone:function(){this.postponed.apply(c.context,arguments)}})}});
