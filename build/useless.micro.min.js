...
g.offset();c.move.call(this,k,new Vec2(a.pageX-e.pageX,a.pageY-e.pageY),new Vec2(a.pageX-d.left,a.pageY-d.top),a)}else l(a)}),m=function(){a(d||document.body).css(d?{display:"none"}:{}).off("mouseup touchend",n).off("mousemove touchmove",p)},n=this.$(function(a){m();c.end&&(a=b(a,this[0]),c.end.call(this,k,new Vec2(a.pageX-e.pageX,a.pageY-e.pageY),a))}),l=this.$(function(a){m();n(a)});a(d||document.body).css(d?{display:"",cursor:c.cursor||""}:{}).on("mousemove touchmove",p).one("mouseup touchend",
