...
_.mixin({zipObjectsWith:function(a,b){return _.reduce(_.rest(a),function(a,d){_.each(_.union(_.keys(d),_.keys(a)),function(e){var g=b(a&&a[e],d&&d[e]);void 0===g?delete a[e]:a[e]=g});return a},_.clone(a[0]))},zip2:function(a,b){var c=2===arguments.length?a:_.initial(arguments),d=2===arguments.length?b:_.last(arguments);return _.isArrayLike(c)&&0!==c.length?_.isArrayLike(c[0])?_.zipWith(c,d):_.isStrictlyObject(c[0])?_.zipObjectsWith(c,d):_.reduce2(c,d):c}});
...
_.find2=function(a,b){if(_.isArrayLike(a))for(var c=0,d=a.length;c<d;c++){var e=b(a[c],c,a);if("boolean"!==typeof e)return e;if(!0===e)return a[c]}else if(_.isStrictlyObject(a))for(var c=0,g=Object.keys(a),d=g.length;c<d;c++){var f=g[c],e=b(a[f],f,a);if("boolean"!==typeof e)return e;if(!0===e)return a[f]}};
_.findFind=function(a,b){return _.hyperOperator(_.unary,function(a,d){if(_.isArrayLike(a))for(var e=0,g=a.length;e<g;e++){var f=d(a[e]);if("boolean"!==typeof f)return f;if(!0===f)return a[e]}else if(_.isStrictlyObject(a))for(var e=0,h=Object.keys(a),g=h.length;e<g;e++){var k=h[e],f=d(a[k]);if("boolean"!==typeof f)return f;if(!0===f)return a[k]}f=b(a);return"boolean"!==typeof f?f:!0===f?a:!1})(a,b)};_.nonempty=function(a){return _.filter2(a,_.isNonempty)};
...
function(b,c){return $global[c]&&a instanceof $global[c]&&c+" "+_.stringifyOneLine(_.omitTypeMismatches(b,a))||!1}))return g;var f=_.isArray(a),g=e.pretty||!1;if($platform.Browser){if(_.isTypeOf(Element,a))return(a.tagName.lowercase+(a.id&&"#"+a.id||"")+(a.className&&"."+a.className||"")).quote("<>");if(_.isTypeOf(Text,a))return"@"+a.wholeText.limitedTo(20)}if(a.toJSON)return _.quoteWith('"',a.toJSON());if(!e.pure&&(d>(e.maxDepth||5)||f&&a.length>(e.maxArrayLength||30)))return f?"<array["+a.length+
