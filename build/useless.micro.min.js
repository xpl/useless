...
_.extend(a.x>this.right?{right:!0}:{},a.x<this.left?{left:!0}:{},a.y>this.bottom?{bottom:!0}:{},a.y<this.top?{top:!0}:{});return _.extend(a,a.left||a.right||a.bottom||a.top?{}:{inside:!0})},classifyRay:function(a,b,c,d){c=c||0;d=d||0;var e=this.size.half,g,f,h,k,m,l;h=1/b.x;k=1/b.y;m=Math.sign(h);l=Math.sign(k);g=(this.x-m*(e.x+c)-a.x)*h;f=(this.y-l*(e.y+d)-a.y)*k;c=(this.x+m*(e.x+c)-a.x)*h;d=(this.y+l*(e.y+d)-a.y)*k;if(!(g>d||f>c||(e=g>f?g:f,1<=e||0>=(c<d?c:d))))return d={time:_.clamp(e,0,1)},d.normal=
g>f?new Vec2(-m,0):new Vec2(0,-l),d.delta=b.scale(d.time),d.where=a.add(d.delta),d},nearestPointTo:function(a,b){var c=b||0,d=new Vec2(this.left,this.top),e=new Vec2(this.right,this.top),g=new Vec2(this.right,this.bottom),f=new Vec2(this.left,this.bottom),c=[a.projectOnLineSegment(d.add(c,0),e.add(-c,0)),a.projectOnLineSegment(e.add(0,c),g.add(0,-c)),a.projectOnLineSegment(g.add(-c,0),f.add(c,0)),a.projectOnLineSegment(f.add(0,-c),d.add(0,c)),a.projectOnCircle(d.add(c,c),c),a.projectOnCircle(e.add(-c,
c),c),a.projectOnCircle(g.add(-c,-c),c),a.projectOnCircle(f.add(c,-c),c)];return _.min(c,function(b){return a.sub(b).length})},clone:$property(function(){return new BBox(this.x,this.y,this.width,this.height)}),floor:$property(function(){return new Vec2(Math.floor(this.x),Math.floor(this.y))}),css:$property(function(){return{left:this.left,top:this.top,width:this.width,height:this.height}}),leftTop:$property(function(){return new Vec2(this.left,this.top)}),rightBottom:$property(function(){return new Vec2(this.right,
...
this.outerHeight())},extent:function(){return new Vec2(this.width(),this.height())},innerExtent:function(){return new Vec2(this.innerWidth(),this.innerHeight())},outerBBox:function(){return BBox.fromLTWH(_.extend(this.offset(),this.outerExtent()))},leftTop:function(){return new Vec2.fromLT(this.offset())},offsetInParent:function(){return Vec2.fromLeftTop(this.offset()).sub(Vec2.fromLeftTop(this.parent().offset()))},caret:function(){var a=this[0];if(a.selectionStart)return a.selectionStart;if(!document.selection)return 0;
var b=document.selection.createRange(),e=b.duplicate(),g=0;e.moveToElementText(a);b.text="\u0001";g=e.text.indexOf("\u0001");b.moveStart("character",-1);b.text="";return g},monitorInput:function(b){var d=function(){""===a.trim(a(this).val())?b.empty(!0):b.empty(!1)};return this.keyup(d).change(d).focus(_.bind(b.focus||_.noop,b,!0)).blur(_.bind(b.focus||_.noop,b,!1))},touchDoubleclick:function(a){if(Platform.touch){var b=Date.now();return this.on("touchend",function(){var e=Date.now();200>e-b&&a.apply(this,
arguments);b=e})}return this.dblclick(a)},touchClick:function(a,b){var e=this;b=b||{};if(!b.disableTouch&&Platform.touch){var g=function(b){a.apply(this,arguments);b.preventDefault();return!1},f=function(a){a.preventDefault();return!1};b.handler&&b.handler({unbind:function(){e.off("touchstart",g).off("click",f)}});return this.on("touchstart",g).on("click",f)}b.handler&&b.handler({unbind:function(){e.off("click",a)}});return this.click(a)},translate:function(a){return this.attr("transform","translate("+
a.x+","+a.y+")")},transform:function(a){a=a.components;return this.attr("transform","matrix("+a[0][0]+","+a[1][0]+","+a[0][1]+","+a[1][1]+","+a[0][2]+","+a[1][2]+")")},clientBBox:function(){var a=this[0].getBoundingClientRect();return new BBox(a.left,a.top,a.width,a.height)}})}(jQuery);
