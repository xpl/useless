...
_.partition2=function(a,b){return _.pluck(_.partition3(a,b),"items")};_.partition3=function(a,b){var c=[],d={label:void 0,items:[a.first]};_.each(a,function(a){var g=b(a);d.label!=g&&d.items.length?c.push(d={label:g,items:[a]}):d.items.push(a)});return d.length&&c.push(d),c};
