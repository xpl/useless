...
f);return _.extend(this,{cancel:this.$(function(){this.off(Platform.touch?"touchstart":"mousedown",f)})})}}(),transform:function(a){return this.css("transform",a&&(a.translate?"translate("+a.translate.x+"px,"+a.translate.y+"px) ":"")+(a.rotate?"rotate("+a.rotate+"rad) ":"")+(a.scale?"scale("+(new Vec2(a.scale)).separatedWith(",")+")":"")||"")},svgTranslate:function(a){return this.attr("transform","translate("+a.x+","+a.y+")")},svgTansformMatrix:function(a){a=a.components;return this.attr("transform",
