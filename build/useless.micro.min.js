...
(0===arguments.length?(_.each(this,function(a){a.queuedBy.remove(this)},this),this.removeAll()):a.queuedBy&&(a.queuedBy.remove(this),this.remove(a)))}}),c=void 0,d=a.write(function(a,d){var e=_.rest(arguments),l=c.context||this,k=b.copy;a&&b.off();c.commitingReads=!0;for(var m=0,n=k.length;m<n;m++)(c.postpones?k[m].postponed:k[m]).apply(l,e);delete c.commitingReads}),e=a.read(function(a){0>b.indexOf(a)&&(a.queuedBy?a.queuedBy.push(b):a.queuedBy=[b],b.push(a))});return c=_.extend($restArg(function(a){_.isFunction(a)?
...
_.mapReduce=function(a,b){var c=0,d=!1,e=a&&a.length||0,f=b.maxConcurrency||e,g=0,h=b.memo;if(0===e)b.complete(b.memo||a);else{var l=function(){for(;c<e&&g<f;)g+=1,b.next(a[c],c++,function(){g--;d||(c>=e?0===g&&(setTimeout(function(){b.complete(b.memo||a)},0),d=!0):l())},function(){g--},h);!d&&c>=e&&0==g&&b.complete(b.memo||a)};l()}};_.asyncJoin=function(a,b,c){_.mapReduce(a,{complete:b.bind(c),next:function(a,b,f,g){a.call(c,f,g)}})};
