...
function(b){b.remove(a)}),delete a.queuedBy)},stream:function(a){a=a||{};var b=_.extend([],{off:function(a){this.length&&(0===arguments.length?(_.each(this,function(a){a.queuedBy.remove(this)},this),this.removeAll()):a.queuedBy&&(a.queuedBy.remove(this),this.remove(a)))}}),c=void 0,d=a.write(function(a,d){var e=_.rest(arguments),l=c.context||this,k=b.copy;a&&b.off();c.commitingReads=!0;for(var m=0,n=k.length;m<n;m++)(c.postpones?k[m].postponed:k[m]).apply(l,e);delete c.commitingReads}),e=a.read(function(a){0>
