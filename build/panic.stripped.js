...
(function (modules) {
    ...
    function (module, exports, __webpack_require__) {
        (function (global) {
            'use strict';
            const O = __webpack_require__(39), bullet = __webpack_require__(13), isBrowser = typeof window !== 'undefined' && window.window === window && window.navigator, maxOf = (arr, pick) => arr.reduce((max, s) => Math.max(max, pick ? pick(s) : s), 0), isInteger = Number.isInteger || (value => typeof value === 'number' && isFinite(value) && Math.floor(value) === value);
            const configure = cfg => {
    ...
    function (module, exports, __webpack_require__) {
        (function () {
            ...
            case 'node':
                __webpack_require__(43).on('uncaughtException', globalUncaughtExceptionHandler);
                break;
            case 'browser':
    ...
    function (module, exports, __webpack_require__) {
        'use strict';
        const O = __webpack_require__(39), bullet = __webpack_require__(13), asTable = __webpack_require__(46);
        _.hasLog = true;
        ;
    ...
    function (module, exports, __webpack_require__) {
        var bullet = __webpack_require__(13), asTable = __webpack_require__(46);
