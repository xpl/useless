...
(function (modules) {
    ...
    function (module, exports, __webpack_require__) {
        ...
        const O = Object;
        _.hasTags = true;
        _.deferTest('meta-tags', function () {
            Tags.define('foo');
            Tags.define('bar');
            Tags.define('qux');
    ...
    function (module, exports, __webpack_require__) {
        (function (global) {
            'use strict';
            const O = __webpack_require__(39), bullet = __webpack_require__(41), isBrowser = typeof window !== 'undefined' && window.window === window && window.navigator, maxOf = (arr, pick) => arr.reduce((max, s) => Math.max(max, pick ? pick(s) : s), 0), isInteger = Number.isInteger || (value => typeof value === 'number' && isFinite(value) && Math.floor(value) === value);
            const configure = cfg => {
    ...
    function (module, exports, __webpack_require__) {
        (function () {
            ...
            case 'node':
                __webpack_require__(44).on('uncaughtException', globalUncaughtExceptionHandler);
                break;
            case 'browser':
    ...
    function (module, exports, __webpack_require__) {
        (function (__filename) {
            ...
            (function () {
                var currentFile = $platform.Browser ? (CallStack.rawStringToArray(CallStack.currentAsRawString)[2] || { file: '' }).file : __filename;
    ...
    function (module, exports, __webpack_require__) {
        'use strict';
        const bullet = __webpack_require__(13), asTable = __webpack_require__(47);
        _.hasLog = true;
        _.tests.log = {
            basic: function () {
                log('log (x)');
    ...
    function (module, exports, __webpack_require__) {
        var bullet = __webpack_require__(13), asTable = __webpack_require__(47);
