...
if(a.verbose||0<this.numEvents.all){for(var g=$jscomp.makeIterator(this.eventLog),h=g.next();!h.done;h=g.next())h=h.value,h instanceof AndrogeneProcessContext?h.eventLog.length&&h.printLog({indent:b+1,visited:c,verbose:a.verbose}):h instanceof Error?c.has(h)||(c.add(h),log.boldRed(log.indent(b+1),h)):log.write.apply(null,[log.indent(b+1)].concat(h));log.margin()}return this.numEvents}});AndrogeneProcessContext.within=function(){return AndrogeneProcessContext.current&&AndrogeneProcessContext.current.within(fn)||
fn};$global.AndrogenePromise=function(a){if(!0===AndrogenePromise.constructing)Promise.call(this,a);else{var b=new AndrogeneProcessContext,c,g;Promise.call(this,function(a,d){c=a;g=function(a){b.eventLog.push(a);d(a)}});this.processContext=b;try{b.within(a)(c,g)}catch(h){g(h)}AndrogenePromise.constructing=!0;Promise.prototype.then.call(this,function(a){b.state="fulfilled"},function(a){b.state="rejected"});delete AndrogenePromise.constructing}};$jscomp.inherits($global.AndrogenePromise,Promise);$global.AndrogenePromise.all=
