...
function(a,b){return{enumerable:!0,value:a}})))})();$overrideUnderscore=function(a,b){return _[a]=b(_[a])};$platform.NodeJS&&($global.alert=function(a){var b=$global.log&&_.partial(log.warn,log.config({stackOffset:2}))||console.log;b.apply(b,["ALERT:"].concat(_.asArray(arguments)))});$global.alert2=function(a){alert(_.map(arguments,_.stringify).join(", "));return arguments[0]};$global.log=function(){console.log.apply(console.log,arguments)};_.hasAsserts=!0;
...
Array.prototype.squash=function(a){a=a||{};var b=a.key||_.identity,c={key:null,next:{},depth:{}},d={};_.each(this,function(a){for(var e=0,f=a.length,g=c,n=void 0;e<f;e++,g=n){var n=a[e],p=b(n),n=d[p]||(d[p]={key:p,item:n,next:{},depth:{}});g&&(g.next[p]=n,g.depth[p]=0)}});var e=function(a,b,c,d){d=d||0;a[b.key]=!0;b.next=_.filter2(_.values(b.next),function(c){if(c.key in a)return!1;c=e(a,c,b);d=Math.max(d,b.depth[c.key]);return c});c&&(c.depth[b.key]=Math.max(c.depth[b.key]||0,d+1));delete a[b.key];
return b},f=function(a,b){return a===b||_.some(a.next,function(a){return f(a,b)})},g=function(a){if(!a)return[];var b=(a.next||[]).sort(function(b,c){return(a.depth[b.key]||0)<(a.depth[c.key]||0)});return[a].concat(g(_.reduce(b,function(a,b){if(a===b)return a;if(f(b,a))return b.next.push(a),b;a.next.push(b);return a})))};return _.rest(_.pluck(g(e({},c)),"item"))};DAG=function(a){this.cfg=a||{};this.nodes=a.nodes||_.noop};
...
arguments.callee,f=b._onceBefore,g=b._onceAfter,h=b._onBefore,k=b._onAfter,l=b._intercept,b=d||this,m,n=void 0;if(f.length){m=0;for(n=f.length;m<n;m++)f[m].apply(b,arguments);f.removeAll()}m=0;for(n=h.length;m<n;m++)h[m].apply(b,arguments);f=(l.length?_.cps.compose([a].concat(l)):a).apply(b,arguments);if(k.length||g.length){h=_.asArray(arguments).concat(f);m=0;for(n=k.length;m<n;m++)k[m].apply(b,h);if(g.length)for(k=g.copy,g.removeAll(),m=0,n=k.length;m<n;m++)k[m].apply(b,h)}return f}))})})})();
...
try{e.mkdirSync(a+".backups")}catch(g){}e.writeFileSync(a+".backups/"+Date.now(),d,f);e.writeFileSync(a,b,f);c()}):JSONAPI.post("source/"+a,_.extend2({},this.apiConfig,{what:{text:b}})).then(function(){log.ok(a,"\u2014 successfully saved");c&&c()})}});_.readSourceLine=SourceFiles.line;_.readSource=SourceFiles.read;_.writeSource=SourceFiles.write;
...
_.barrier(),SourceFiles.line((a.remote?"api/source/":"")+a.file,a.line-1,function(c){a.sourceReady(a.source=c)}));this.push(a)},this)},fromParsedArray:$static(function(a){return new CallStack(a)}),currentAsRawString:$static($property(function(){var a=$platform.Browser?3:2;return _.rest((Error().stack||"").split("\n"),a).join("\n")})),shortenPath:$static(function(a){var b=a.replace($uselessPath,"").replace($sourcePath,"");return b!==a?b:a.split("/").last}),isThirdParty:$static(_.bindable(function(a){var b=
...
rawStringToArray:$static(function(a){a=(a||"").split("\n");return _.filter2(a,function(a){a=a.trimmed;var c,d=[],e=!1,d=d=void 0;if((d=a.match(/at (.+) \((.+)\)/))||(d=a.match(/(.*)@(.*)/)))c=d[1],e="native"===d[2],d=_.rest(d[2].match(/(.*):(.+):(.+)/)||[]);else if(d=a.match(/^(at\s+)*(.+):([0-9]+):([0-9]+)/))d=_.rest(d,2);else return!1;return 0<=(c||"").indexOf("__supressErrorReporting")?!1:{beforeParse:a,callee:c||"",index:$platform.Browser&&d[0]===window.location.href,"native":e,file:d[0]||"",
line:(d[1]||"").integerValue,column:(d[2]||"").integerValue}})})});$prototype.impl.findMeta=function(a){return function(b){_.cps.find(CallStack.fromRawString(a).reversed,function(a,b){a.sourceReady(function(e){e=(e||"").match(/([A-z]+)\s*=\s*\$(prototype|singleton|component|extends|trait|aspect)/);b(e&&{name:e[1],type:e[2],file:a.fileShort}||!1)})},function(a){b(a||{})})}};
...
a.concat({config:c,text:log.impl.stringifyArguments(b.items,c)})}),e=d.last&&d.last.text.reversed.match(/(\n*)([^]*)/),f=e&&e[1];e&&(d.last.text=e[2].reversed);var g={},e=_.pluck["with"]("items",_.reject["with"](_.property("label"),_.partition3["with"](_.equals(g),_.scatter(d,function(a,b,c){_.each(a.text.split("\n"),function(b,d,e){c(_.extended(a,{text:b}));d!==e.lastIndex&&c(g)})})))),d=_.pluck(d,"text").join(""),h=c.where||log.impl.walkStack($callStack)||{},k="\t".repeats(c.indent);a({lines:e,
config:c,color:c.color,when:Date.now(),args:_.reject(b,_.isTypeOf.$(log.Config)),indentation:k,indentedText:e.map(_.seq(_.pluck.tails2("text"),_.joinsWith(""),_.prepends(k))).join("\n"),text:d,codeLocation:c.location&&log.impl.location(h)||"",trailNewlines:f||"",where:c.location&&h||void 0});return _.find(b,_.not(_.isTypeOf.$(log.Config)))})),walkStack:function(a){return _.find(a.clean,function(a){return 0>a.fileShort.indexOf("base/log.js")})||a[0]},defaultWriteBackend:function(a){var b=a.codeLocation;
if($platform.NodeJS){var c=_.map(a.lines,function(b){return a.indentation+_.map(b,function(a){return a.config.color?a.config.color.shell+a.text+"\u001b[0m":a.text}).join("")}).join("\n");log.timestampEnabled&&(c=log.color("dark").shell+_.bullet(log.impl.timestamp(a.when)+" ",log.color("none").shell+c));console.log(c,log.color("dark").shell+b+"\u001b[0m",a.trailNewlines)}else console.log.apply(console,_.reject["with"](_.equals(void 0),[].concat(_.map(a.lines,function(b,c){return a.indentation+_.reduce2("",
b,function(a,b){return a+(b.text&&(b.config.color?"%c":"")+b.text||"")})}).join("\n")+(b&&"%c "+b||""),(_.scatter(a.lines,function(a,b,c){_.each(a,function(a){a.text&&a.config.color&&c(a.config.color.css)})})||[]).concat(b?"color:rgba(0,0,0,0.25)":[]),a.trailNewlines)))},timestamp:function(a){a=new Date(a);return String.leadingZero(a.getDay())+"/"+String.leadingZero(a.getMonth()+1)+" "+String.leadingZero(a.getHours())+":"+String.leadingZero(a.getMonth())},location:function(a){return _.quoteWith("()",
...
(function(){$mixin(Promise,{guard:$static(function(a){return Promise.resolve().then(a)}),shouldBe:function(b){return this.then(function(c){if(b!==c)throw new a;})},shouldFail:$property(function(){return this.then(function(){throw new a;},function(){})})});var a=function(a){Error.call(this,a||"assertion failed")};$jscomp.inherits(a,Error);a.captureStackTrace=Error.captureStackTrace;var b=Promise,c=$prototype({current:void 0,constructor:function(){this.eventLog=[];this.callStack=$callStack;this.stackOffset=
c.stackOffset||0;this.state="pending";void 0!==(this.parent=c.current)&&this.parent.eventLog.push(this)},root:$property(function(){return this.parent&&this.parent.root||this}),push:$static(function(a,b){c.stackOffset=b;var d=c.current;c.current=a;var e=Promise;Promise=AndrogenePromise;var l=function(){a.eventLog.push([log.config({where:$callStack.safeLocation(5)})].concat(_.initial(arguments)))};log.impl.write.intercept(l);return function(){c.current=d;Promise=e;log.impl.write.off(l)}}),within:function(a,
b){var d=this;return function(){var e=c.push(d,b||0);try{var l=a.apply(this,arguments);e();return l}catch(m){throw log.newline(),log.ee(m),e(),m;}}},printLog:function(a){a=a||0;var b=this.callStack[5+this.stackOffset],d=b.source||"Promise",e=log.color[{fulfilled:"green",pending:"orange",rejected:"red","":"purple"}[this.state||""]];log.write(e,log.config({indent:a,location:!0,where:b}),d);log.write(e,log.config({indent:a}),"-".repeats(d.length));b=$jscomp.makeIterator(1===this.eventLog.length&&this.eventLog[0]instanceof
c?this.eventLog[0].eventLog:this.eventLog);for(d=b.next();!d.done;d=b.next())d=d.value,d instanceof c?d.eventLog.length&&(log.newline(),d.printLog(a+1)):log.write.apply(null,[log.indent(a+1)].concat(d))}});$global.AndrogenePromise=function(a){if(!0===AndrogenePromise.initializing)Promise.call(this,a);else{var b=new c;Promise.call(this,b.within(a));this.processContext=b;AndrogenePromise.initializing=!0;Promise.prototype.then.call(this,_.$(this,function(){this.processContext.state="fulfilled"}),_.$(this,
function(){this.processContext.state="rejected"}));delete AndrogenePromise.initializing}};$jscomp.inherits($global.AndrogenePromise,Promise);$global.AndrogenePromise.race=Promise.race;$global.AndrogenePromise.all=Promise.all;$global.AndrogenePromise.reject=Promise.reject;$global.AndrogenePromise.resolve=Promise.resolve;$global.AndrogenePromise.prototype.then=function(a,c){var d=this.processContext.within(b.prototype.then,2).apply(this,_.map(arguments,function(a){return function(b){return d.processContext.within(a,
-3)(b)}}));return d};$global.AndrogenePromise.prototype.disarm=function(){return new b(b.prototype.then.bind(this))};$global.AndrogenePromise.guard=function(a){return AndrogenePromise.resolve().then(a)};var d=function(a){return function(){return AndrogenePromise.guard(a.applies(null,arguments))}};d(function(b,c){if(b!==c)throw new a;});d(function(a){for(var b=[],c=[],d=0,e=a.length;d<e;d++)b.push(new Promise(function(a){c.push(a.$(!0))}));a.apply(this,c);return Promise.all(b)});d(function(){return __("foo").then(_.appends("bar")).shouldBe("foobr")});
var e=d(function(){return(new Promise(function(a){log.i("A");(new Promise(function(a){log.i("AA");a()})).then(function(){log.i("B");a()})})).then(function(){log.i("C")})});d(function(){var a=(new Promise(function(a){log.i("A");a("A")})).then(function(a){log.i("B");return"B"});return(new Promise(function(a){log.i("C");a("C")})).then(function(b){log.i("D");return a.then(function(a){log.i("E");return"E"})}).then(function(a){log.i("F");return"F"})});_.tests.Androgene=function(){var a=e();return a.disarm()["finally"](function(b,
c){a.processContext.root.printLog();log.newline()})["catch"](log.ee)}})();
...
a.parse(e),k=h.name&&h.name.decapitalized||e;if(h=h.how&&_["on"+h.how.capitalized]||_.intercept){var l=b[k];l&&_.isFunction(l)&&h(b,k,c);var l=b.prototype,m=l[k];m&&_.isFunction(m)&&h(l,k,c)}}});b.aspectAdded&&b.aspectAdded(d);return d})})();TimeoutError=$extends(Error,{message:"timeout expired"});__=function(a){return a instanceof Function?new Promise(a):Promise.resolve(a)};__.noop=function(){return Promise.resolve()};__.identity=function(a){return Promise.resolve(a)};__.constant=function(a){return function(){return Promise.resolve(a)}};
...
$mixin(Promise,{race:function(a){return[this,a].race},reject:function(a){return this.then(__.rejects(a))},delay:function(a){return this.then(__.delays(a))},timeout:function(a){return this.race(__.delay(a).reject(new TimeoutError))},now:$property(function(){return this.timeout(0)}),log:$property(function(){return this.then(log,log.e.then(_.throwError))}),alert:$property(function(){return this.then(alert2,alert2.then(_.throwError))}),done:function(a){return this.then(function(b){a(null,b)},function(b){a(b,
null);throw b;})},"finally":function(a){return this.then(function(b){a(null,b)},function(b){a(b,null)})},assert:function(a){return this.then(function(b){$assert(b,a);return b})},assertRejected:function(a){var b=0<arguments.length;return this["catch"](function(c){b&&$assert(c,a);return c})},panic:$property(function(){return this["catch"](function(a){($global.Panic||$global.log)(a);throw a;})})});
$mixin(Function,{promisify:$hidden($property(function(){var a=this;return function(){var b=this,c=arguments;return new Promise(function(d,e){a.apply(b,_.asArray(c).concat(function(a,b){a&&e(a);d(b)}))})}}))});$mixin(Set,{copy:$property(function(){return new Set(this)}),items:$property(function(){return Array.from(this.values())}),extend:function(a){a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())this.add(b.value);return this},extended:function(a){return this.copy.extend(a)}});
