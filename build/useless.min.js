...
_(["constant","get"]).each(_.defineTagKeyword);_.defineModifierKeyword=function(a,b){_.defineKeyword(a,function(a){return Tags.modifySubject(a,b)})};_.deleteKeyword=function(a){delete $global[_.keyword(a)]};_.defineTagKeyword("required");_.defineTagKeyword("atom");_.defineKeyword("any",_.identity);
...
_.defineKeyword("component",function(a){return $extends(Component,a)});_("trigger triggerOnce barrier observable bindable memoize memoizeCPS debounce throttle overrideThis listener postpones".split(" ")).each(_.defineTagKeyword);_.defineTagKeyword("observableProperty",_.flip);$prototype.inheritsBaseValues=function(a){$prototype.macro(a,function(b,c,d,e){_.extend2(c,e&&e[a]||{},c);_.each(b.$traits,function(b){_.extend2(c,b[a])});b[a]=$static($builtin($property(_.constant(c))));return b})};$prototype.inheritsBaseValues("$defaults");
