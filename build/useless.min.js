...
!0})},assertNotCalled:function(a){var c=!0;a(function(){c&&$fail});c=!1},assertEveryCalledOnce:function(a,c){return _.assertEveryCalled(_.hasTags?$once(a):(a.once=!0,a),c)},assertEveryCalled:function(a,c){var d=_.hasTags?$untag(a):a,e=_.hasTags?$async.is(a):a.async,f=(once=_.hasTags?$once.is(a):a.once)?null:d.toString().match(/.*function[^\(]\(([^\)]+)\)/),g=once?_.times(d.length,_.constant(1)):_.map(f[1].split(","),function(a){a=(a=a.trim().match(/^(.+)__(\d+)$/))&&parseInt(a[2],10);return _.isFinite(a)?
a||!1:!0}),h=_.times(d.length,_.constant(!1)),f=_.times(d.length,function(a){return function(){h[a]=_.isNumber(g[a])?(h[a]||0)+1:!0;e&&_.isEqual(h,g)&&c()}});d.apply(null,f);e||(_.assert(h,g),c&&c())},assertCalledWithArguments:function(a,c){return _.assert(_.arr(c),a)},assertCallOrder:function(a){var c=0,d=_.times(a.length,function(a){return function(){arguments.callee.callIndex=c++}});a.apply(null,d);return _.assert(_.pluck(d,"callIndex"),_.times(d.length,_.identity.arity1))},assertMatches:function(a,
c){try{return _.assert(_.matches.apply(null,_.rest(arguments))(a))}catch(d){throw _.isAssertionError(d)?_.extend(d,{notMatching:[a,c]}):d;}},assertNotMatches:function(a,c){try{return _.assert(!_.matches.apply(null,_.rest(arguments))(a))}catch(d){throw _.isAssertionError(d)?_.extend(d,{notMatching:[a,c]}):d;}},assertType:function(a,c){return _.assert(_.decideType(a),c)},assertTypeMatches:function(a,c){return _.isEmpty(mismatches=_.typeMismatches(c,a))?!0:_.assertionFailed({message:"provided value type not matches required contract",
asColumns:!0,notMatching:[{provided:a},{required:c},{mismatches:mismatches}]})},assertFails:function(a){return _.assertThrows.call(this,a,_.isAssertionError)},assertThrows:function(a,c){var d=void 0,e=!1;try{a.call(this)}catch(f){d=f,e=!0}_.assert.call(this,e);1<arguments.length&&_.assertMatches.call(this,d,c)},assertNotThrows:function(a){return _.assertEveryCalled(function(c){a();c()})},assertArguments:function(a,c,d){c=(c||a.callee).toString();var e=c.match(/.*function[^\(]\(([^\)]+)\)/);if(e){a=
...
a,{assertion:!0})},assertionFailed:function(a){throw _.extend(_.assertionError(a),{stack:_.rest(Error().stack.split("\n"),3).join("\n")});},isAssertionError:function(a){return a&&!0===a.assertion}});_.extend(_,{allEqual:function(a){return _.reduce(a,function(c,d){return c&&_.isEqual(a[0],d)},!0)}});_.each(_.keys(_.assertions),function(a){$global.define("$"+a,_[a],{configurable:!0})})})();_.extend(_,{asArray:function(a){return void 0!==a.length?[].slice.call(a,0):[a]}});
...
JSONAPI=$singleton(Component,{$traits:[HttpMethods],request:function(a,b,c){var d=_.hasReflection&&$callStack.offset((c.stackOffset||0)+1).asArray;c=_.extend2({headers:{"Cache-Control":"no-cache","Content-Type":"application/json; charset=utf-8"}},c);c.what&&(c.data=JSON.stringify(c.what));return Http.request(a,"/api/"+b,c)["finally"](function(a,b){if(b)return JSON.parse(b);if(a){if(a.httpResponse)return JSON.parse(a.httpResponse);throw a;}throw Error("empty response");}).then(function(a){if(a.success)return a.value;
