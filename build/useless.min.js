...
var globalUncaughtExceptionHandler=function(a){var b=arguments.callee.chain;arguments.callee.chain=_.reject(b,_.property("catchesOnce"));if(b.length)for(var c=0,d=b.length;c<d;c++)try{b[c](a);break}catch(e){if(c===d-1)throw e;e.originalError=a;a=e}else throw console.log("Uncaught exception: ",a),a;};_.withUncaughtExceptionHandler=function(a,b){var c=b||_.identity;b&&(a.catchesOnce=!0);globalUncaughtExceptionHandler.chain.unshift(a);c(function(){globalUncaughtExceptionHandler.chain.remove(a)})};
globalUncaughtExceptionHandler.chain=[];switch(_.platform().engine){case "node":require("process").on("uncaughtException",globalUncaughtExceptionHandler);break;case "browser":window.addEventListener("error",function(a){globalUncaughtExceptionHandler(a.error)})}_.hasAsserts=!0;
...
CallStack=$extends(Array,{enableAsyncPersistence:$static(function(){var a=$global.setTimeout;$global.setTimeout=function(b,c){var d=CallStack.current;return a(function(){_.withUncaughtExceptionHandler(function(a){throw _.extend(a,{parsedStack:CallStack.fromError(a).initial(4).concat(d)});},function(a){b();a()})},c)}}),current:$static($property(function(){return CallStack.fromRawString(CallStack.currentAsRawString).offset(1)})),fromError:$static(function(a){return a.parsedStack?CallStack.fromParsedArray(a.parsedStack):
CallStack.fromRawString(a.stack)}),locationEquals:$static(function(a,b){return a.file===b.file&&a.line===b.line&&a.column===b.column}),safeLocation:function(a){return this[a]||{callee:"",calleeShort:"",file:"",fileName:"",fileShort:"",thirdParty:!1,source:"??? WRONG LOCATION ???",sourceReady:_.barrier("??? WRONG LOCATION ???")}},clean:$property(function(){return this.reject(_.property("thirdParty"))}),asArray:$property(function(){return _.asArray(this)}),offset:function(a){return CallStack.fromParsedArray(_.rest(this,
a))},initial:function(a){return CallStack.fromParsedArray(_.initial(this,a))},concat:function(a){return CallStack.fromParsedArray(this.asArray.concat(a.asArray))},filter:function(a){return CallStack.fromParsedArray(_.filter(this,a))},reject:function(a){return CallStack.fromParsedArray(_.reject(this,a))},reversed:$property(function(){return CallStack.fromParsedArray(_.reversed(this))}),sourcesReady:function(a){return _.allTriggered(_.pluck(this,"sourceReady"),a)},constructor:function(a){Array.prototype.constructor.call(this);
...
a.replace($sourcePath,"");return Platform.NodeJS&&"/"!==a[0]||0<=b.indexOf("/node_modules/")||0<=a.indexOf("/node_modules/")&&!b||0<=b.indexOf("underscore")||0<=b.indexOf("jquery")})),fromRawString:$static(_.sequence(function(a){return CallStack.rawStringToArray(a)},function(a){return _.map(a,function(a){return _.extend(a,{calleeShort:_.last(a.callee.split(".")),fileName:_.last(a.file.split("/")),fileShort:CallStack.shortenPath(a.file),thirdParty:CallStack.isThirdParty(a.file)})})},function(a){return CallStack.fromParsedArray(a)})),
rawStringToArray:$static(function(a){a=(a||"").split("\n");return _.filter2(a,function(a){a=a.trimmed;var c,d=[],e,d=a.match(/at (.+) \((.+)\)/),f=a.match(/at (.+)/);if(d)c=d[1],e="native"===d[2],d=_.rest(d[2].match(/(.*):(.+):(.+)/)||[]);else if(f)d=_.rest(f[1].match(/(.*):(.+):(.+)/)||[]);else return!1;return{beforeParse:a,callee:c||"",index:Platform.Browser&&d[0]===window.location.href,"native":e,file:d[0]||"",line:(d[1]||"").integerValue,column:(d[2]||"").integerValue}})})});
