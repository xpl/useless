...
_.defineKeyword=function(a,b){_.defineProperty(_.global(),_.keyword(a),b)};_.defineKeyword("global",_.global);_.defineKeyword("platform",_.platform);
_.defineTagKeyword=function(a){_.keyword(a)in $global||(_.defineKeyword(a,Tags.add("constant",_.extend(_.partial(Tags.add,a),{matches:Tags.matches(a)}))),_.tagKeywords[a]=!0);var b=_.keyword(a);return _.extend($global[b],{is:function(a){return _.isTypeOf(Tags,a)&&b in a||!1},isNot:function(a){return!(_.isTypeOf(Tags,a)&&b in a)||!1},unwrap:function(a){return!0===$atom.matches(a)?Tags.unwrap(a):a}})};_(["constant","get"]).each(_.defineTagKeyword);
_.defineModifierKeyword=function(a,b){_.defineKeyword(a,function(a){return Tags.modifySubject(a,b)})};_.deleteKeyword=function(a){delete $global[_.keyword(a)]};_.defineTagKeyword("required");_.defineTagKeyword("atom");_.defineKeyword("any",_.identity);
...
arity0:_.arity0,arity1:_.arity1,arity2:_.arity2,arity3:_.arity3,or:_.or,and:_.and,not:_.not,applies:_.applies,memoized:_.memoize,throttled:_.throttle,debounced:function(a,b,c){var d,e,f,g,h,k=function(){var l=Date.now()-d;l<b&&0<l?e=setTimeout(k,b-l):(e=null,c||(f=a.apply(h,g),e||(h=g=null)))},m=function(){h=this;g=arguments;d=Date.now();var l=c&&!e;e||(e=setTimeout(k,b));l&&(f=a.apply(h,g),h=g=null);return f};m.callImmediately=function(){e&&(clearTimeout(e),e=null);a.apply(h,g)};return m},postpone:$method(function(a){var b=
_.rest(arguments);a._postponed||(a._postponed=!0,_.delay(function(){a._postponed=!1;a.apply(null,b)}))}),postponed:function(a){return function(){a.postpone.apply(a,arguments)}},delay:_.delay,delayed:function(a,b){return function(){var c=arguments,d=this;_.delay(function(){a.apply(d,c)},b)}}});
...
"\u043b":"l","\u043c":"m","\u043d":"n","\u043e":"o","\u043f":"p","\u0440":"r","\u0441":"s","\u0442":"t","\u0443":"u","\u0444":"ph","\u0445":"h","\u0446":"ts","\u0447":"ch","\u0448":"sh","\u0449":"sch","\u044c":"","\u044a":"","\u044b":"y","\u044d":"e","\u044e":"yu","\u044f":"ya"},_.object(_.map("_-1234567890qwertyuiopasdfghjklzxcvbnm",function(a){return[a,a]})));return function(b){var c="";b=(b||"").toLowerCase();for(var d=0,e=b.length;d<e;d++)c+=a[b[d]]||"";return c}}(),fixedEncodeURIComponent:function(a,
b){return encodeURIComponent(a).replace(b?b:/[!'().,*-]/g,function(a){return"%"+a.charCodeAt(0).toString(16)})}});
...
e){var f=b[d];_.isBindable(f)&&_.each(a,function(a){f["_"+a]=_.without(f["_"+a],e)})},isBindable:function(a){return a&&a._bindable?!0:!1},bindable:function(a,d){return _.withSameArgs(a,_.extendWith(b(a),function(){var b=arguments.callee,f=b._onceBefore,g=b._onceAfter,h=b._onBefore,k=b._onAfter,m=b._intercept,b=d||this,l,n=void 0;if(f.length){l=0;for(n=f.length;l<n;l++)f[l].apply(b,arguments);f.removeAll()}l=0;for(n=h.length;l<n;l++)h[l].apply(b,arguments);f=(m.length?_.cps.compose([a].concat(m)):
a).apply(b,arguments);if(k.length||g.length){h=_.asArray(arguments).concat(f);l=0;for(n=k.length;l<n;l++)k[l].apply(b,h);if(g.length){l=0;for(n=g.length;l<n;l++)g[l].apply(b,h);g.removeAll()}}return f}))}})})();
...
read:function(a){return function(d){b.hasValue&&d.call(this,b.value);a.call(this,d)}},write:function(a){return function(d){b.beforeWrite&&(d=b.beforeWrite(d));if(!b.hasValue||(b.trackReference?b.value!==d:!_.isEqual(b.value,d))){var e=b.value,f=b.hasValue;b.hasValue=!0;b.value=d;f?a.call(this,!1,b.value,e):a.call(this,!1,b.value)}}}});arguments.length&&b.apply(this,arguments);return _.extend(b,{force:function(a){b.hasValue=!1;b(a||b.value)},when:function(a,d){b(function(e){a(e)&&(b.off(arguments.callee),
d(e))})}})},barrier:function(a){var b=_.stream({already:void 0!==a,value:a,write:function(a){return function(d){b.already||(b.already=!0,b.value=d);a.call(this,!0,b.value)}},read:function(a){return function(d){b.already?d.call(this,b.value):a.call(this,d)}}});return b},triggerOnce:$restArg(function(){return _.stream({read:_.identity,write:function(a){return a.partial(!0)}}).apply(this,arguments)}),trigger:$restArg(function(){return _.stream({read:_.identity,write:function(a){return a.partial(!1)}}).apply(this,
arguments)}),off:function(a,b){a.queue&&(1===arguments.length?a.queue.off():a.queue.off(b));a.queuedBy&&(_.each(a.queuedBy,function(b){b.remove(a)}),delete a.queuedBy)},stream:function(a){a=a||{};var b=_.extend([],{off:function(a){this.length&&(0===arguments.length?(_.each(this,function(a){a.queuedBy.remove(this)},this),this.removeAll()):a.queuedBy&&(a.queuedBy.remove(this),this.remove(a)))}}),c=void 0,d=a.write(function(a,d){var e=_.rest(arguments),k=b.copy,m=c.context;a&&b.off();_.each(k,function(a){a.apply(this,
e)},m||this)}),e=a.read(function(a){0>b.indexOf(a)&&(a.queuedBy?a.queuedBy.push(b):a.queuedBy=[b],b.push(a))});return c=_.extend($restArg(function(a){_.isFunction(a)?e.call(this,a):d.apply(this,arguments);return arguments.callee}),a,{queue:b,once:function(a){e(function(b){_.off(c,arguments.callee);a(b)})},off:_.off.asMethod,read:e,write:d})}});_.hasOOP=!0;_("property static final alias memoized private builtin testArguments".split(" ")).each(_.defineTagKeyword);
...
Platform=$singleton({$property:{engine:_.platform().engine,system:_.platform().system,device:_.platform().device,touch:_.platform().touch||!1,Browser:"browser"===_.platform().engine,NodeJS:"node"===_.platform().engine,iPad:"iPad"===_.platform().device,iPhone:"iPhone"===_.platform().device,iOS:"iOS"===_.platform().system}});
...
Lock=$prototype({acquire:function(a){this.wait(this.$(function(){this.waitQueue||(this.waitQueue=[]);a()}))},acquired:function(){return void 0!==this.waitQueue},wait:function(a){this.acquired()?this.waitQueue.push(a):a()},release:function(){if(this.waitQueue.length){var a=_.first(this.waitQueue);this.waitQueue=_.rest(this.waitQueue);a()}else delete this.waitQueue}});_.defineKeyword("interlocked",function(a){var b=new Lock;return _.wrapper(Tags.unwrap(a),function(a){b.acquire(function(){a(b.$(b.release))})})});
Platform.NodeJS&&(module.exports=_);_.clamp=function(a,b,c){return Math.max(b,Math.min(c,a))};_.lerp=function(a,b,c){return b+(c-b)*a};_.rescale=function(a,b,c,d){a=(a-b[0])/(b[1]-b[0]);return _.lerp(d&&d.clamp?_.clamp(a,0,1):a,c[0],c[1])};_.sqr=function(a){return a*a};Math.sign||(Math.sign=function(a){return 0>a?-1:0<a?1:0});
...
Vec2=$prototype({$static:{zero:$property(function(){return new Vec2(0,0)}),unit:$property(function(){return new Vec2(1,1)}),one:$alias("unit"),fromLT:function(a){return new Vec2(a.left,a.top)},fromWH:function(a){return new Vec2(a.width,a.height)},fromLeftTop:$alias("fromLT"),fromWidthHeight:$alias("fromWH"),lerp:function(a,b,c){return new Vec2(_.lerp(a,b.x,c.x),_.lerp(a,b.y,c.y))},clamp:function(a,b,c){return new Vec2(_.clamp(a.x,b.x,c.x),_.clamp(a.y,b.y,c.y))}},constructor:function(a,b){1===arguments.length?
_.isNumber(a)?this.x=this.y=a:(this.x=a.x,this.y=a.y):(this.x=a,this.y=b)},length:$property(function(){return Math.sqrt(this.lengthSquared)}),lengthSquared:$property(function(){return this.x*this.x+this.y*this.y}),distance:function(a){return this.sub(a).length},aspect:$property(function(){return this.x/this.y}),add:function(a,b){return void 0===b?"number"===typeof a?new Vec2(this.x+a,this.y+a):new Vec2(this.x+a.x,this.y+a.y):new Vec2(this.x+a,this.y+b)},dot:function(a){return this.x*a.x+this.y*a.y},
...
function(a,c){return a.add(c||Vec2.zero)},Vec2.zero)}),toString:function(){return"{"+this.x+","+this.y+"}"},projectOnCircle:function(a,b){return a.add(this.sub(a).normal.scale(b))},projectOnLineSegment:function(a,b){var c=b.sub(a),d=c.lengthSquared;if(0==d)return a;d=this.sub(a).dot(c)/d;return 0>d?a:1<d?b:a.add(c.scale(d))},projectOnRay:function(a,b){var c=b.lengthSquared;return 0==c?0:this.sub(a).dot(b)/c}});
...
this.bottom),g=new Vec2(this.left,this.bottom),c=[a.projectOnLineSegment(d.add(c,0),e.add(-c,0)),a.projectOnLineSegment(e.add(0,c),f.add(0,-c)),a.projectOnLineSegment(f.add(-c,0),g.add(c,0)),a.projectOnLineSegment(g.add(0,-c),d.add(0,c)),a.projectOnCircle(d.add(c,c),c),a.projectOnCircle(e.add(-c,c),c),a.projectOnCircle(f.add(-c,-c),c),a.projectOnCircle(g.add(c,-c),c)];return _.min(c,function(b){return a.sub(b).length})},clone:$property(function(){return new BBox(this.x,this.y,this.width,this.height)}),
floor:$property(function(){return new Vec2(Math.floor(this.x),Math.floor(this.y))}),css:$property(function(){return{left:this.left,top:this.top,width:this.width,height:this.height}}),leftTop:$property(function(){return new Vec2(this.left,this.top)}),leftBottom:$property(function(){return new Vec2(this.left,this.bottom)}),rightBottom:$property(function(){return new Vec2(this.right,this.bottom)}),rightTop:$property(function(){return new Vec2(this.right,this.top)}),left:$property(function(){return this.x-
this.width/2}),right:$property(function(){return this.x+this.width/2}),top:$property(function(){return this.y-this.height/2}),bottom:$property(function(){return this.y+this.height/2}),center:$property(function(){return new Vec2(this.x,this.y)}),size:$property(function(){return new Vec2(this.width,this.height)}),offset:function(a){return new BBox(this.x+a.x,this.y+a.y,this.width,this.height)},newWidth:function(a){return new BBox(this.x-(a-this.width)/2,this.y,a,this.height)},grow:function(a){return new BBox(this.x,
this.y,this.width+2*a,this.height+2*a)},shrink:function(a){return this.grow(-a)},area:$property(function(){return Math.abs(this.width*this.height)}),toString:function(){return"{"+this.x+","+this.y+":"+this.width+"\u00d7"+this.height+"}"}});
Transform=$prototype({identity:$static(function(){return new Transform}),svgMatrix:$static(function(a){return new Transform([[a.a,a.c,a.e],[a.b,a.d,a.f],[0,0,1]])}),constructor:function(a){this.components=a||[[1,0,0],[0,1,0],[0,0,1]]},multiply:function(a){var b=[[0,0,0],[0,0,0],[0,0,0]],c,d,e=this.components,f=a.components;for(a=0;3>a;a++)for(c=0;3>c;c++)for(d=0;3>d;d++)b[a][c]+=e[a][d]*f[d][c];return new Transform(b)},translate:function(a){return this.multiply(new Transform([[1,0,a.x],[0,1,a.y],
[0,0,1]]))},scale:function(a){return this.multiply(new Transform([[a,0,0],[0,a,0],[0,0,1]]))},inverse:$property($memoized(function(){var a=this.components,b=1/(a[0][0]*(a[1][1]*a[2][2]-a[2][1]*a[1][2])-a[0][1]*(a[1][0]*a[2][2]-a[1][2]*a[2][0])+a[0][2]*(a[1][0]*a[2][1]-a[1][1]*a[2][0]));return new Transform([[(a[1][1]*a[2][2]-a[2][1]*a[1][2])*b,-(a[0][1]*a[2][2]-a[0][2]*a[2][1])*b,(a[0][1]*a[1][2]-a[0][2]*a[1][1])*b],[(a[1][0]*a[2][2]-a[1][2]*a[2][0])*b,(a[0][0]*a[2][2]-a[0][2]*a[2][0])*b,-(a[0][0]*
a[1][2]-a[1][0]*a[0][2])*b],[(a[1][0]*a[2][1]-a[2][0]*a[1][1])*b,-(a[0][0]*a[2][1]-a[2][0]*a[0][1])*b,(a[0][0]*a[1][1]-a[1][0]*a[0][1])*b]])})),unproject:function(a){var b=this.components;return new Vec2(a.x*b[0][0]+a.y*b[0][1]+b[0][2],a.x*b[1][0]+a.y*b[1][1]+b[1][2])},project:function(a){return this.inverse.unproject(a)}});
...
_.extend(Math,function(a){return{roundTo:function(a,c){return a-a%c},round10:function(b,c){return a("round",b,c)},floor10:function(b,c){return a("floor",b,c)},ceil10:function(b,c){return a("ceil",b,c)}}}(function(a,b,c){if("undefined"===typeof c||0===+c)return Math[a](b);b=+b;c=+c;if(isNaN(b)||"number"!==typeof c||0!==c%1)return NaN;b=b.toString().split("e");b=Math[a](+(b[0]+"e"+(b[1]?+b[1]-c:-c)));b=b.toString().split("e");return+(b[0]+"e"+(b[1]?+b[1]+c:c))}));_("bindable trigger triggerOnce barrier observable observableProperty memoize memoizeCPS debounce throttle overrideThis listener".split(" ")).each(_.defineTagKeyword);
_.defineKeyword("component",function(a){return $extends(Component,a)});$prototype.inheritsBaseValues=function(a){$prototype.macro(a,function(b,c,d,e){_.defaults(c,e&&e[a]);(b.$trait||b.$traits)&&_.each(b.$trait&&[b.$trait]||b.$traits,function(b){_.defaults(c,b[a])});b[a]=$static($builtin($property(_.constant(c))));return b})};$prototype.inheritsBaseValues("$defaults");$prototype.inheritsBaseValues("$requires");
Component=$prototype({isStreamDefinition:$static(function(a){return _.isObject(a)&&(a.$trigger||a.$triggerOnce||a.$barrier||a.$observable||a.$observableProperty)}),enumMethods:function(a){for(var b in this){var c=this.constructor.$definition[b];c&&c.$property||(c=this[b],_.isFunction(c)&&!_.isPrototypeConstructor(c)&&a.call(this,c,b))}},constructor:$final(function(a,b){var c=this.cfg="object"===typeof a?a:{},d=this.constructor.$definition;this.constructor.$defaults&&_.defaults(this,_.cloneDeep(this.constructor.$defaults));
this.enumMethods(function(a,b){"$"!==b&&"init"!==b&&(this[b]=this.$(a))});_.onBefore(this,"destroy",this.beforeDestroy);_.onAfter(this,"destroy",this.afterDestroy);_.extend(this,{parent_:void 0,children_:[]},_.omit(_.omit(c,"init","attachTo","attach"),function(a,b){return Component.isStreamDefinition(d[b])},this));_.each(d,function(a,b){if(void 0!==a){if(a.$observableProperty){var d=this[b];defaultValue=b in c?c[b]:d;var h=this[b+"Change"]=_.observable();h.context=this;if(_.isPrototypeInstance(d)){var k=
d.constructor;h.beforeWrite=function(a){return k.isTypeOf(a)?a:new k(a)}}_.defineProperty(this,b,{get:function(){return h.value},set:function(a){h.call(this,a)}});void 0!==defaultValue&&h(_.isFunction(defaultValue)?this.$(defaultValue):defaultValue)}else if(Component.isStreamDefinition(a)){d=(a.$trigger?_.trigger:a.$triggerOnce?_.triggerOnce:a.$observable?_.observable:a.$barrier?_.barrier:void 0)(this[b]);this[b]=_.extend(d,{context:this});var m=c[b];m&&d(this.$(m))}a.$listener&&(this[b].queuedBy=
[]);a.$bindable&&(_.hasAsserts&&$assert(_.isFunction(this[b])),this[b]=_.bindable(this[b],this));a.$debounce&&(d=this[b],this[b]=_.debounce(d,d.wait||500,d.immediate));a.$throttle&&(d=this[b],this[b]=_.throttle(d,d.wait||500,_.pick(d,"leading","trailing")));a.$memoize?this[b]=_.memoize(this[b]):a.$memoizeCPS&&(this[b]=_.cps.memoize(this[b]))}},this);_.intercept(this,"init",function(a){(_.hasArgs(this.constructor.prototype.init)?_.cps.sequence:_.sequence)([this._beforeInit,a.bind(this),this._afterInit]).call(this)});
_.each(d,function(a,b){a&&a.$alias&&(this[b]=this[Tags.unwrap(a)])},this);_.hasAsserts&&_.each(this.constructor.$requires,function(a,b){$assertTypeMatches(this[b],a)},this);!1===c.init||this.constructor.$defaults&&!1===this.constructor.$defaults.init||this.init()}),callTraitsMethod:function(a,b){_.isFunction(b)?_.cps.sequence(_.filter2(this.constructor.$traits||[],this.$(function(b){return(b=b.prototype[a])&&_.cps.arity0(_.noArgs(b)?b.asContinuation:b).bind(this)||!1})).concat(b.arity0))():_.sequence(_.filter2(this.constructor.$traits||
[],this.$(function(b){return(b=b.prototype[a])&&(_.hasArgs(b)?b.bind(this,_.identity):b.bind(this))||!1})))()},_beforeInit:function(a){if(this.initialized.already)throw Error("Component: I am already initialized. Probably you're doing it wrong.");this.callTraitsMethod("beforeInit",a)},init:function(){},_afterInit:function(a){var b=this.cfg;b.attach&&!_.isFunction(b.attach)&&this.attach(b.attach);b.attachTo&&!_.isFunction(b.attachTo)&&this.attachTo(b.attachTo);this.callTraitsMethod("afterInit",a);
this.initialized(!0);_.each(this.constructor.$definition,function(a,d){d+="Change";if(a&&a.$observableProperty){var e=b[d];if(_.isFunction(e))this[d](e)}},this)},initialized:$barrier(),beforeDestroy:function(){if(this.destroyed_)throw Error("Component: I am already destroyed. Probably you're doing it wrong.");if(this.destroying_)throw Error("Component: Recursive destroy() call detected. Probably you're doing it wrong.");this.destroying_=!0;this.enumMethods(_.off);_.each(this.children_,_.method("destroy"));
...
(function(){var a=_.globalUncaughtExceptionHandler=function(a){var b=arguments.callee.chain;arguments.callee.chain=_.reject(b,_.property("catchesOnce"));if(b.length)for(var c=0,d=b.length;c<d;c++)try{b[c](a);break}catch(k){if(c===d-1)throw k.message+=" [re-thrown by a hook]",k;k&&"object"===typeof k&&(k.originalError=a);a=k}else throw a.message+=" [re-thrown by a hook]",a;};_.withUncaughtExceptionHandler=function(b,c){var d=c||_.identity;c&&(b.catchesOnce=!0);a.chain.unshift(b);d(function(){a.chain.remove(b)})};
a.chain=[];var b=function(a,b){var c=function(c){c.addEventListener=a(c.addEventListener);c.removeEventListener=b(c.removeEventListener)};window.EventTarget?c(window.EventTarget.prototype):(c(Node.prototype),c(XMLHttpRequest.prototype))},c=void 0;switch(Platform.engine){case "node":require("process").on("uncaughtException",a);break;case "browser":window.addEventListener("error",function(b){0>b.message.indexOf(" [re-thrown by a hook]")&&(b.error?a(b.error):a(_.extend(Error(b.message),{stub:!0,stack:"at "+
b.filename+":"+b.lineno+":"+b.colno})))});var d=function(b,d){return __supressErrorReporting=function(){var g={name:name,stack:Error().stack,asyncContext:c},h=_.asArray(arguments),k=h[d];k.__uncaughtJS_wrapper=h[d]=__supressErrorReporting=function(){c=g;try{return k.apply(this,arguments)}catch(b){a(_.extend(b,{asyncContext:g}))}};return b.apply(this,h)}};window.setTimeout=d(window.setTimeout,0);b(function(a){return d(a,1)},function(a){return function(b,c,d,k){return a.call(this,b,c.__uncaughtJS_wrapper||
c,d)}})}})();_.hasReflection=!0;_.defineKeyword("callStack",function(){return CallStack.fromRawString(CallStack.currentAsRawString).offset(Platform.NodeJS?1:0)});_.defineKeyword("currentFile",function(){return(CallStack.rawStringToArray(CallStack.currentAsRawString)[Platform.NodeJS?3:1]||{file:""}).file});_.defineKeyword("uselessPath",_.memoize(function(){return _.initial($currentFile.split("/"),Platform.NodeJS?2:1).join("/")+"/"}));
...
a)},animationend:function(a){return this.one("animationend webkitAnimationEnd oAnimationEnd oanimation MSAnimationEnd",a)},animateWith:function(a,b){this.addClass(a);this.animationend(this.$(function(){this.removeClass(a);b&&b.call(this)}));return this},drag:function(){var b=function(b,c){return b.originalEvent.touches&&_.find(b.originalEvent.touches,function(b){return a(b.target).hasParent(c)})||b};return function(d){Platform.touch||window.__globalDragOverlay||(window.__globalDragOverlay=a("<div>").css({display:"none",
position:"fixed",top:0,right:0,bottom:0,left:0,zIndex:999999}).appendTo(document.body));var e=window.__globalDragOverlay,f=this.$(function(f){var g=d.relativeTo||this;this.addClass(d.cls||"");if(Platform.touch||1===f.which){var m=g.offset(),l=void 0;if(!d.start||!1!==(l=d.start.call(d.context||this,new Vec2(f.pageX-m.left,f.pageY-m.top),f))){var n=void 0,p=void 0,q=void 0,l=_.clone(l),r=this.$(function(a){if(Platform.touch||1===a.which){a.preventDefault();a=b(a,this[0]);var e=g.offset();l=d.move.call(d.context||
this,l,new Vec2(a.pageX-f.pageX,a.pageY-f.pageY),new Vec2(a.pageX-e.left,a.pageY-e.top),a)||l}else n(a)}),p=function(){a(e||document.body).css(e?{display:"none"}:{}).off("mouseup touchend",q).off("mousemove touchmove",r)},q=this.$(function(a){p();d.end&&(a=b(a,this[0]),d.end.call(d.context||this,l,new Vec2(a.pageX-f.pageX,a.pageY-f.pageY),a));this.removeClass(d.cls||"")}),n=this.$(function(a){p();q(a)});a(e||document.body).css(e?{display:"",cursor:d.cursor||""}:{}).on("mousemove touchmove",r).one("mouseup touchend",
q);d.callMoveAtStart&&d.move.call(d.context||this,l,Vec2.zero,new Vec2(f.pageX-m.left,f.pageY-m.top),f)}}}),g=_.$(this,function(a){var e=_.extend({},b(a,this[0]));if(Platform.touch&&d.longPress){var g=void 0,l=window.setTimeout(_.$(this,function(){this.off("touchmove touchend",g);f(e)}),300),g=this.$(function(){window.clearTimeout(l);this.off("touchmove touchend",g)});this.one("touchmove touchend",g)}else f(e),a.preventDefault(),a.stopPropagation()});this.on(Platform.touch?"touchstart":"mousedown",
g);return _.extend(this,{cancel:this.$(function(){this.off(Platform.touch?"touchstart":"mousedown",g)})})}}(),transform:function(a){if(0===arguments.length){var b=this.css("transform").match(/^matrix\((.+\))$/);return b?(b=b[1].split(",").map(parseFloat),new Transform({a:b[0],b:b[1],c:b[2],d:b[3],e:b[4],f:b[5]})):Transform.identity}return this.css("transform",_.isStrictlyObject(a)&&(a.translate?"translate("+a.translate.x+"px,"+a.translate.y+"px) ":"")+(a.rotate?"rotate("+a.rotate+"rad) ":"")+(a.scale?
"scale("+(new Vec2(a.scale)).separatedWith(",")+")":"")||"")},svgTranslate:function(a){return this.attr("transform","translate("+a.x+","+a.y+")")},svgTansformMatrix:function(a){a=a.components;return this.attr("transform","matrix("+a[0][0]+","+a[1][0]+","+a[0][1]+","+a[1][1]+","+a[0][2]+","+a[1][2]+")")},outerExtent:function(){return new Vec2(this.outerWidth(),this.outerHeight())},extent:function(){return new Vec2(this.width(),this.height())},innerExtent:function(){return new Vec2(this.innerWidth(),
this.innerHeight())},outerBBox:function(){return BBox.fromLTWH(_.extend(this.offset(),this.outerExtent().asWidthHeight))},clientBBox:function(){var a=this[0].getBoundingClientRect();return new BBox(a.left,a.top,a.width,a.height)},leftTop:function(){return new Vec2.fromLT(this.offset())},offsetInParent:function(){return Vec2.fromLeftTop(this.offset()).sub(Vec2.fromLeftTop(this.parent().offset()))},monitorInput:function(b){var d=function(){""===a.trim(a(this).val())?b.empty(!0):b.empty(!1)};return this.keyup(d).change(d).focus(_.bind(b.focus||
_.noop,b,!0)).blur(_.bind(b.focus||_.noop,b,!1))},touchClick:function(a,b){var e=this;b=b||{};if(!b.disableTouch&&Platform.touch){var f=function(b){a.apply(this,arguments);b.preventDefault();return!1},g=function(a){a.preventDefault();return!1};b.handler&&b.handler({unbind:function(){e.off("touchstart",f).off("click",g)}});return this.on("touchstart",f).on("click",g)}b.handler&&b.handler({unbind:function(){e.off("click",a)}});return this.click(a)},touchDoubleclick:function(a){if(Platform.touch){var b=
Date.now();return this.on("touchend",function(){var e=Date.now();200>e-b&&a.apply(this,arguments);b=e})}return this.dblclick(a)},nodoubletapzoom:function(){return a(this).bind("touchstart",function(b){var d=b.timeStamp,e=a(this).data("lastTouch")||d,e=d-e,f=b.originalEvent.touches.length;a(this).data("lastTouch",d);!e||500<e||1<f||(b.preventDefault(),a(b.target).trigger("click"))})}})}(jQuery);Platform.NodeJS&&(module.exports=_);
