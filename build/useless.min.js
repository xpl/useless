...
_.platform=function(){return arguments.callee.__value||(arguments.callee.__value="undefined"!==typeof window&&window._&&window._.platform===_.platform&&"undefined"!==typeof navigator&&navigator.platform&&navigator.platform.indexOf?_.extend({engine:"browser",browser:0<=navigator.userAgent.indexOf("Firefox")?"Firefox":0<=navigator.userAgent.indexOf("Chrome")?"Chrome":0<=navigator.userAgent.indexOf("Safari")?"Safari":0<=navigator.userAgent.indexOf("Trident")?"IE":void 0},0<=navigator.platform.indexOf("Linux arm")||
0<=navigator.platform.indexOf("Android")||0<=navigator.userAgent.indexOf("Android")?{touch:!0,system:"Android"}:0<=navigator.platform.indexOf("iPad")?{touch:!0,system:"iOS",device:"iPad"}:0<=navigator.platform.indexOf("iPhone")||0<=navigator.platform.indexOf("iPod")?{touch:!0,system:"iOS",device:"iPhone"}:{}):"undefined"!==typeof global&&global._&&global._.platform===_.platform?{engine:"node"}:{})};
...
Format={urlencode:function(a){return _.map(a,function(a,c){return c+"="+_.fixedEncodeURIComponent(a)}).join("&")},javascript:function(a){return _.stringify(a,{pretty:!0,pure:!0,formatter:function(a){if(_.isTypeOf(Tags,a))return _.reduce(_.keys(_.pick(a,_.keyIsKeyword)),function(a,b){return b+" "+_.quote(a,"()")},_.stringify(Tags.unwrap(a)));if(_.isFunction(a))return a.toString()}})},progressPercents:function(a,b){return Math.floor(a/b*100)+"%"},randomHexString:function(a){for(var b="",c=0;c<a;c++)b+=
Math.floor(16*Math.random()).toString(16);return b},leadingZero:function(a){return 10>a?"0"+a:a.toString()}};
