...
a.parse(e),k=h.name&&h.name.decapitalized||e;if(h=h.how&&_["on"+h.how.capitalized]||_.intercept){var l=b[k];l&&_.isFunction(l)&&h(b,k,c);var l=b.prototype,n=l[k];n&&_.isFunction(n)&&h(l,k,c)}}});b.aspectAdded&&b.aspectAdded(d);return d})})();TimeoutError=$extends(Error,{message:"timeout expired"});__=function(a){return a instanceof Function?new Promise(a):Promise.resolve(a)};__.noop=function(){return Promise.resolve()};__.identity=function(a){return Promise.resolve(a)};__.constant=function(a){return function(){return Promise.resolve(a)}};
...
b)},function(b){a(b,null);throw b;})},"finally":function(a){return this.then(function(b){a(null,b)},function(b){a(b,null)})},state:$property(function(){return this.then(function(a){return{state:"fulfilled",fulfilled:!0,value:a}},function(a){return{state:"rejected",rejected:!0,value:x}}).now["catch"](function(){return{state:"pending",pending:!0}})}),assert:function(a){return this.then(function(b){$assert(b,a);return b})},assertRejected:function(a){var b=0<arguments.length;return this["catch"](function(c){b&&
$assert(c,a);return c})},panic:$property(function(){return this["catch"](function(a){($global.Panic||$global.log)(a);throw a;})})});$mixin(Function,{promisify:$hidden($property(function(){var a=this;return function(){var b=this,c=arguments;return new Promise(function(d,e){a.apply(b,_.asArray(c).concat(function(a,b){a&&e(a);d(b)}))})}}))});
