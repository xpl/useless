...
f=e&&e[1];e&&(d.last.text=e[2].reversed);var g={},e=_.pluck.with_("items",_.reject.with_(_.property("label"),_.partition3.with_(_.equals(g),_.scatter(d,function(a,b,c){_.each(a.text.split("\n"),function(b,d,e){c(_.extended(a,{text:b}));d!==e.lastIndex&&c(g)})})))),d=_.pluck(d,"text").join(""),h=c.where||log.impl.walkStack($callStack)||{},k=_.times(c.indent,_.constant("\t")).join("");a({lines:e,config:c,color:c.color,args:arguments,indentation:k,indentedText:e.map(_.seq(_.pluck.tails2("text"),_.joinsWith(""),
