...
a.parse(e),k=h.name&&h.name.decapitalized||e;if(h=h.how&&_["on"+h.how.capitalized]||_.intercept){var l=b[k];l&&_.isFunction(l)&&h(b,k,c);var l=b.prototype,m=l[k];m&&_.isFunction(m)&&h(l,k,c)}}});b.aspectAdded&&b.aspectAdded(d);return d})})();TimeoutError=$extends(Error,{message:"timeout expired"});__=Promise.coerce=function(a){return a instanceof Promise?a:a instanceof Function?new Promise(function(b){b(a())}):Promise.resolve(a)};__.noop=function(){return Promise.resolve()};__.identity=function(a){return Promise.resolve(a)};
__.constant=function(a){return function(){return Promise.resolve(a)}};__.reject=function(a){return Promise.reject(a)};__.rejects=function(a){return function(){return Promise.reject(a)}};__.map=function(a,b){return __.then(a,function(a){if(_.isStrictlyObject(a)){var d=_.coerceToEmpty(a),e=[];_.each2(a,function(a,c){e.push(__.identity(b(a,c)).then(function(a){d[c]=a}))});return __.all(e).then(_.constant(d))}return b(a)})};
__.each=function(a,b){return __.then(a,function(a){return new Promise(function(d,e){_.cps.each(a,function(a,c,d){__(b(a,c)).then(d)["catch"](e)},d)})})};__.then=function(a,b){return __(a).then(_.coerceToFunction(b))};__.seq=function(a){return __(_.reduce2(a,__.then))};__.all=function(a){return Promise.all(a)};__.delay=function(a){return __.delays(a)()};__.delays=function(a){return function(b){return new Promise(function(c){setTimeout(function(){c(b)},a||0)})}};$mixin(Array,{race:$property(function(){return Promise.race(this)})});
