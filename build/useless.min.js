...
run:$interlocked(function(a,b){var c=_.last(arguments),d=3===arguments.length?b:_.identity,e=this.runConfig=_.extend({silent:!0,verbose:!1,timeout:2E3,testStarted:function(a){},testComplete:function(a){}},a),f=_.map(e.suites||[],this.$(function(a){return this.testSuite(a.name,a.tests,e.context)}));(!1===e.codebase?_.cps.constant([]):this.$(this.collectPrototypeTests))(this.$(function(a){var b=!1===e.codebase?[]:this.collectTests();a=_.flatten(_.pluck(b.concat(f).concat(a),"tests"));a=_.filter(a,e.shouldRun||
_.constant(!0));this.runningTests=_.map(a,function(a,b){return _.extend(a,{index:b})});_.cps.each(a,this.$(this.runTest),this.$(function(){_.assert(!0!==e.done);e.done=!0;this.printLog(e);this.failedTests=_.filter(this.runningTests,_.property("failed"));this.failed=0<this.failedTests.length;d(!this.failed);c()}))}))}),defineAssertions:function(a){_.each(a,function(a,c){this.defineAssertion(c,a)},this)},runTest:function(a,b,c){var d=this,e=this.runConfig;this.currentTest=a;e.testStarted(a);a.verbose=
e.verbose;a.timeout=e.timeout;a.run(function(){e.testComplete(a);delete d.currentTest;c()})},collectTests:function(){return _.map(_.tests,this.$(function(a,b){return this.testSuite(b,a)}))},collectPrototypeTests:function(a){_.cps.map(this.prototypeTests,this.$(function(a,c){a[0](this.$(function(d){c(this.testSuite(d.name,a[1]))}))}),a)},testSuite:function(a,b,c){return{name:a,tests:_(_.pairs("function"===typeof b&&_.object([[a,b]])||b)).map(function(b){return new Test({name:b[0],routine:b[1],suite:a,
context:c})})}},defineAssertion:function(a,b){var c=this;_.deleteKeyword(a);_.defineKeyword(a,Tags.modifySubject(b,function(d){return _.withSameArgs(d,function(){return c.currentTest?c.currentTest.runAssertion(a,b,d,arguments):d.apply(c,arguments)})}))},printLog:function(a){var b=_.filter(this.runningTests,function(b){return b.failed||!a.silent&&b.hasLog}),c=_.filter(this.runningTests,_.property("failed"));_.invoke(a.verbose?this.runningTests:b,"printLog");c.length?log.orange("\n"+log.boldLine+"\nSOME TESTS FAILED:",
