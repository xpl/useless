...
$overrideUnderscore=function(a,b){return _[a]=b(_[a])};"browser"!==_.platform().engine&&_.defineGlobalProperty("alert",function(a){var b=_.global().log&&_.partial(log.warn,log.config({stackOffset:2}))||console.log;b.apply(b,["ALERT:"].concat(_.asArray(arguments)))});_.defineGlobalProperty("alert2",function(a){alert(_.map(arguments,_.stringify).join(", "))});
var globalUncaughtExceptionHandler=function(a){var b=arguments.callee.chain;if(b.length)for(var c=0,d=b.length;c<d;c++)try{b[c](a);break}catch(e){if(c===d-1)throw e;e.originalError=a;a=e}else throw console.log("Uncaught exception: ",a),a;};_.withUncaughtExceptionHandler=function(a,b){b=b||_.identity;globalUncaughtExceptionHandler.chain.unshift(a);b(function(){globalUncaughtExceptionHandler.chain.remove(a)})};globalUncaughtExceptionHandler.chain=[];
switch(_.platform().engine){case "node":require("process").on("uncaughtException",globalUncaughtExceptionHandler);break;case "browser":window.addEventListener("error",function(a){globalUncaughtExceptionHandler(a.error)})}_.hasAsserts=!0;
...
_.extend(c,{notMatching:[a,b]}):c;}},assertTypeof:function(a,b){var c=_.typeMismatches(b,a);return _.isEmpty(c)?!0:_.assertionFailed({asColumns:!0,notMatching:[{value:a},{type:_.decideType(a)},{contract:b},{mismatches:c}]})},assertFails:function(a){_.assertThrows.call(this,a,_.isAssertionError)},assertThrows:function(a,b){var c=void 0,d=!1;try{a.call(this)}catch(e){c=e,d=!0}_.assert.call(this,d);1===arguments.length&&_.assertMatches.apply(this,[c].concat(_.rest(arguments)))},assertNotThrows:function(a){_.assertCalls.call(this,
0,function(){a()})},assertArguments:function(a,b,c){b=(b||a.callee).toString();var d=b.match(/.*function[^\(]\(([^\)]+)\)/);if(d){a=_.asArray(a);var d=_.map(d[1].split(","),function(a){a="_"===a.trim()[0]?a.replace(/_/g," ").trim():void 0;var b=parseInt(a,10);return _.isFinite(b)?b:a}),e=_.zipWith([d,a],function(a,b){return void 0===a?!0:a===b});_.every(e)||_.assertionFailed({notMatching:_.nonempty([[c,b].join(": "),d,a])})}},fail:function(){_.assertionFailed()},fails:_.constant(function(){_.assertionFailed()}),
...
_.isTypeOf_ES4=function(a,b){for(;b;){if(b.constructor===a)return!0;b=b.constructor.$base}return!1};_.isTypeOf_ES5=function(a,b){return b instanceof a};_.isTypeOf=_.isInstanceofSyntaxAvailable()?_.isTypeOf_ES5:_.isTypeOf_ES4;_.isPrototypeInstance=function(a){return a&&a.constructor&&_.isPrototypeConstructor(a.constructor)};_.isPrototypeConstructor=function(a){return a&&void 0!==a.$definition||!1};_.typeOf2=function(a){return _.isEmptyArray(a)?a:typeof a};
_.coerceToArray=function(a){return void 0===a?[]:_.isArray(a)?a:[a]};$overrideUnderscore("isArray",function(a){return function(b){return _.isTypeOf(Array,b)||a(b)}});
...
_.extend(_,{filterMap:function(a,b,c){var d=0,e=a&&a.length||0;b=b||_.identity;c=c||_.isNonempty;for(var f=[];d<e;d++){var g=b.call(this,a[d]);c.call(this,g)&&f.push(g)}return f}});_.quote=function(a,b){var c=b||'"',d=c.slice(0,Math.floor(c.length/2+c.length%2)),c=c.slice(c.length/2)||d;return d+a+c};_.quoteWith=_.flip2(_.quote);_.quotesWith=_.higherOrder(_.quoteWith);
...
function(a,b){return a&&a.constructor&&a.constructor.$definition?a.constructor:d(_.map2(a,b))})(a,_.typeOf2)}})();_.cps=function(){return _.cps.sequence.apply(null,arguments)};_.cps.apply=function(a,b,c,d){c=_.asArray(c);var e=_.numArgs(a)-1,f=c[e];c[e]=function(){d.call(this,arguments,f)};return a.apply(b,c)};
_.extend(_.cps,{each:function(a,b,c,d,e,f){var g=arguments.callee,h=d||0,k=0===h?void 0===a.length?_.keys(a):void 0:f,m=0===h?k?k.length:a.length:e;if(!a||h>=(m||0))c&&c();else{var l=k?k[h]:h;b(a[l],l,function(){g(a,b,c,h+1,m,k)},a)}}});_.extend(_.cps,{map:function(a,b,c){var d=_.isArray(a)?[]:{};_.cps.each(a,function(a,c,g){b(a,c,function(a){d[c]=a;g()})},function(){c(d)})}});
...
_(["method","property","flipped"]).each(_.defineTagKeyword);$extensionMethods=function(a,b){_.each(b,function(b,d){var e=Tags.unwrap(b);d in _||(_[d]=_[d]||e);if(b.$method||!b.$property&&!_.oneArg(e)){if(b.$property)throw Error("$extensionMethods: crazy input, unable to match");d in a.prototype||(a.prototype[d]=_.asMethod(b.$flipped?_.flip(e):e))}else d in a.prototype||_.defineHiddenProperty(a.prototype,d,function(){return e(this)})})};
...
write:function(a){return function(d){b.beforeWrite&&(d=b.beforeWrite(d));if(!b.hasValue||(b.trackReference?b.value!==d:!_.isEqual(b.value,d))){var e=b.value,f=b.hasValue;b.hasValue=!0;b.value=d;f?a.call(this,!1,b.value,e):a.call(this,!1,b.value)}}}});arguments.length&&b.apply(this,arguments);return _.extend(b,{force:function(a){b.hasValue=!1;b(a||b.value)},when:function(a,d){b.readWith(function(e){a(e)&&(b.off(arguments.callee),d(e))})},readWith:function(a){this.hasValue?a.call(this.context,this.value):
a.call(this.context);this(a)}})},barrier:function(){var a=_.stream({already:!1,value:void 0,write:function(b){return function(c){a.already||(a.already=!0,a.value=c);b.call(this,!0,a.value)}},read:function(b){return function(c){a.already?c.call(this,a.value):b.call(this,c)}}});return a},triggerOnce:$restArg(function(){return _.stream({read:_.identity,write:function(a){return a.partial(!0)}}).apply(this,arguments)}),trigger:$restArg(function(){return _.stream({read:_.identity,write:function(a){return a.partial(!1)}}).apply(this,
arguments)}),off:function(a){a.queue&&a.queue.off();a.queuedBy&&(_.each(a.queuedBy,function(b){b.remove(a)}),delete a.queuedBy)},stream:function(a){a=a||{};var b=!1,c=_.extend([],{off:function(a){this.length&&(0===arguments.length?(_.each(this,function(a){a.queuedBy.remove(this)},this),this.removeAll()):(a.queuedBy.remove(this),this.remove(a)))}}),d=void 0,e=a.write(function(a,b){var e=_.rest(arguments),f=c.copy,l=d.context;a&&c.off();_.each(f,function(a){a.apply(this,e)},l||this)}),f=a.read(function(a){0>
c.indexOf(a)&&(a.queuedBy?a.queuedBy.push(c):a.queuedBy=[c],c.push(a))});a=$restArg(function(){b||(b=!0,_.delay(_.applies(e,d,arguments).arity0.then(function(){b=!1})))});return d=_.extend($restArg(function(a){_.isFunction(a)?f.call(this,a):b||e.apply(this,arguments);return arguments.callee}),{queue:c,off:_.off.asMethod,postpone:a,read:f,write:e})}});_.clamp=function(a,b,c){return Math.max(b,Math.min(c,a))};_.lerp=function(a,b,c){return b+(c-b)*a};
_.rescale=function(a,b,c,d){a=(a-b[0])/(b[1]-b[0]);return _.lerp(d&&d.clamp?_.clamp(a,0,1):a,c[0],c[1])};_.sqr=function(a){return a*a};
Vec2=$prototype({$static:{zero:$property(function(){return new Vec2(0,0)}),unit:$property(function(){return new Vec2(1,1)}),one:$alias("unit"),fromLT:function(a){return new Vec2(a.left,a.top)},fromWH:function(a){return new Vec2(a.width,a.height)},fromLeftTop:$alias("fromLT"),fromWidthHeight:$alias("fromWH"),dot:function(a,b){return a.x*b.x+a.y*b.y},lerp:function(a,b,c){return new Vec2(_.lerp(a,b.x,c.x),_.lerp(a,b.y,c.y))},clamp:function(a,b,c){return new Vec2(_.clamp(a.x,b.x,c.x),_.clamp(a.y,b.y,
c.y))}},constructor:function(a,b){1===arguments.length?_.isNumber(a)?this.x=this.y=a:(this.x=a.x,this.y=a.y):(this.x=a,this.y=b)},length:$property(function(){return Math.sqrt(this.lengthSquared)}),lengthSquared:$property(function(){return this.x*this.x+this.y*this.y}),add:function(a,b){return void 0===b?new Vec2(this.x+a.x,this.y+a.y):new Vec2(this.x+a,this.y+b)},sub:function(a){return new Vec2(this.x-a.x,this.y-a.y)},scale:function(a,b){return new Vec2(this.x*a,this.y*(void 0===b?a:b))},mul:function(a){return new Vec2(this.x*
a.x,this.y*a.y)},divide:function(a){return new Vec2(this.x/a.x,this.y/a.y)},normal:$property(function(){return this.scale(1/this.length)}),perp:$property(function(){return new Vec2(this.y,-this.x)}),half:$property(function(){return new Vec2(.5*this.x,.5*this.y)}),inverse:$property(function(){return new Vec2(-this.x,-this.y)}),asLeftTop:$property(function(){return{left:Math.floor(this.x),top:Math.floor(this.y)}}),asLeftTopMargin:$property(function(){return{marginLeft:Math.floor(this.x),marginTop:Math.floor(this.y)}}),
asWidthHeight:$property(function(){return{width:Math.floor(this.x),height:Math.floor(this.y)}}),floor:$property(function(){return new Vec2(Math.floor(this.x),Math.floor(this.y))}),sum:$static(function(a){return _.reduce(_.isArray(a)&&a||_.asArray(arguments),function(a,c){return a.add(c||Vec2.zero)},Vec2.zero)}),toString:function(){return"{"+this.x+","+this.y+"}"},projectOnCircle:function(a,b){return a.add(this.sub(a).normal.scale(b))},projectOnLineSegment:function(a,b){var c=b.sub(a),d=c.lengthSquared;
if(0==d)return a;d=Vec2.dot(this.sub(a),c)/d;return 0>d?a:1<d?b:a.add(c.scale(d))}});
...
_.extend(a.x>this.right?{right:!0}:{},a.x<this.left?{left:!0}:{},a.y>this.bottom?{bottom:!0}:{},a.y<this.top?{top:!0}:{});return _.extend(a,a.left||a.right||a.bottom||a.top?{}:{inside:!0})},classifyRay:function(a,b,c,d){c=c||0;d=d||0;var e=this.size.half,f,g,h,k,m,l;h=1/b.x;k=1/b.y;m=Math.sign(h);l=Math.sign(k);f=(this.x-m*(e.x+c)-a.x)*h;g=(this.y-l*(e.y+d)-a.y)*k;c=(this.x+m*(e.x+c)-a.x)*h;d=(this.y+l*(e.y+d)-a.y)*k;if(!(f>d||g>c||(e=f>g?f:g,1<=e||0>=(c<d?c:d))))return d={time:_.clamp(e,0,1)},d.normal=
f>g?new Vec2(-m,0):new Vec2(0,-l),d.delta=b.scale(d.time),d.where=a.add(d.delta),d},nearestPointTo:function(a,b){var c=b||0,d=new Vec2(this.left,this.top),e=new Vec2(this.right,this.top),f=new Vec2(this.right,this.bottom),g=new Vec2(this.left,this.bottom),c=[a.projectOnLineSegment(d.add(c,0),e.add(-c,0)),a.projectOnLineSegment(e.add(0,c),f.add(0,-c)),a.projectOnLineSegment(f.add(-c,0),g.add(c,0)),a.projectOnLineSegment(g.add(0,-c),d.add(0,c)),a.projectOnCircle(d.add(c,c),c),a.projectOnCircle(e.add(-c,
...
2,this.y,a,this.height)},grow:function(a){return new BBox(this.x,this.y,this.width+a,this.height+a)},area:$property(function(){return Math.abs(this.width*this.height)}),toString:function(){return"{"+this.x+","+this.y+":"+this.width+"\u00d7"+this.height+"}"}});
...
b=[d,b,c,c,c,d];return a+" "+(4<a%100&&20>a%100?d:b[Math.min(a%10,5)])}};
...
_.defineKeyword("sourcePath",_.memoize(function(){var a=($uselessPath.match(/(.+)\/node_modules\/(.+)/)||[])[1];return a?a+"/":$uselessPath}));_.readSourceLine=function(a,b,c){_.readSource(a,function(a){c((a.split("\n")[b]||"").trimmed)})};_.readSource=_.cps.memoize(function(a,b){if(0>a.indexOf("<"))try{Platform.NodeJS?b(require("fs").readFileSync(a,{encoding:"utf8"})||""):jQuery.get(a,b,"text")}catch(c){b("")}else b("")});
CallStack=$extends(Array,{current:$static($property(function(){return CallStack.fromRawString(CallStack.currentAsRawString).offset(1)})),fromError:$static(function(a){return a.parsedStack?CallStack.fromParsedArray(_.map(a.parsedStack,function(a){return _.extend(a,{sourceReady:_.constant(a.source)})})):CallStack.fromRawString(a.stack)}),locationEquals:$static(function(a,b){return a.file===b.file&&a.line===b.line&&a.column===b.column}),safeLocation:function(a){return this[a]||{callee:"",calleeShort:"",
file:"",fileName:"",fileShort:"",thirdParty:!1,source:"??? WRONG LOCATION ???",sourceReady:_.cps.constant("??? WRONG LOCATION ???")}},clean:$property(function(){return this.reject(_.property("thirdParty"))}),asArray:$property(function(){return _.asArray(this)}),offset:function(a){return CallStack.fromParsedArray(_.rest(this,a))},filter:function(a){return CallStack.fromParsedArray(_.filter(this,a))},reject:function(a){return CallStack.fromParsedArray(_.reject(this,a))},reversed:$property(function(){return CallStack.fromParsedArray(_.reversed(this))}),
sourcesReady:function(a){return _.allTriggered(_.pluck(this,"sourceReady"),a)},constructor:function(a){Array.prototype.constructor.call(this);for(var b=0,c=a.length;b<c;b++)this.push(a[b])},fromParsedArray:$static(function(a){return new CallStack(a)}),currentAsRawString:$static($property(function(){var a="browser"===_.platform().engine?3:2;return _.rest((Error().stack||"").split("\n"),a).join("\n")})),shortenPath:$static(function(a){return a.replace($uselessPath,"").replace($sourcePath,"")}),isThirdParty:$static(function(a){var b=
a.replace($sourcePath,"");return 0<=b.indexOf("/node_modules/")||0<=a.indexOf("/node_modules/")&&!b||0<=b.indexOf("underscore")||0<=b.indexOf("jquery")}),fromRawString:$static(_.sequence(function(a){return CallStack.rawStringToArray(a)},function(a){return _.map(a,function(a){return _.extend(a,{calleeShort:_.last(a.callee.split(".")),fileName:_.last(a.file.split("/")),fileShort:CallStack.shortenPath(a.file),thirdParty:CallStack.isThirdParty(a.file)})})},function(a){return _.map(a,function(a){a.source=
"";a.sourceReady=_.barrier();_.readSourceLine(a.file,a.line-1,function(c){a.source=c;a.sourceReady(c)});return a})},function(a){return CallStack.fromParsedArray(a)})),rawStringToArray:$static(function(a){a=_.rest((a||"").split("\n"),"browser"===_.platform().engine?1:0);return _.map(a,function(a){a=a.trimmed;var c,d=[],e=a.match(/at (.+) \((.+)\)/);e?(c=e[1],d=_.rest(e[2].match(/(.*):(.+):(.+)/)||[])):(e=a.match(/at (.+)/))&&e[1]&&(d=_.rest(e[1].match(/(.*):(.+):(.+)/)||[]));return{beforeParse:a,callee:c||
"",file:d[0]||"",line:(d[1]||"").integerValue,column:(d[2]||"").integerValue}})})});$prototype.macro(function(a,b){var c=$callStack[5];a.$sourceFile=$static($property(c?c.fileShort:"unknown"));return a});_.measure=function(a,b){if(b){var c=_.now();a(function(){b(_.now()-c)})}else return c=_.now(),a(),_.now()-c};
...
_.extend(log=function(){log.write.apply(this,arguments)},{Color:$prototype(),Config:$prototype(),cleanArgs:function(a){return _.reject(a,_.or(log.Color.isTypeOf,log.Config.isTypeOf))},read:function(a,b){return _.find(b,a.isTypeOf)||new a({})},modify:function(a,b,c){return _.reject(b,a.isTypeOf).concat(c(log.read(a,b)))}});
...
c=log.cleanArgs(b),d=_.extend({indent:0},a,log.readConfig(b)),e=Platform.NodeJS?3:2,f=(log.impl.writeBackend.indent||0)+d.indent,g=log.impl.stringifyArguments(c),f=_.times(f,_.constant("\t")).join(""),g=g.reversed.match(/(\n*)([^]*)/),d=d.location&&log.impl.location(d.where||$callStack[e+(d.stackOffset||0)])||"",b={color:log.readColor(b),indentedText:g[2].reversed.split("\n").map(_.prepends(f)).join("\n"),trailNewlines:g[1],codeLocation:d};log.impl.writeBackend(b);return c[0]})},defaultWriteBackend:function(a){var b=
a.color,c=a.indentedText,d=a.codeLocation;a=a.trailNewlines;(b=b&&(Platform.NodeJS?b.shell:b.css))?Platform.NodeJS?console.log(b+c+"\u001b[0m",d,a):(c=c.split("\n"),c=[_.first(c)||""].concat(_.rest(c).map(_.prepends(" "))),console.log("%c"+c.join("\n"),"color: "+b,d,a)):console.log(c,d,a)},location:function(a){return _.quoteWith("()",_.nonempty([a.calleeShort,a.fileName+":"+a.line]).join(" @ "))},stringifyArguments:function(a){return _.map(a,log.impl.stringify).join(" ")},stringify:function(a){if(_.isTypeOf(Error,
a)){var b=log.impl.stringifyError(a);return a.originalError?b+"\n\n"+log.impl.stringify(a.originalError):b}return _.isTypeOf(CallStack,a)?log.impl.stringifyCallStack(a):"object"===typeof a?_.stringify(a):"string"===typeof a?a:_.stringify(a)},stringifyError:function(a){try{var b=CallStack.fromError(a).clean.offset(a.stackOffset||0);return"[EXCEPTION] "+(a.message||"").replace(/\r|\n/g,"").trimmed.first(120)+"\n\n"+log.impl.stringifyCallStack(b)+"\n"}catch(c){return"YO DAWG I HEARD YOU LIKE EXCEPTIONS... SO WE THREW EXCEPTION WHILE PRINTING YOUR EXCEPTION:\n\n"+
...
Platform.NodeJS&&(module.exports=_);_("bindable trigger triggerOnce barrier observable observableProperty memoize memoizeCPS debounce throttle overrideThis".split(" ")).each(_.defineTagKeyword);_.defineKeyword("component",function(a){return $extends(Component,a)});
...
"attachTo",this);return this},detachAll:function(){_.each(this.children_,function(a){a.parent_=void 0});this.children_=[];return this},destroyAll:function(){_.each(this.children_,function(a){a.parent_=void 0;a.destroy()});this.children_=[];return this}});_.defineTagKeyword("shouldFail");_.defineTagKeyword("async");_.defineTagKeyword("assertion");
Testosterone=$singleton({isRunning:$property(function(){return void 0!==this.currentTest}),constructor:function(){this.defineAssertion("assertFails",$shouldFail(function(a){a.call(this)}));_.each(_.omit(_.assertions,"assertFails"),function(a,b){this.defineAssertion(b,b in _.asyncAssertions?$async(a):a)},this);$prototype.macro("$tests",function(a,b,c){var d=Tags.unwrap(a.$sourceFile);_.extend(_.tests[d]||(_.tests[d]={}),b);return _.extend(a,_.object([[c,$static(b)]]))});this.run=this.$(this.run)},
findAndPublishPrototypeTests:_.trigger(function(){$prototype.each(function(a,b){a.$tests&&(_.tests[b]=a.$tests)})}),run:$interlocked(function(a,b){var c=_.last(arguments),d=3===arguments.length?b:_.identity,e=this.runConfig=_.extend({silent:!0,verbose:!1,timeout:2E3,testStarted:function(a){},testComplete:function(a){}},a),f=_.map(e.suites||[],this.$(function(a){return this.testSuite(a.name,a.tests,e.context)})),g=!1===e.codebase?[]:this.collectTests(),f=_.flatten(_.pluck(g.concat(f),"tests"));this.runningTests=
f=_.filter(f,e.shouldRun||_.constant(!0));_.cps.each(f,this.$(this.runTest),this.$(function(){_.assert(!0!==e.done);e.done=!0;this.printLog(e);this.failedTests=_.filter(this.runningTests,_.property("failed"));this.failed=0<this.failedTests.length;d(!this.failed);c()}))}),defineAssertions:function(a){_.each(a,function(a,c){this.defineAssertion(c,a)},this)},runTest:function(a,b,c){var d=this,e=this.runConfig;this.currentTest=a;e.testStarted(a);a.verbose=e.verbose;a.timeout=e.timeout;a.run(function(){e.testComplete(a);
delete d.currentTest;c()})},collectTests:function(){return _.map(_.tests,this.$(function(a,b){return this.testSuite(b,"function"===typeof a&&_.object([[b,a]])||a)}))},testSuite:function(a,b,c){return{name:a,tests:_(_.pairs(b)).map(function(b){return new Test({name:b[0],routine:b[1],suite:a,context:c})})}},defineAssertion:function(a,b){var c=this;_.deleteKeyword(a);_.defineKeyword(a,Tags.modifySubject(b,function(d){return _.withSameArgs(d,function(){return c.currentTest?c.currentTest.runAssertion(a,
b,d,arguments):d.apply(c,arguments)})}))},printLog:function(a){var b=_.filter(this.runningTests,function(b){return b.failed||!a.silent&&b.hasLog}),c=_.filter(this.runningTests,_.property("failed"));_.invoke(a.verbose?this.runningTests:b,"printLog");c.length?log.orange("\n"+log.boldLine+"\nSOME TESTS FAILED:",_.pluck(c,"name").join(", "),"\n\n"):!0!==a.silent&&log.green("\n"+log.boldLine+"\nALL TESTS PASS\n\n")}});
...
"\u2022",a)})}}else log.write(log.indent(d.length),a);log.newline();b&&b.call(c)}):b&&b.call(this)},tryCatch:function(a,b){var c=this;c.afterUnhandledException=b;a.call(c.context,function(){c.afterUnhandledException=void 0;b()})},onUnhandledException:function(a){this.onException(a,function(){if(this.afterUnhandledException){var a=this.afterUnhandledException;this.afterUnhandledException=void 0;a()}})},run:function(a){var b=this;this.hasLog=this.failed=!1;this.logCalls=[];this.assertionStack([]);this.failureLocations=
{};var c=Tags.unwrap(this.routine),d=function(a){var d=function(){b.done=!0;a()};try{_.noArgs(c)?(c.call(b.context),d()):b.tryCatch(c,d)}catch(e){b.onException(e,a)}},e=function(a){b.assertionStack.when(_.isEmpty,a)},f=_.withTimeout.partial({maxTime:b.timeout,expired:function(a){b.failed=!0;log.error("TIMEOUT EXPIRED");a()}}),g=log.withCustomWriteBackend.partial(_.extendWith({indent:b.depth},function(a){b.logCalls.push(a)})),h=_.withUncaughtExceptionHandler.partial(b.$(b.onUnhandledException));g(function(c){h(function(g){f(function(a){_.cps.sequence(d,
e,a)()},function(){b.routine.$shouldFail&&(b.failed=!b.failed);(b.hasLog=0<b.logCalls.length)||(b.failed?log.red("FAIL"):b.verbose&&log.green("PASS"));g();c();a()})})})},printLog:function(){var a=Testosterone.runningTests.indexOf(this)+1,b=Testosterone.runningTests.length;log.write(log.color.blue,"\n"+log.boldLine,"\n"+(this.suite!==this.name&&this.suite.quote("[]")||""),this.name,(a+" of "+b).quote("()")+(this.failed?" FAILED":"")+":","\n");this.evalLogCalls()},evalLogCalls:function(){_.each(this.logCalls,
function(a){log.impl.writeBackend(a)})}});Platform.NodeJS&&(module.exports=Testosterone);_.clamp=function(a,b,c){return Math.max(b,Math.min(c,a))};_.lerp=function(a,b,c){return b+(c-b)*a};_.rescale=function(a,b,c,d){a=(a-b[0])/(b[1]-b[0]);return _.lerp(d&&d.clamp?_.clamp(a,0,1):a,c[0],c[1])};_.sqr=function(a){return a*a};
Vec2=$prototype({$static:{zero:$property(function(){return new Vec2(0,0)}),unit:$property(function(){return new Vec2(1,1)}),one:$alias("unit"),fromLT:function(a){return new Vec2(a.left,a.top)},fromWH:function(a){return new Vec2(a.width,a.height)},fromLeftTop:$alias("fromLT"),fromWidthHeight:$alias("fromWH"),dot:function(a,b){return a.x*b.x+a.y*b.y},lerp:function(a,b,c){return new Vec2(_.lerp(a,b.x,c.x),_.lerp(a,b.y,c.y))},clamp:function(a,b,c){return new Vec2(_.clamp(a.x,b.x,c.x),_.clamp(a.y,b.y,
c.y))}},constructor:function(a,b){1===arguments.length?_.isNumber(a)?this.x=this.y=a:(this.x=a.x,this.y=a.y):(this.x=a,this.y=b)},length:$property(function(){return Math.sqrt(this.lengthSquared)}),lengthSquared:$property(function(){return this.x*this.x+this.y*this.y}),add:function(a,b){return void 0===b?new Vec2(this.x+a.x,this.y+a.y):new Vec2(this.x+a,this.y+b)},sub:function(a){return new Vec2(this.x-a.x,this.y-a.y)},scale:function(a,b){return new Vec2(this.x*a,this.y*(void 0===b?a:b))},mul:function(a){return new Vec2(this.x*
a.x,this.y*a.y)},divide:function(a){return new Vec2(this.x/a.x,this.y/a.y)},normal:$property(function(){return this.scale(1/this.length)}),perp:$property(function(){return new Vec2(this.y,-this.x)}),half:$property(function(){return new Vec2(.5*this.x,.5*this.y)}),inverse:$property(function(){return new Vec2(-this.x,-this.y)}),asLeftTop:$property(function(){return{left:Math.floor(this.x),top:Math.floor(this.y)}}),asLeftTopMargin:$property(function(){return{marginLeft:Math.floor(this.x),marginTop:Math.floor(this.y)}}),
asWidthHeight:$property(function(){return{width:Math.floor(this.x),height:Math.floor(this.y)}}),floor:$property(function(){return new Vec2(Math.floor(this.x),Math.floor(this.y))}),sum:$static(function(a){return _.reduce(_.isArray(a)&&a||_.asArray(arguments),function(a,c){return a.add(c||Vec2.zero)},Vec2.zero)}),toString:function(){return"{"+this.x+","+this.y+"}"},projectOnCircle:function(a,b){return a.add(this.sub(a).normal.scale(b))},projectOnLineSegment:function(a,b){var c=b.sub(a),d=c.lengthSquared;
...
_.RGB2HSL=function(a,b){var c=a[0],d=a[1],e=a[2],f=void 0===b?a[3]:b,g=Math.max(c,d,e),h=Math.min(c,d,e),k,m=(g+h)/2;if(g==h)k=h=0;else{var l=g-h,h=.5<m?l/(2-g-h):l/(g+h);switch(g){case c:k=(d-e)/l+(d<e?6:0);break;case d:k=(e-c)/l+2;break;case e:k=(c-d)/l+4}k/=6}return void 0===f?[k,h,m]:[k,h,m,f]};
_.extend(Math,function(a){return{roundTo:function(a,c){return a-a%c},round10:function(b,c){return a("round",b,c)},floor10:function(b,c){return a("floor",b,c)},ceil10:function(b,c){return a("ceil",b,c)}}}(function(a,b,c){if("undefined"===typeof c||0===+c)return Math[a](b);b=+b;c=+c;if(isNaN(b)||"number"!==typeof c||0!==c%1)return NaN;b=b.toString().split("e");b=Math[a](+(b[0]+"e"+(b[1]?+b[1]-c:-c)));b=b.toString().split("e");return+(b[0]+"e"+(b[1]?+b[1]+c:c))}));
R=$singleton({constructor:function(){this.reduce=_.hyperOperator(_.binary,_.reduce2,_.goDeeperAlwaysIfPossible,_.isNonTrivial.and(_.not(this.isSubexpr)));this.initDSL()},expr:function(a,b){b=b||[];return new R.Expr(R.reduce(a,"",function(a,d){return R.isSubexpr(a)?(b.push(a),d+R.expr(R.root(a.value),b).str):d+a}),b)},Expr:$prototype({constructor:function(a,b){this.rx=RegExp();this.rx.compile(a);this.str=a;this.subexprs=b},parse:function(a){return(a=a.match(this.rx))&&_.extend.apply(null,_.zipWith([_.rest(a),
this.subexprs],function(a,c){return _.object([[c.name,a]])}))||{}}}),metacharacters:$property(_.index("\\^$.|?*+()[{")),escape:function(a){return _.map(a,function(a){return R.metacharacters[a]?"\\"+a:a}).join("")},text:$alias("escape"),subexpr:function(a,b){return{name:a,value:["(",b,")"]}},maybe:function(a){return[a,"?"]},anyOf:function(a){return[a,"*"]},someOf:function(a){return[a,"+"]},oneOf:function(a){return["[",a,"]"]},except:function(a){return["[^",a,"]"]},or:function(a,b){return[a,"|",b]},
begin:$property("^"),end:$property("$"),space:$property("\\s"),maybeSpaces:$property("\\s*"),spaces:$property("\\s+"),anything:$property(".*"),something:$property(".+"),comma:$property(","),parentheses:function(a){return["\\(",a,"\\)"]},brackets:function(a){return["\\[",a,"\\]"]},isSubexpr:function(a){return _.isStrictlyObject(a)&&!_.isArray(a)?!0:!1},root:function(a){return a&&a.$$?a.$$:a},initDSL:function(){_.defineKeyword("r",function(){return $$r([])});_.defineKeyword("$r",function(a){var b=function(b){a.push(b);
return a.forward};_.defineHiddenProperty(a,"then",function(b){a.push(R.root(b));return a});_.defineHiddenProperty(a,"text",function(b){a.push(R.text(b));return a});_.defineHiddenProperty(a,"expr",function(b,d){a.push(R.subexpr(b,R.root(d)));return a});_.defineHiddenProperty(a,"forward",function(){return a.next||((a.next=$r).prev=a).next});_.each(["maybe","anyOf","someOf","oneOf","except"],function(c){_.defineHiddenProperty(a,c,function(){return b(R[c](a.forward))})});_.each(["parentheses","brackets"],
function(b){_.defineHiddenProperty(a,"in"+b.capitalized,function(){return a.$$.prev=$$r(R[b](a.$$))})});_.each(["or"],function(b){_.defineHiddenProperty(a,b,function(){var d=$r;return(d.prev=a.$$.prev=$$r(R[b](a.$$,d))).next=d})});_.each(["begin","end","space","anything","something"],function(c){_.defineHiddenProperty(a,c,function(){return b([R[c],a.forward])})});_.defineHiddenProperty(a,"$$",function(){for(var b=a;b.prev;)b=b.prev;return b});_.defineHiddenProperty(a,"$",function(){return R.expr(a.$$)});
return a})}});
(function(){var a=$r.expr("how",$r.text("before").or.text("after")).expr("name",$r.anything).$;_.defineKeyword("aspect",function(b,c){var d=Tags.unwrap(_.sequence($prototype.impl.extendWithTags,$prototype.impl.flatten,$prototype.impl.generateArgumentContractsIfTaggedAsTest,$prototype.impl.contributeTraits,$prototype.impl.expandAliases).call($prototype.impl,c)),e=b.constructor&&b.constructor.$definition;e&&(e.$aspects=e.$aspects||[]).push(d);_.each(d,function(c,e){if(d.hasOwnProperty(e)&&_.isFunction(c)){var h=
a.parse(e),k=h.name&&h.name.decapitalized||e;if(h=h.how&&_["on"+h.how.capitalized]||_.intercept){var m=b[k];m&&_.isFunction(m)&&h(b,k,c);var m=b.prototype,l=m[k];l&&_.isFunction(l)&&h(m,k,c)}}});b.aspectAdded&&b.aspectAdded(d);return d})})();Platform.NodeJS&&(module.exports=_);
