...
_.count(e.last))+(g?" ]":" }"))}return _.quoteWith(g?"[]":"{  }",_.joinWith(", ",_.map(k,function(a){return(g?"":a[0].quote(m)+": ")+l(a[1])})))};_.toFixed=function(a,b){return a&&a.toFixed&&a.toFixed(b)||void 0};_.toFixed2=function(a){return _.toFixed(a,2)};_.toFixed3=function(a){return _.toFixed(a,3)};_.cps=function(){return _.cps.sequence.apply(null,arguments)};_.cps.apply=function(a,b,c,d){c=_.asArray(c);var e=_.numArgs(a)-1,f=c[e];c[e]=function(){d.call(this,arguments,f)};return a.apply(b,c)};
...
e.call(this,a):d.apply(this,arguments);return arguments.callee}),a,{queue:b,once:function(a){_.find(b,function(b){return b.onceWrapped_===a})||e(_.extend(function(b){_.off(c,arguments.callee);a(b)},{onceWrapped_:a}))},off:_.off.asMethod,read:e,write:d,postpone:function(){this.postponed.apply(c.context,arguments)}})}});$global.define("DAG",{});
DAG.sparseZip=function(a,b){b=b||{};var c=b.key||_.identity,d=b.sort||void 0,e={key:null,next:{}},f={};_.each(a,function(a){for(var b=0,d=a.length,g=e,h=void 0;b<d;b++,g=h){var h=a[b],k=c(h),h=f[k]||(f[k]={key:k,item:h,next:{}});g&&(g.next[k]=h)}});var g=function(a,b){a[b.key]=!0;b.next=_.chain(_.values(b.next)).filter(function(b){return!(b.key in a)}).map(_.partial(g,a)).value();delete a[b.key];return b},h=function(a,b){return a===b||_.some(a.next,function(a){return h(a,b)})},k=function(a){if(!a)return[];
var b=d?_.sortBy(a.next||[],d):a.next||[];return[a].concat(k(_.reduce(b,function(a,b){if(a===b)return a;if(h(b,a))return b.next.push(a),b;a.next.push(b);return a})))};return _.rest(_.pluck(k(g({},e)),"item"))};DAG.linearize=function(a,b){b=b||{};var c=b.items||_.noop,d=function(a,b){b=b||[];(upper=c(a))&&upper.length&&(upper.fold(function(a,c){return b.push([c,a]),c}),upper.forEach(function(c){b.push([a,c]);d(c,b)}));return b};return DAG.sparseZip(d(a),b).reverse().remove(a)};_.hasOOP=!0;_("property static final alias memoized private builtin testArguments".split(" ")).each(_.defineTagKeyword);
...
this.callStaticConstructor,this.expandAliases,this.groupMembersByTagForFastEnumeration,this.defineStaticMembers,this.defineInstanceMembers)},expandTraitsDependencies:function(a){_.isNonempty($untag(a.$depends))&&_.isEmpty($untag(a.$traits))&&(a.$traits=DAG.linearize(a,{items:function(a){return $untag(a.$depends)},key:function(a){return $untag(a.$nonce)}}));return a},mergeExtendables:function(a){return function(b){_.each(a.$definition,function(a,d){a&&a.$extendable&&(b[d]=Tags.modify(a,function(a){a=
...
a.parse(e),k=h.name&&h.name.decapitalized||e;if(h=h.how&&_["on"+h.how.capitalized]||_.intercept){var l=b[k];l&&_.isFunction(l)&&h(b,k,c);var l=b.prototype,m=l[k];m&&_.isFunction(m)&&h(l,k,c)}}});b.aspectAdded&&b.aspectAdded(d);return d})})();Promise.prototype.seq=function(a){return _.reduce2(this,a,function(a,c){return a.then(c)})};Promise.prototype.assert=function(a){return this.then(function(b){$assert(b,a);return b})};
