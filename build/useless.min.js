...
a))return"<"+a.tagName.lowercase+">";if(_.isTypeOf(Text,a))return"@"+a.wholeText}if(a.toJSON)return _.quoteWith('"',a.toJSON());if(!e.pure&&(d>(e.maxDepth||5)||g&&a.length>(e.maxArrayLength||30)))return g?"<array["+a.length+"]>":"<object>";var h=b.concat([a]);c.push(a);var k=_.pairs(a),l=_.stringifyImpl.tails2(h,c,d+1,e);if(f){k=_.values(a);a=_.alignStringsRight(_.keys(a).map(_.appends(": ")));d=k.map(l);e=d.map(function(a,b){return"["===a[0]||"{"===a[0]?3:_.isString(k[b])?1:0});var m=_.max(e);d=
[e,d].zip(function(a,b){return" ".repeats(m-a)+b});a=g?d:[a,d].zip(_.bullet);a=_.bullet(g?"[ ":"{ ",a.join(",\n"));d=a.split("\n");return a+(" ".repeats(_.max(d.map(_.count))-_.count(d.last))+(g?" ]":" }"))}return _.quoteWith(g?"[]":"{  }",_.joinWith(", ",_.map(k,function(a){return(g?"":a[0]+": ")+l(a[1])})))};_.toFixed=function(a,b){return a&&a.toFixed&&a.toFixed(b)||void 0};_.toFixed2=function(a){return _.toFixed(a,2)};_.toFixed3=function(a){return _.toFixed(a,3)};_.hasStdlib=!0;
...
_(["constant","get","once","async"]).each(_.defineTagKeyword);_.defineModifierKeyword=function(a,b){_.defineKeyword(a,function(a){return Tags.modify(a,b)})};_.deleteKeyword=function(a){delete $global[_.keyword(a)]};_.defineTagKeyword("required");_.defineTagKeyword("atom");_.defineKeyword("any",_.identity);
...
Lock=$prototype({acquire:function(a){this.wait(this.$(function(){this.waitQueue||(this.waitQueue=[]);a()}))},acquired:function(){return void 0!==this.waitQueue},wait:function(a){this.acquired()?this.waitQueue.push(a):a()},release:function(){if(this.waitQueue.length){var a=_.first(this.waitQueue);this.waitQueue=_.rest(this.waitQueue);a()}else delete this.waitQueue}});_.interlocked=function(a){var b=new Lock;return _.extendWith({wait:b.$(b.wait)},_.prependsArguments(Tags.unwrap(a),function(a){b.acquire(function(){a(b.$(b.release))})}))};
