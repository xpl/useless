...
b;Promise=c;log.impl.write.off(g)}}),within:function(a){var b=this;return function(){var c=AndrogeneProcessContext.push(b);try{var g=a.apply(this,arguments);c();return g}catch(h){throw c(),h;}}},numEvents:$memoized($property(function(){return _.reduce2({log:0,errors:0},this.eventLog,function(a,b){var c=b instanceof AndrogeneProcessContext?b.numEvents:b instanceof Error?{errors:1}:{log:1};a.all=(a.errors+=c.errors||0)+(a.log+=c.log||0);return a})})),printLog:function(a){var b=this;a=a||{};(a.verbose||
0<this.numEvents.all)&&log.withConfig(log.config({indentPattern:"    "}),function(){b.printWhere(a);b.printEvents(a)})},printWhere:function(a){a=a&&a.indent||0;var b=log.color[{fulfilled:"green",pending:"orange",rejected:"red","":"purple"}[this.state||""]];log.margin();for(var c=$jscomp.makeIterator(CallStack.fromError(this.where).offset(3).clean.reject(function(a){return a["native"]}).reversed),g=c.next();!g.done;g=c.next())g=g.value,log.write(b,log.config({indent:a,location:!0,where:g}),"\u00b7",
g.source.trimmed);log.margin()},printEvents:function(a){a=a||{};var b=a.indent||0,c=a.visited||new Set;if(a.verbose||0<this.numEvents.all){for(var g=$jscomp.makeIterator(this.eventLog),h=g.next();!h.done;h=g.next())h=h.value,h instanceof AndrogeneProcessContext?h.eventLog.length&&h.printLog({indent:b+1,visited:c,verbose:a.verbose}):h instanceof Error?c.has(h)||(c.add(h),log.boldRed(log.indent(b+1),h)):log.write.apply(null,[log.indent(b+1)].concat(h));log.margin()}}});AndrogeneProcessContext.within=
function(){return AndrogeneProcessContext.current&&AndrogeneProcessContext.current.within(fn)||fn};$global.AndrogenePromise=function(a){if(!0===AndrogenePromise.constructing)Promise.call(this,a);else{var b=new AndrogeneProcessContext,c,g;Promise.call(this,function(a,d){c=a;g=function(a){b.eventLog.push(a);d(a)}});this.processContext=b;try{b.within(a)(c,g)}catch(h){g(h)}AndrogenePromise.constructing=!0;Promise.prototype.then.call(this,function(a){b.state="fulfilled"},function(a){b.state="rejected"});
delete AndrogenePromise.constructing}};$jscomp.inherits($global.AndrogenePromise,Promise);$global.AndrogenePromise.all=Promise.all;$global.AndrogenePromise.reject=Promise.reject;$global.AndrogenePromise.resolve=Promise.resolve;$global.AndrogenePromise.prototype.then=function(a,c){var f=this.processContext.within(b.prototype.then,2).apply(this,_.map(arguments,function(a){return a&&function(b){return f.processContext.within(a,-3)(b)}}));return f};$global.AndrogenePromise.prototype.disarmAndrogene=function(){return new b(b.prototype.then.bind(this))};
$global.AndrogenePromise.race=function(a){return b.race(a)};$global.AndrogenePromise.coerce=function(a){return a instanceof AndrogenePromise?a:a instanceof Function?new AndrogenePromise(function(b){b(a())}):AndrogenePromise.resolve(a)};var c=function(a){return function(){return AndrogenePromise.coerce(a)}};c(function(b,c){if(b!==c)throw new a;});c(function(a){for(var b=[],c=[],g=0,h=a.length;g<h;g++)b.push(new Promise(function(a){c.push(a.$(!0))}));a.apply(this,c);return Promise.all(b)});c(function(){return __("foo").then(_.appends("bar")).shouldBe("foobr")});
...
return"F"})});c(function(){return __("foo").then(_.appends("bar")).delay(500).log.then(function(){dasdsad()}).timeout(600)});c(function(){throw Error("yo");});c(function(){return Promise.resolve().then(function(){return function(){}}).then(function(a){console.log(a)})})})();
