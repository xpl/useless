...
(this.parent.eventLog.push(this),this.env=this.parent.env)},root:$property(function(){return this.parent&&this.parent.root||this}),push:$static(function(a){var b=AndrogeneProcessContext.current;AndrogeneProcessContext.current=a;var c=Promise;Promise=AndrogenePromise;var g=function(){a.eventLog.push([log.config({where:$callStack.safeLocation(5)})].concat(_.initial(arguments)))};log.impl.write.intercept(g);return function(){AndrogeneProcessContext.current=b;Promise=c;log.impl.write.off(g)}}),within:function(a){var b=
this;return function(){var c=AndrogeneProcessContext.push(b);try{var g=a.apply(this,arguments);c();return g}catch(h){throw c(),h;}}},numEvents:$memoized($property(function(){return _.reduce2({log:0,errors:0},this.eventLog,function(a,b){var c=b instanceof AndrogeneProcessContext?b.numEvents:b instanceof Error?{errors:1}:{log:1};a.all=(a.errors+=c.errors||0)+(a.log+=c.log||0);return a})})),printLog:function(a){if((a=a||{},a.verbose)||0<this.numEvents.all)this.printWhere(a),this.printEvents(a)},printWhere:function(a){a=
a&&a.indent||0;var b=log.color[{fulfilled:"green",pending:"orange",rejected:"red","":"purple"}[this.state||""]];log.margin();for(var c=$jscomp.makeIterator(CallStack.fromError(this.where).clean.reversed),g=c.next();!g.done;g=c.next())g=g.value,log.write(b,log.config({indent:a,location:!0,where:g}),"\u00b7",g.source.trimmed);log.margin()},printEvents:function(a){a=a||{};var b=a.indent||0,c=a.visited||new Set;if(a&&a.verbose||0<this.numEvents.all){a=$jscomp.makeIterator(this.eventLog);for(var g=a.next();!g.done;g=
a.next())g=g.value,g instanceof AndrogeneProcessContext?g.eventLog.length&&g.printLog({indent:b+1,visited:c}):g instanceof Error?c.has(g)||(c.add(g),log.boldRed(log.indent(b+1),g)):log.write.apply(null,[log.indent(b+1)].concat(g));log.margin()}}});AndrogeneProcessContext.within=function(){return AndrogeneProcessContext.current&&AndrogeneProcessContext.current.within(fn)||fn};$global.AndrogenePromise=function(a){if(!0===AndrogenePromise.constructing)Promise.call(this,a);else{var b=new AndrogeneProcessContext,
c,g;Promise.call(this,function(a,d){c=a;g=function(a){b.eventLog.push(a);d(a)}});this.processContext=b;try{b.within(a)(c,g)}catch(h){g(h)}AndrogenePromise.constructing=!0;Promise.prototype.then.call(this,function(a){b.state="fulfilled"},function(a){b.state="rejected"});delete AndrogenePromise.constructing}};$jscomp.inherits($global.AndrogenePromise,Promise);$global.AndrogenePromise.all=Promise.all;$global.AndrogenePromise.reject=Promise.reject;$global.AndrogenePromise.resolve=Promise.resolve;$global.AndrogenePromise.prototype.then=
function(a,c){var f=this.processContext.within(b.prototype.then,2).apply(this,_.map(arguments,function(a){return a&&function(b){return f.processContext.within(a,-3)(b)}}));return f};$global.AndrogenePromise.prototype.disarmAndrogene=function(){return new b(b.prototype.then.bind(this))};$global.AndrogenePromise.race=function(a){return b.race(a)};$global.AndrogenePromise.coerce=function(a){return a instanceof AndrogenePromise?a:a instanceof Function?new AndrogenePromise(function(b){b(a())}):AndrogenePromise.resolve(a)};
var c=function(a){return function(){return AndrogenePromise.coerce(a)}};c(function(b,c){if(b!==c)throw new a;});c(function(a){for(var b=[],c=[],g=0,h=a.length;g<h;g++)b.push(new Promise(function(a){c.push(a.$(!0))}));a.apply(this,c);return Promise.all(b)});c(function(){return __("foo").then(_.appends("bar")).shouldBe("foobr")});c(function(){return(new Promise(function(a){log.i("example log message #1");(new Promise(function(a){log.i("example log message #2");a()})).then(function(){log.i("example log message #3");
a()})})).then(function(){log.i("example log message #4");some_undefined_function()})});c(function(){var a=(new Promise(function(a){log.i("A");a("A")})).then(function(a){log.i("B");return"B"});return(new Promise(function(a){log.i("C");a("C")})).then(function(b){log.i("D");return a.then(function(a){log.i("E");return"E"})}).then(function(a){log.i("F");return"F"})});c(function(){return __("foo").then(_.appends("bar")).delay(500).log.then(function(){dasdsad()}).timeout(600)});c(function(){throw Error("yo");
})})();
...
$mixin(Promise,{race:function(a){return[this,a].race},reject:function(a){return this.then(_.throwsError(a))},delay:function(a){return this.then(__.delays(a))},timeout:function(a){return this.race(__.delay(a).reject(new TimeoutError))},now:$property(function(){return this.timeout(0)}),log:$property(function(){return this.then(log,log.e.then(_.throwError))}),alert:$property(function(){return this.then(alert2,alert2.then(_.throwError))}),chain:function(a){return this.then(function(b){a(b);return b})},
done:function(a){return this.then(function(b){return a(null,b)},function(b){a(b,null);throw b;})},"finally":function(a){return this.then(function(b){return a(null,b)},function(b){return a(b,null)})},assert:function(a){return this.then(function(b){$assert(b,a);return b})},assertRejected:function(a){var b=0<arguments.length;return this["catch"](function(c){b&&$assert(c,a);return c})},panic:$property(function(){return this["catch"](function(a){($global.Panic||$global.log)(a);throw a;})})});
...
$mixin(Set,{copy:$property(function(){return new Set(this)}),items:$property(function(){return Array.from(this.values())}),matches:$property(function(){var a=this;return function(b){return a.has(b)}}),extend:function(a){a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())this.add(b.value);return this},extended:function(a){return this.copy.extend(a)}});
