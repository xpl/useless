...
0<e.precision?_.toFixed(a,e.precision):a+"";var h=_.isArray(a),g=e.pretty||!1;if("browser"===_.platform().engine){if(_.isTypeOf(Element,a))return"<"+a.tagName.lowercase+">";if(_.isTypeOf(Text,a))return"@"+a.wholeText}if(a.toJSON)return _.quoteWith('"',a.toJSON());if(!e.pure&&(d>(e.maxDepth||5)||h&&a.length>(e.maxArrayLength||30)))return h?"<array["+a.length+"]>":"<object>";var k=b.concat([a]);c.push(a);b=_.pairs(a);var l=!g||2>b.length,m=f+1,n=l?"":"\t".repeats(m);if(g&&!h){var p=_.reduce(_.map(_.keys(a),
...
arity0:_.arity0,arity1:_.arity1,arity2:_.arity2,arity3:_.arity3,or:_.or,and:_.and,not:_.not,applies:_.applies,memoized:_.memoize,throttled:_.throttle,debounced:function(a,b,c){var d,e,f,g,h,k=function(){var m=Date.now()-d;m<b&&0<m?e=setTimeout(k,b-m):(e=null,c||(f=a.apply(h,g),e||(h=g=null)))},l=function(){h=this;g=arguments;d=Date.now();var m=c&&!e;e||(e=setTimeout(k,b));m&&(f=a.apply(h,g),h=g=null);return f};l.callImmediately=function(){e&&(clearTimeout(e),e=null);a.apply(h,g)};return l},postpone:$method(function(a){var b=
...
a).apply(b,arguments);if(k.length||g.length){h=_.asArray(arguments).concat(f);m=0;for(n=k.length;m<n;m++)k[m].apply(b,h);if(g.length){m=0;for(n=g.length;m<n;m++)g[m].apply(b,h);g.removeAll()}}return f}))}})})();
...
function(){var g={name:name,stack:Error().stack,asyncContext:c},h=_.asArray(arguments),k=h[d];h[d]=_.extendWith({__uncaughtJS_wraps:k},__supressErrorReporting=function(){c=g;try{return k.apply(this,arguments)}catch(b){a(_.extend(b,{asyncContext:g}))}});return b.apply(this,h)}};window.setTimeout=d(window.setTimeout,0);b(function(a){return d(a,1)},function(a){return function(b,c,d,k){return a.call(this,b,c.__uncaughtJS_wraps||c,d)}})}})();_.hasReflection=!0;
...
Platform.Browser&&jQuery&&function(a){var b=function(b,d){return b.originalEvent.touches&&_.find(b.originalEvent.touches,function(b){return a(b.target).hasParent(d)})||b};a.svg=function(b){return a(document.createElementNS("http://www.w3.org/2000/svg",b))};a.fn.extend({item:function(a){return a?(this.length&&(this[0]._item=a),this):this.length?this[0]._item:void 0},hasWait:function(){return this.hasClass("i-am-busy")},waitUntil:function(a,b){this.addClass("i-am-busy").attr("disabled",!0);a(this.$(function(){this.removeClass("i-am-busy").removeAttr("disabled");
...
a)},animateWith:function(a,b){this.addClass(a);this.animationend(this.$(function(){this.removeClass(a);b&&b.call(this)}));return this},drag:function(c){Platform.touch||window.__globalDragOverlay||(window.__globalDragOverlay=a("<div>").css({display:"none",position:"fixed",top:0,right:0,bottom:0,left:0,zIndex:999999}).appendTo(document.body));var d=window.__globalDragOverlay,e=this.$(function(e){var g=c.relativeTo||this;if(Platform.touch||1===e.which){var h=g.offset(),k=void 0;if(!c.start||!1!==(k=
c.start.call(this,new Vec2(e.pageX-h.left,e.pageY-h.top),e))){var l=void 0,m=void 0,n=void 0,k=_.clone(k),p=this.$(function(a){if(Platform.touch||1===a.which){a.preventDefault();a=b(a,this[0]);var d=g.offset();k=c.move.call(this,k,new Vec2(a.pageX-e.pageX,a.pageY-e.pageY),new Vec2(a.pageX-d.left,a.pageY-d.top),a)||k}else l(a)}),m=function(){a(d||document.body).css(d?{display:"none"}:{}).off("mouseup touchend",n).off("mousemove touchmove",p)},n=this.$(function(a){m();c.end&&(a=b(a,this[0]),c.end.call(this,
k,new Vec2(a.pageX-e.pageX,a.pageY-e.pageY),a))}),l=this.$(function(a){m();n(a)});a(d||document.body).css(d?{display:"",cursor:c.cursor||""}:{}).on("mousemove touchmove",p).one("mouseup touchend",n);c.callMoveAtStart&&c.move.call(this,k,Vec2.zero,new Vec2(e.pageX-h.left,e.pageY-h.top),e)}}});return this.on(Platform.touch?"touchstart":"mousedown",_.$(this,function(a){var d=_.extend({},b(a,this[0]));if(Platform.touch&&c.longPress){var h=void 0,k=window.setTimeout(_.$(this,function(){this.off("touchmove touchend",
...
Date.now();200>e-b&&a.apply(this,arguments);b=e})}return this.dblclick(a)},touchClick:function(a,b){var e=this;b=b||{};if(!b.disableTouch&&Platform.touch){var f=function(b){a.apply(this,arguments);b.preventDefault();return!1},g=function(a){a.preventDefault();return!1};b.handler&&b.handler({unbind:function(){e.off("touchstart",f).off("click",g)}});return this.on("touchstart",f).on("click",g)}b.handler&&b.handler({unbind:function(){e.off("click",a)}});return this.click(a)},translate:function(a){return this.attr("transform",
"translate("+a.x+","+a.y+")")},transform:function(a){a=a.components;return this.attr("transform","matrix("+a[0][0]+","+a[1][0]+","+a[0][1]+","+a[1][1]+","+a[0][2]+","+a[1][2]+")")},clientBBox:function(){var a=this[0].getBoundingClientRect();return new BBox(a.left,a.top,a.width,a.height)}})}(jQuery);Platform.NodeJS&&(module.exports=_);
