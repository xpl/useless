...
a.parse(e),k=h.name&&h.name.decapitalized||e;if(h=h.how&&_["on"+h.how.capitalized]||_.intercept){var l=b[k];l&&_.isFunction(l)&&h(b,k,c);var l=b.prototype,n=l[k];n&&_.isFunction(n)&&h(l,k,c)}}});b.aspectAdded&&b.aspectAdded(d);return d})})();Promise.prototype.seq=function(a){return _.reduce2(this,a,function(a,c){return a.then(c)})};Promise.prototype.assert=function(a){return this.then(function(b){$assert(b,a);return b})};
Promise.prototype.assertRejected=function(a){var b=0<arguments.length;return this["catch"](function(c){b&&$assert(c,a);return c})};TimeoutError=$extends(Error,{message:"timeout expired"});__=function(a){return a instanceof Function?new Promise(a):Promise.resolve(a)};__.noop=function(){return Promise.resolve()};__.identity=function(a){return Promise.resolve(a)};__.constant=function(a){return function(){return Promise.resolve(a)}};__.reject=function(a){return Promise.reject(a)};__.rejects=function(a){return function(){return Promise.reject(a)}};
__.safe=function(a){return function(){try{return Promise.resolve(a.apply(this,arguments))}catch(b){return Promise.reject(b)}}};__.map=__.safe(function(a,b){if(_.isStrictlyObject(a)){var c=_.coerceToEmpty(a),d=[];_.each2(a,function(a,f){d.push(__.identity(b(a,f)).then(function(a){c[f]=a}))});return __.all(d).then(_.constant(c))}return b(a)});__.then=function(a,b){return __.identity(a).then(_.coerceToFunction(b))};__.seq=function(a){return __.identity(_.reduce2(a,__.then))};__.all=function(a){return Promise.all(a)};
__.delay=function(a){return __.delays(a)()};__.delays=function(a){return function(b){return new Promise(function(c){setTimeout(function(){c(b)},a||0)})}};$mixin(Array,{race:$property(function(){return Promise.race(this)})});
