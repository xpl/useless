...
(function(){var a=$prototype({constructor:function(a){this.maxTime=a&&a.maxTime;this.pending=[];if(this.maxConcurrency=a&&a.maxConcurrency)this.numActive=0,this.queue=[]},run:function(a){var c=this;if(this.numActive>=this.maxConcurrency)return new Promise(function(d){c.queue.push(function(){d(c.run(a))})});var d=__(a);void 0!==this.maxTime&&(d=d.timeout(this.maxTime));void 0!==this.maxConcurrency&&(c.numActive++,d=d.then(function(a){c.numActive--;return c.queue.length&&c.numActive<c.maxConcurrency?
c.queue.pop()():a}));this.pending.push(d);return d},all:$property(function(){return Promise.all(this.pending)})});__.scatter=function(b,c,d){return __.then(b,function(b){if(_.isStrictlyObject(b)){var f=_.coerceToEmpty(b),g=new a(d);_.each2(b,function(a,d){g.run(c.$(a,d,b)).then(function(a){a instanceof Array?f[a.second]=a.first:void 0!==a&&(f instanceof Array?f.push(a):f[d]=a)})});return g.all.then(_.constant(f))}return __(c,b,void 0,b).then(function(a){return a instanceof Array?a.first:a})})}})();
__.map=function(a,b,c){return __.scatter(a,__.$(b))};__.filter=function(a,b,c){return __.scatter(a,function(a,c,f){return __(b,a,c,f).then(function(b){return!1===b?void 0:!0===b?a:b})})};__.each=function(a,b){return __.then(a,function(a){return new Promise(function(d,e){_.cps.each(a,function(a,c,d){__(b(a,c)).then(d)["catch"](e)},d)})})};__.seq=function(a){return _.reduce2(a,__.then)};__.all=function(a){return Promise.all(a)};
...
"tests"));a=_.filter(a,b.shouldRun||_.constant(!0));this.runningTests=_.map(a,function(a,c){return _.extend(a,{indent:b.indent,index:c})});_.assertTypeMatches(_.map(_.pluck(this.runningTests,"routine"),$untag),["function"]);this.runningTests=_.filter(this.runningTests,b.filter||_.identity);return __.each(this.runningTests,this.$(this.runTest)).then(this.$(function(){_.assert(!0!==b.done);b.done=!0;this.printLog(b);this.failedTests=_.filter(this.runningTests,_.property("failed"));this.failed=0<this.failedTests.length;
return!this.failed}))}))["catch"](function(a){log.margin();log.ee(log.boldLine,"TESTOSTERONE CRASHED",log.boldLine,"\n\n",a);throw a;})}),onException:function(a){if(this.currentAssertion)this.currentAssertion.onException(a);else throw a;},defineAssertions:function(a){_.each(a,function(a,c){this.defineAssertion(c,a)},this)},runTest:function(a,b){var c=this.runConfig;log.impl.configStack=[];a.verbose=c.verbose;a.timeout=c.timeout;a.startTime=Date.now();return a.run().then(function(){a.time=Date.now()-
a.startTime})},collectTests:function(){return _.map(_.tests,this.$(function(a,b){return this.testSuite(b,a)}))},collectPrototypeTests:function(){var a=this;return __.map(this.prototypeTests,function(b,c){return b.proto.$meta.promise.then(function(c){return a.testSuite(c.name,b.tests,void 0,b.proto)})})},testSuite:function(a,b,c,d){return{name:a||"",tests:_(_.pairs("function"===typeof b&&_.object([[a,b]])||b)).map(function(b){var f=new Test({proto:d,name:b[0],routine:b[1],suite:a,context:c});f.complete(function(){(f.hasLog=
