...
_.defineGlobalProperty("alert2",function(a){alert(_.map(arguments,_.stringify).join(", "));return arguments[0]});_.global().log=function(){console.log.call(console.log,arguments)};_.hasAsserts=!0;
...
(_.tests[a[0]]||(_.tests[a[0]]={}))[a[1]]=b:_.tests[a]=b}});$overrideUnderscore("matches",function(a){return function(b){return _.isObject(b)?a(b):function(a){return b===a}}});
_.extend(_,_.assertions={assert:function(a){var b=[].splice.call(arguments,0);1===b.length?!0!==b[0]&&_.assertionFailed({notMatching:b}):_.allEqual(b)||_.assertionFailed({notMatching:b});return!0},assertCPS:function(a,b,c){var d=b&&(_.isArray(b)?b:[b])||[];a(function(){$assert([].splice.call(arguments,0),d);if(c)return c(),!0})},assertNotCalled:function(a){var b=!0;a(function(){b&&$fail});b=!1},assertEveryCalledOnce:function(a,b){return _.assertEveryCalled(_.hasTags?$once(a):(a.once=!0,a),b)},assertEveryCalled:function(a,
...
b]}):c;}},assertType:function(a,b){return _.assert(_.decideType(a),b)},assertTypeMatches:function(a,b){return _.isEmpty(mismatches=_.typeMismatches(b,a))?!0:_.assertionFailed({message:"provided value type not matches required contract",asColumns:!0,notMatching:[{provided:a},{required:b},{mismatches:mismatches}]})},assertFails:function(a){return _.assertThrows.call(this,a,_.isAssertionError)},assertThrows:function(a,b){var c=void 0,d=!1;try{a.call(this)}catch(e){c=e,d=!0}_.assert.call(this,d);1<arguments.length&&
_.assertMatches.call(this,c,b)},assertNotThrows:function(a){return _.assertEveryCalled(function(b){a();b()})},assertArguments:function(a,b,c){b=(b||a.callee).toString();var d=b.match(/.*function[^\(]\(([^\)]+)\)/);if(d){a=_.asArray(a);var d=_.map(d[1].split(","),function(a){a="_"===a.trim()[0]?a.replace(/_/g," ").trim():void 0;var b=parseInt(a,10);return _.isFinite(b)?b:a}),e=_.zipWith([d,a],function(a,b){return void 0===a?!0:a===b});_.every(e)||_.assertionFailed({notMatching:_.nonempty([[c,b].join(": "),
d,a])})}},fail:function(){_.assertionFailed()},fails:_.constant(function(){_.assertionFailed()}),stub:function(){_.assertionFailed()}});_.extend(_,{assertionError:function(a){return _.extend(Error(a&&a.message||"assertion failed"),a,{assertion:!0})},assertionFailed:function(a){throw _.extend(_.assertionError(a),{stack:_.rest(Error().stack.split("\n"),3).join("\n")});},isAssertionError:function(a){return!0===a.assertion}});
_.extend(_,{allEqual:function(a){return _.reduce(a,function(b,c){return b&&_.isEqual(a[0],c)},!0)}});_.each(_.keys(_.assertions),function(a){_.defineGlobalProperty("$"+a,_[a],{configurable:!0})});_.extend(_,{asArray:function(a){return void 0!==a.length?[].slice.call(a,0):[a]}});
...
$overrideUnderscore("bind",function(a){return $restArg(function(b,c){return _.withArgs(Math.max(0,_.numArgs(b)-(arguments.length-2)),b._ra,a.apply(this,arguments))})});_.debugEcho=function(){return[this].concat(_.asArray(arguments))};_.arity=function(a,b){return function(){return b.apply(this,_.first(arguments,a))}};_.arity0=function(a){return function(){return a.call(this)}};_.arity1=function(a){return function(b){return a.call(this,b)}};
...
_.then=function(a,b){return function(c){return b.call(this,a.apply(this,arguments))}};_.makes=function(a){return function(){switch(arguments.length){case 0:return new a;case 1:return new a(arguments[0]);case 2:return new a(arguments[0],arguments[1]);default:throw Error("not supported");}}};_.asString=function(a){return a+""};_.typeOf=function(a){return typeof a};_.instanceOf=function(a){return function(b){return b instanceof a}};_.count=function(a){return a.length};_.array=_.tuple=function(){return _.asArray(arguments)};
_.cons=function(a,b){return[a].concat(b||[])};_.atIndex=function(a){return function(b){return b[a]}};_.takesFirst=_.higherOrder(_.first);_.takesLast=_.higherOrder(_.last);_.call=function(a){return a()};_.applies=function(a,b,c){return function(){return a.apply(b,c)}};_.prepends=function(a){return function(b){return a+b}};_.appends=function(a){return function(b){return b+a}};_.join=function(a,b){return a.join(b)};_.joinWith=_.flip2(_.join);_.joinsWith=_.higherOrder(_.joinWith);_.split=function(a,b){return a.split(b)};
_.splitWith=_.flip2(_.split);_.splitsWith=_.higherOrder(_.splitWith);_.sum=function(a,b){return(a||0)+(b||0)};_.subtract=function(a,b){return(a||0)-(b||0)};_.mul=function(a,b){return(a||0)*(b||0)};_.equal=function(a,b){return a===b};_.sums=_.plus=_.higherOrder(_.sum);_.subtracts=_.minus=_.higherOrder(_.subtract);_.muls=_.higherOrder(_.mul);_.equals=_.higherOrder(_.equal);_.less=function(a,b){return a<b};_.lessOrEqual=function(a,b){return a<=b};_.greater=function(a,b){return a>b};
_.greaterOrEqual=function(a,b){return a>=b};_.isNegative=function(a){return 0>a};_.largest=function(a,b){return isNaN(a)&&isNaN(b)?NaN:isNaN(a)?b:isNaN(b)?a:Math.max(a,b)};_.notZero=function(a){return 0!==a};_.propertyOf=function(a){return function(b){return a[b]}};_.oneOf=$restArg(function(){return _.propertyOf(_.index(_.asArray(arguments)))});_.isInstanceofSyntaxAvailable=function(){var a=Error();try{return a instanceof Error}catch(b){return!1}};
_.isTypeOf_ES4=function(a,b){for(;b;){if(b.constructor===a)return!0;b=b.constructor.$base}return!1};_.isTypeOf_ES5=function(a,b){return b instanceof a};_.isTypeOf=_.isInstanceofSyntaxAvailable()?_.isTypeOf_ES5:_.isTypeOf_ES4;_.isPrototypeInstance=function(a){return a&&a.constructor&&_.isPrototypeConstructor(a.constructor)};_.isPrototypeConstructor=function(a){return a&&void 0!==a.$definition||!1};_.coerceToArray=function(a){return void 0===a?[]:_.isArray(a)?a:[a]};
_.coerceToFunction=function(a){return _.isFunction(a)?a:_.constant(a)};$overrideUnderscore("isArray",function(a){return function(b){return _.isTypeOf(Array,b)||a(b)}});
...
if(_.isStrictlyObject(a))return{}},coerceToUndefined:function(a){return void 0===a||null===a||a===Math.NaN||""===a||_.isPOD(a)&&(_.isEmptyObject(a)||0===a.length)?void 0:a}});_.hasStdlib=!0;_.throwsError=_.higherOrder(_.throwError=function(a){throw Error(a);});_.overrideThis=_.throwsError("override this");_.notImplemented=_.throwsError("not implemented");_.mixin({values2:function(a){return _.isArray(a)?a:_.isStrictlyObject(a)?_.values(a):_.isEmpty(a)?[]:[a]}});
_.mixin({map2:function(a,b,c){return _.isArray(a)?_.map(a,b,c):_.isStrictlyObject(a)?_.mapObject(a,b,c):b.call(c,a)}});_.mapsWith=_.higherOrder(_.mapWith=_.flip2(_.map2));_.scatter=function(a,b){var c=void 0;_.map2(a,function(a,e){b(a,e,function(a,b){2>arguments.length?(c=c||[]).push(a):(c=c||{})[b]=a})});return c};_.mapKeys=function(a,b){return _.isArray(a)?_.map(a,_.tails2(_.mapKeys,b)):_.isStrictlyObject(a)?_.object(_.map(_.pairs(a),function(a){return[b(a[0]),_.mapKeys(a[1],b)]})):a};
_.mixin({mapMap:_.hyperOperator(_.unary,_.map2)});_.mixin({reject2:function(a,b){return _.filter2(a,_.not(b))},filter2:function(a,b){if(_.isArray(a)){for(var c=[],d=0,e=a.length;d<e;d++){var f=a[d],g=b(f,d);!0===g?c.push(f):!1!==g&&c.push(g)}return c}if(_.isStrictlyObject(a))return c={},_.each(Object.keys(a),function(d){var e=a[d],f=b(e,d);!0===f?c[d]=e:!1!==f&&(c[d]=f)}),c;g=b(a);if(!0===g)return a;if(!1!==g)return g}});_.mixin({filterFilter:_.hyperOperator(_.unary,_.filter2)});
_.each2=function(a,b){if(_.isArray(a))for(var c=0,d=a.length;c<d;c++)b(a[c],c,d);else if(_.isStrictlyObject(a))for(var e=Object.keys(a),f,c=0,d=e.length;c<d;c++)b(a[f=e[c]],f,d);else b(a,void 0,1)};_.reduce2=function(a,b,c){var d=3>arguments.length,e=a,f=b,g=c;d&&(e=void 0,f=a,g=b);_.each2(f,function(a){e=d?a:g(e,a);d=!1});return e};_.reduceReduce=function(a,b,c){var d=a,e=b,f=c;3>arguments.length&&(d={},e=a,f=b);return _.hyperOperator(_.binary,_.reduce2,_.goDeeperAlwaysIfPossible)(d,e,f)};
_.concat=function(a,b){var c,d;1===arguments.length?(c=a[0],d=_.rest(a)):(c=a,d=_.rest(arguments));return _.isArray(c)?c.concat.apply(c,d):_.reduce2(c,d,function(a,b){return _.isObject(a)&&_.isObject(b)?_.extend({},a,b):a+b})};
...
_.extend=$restArg(_.extend);_.extended=$restArg(function(){return _.extend.apply(this,[{}].concat(_.asArray(arguments)))});_.extendWith=_.flip(_.extend);_.extendsWith=_.flip(_.partial(_.partial,_.flip(_.extend)));_.extendedDeep=_.tails3(_.zipZip,function(a,b){return void 0===b?a:b});
_.extend2=$restArg(function(a){return _.extend(a,_.reduceRight(arguments,function(a,c){return _.object(_.map(_.union(_.keys(c),_.keys(a)),function(d){var e=c[d];return[d,d in a?"object"===typeof e?_.extend(e,a[d]):a[d]:e]}))},{}))});
_.find2=function(a,b){if(_.isArray(a))for(var c=0,d=a.length;c<d;c++){var e=b(a[c],c,a);if("boolean"!==typeof e)return e;if(!0===e)return a[c]}else if(_.isStrictlyObject(a))for(var c=0,f=Object.keys(a),d=f.length;c<d;c++){var g=f[c],e=b(a[g],g,a);if("boolean"!==typeof e)return e;if(!0===e)return a[g]}};
_.findFind=function(a,b){return _.hyperOperator(_.unary,function(a,d){if(_.isArray(a))for(var e=0,f=a.length;e<f;e++){var g=d(a[e]);if("boolean"!==typeof g)return g;if(!0===g)return a[e]}else if(_.isStrictlyObject(a))for(var e=0,h=Object.keys(a),f=h.length;e<f;e++){var k=h[e],g=d(a[k]);if("boolean"!==typeof g)return g;if(!0===g)return a[k]}g=b(a);return"boolean"!==typeof g?g:!0===g?a:!1})(a,b)};_.nonempty=function(a){return _.filter2(a,_.isNonempty)};
_.extend(_,{cloneDeep:_.tails2(_.mapMap,function(a){return _.isStrictlyObject(a)&&!_.isPrototypeInstance(a)?_.clone(a):a})});_.hyperMatch=_.hyperOperator(_.binary,function(a,b,c){return _.coerceToUndefined(_.nonempty(_.zip2(a,b,c)))});_.diff=_.tails3(_.hyperMatch,function(a,b){return $atom.unwrap(a)===$atom.unwrap(b)||a===$any||b===$any?void 0:b});_.hyperMatch=_.hyperOperator(_.binary,function(a,b,c){return _.coerceToUndefined(_.zip2(a,b,c))});
_.undiff=_.tails3(_.hyperMatch,function(a,b){return $atom.unwrap(a)===$atom.unwrap(b)||a===$any||b===$any?b:void 0});_.extend(_,{index:function(a){for(var b={},c=0,d=a.length;c<d;c++)b[a[c]]=!0;return b}});_.quote=function(a,b){var c=b||'"',d=Math.floor(c.length/2+c.length%2),e=c.slice(0,d),c=c.slice(d)||e;return e+a+c};_.quoteWith=_.flip2(_.quote);_.quotesWith=_.higherOrder(_.quoteWith);_.partition2=function(a,b){return _.pluck(_.partition3(a,b),"items")};
_.partition3=function(a,b){var c=[],d={label:void 0,items:[a.first]};_.each(a,function(a){var f=b(a);d.label!=f&&d.items.length?c.push(d={label:f,items:[a]}):d.items.push(a)});return d.length&&c.push(d),c};
_.linearMerge=function(a,b){b=b||{key:_.identity};var c={key:null,next:{}},d={};_.each(a,function(a){for(var e=0,f=a.length,g=c,n=void 0;e<f;e++,g=n){var n=a[e],p=b.key(n),n=d[p]||(d[p]={key:p,item:n,next:{}});g&&(g.next[p]=n)}});var e=function(a,b){a[b.key]=!0;b.next=_.chain(_.values(b.next)).filter(function(b){return!(b.key in a)}).map(_.partial(e,a)).value();delete a[b.key];return b},f=function(a,b){return a===b||_.some(a.next,function(a){return f(a,b)})},g=function(a){if(!a)return[];var c=b.sort?
_.sortBy(a.next||[],b.sort):a.next||[];return[a].concat(g(_.reduce(c,function(a,b){if(a===b)return a;if(f(b,a))return b.next.push(a),b;a.next.push(b);return a})))};return _.rest(_.pluck(g(e({},c)),"item"))};
...
_.stringifyPrototype=function(a){if(Platform.NodeJS&&a.$meta){var b="";a.$meta(function(a){b=a.name});return b&&b+" ()"}return"<prototype>"};_.builtInTypes={Event:{target:$any},MutationEvent:{target:$any,attrName:$any,prevValue:$any}};
...
a);if(_.isTypeOf(Tags,a))return _.reduce(Tags.get(a),function(a,d,e){return _.isBoolean(d)?e+" "+a.quote("()"):e+" ("+_.stringifyImpl(d,b,c,0,{pretty:!1})+", "+a+")"},_.stringifyImpl($untag(a),b,c,d+1,e));if(!e.pure&&_.hasOOP&&_.isPrototypeInstance(a)&&$prototype.defines(a.constructor,"toString"))return a.toString();if(!_.isObject(a)||"undefined"!==typeof $atom&&$atom.is(a))return _.isDecimal(a)&&0<e.precision?_.toFixed(a,e.precision):a+"";if(f=_.find2(_.builtInTypes,function(b,c){return $global[c]&&
a instanceof $global[c]&&c+" "+_.stringifyOneLine(_.omitTypeMismatches(b,a))||!1}))return f;var g=_.isArray(a),f=e.pretty||!1;if("browser"===_.platform().engine){if(_.isTypeOf(Element,a))return"<"+a.tagName.lowercase+">";if(_.isTypeOf(Text,a))return"@"+a.wholeText}if(a.toJSON)return _.quoteWith('"',a.toJSON());if(!e.pure&&(d>(e.maxDepth||5)||g&&a.length>(e.maxArrayLength||30)))return g?"<array["+a.length+"]>":"<object>";var h=b.concat([a]);c.push(a);var k=_.pairs(a),l=_.stringifyImpl.tails2(h,c,d+
1,e);if(f){k=_.values(a);d=_.alignStringsRight(_.keys(a).map(_.appends(": ")));e=k.map(l);var f=e.map(function(a,b){return"["===a[0]||"{"===a[0]?3:_.isString(k[b])?1:0}),m=_.max(f);e=[f,e].zip(function(a,b){return" ".repeats(m-a)+b});d=g?e:[d,e].zip(_.bullet);d=_.bullet(g?"[ ":"{ ",d.join(",\n"));e=d.split("\n");return d+(" ".repeats(_.max(e.map(_.count))-_.count(e.last))+(g?" ]":" }"))}return _.quoteWith(g?"[]":"{  }",_.joinWith(", ",_.map(k,function(a){return(g?"":a[0]+": ")+l(a[1])})))};
_.toFixed=function(a,b){return a&&a.toFixed&&a.toFixed(b)||void 0};_.toFixed2=function(a){return _.toFixed(a,2)};_.toFixed3=function(a){return _.toFixed(a,3)};_.cps=function(){return _.cps.sequence.apply(null,arguments)};_.cps.apply=function(a,b,c,d){c=_.asArray(c);var e=_.numArgs(a)-1,f=c[e];c[e]=function(){d.call(this,arguments,f)};return a.apply(b,c)};
_.extend(_.cps,{each:function(a,b,c,d,e,f){var g=arguments.callee,h=d||0,k=0===h?void 0===a.length?_.keys(a):void 0:f,l=0===h?k?k.length:a.length:e,m=2!==_.numArgs(b);if(!a||h>=(l||0))c&&c();else{var n=k?k[h]:h,p=function(){g(a,b,c,h+1,l,k)};m?b(a[n],n,p,c,a):b(a[n],p,c,a)}}});_.extend(_.cps,{map:function(a,b,c){var d=_.isArray(a)?[]:{};_.cps.each(a,2==_.numArgs(b)?function(a,c,g){b(a,function(a){d[c]=a;g()})}:function(a,c,g){b(a,c,function(a){d[c]=a;g()})},function(){c(d)})}});
_.extend(_.cps,{find:function(a,b,c){var d=2!==_.numArgs(b);_.cps.each(a,function(a,c,g,h){var k=function(b){!1===b?g():h(!0===b?a:b,c)};d?b(a,c,k):b(a,k)},c)}});
...
$extensionMethods(Function,{$:$method(_.partial),bind:_.bind,partial:_.partial,tails:_.tails,tails2:_.tails2,tails3:_.tails3,compose:_.compose,then:_.then,flip:_.flip,with_:_.flipN,flip2:_.flip2,flip3:_.flip3,asFreeFunction:_.asFreeFunction,asMethod:_.asMethod,callsWith:_.callsTo,tailsWith:_.tailsTo,returns:function(a,b){return function(){a.apply(this,arguments);return b}},asPromise:function(a){return new Promise(a)},asContinuation:function(a){return $restArg(function(){_.last(arguments)(a.apply(this,
_.initial(arguments)))})},wraps:function(a,b){a._wrapped=_.withSameArgs(a,b);return a},wrapped:function(a){return a._wrapped||a},original:function(a){for(;a&&a._wrapped;)a=a._wrapped;return a},arity0:_.arity0,arity1:_.arity1,arity2:_.arity2,arity3:_.arity3,or:_.or,and:_.and,not:_.not,applies:_.applies,new_:_.new_,oneShot:function(a){var b=!1;return function(){if(!b)return b=!0,a.apply(this,arguments)}},memoized:_.memoize,throttled:_.throttle,debounced:function(a,b,c){var d,e,f,g,h,k=function(){var m=
Date.now()-d;m<b&&0<m?e=setTimeout(k,b-m):(e=null,c||(f=a.apply(h,g),e||(h=g=null)))},l=function(){h=this;g=arguments;d=Date.now();var m=c&&!e;e||(e=setTimeout(k,b));m&&(f=a.apply(h,g),h=g=null);return f};l.cancel=function(){e&&(clearTimeout(e),e=null)};l.callImmediately=function(){l.cancel();a.apply(h,g)};return l},postpone:$method(function(a){a.postponed.apply(null,arguments)}),postponed:function(a){return function(){var b=arguments;a._postponed||(a._postponed=!0,_.delay(function(){a._postponed=
!1;a.apply(this,b)}))}},delay:_.delay,delayed:function(a,b){return function(){var c=arguments,d=this;_.delay(function(){a.apply(d,c)},b)}}});$extensionMethods(Function,{catch_:function(a,b,c,d){return a.catches(b,c)()},catches:function(a,b,c,d){var e=arguments.length;b=1<e?_.coerceToFunction(b):_.identity;c=2<e?_.coerceToFunction(c):_.identity;d=3<e?_.coerceToFunction(d):_.identity;return function(){var e=void 0,g=!1;try{e=a.apply(this,arguments)}catch(h){e=b(h),g=!0}g||(e=c(e));return d(e)}}});
"undefined"!==typeof Promise&&(Promise.prototype.done=function(a,b){return this.then(a,b)["catch"](_.globalUncaughtExceptionHandler||_["throws"])});
$extensionMethods(Array,{each:_.each,map:_.map,reduce:_.reduce,reduceRight:_.reduceRight,zip:_.zipWith,groupBy:_.groupBy,indexBy:_.indexBy,filter:_.filter,flat:_.flatten.tails2(!0),object:_.object,join:function(a){return $forceOverride(function(b,c){c=2>arguments.length?"":c;return _.isString(c)?a.call(b,c):_.reduce2(b,function(a,b){return[a].concat([c,b])})})}(Array.prototype.join),contains:function(a,b){return 0<=a.indexOf(b)},top:function(a){return a[a.length-1]},first:function(a){return a[0]},
last:function(a){return a[a.length-1]},take:function(a,b){return a.slice(0,b)},before:function(a,b){var c=a.indexOf(b);return 0>c?a:a.slice(0,c-1)},after:function(a,b){var c=a.indexOf(b);return 0>c?a:a.slice(c+1)},isEmpty:function(a){return 0===a.length},notEmpty:function(a){return 0<a.length},lastIndex:function(a){return a.length-1},random:function(a){return a[_.random(0,a.lastIndex)]},copy:function(a){return a.slice(0)},removeAll:$method(function(a){return a.splice(0,a.length),a}),remove:function(a,
b){for(var c;-1!==(c=a.indexOf(b));)a.splice(c,1);return a},removeAt:function(a,b){a.splice(b,1);return a},insertAt:function(a,b,c){a.splice(c,0,b);return a},itemAtWrappedIndex:function(a,b){return a[b%a.length]},reversed:function(a){return a.slice().reverse()},swap:$method(function(a,b,c){var d=a[b];a[b]=a[c];a[c]=d;return a})});
...
$extensionMethods(String,{quote:_.quote,contains:function(a,b){return 0<=a.indexOf(b)},cut:function(a,b){return a.substring(0,b-1)+a.substring(b,a.length)},insert:function(a,b,c){return a.substring(0,b)+c+a.substring(b,a.length)},lowercase:function(a){return a.toLowerCase()},uppercase:function(a){return a.toUpperCase()},trimmed:function(a){return a.trim()},escaped:function(a){return _.escape(a)},repeats:function(a,b){return _.times(b,_.constant(a)).join("")},prepend:function(a,b){return b+a},append:function(a,
b){return a+b},first:function(a,b){return _.first(a,b).join("")},last:function(a,b){return _.last(a,b).join("")},reversed:function(a){return a.split("").reverse().join("")},capitalized:function(a){return a.charAt(0).toUpperCase()+a.slice(1)},decapitalized:function(a){return a.charAt(0).toLowerCase()+a.slice(1)},latinAlphanumericValue:function(a){return a.replace(/[^a-z0-9]/gi,"")},alphanumericValue:function(a){return a.replace(unicode_hack(/[^0-9\p{L}|^0-9\p{N}|^0-9\p{Pc}|^0-9\p{M}]/g),"")},numericValue:function(a){return a.replace(/[^0-9]/g,
...
(function(){var a=["onceBefore","onceAfter","onBefore","onAfter","intercept"],b=function(b,d){if("function"!==typeof b)throw Error("method should be a function");return _.extend({},b,{_bindable:!0,impl:b,_wrapped:b,context:d},_.object(_.map(a,function(a){var b="_"+a,c=0<=a.indexOf("once");return[a,function(a){if(!_.isBindable(this))throw Error("wrong this");var d=this[b];(!c||0>d.indexOf(a))&&this[b].push(a);return this}]})),_.object(_.map(a,function(a){return["_"+a,[]]})))};_.extend(_,_.mapObject(_.invert(a),
function(a){return function(b,e,f){var g=b[e];b=_.isBindable(g)?g:b[e]=_.bindable(g);return b[a].call(b,f)}}.flip2),{unbind:function(b,d,e){var f=b[d];_.isBindable(f)&&_.each(a,function(a){f["_"+a]=_.without(f["_"+a],e)})},isBindable:function(a){return a&&a._bindable?!0:!1},bindable:_.extendWith({hooks:a,hooksShort:["onceBefore","onceAfter","before","after","intercept"]},function(a,d){return _.withSameArgs(a,_.extendWith(b(a,d),function(){var b=arguments.callee,f=b._onceBefore,g=b._onceAfter,h=b._onBefore,
k=b._onAfter,l=b._intercept,b=d||this,m,n=void 0;if(f.length){m=0;for(n=f.length;m<n;m++)f[m].apply(b,arguments);f.removeAll()}m=0;for(n=h.length;m<n;m++)h[m].apply(b,arguments);f=(l.length?_.cps.compose([a].concat(l)):a).apply(b,arguments);if(k.length||g.length){h=_.asArray(arguments).concat(f);m=0;for(n=k.length;m<n;m++)k[m].apply(b,h);if(g.length){m=0;for(n=g.length;m<n;m++)g[m].apply(b,h);g.removeAll()}}return f}))})})})();
...
read:function(a){return function(d){b.hasValue&&d.call(this,b.value);a.call(this,d)}},write:function(a){return function(d){b.beforeWrite&&(d=b.beforeWrite(d));if(!b.hasValue||(b.trackReference?b.value!==d:!_.isEqual(b.value,d))){var e=b.value,f=b.hasValue;b.hasValue=!0;b.value=d;f?a.call(this,!1,b.value,e):a.call(this,!1,b.value)}}}});arguments.length&&b.apply(this,arguments);return _.extend(b,{force:function(a){b.hasValue=!1;b(a||b.value)},when:function(a,d){var e=_.isFunction(a)?a:_.equals(a);b(function(a){e(a)&&
(b.off(arguments.callee),d(a))})}})},barrier:function(a){var b=void 0;_.isFunction(a)&&(b=a,a=void 0);var c=_.stream({already:void 0!==a,value:a,reset:function(){c.already=!1;delete c.value},write:function(a){return function(b){c.already||(c.already=!0,c.value=b);a.call(this,!0,c.value)}},read:function(a){return function(b){c.already?b.call(this,c.value):a.call(this,b)}}});b&&c(b);return c},triggerOnce:$restArg(function(){var a=_.stream({read:function(b){return function(c){0>a.queue.indexOf(c)&&b.call(this,
c)}},write:function(a){return a.partial(!0)}}).apply(this,arguments);return a}),trigger:$restArg(function(){return _.stream({read:_.identity,write:function(a){return a.partial(!1)}}).apply(this,arguments)}),off:function(a,b){a.queue&&(1===arguments.length?a.queue.off():a.queue.off(b));a.queuedBy&&(_.each(a.queuedBy,function(b){b.remove(a)}),delete a.queuedBy)},stream:function(a){a=a||{};var b=_.extend([],{off:function(a){this.length&&(0===arguments.length?(_.each(this,function(a){a.queuedBy.remove(this)},
this),this.removeAll()):a.queuedBy&&(a.queuedBy.remove(this),this.remove(a)))}}),c=void 0,d=a.write(function(a,d){var e=_.rest(arguments),k=b.copy,l=c.context;a&&b.off();_.each(k,function(a){c.postpones?a.postponed.apply(this,e):a.apply(this,e)},l||this)}),e=a.read(function(a){0>b.indexOf(a)&&(a.queuedBy?a.queuedBy.push(b):a.queuedBy=[b],b.push(a))});return c=_.extend($restArg(function(a){_.isFunction(a)?e.call(this,a):d.apply(this,arguments);return arguments.callee}),a,{queue:b,once:function(a){_.find(b,
function(b){return b.onceWrapped_===a})||e(_.extend(function(b){_.off(c,arguments.callee);a(b)},{onceWrapped_:a}))},off:_.off.asMethod,read:e,write:d,postpone:function(){this.postponed.apply(c.context,arguments)}})}});_.hasOOP=!0;_("property static final alias memoized private builtin testArguments".split(" ")).each(_.defineTagKeyword);$prototype=function(a,b){return $prototype.impl.compile.apply($prototype.impl,1<arguments.length?_.asArray(arguments).reverse():arguments)};
...
this.defineStaticMembers,this.defineInstanceMembers).call(this,a||{}).constructor},evalAlwaysTriggeredMacros:function(a){return function(b){for(var c=$prototype.impl.alwaysTriggeredMacros,d=0,e=c.length;d<e;d++)b=c[d](b,a)||b;return b}},evalMemberTriggeredMacros:function(a){return function(b){var c=$prototype.impl.memberNameTriggeredMacros,d=$prototype.impl.tagTriggeredMacros;_.each(b,function(e,f){c.hasOwnProperty(f)&&(b=c[f](b,e,f,a)||b);_.each(_.keys(e),function(c){d.hasOwnProperty(c)&&(b=d[c](b,
e,f,a)||b)})});return b}},evalPrototypeSpecificMacros:function(a){return function(b){if(!b.isTraitOf){var c=$untag(b.$macroTags||a&&a.$definition&&a.$definition.$macroTags);c&&_.each(b,function(a,e){_.each(c,function(f,g){a=b[e];_.keyword(g)in a&&(b[e]=f.call(c,b,a,e)||a)})})}return b}},generateCustomCompilerImpl:function(a){return function(b){b.$impl?(b.$impl.__proto__=a&&a.$impl||this,b.$impl=$static($builtin($property(b.$impl)))):a&&a.$impl&&(b.$impl=$static($builtin($property(a.$impl))));return b}},
generateArgumentContractsIfNeeded:function(a){return a.$testArguments?$prototype.wrapMethods(a,function(a,c){return function(){var d=_.asArray(arguments);$assertArguments(d.copy,a.original,c);return a.apply(this,d)}}):a},contributeTraits:function(a){return function(b){if(b.$traits){var c=b.$traits;this.mergeTraitsMembers(b,c,a);b.$traits=$static($builtin($property(c)));b.hasTrait=$static($builtin(function(a){return 0<=c.indexOf(a)}))}return b}},mergeTraitsMembers:function(a,b,c){_.each(b,function(b){_.defaults(a,
_.omit(b.$definition,_.or($builtin.matches,_.key(_.equals("constructor")))))})},extendWithTags:function(a){return _.extendWith(Tags.unwrap(a),_.mapObject(Tags.get(a),$static.arity1))},callStaticConstructor:function(a){a.isTraitOf||(_.each($untag(a.$traits),function(b){b.$definition.$constructor&&$untag(b.$definition.$constructor).call(a)}),a.$constructor&&$untag(a.$constructor).call(a));return a},generateConstructor:function(a){return function(b){return _.extend(b,{constructor:Tags.modify(b.hasOwnProperty("constructor")?
b.constructor:this.defaultConstructor(a),function(b){a&&(b.prototype.__proto__=a.prototype);return b})})}},generateBuiltInMembers:function(a){return function(b){b.$constructor&&(b.$constructor=$builtin($static(b.$constructor)));return _.defaults(b,{$base:$builtin($static($property(_.constant(a&&a.prototype)))),$definition:$builtin($static($property(_.constant(_.extend({},a&&a.$definition,b))))),isTypeOf:$builtin($static(_.partial(_.isTypeOf,Tags.unwrap(b.constructor)))),isInstanceOf:$builtin(function(a){return _.isTypeOf(a,
this)}),$:$builtin(function(a){return _.$.apply(null,[this].concat(_.asArray(arguments)))})})}},defaultConstructor:function(a){return a?function(){a.prototype.constructor.apply(this,arguments)}:function(a){_.extend(this,a||{})}},defineStaticMembers:function(a){this.defineMembers(Tags.unwrap(a.constructor),_.pick(a,$static.matches));return a},defineInstanceMembers:function(a){this.defineMembers(Tags.unwrap(a.constructor).prototype,_.omit(a,$static.matches));return a},defineMembers:function(a,b){_.each(b,
...
}}return b}},expandAliases:function(a){return _.mapObject(a,function(b){var c=Tags.unwrap(b);return $alias.is(b)?$property.is(b)?$property({get:function(){return this[c]},set:function(a){this[c]=a}}):a[c]:b})},flatten:function(a){var b=_.pick(a,this.isTagKeywordGroup),b=_.object(_.flatten(_.map(b,function(a,b){return _.map(this.flatten(a),function(a,c){return[c,$global[b](a)]})},this),!0));a=_.omit(a,this.isTagKeywordGroup);return _.extend(a,b)},isTagKeywordGroup:function(a,b){var c=Tags.unwrap(a);
return _.isKeyword(b)&&_.isFunction($global[b])&&"object"===typeof c&&!_.isArray(c)}}});_.isTraitOf=function(a,b){var c=b&&b.constructor;return c&&c.hasTrait&&c.hasTrait(a)||!1};_.isTypeOf=_.or(_.isTypeOf,_.isTraitOf);$trait=function(a,b){var c=void 0,d=_.extend(1<arguments.length?b:a,{constructor:_.throwsError("Traits are not instantiable (what for?)"),isTraitOf:$static($builtin(function(a){return _.isTraitOf(c,a)}))});return c=$prototype.impl.compile(d,1<arguments.length?a:b)};
$prototype.macro("$macroTags",function(a,b,c){_.each($untag(b),function(a,b){_.defineTagKeyword(b)})});_.$=function(a,b){return _.rest(arguments,2).length?_.bind.apply(void 0,[b,a].concat(_.rest(arguments,2))):_.withSameArgs(b,function(){return b.apply(a,arguments)})};"undefined"!==typeof jQuery&&jQuery.fn.extend({$:function(){return _.$.apply(null,[this].concat(_.asArray(arguments)))}});_.defineKeyword("const",function(a){return $static($property(a))});_.defineTagKeyword("callableAsFreeFunction");
$prototype.macroTag("callableAsFreeFunction",function(a,b,c){a.constructor[c]=Tags.unwrap(b).asFreeFunction;return a});$singleton=function(a,b){return new ($prototype.apply(null,arguments))};
...
(c-Math.floor(c)))}},timestampFromDateTimeString:function(a){if(a){var b=a.split(" ");a=b[0].split(".");b=1<b.length?b[1].split(":"):["0","0","0"];return(new Date((2<a[2].length?0:2E3)+parseInt(a[2],10),parseInt(a[1],10)-1,parseInt(a[0],10),parseInt(b[0],10),parseInt(b[1],10))).getTime()}}};_.camelCaseToDashes=function(a){return a.replace(/[a-z][A-Z]/g,function(a){return a[0]+"-"+a[1].lowercase})};_.camelCaseToLoDashes=function(a){return a.replace(/[a-z][A-Z]/g,function(a){return a[0]+"_"+a[1].lowercase})};
_.dashesToCamelCase=function(a){return a.replace(/(-.)/g,function(a){return a[1].uppercase})};_.loDashesToCamelCase=function(a){return a.replace(/(_.)/g,function(a){return a[1].uppercase})};
...
Lock=$prototype({acquire:function(a){this.wait(this.$(function(){this.waitQueue||(this.waitQueue=[]);a()}))},acquired:function(){return void 0!==this.waitQueue},wait:function(a){this.acquired()?this.waitQueue.push(a):a()},release:function(){if(this.waitQueue.length){var a=_.first(this.waitQueue);this.waitQueue=_.rest(this.waitQueue);a()}else delete this.waitQueue}});_.interlocked=function(a){var b=new Lock;return _.extendWith({wait:b.$(b.wait)},_.argumentPrependingWrapper(Tags.unwrap(a),function(a){b.acquire(function(){a(b.$(b.release))})}))};
...
_.defineKeyword("component",function(a){return $extends(Component,a)});_("extendable trigger triggerOnce barrier observable bindable memoize interlocked memoizeCPS debounce throttle overrideThis listener postpones reference".split(" ")).each(_.defineTagKeyword);_.defineTagKeyword("observableProperty",_.flip);_.defineKeyword("observableRef",function(a){return $observableProperty($reference(a))});$prototype.macro("$depends",function(a,b,c){a.$depends=$builtin($const(_.coerceToArray(b)));return a});
$prototype.macroTag("extendable",function(a,b,c){a[c]=$builtin($const(b));return a});
...
this.generateBuiltInMembers(b),this.callStaticConstructor,this.expandAliases,this.defineStaticMembers,this.defineInstanceMembers)},expandTraitsDependencies:function(a){if(a.$depends){var b=[],c=0,d=function(a,f){f.__tempId||(f.__tempId=c++);_.each(a,function(a){b.push([f,a]);d(a.$depends||[],a)})};d($untag(a.$depends),{});_.each(a.$traits=_.reversed(_.rest(_.linearMerge(b,{key:_.property("__tempId")}))),function(a){delete a.__tempId})}return a},mergeExtendables:function(a){return function(b){_.each(_.pick(a.$definition,
$extendable.is),function(a,d){b[d]=Tags.modify(a,function(a){a=_.extendedDeep(a,$untag(b[d]||{}));_.each($untag(b.$traits),function(c){if(!c)throw log.e(b.$traits),Error("invalid $traits value");(c=c.$definition[d])&&(a=_.extendedDeep($untag(c),a))});return a})});return b}},mergeTraitsMembers:function(a,b){var c={},d={};_.each([a].concat(_.pluck(b,"$definition")),function(a){_.each(_.omit(a,_.or($builtin.matches,_.key(_.equals("constructor")))),function(a,b){$bindable.is(a)&&(d[b]=a);(c[b]||(c[b]=
[])).push(a)})});_.each(c,function(b,d){var g=_.find(b,Component.isStreamDefinition);if(g){var h=a[d]=Tags.clone(g);h.listeners=[];_.each(b,function(a){a!==g&&h.listeners.push(a)})}else a[d]||(a[d]=c[d][0])});a.__bindables=d;a.__members=c},mergeBindables:function(a){var b=a.__members;_.each(a.__bindables,function(c,d){var e=_.filter2(_.bindable.hooks,function(a,c){var e=b[_.bindable.hooksShort[c]+d.capitalized];return e?[a,e]:!1});if(e.length){var f={};_.each(e,function(a){_.each(a[1],function(b){b=
$untag(b);if(_.isFunction(b)){var c="_"+a[0];(f[c]||(f[c]=[])).push(b)}})});a[d]=$bindable({hooks:f},Tags.clone(a[d]))}});return a}},isStreamDefinition:$static(function(a){return _.isObject(a)&&(a.$trigger||a.$triggerOnce||a.$barrier||a.$observable||a.$observableProperty)}),mapMethods:function(){var a=_.last(arguments),b=1===arguments.length?_.constant(!0):arguments[0],c;for(c in this){var d=this.constructor.$definition[c];if(!d||!d.$property){var e=this[c];_.isFunction(e)&&!_.isPrototypeConstructor(e)&&
b(d)&&(this[c]=a.call(this,e,c,d)||e)}}},enumMethods:function(a,b){2===arguments.length?this.mapMethods(a,b.returns(void 0)):this.mapMethods(a.returns(void 0))},constructor:$final(function(a,b){this.parent_=void 0;this.children_=[];var c=this.cfg="object"===typeof a?a:{},d=this.constructor.$definition;this.constructor.$defaults&&(c=this.cfg=_.extend(_.cloneDeep(this.constructor.$defaults),c));this.mapMethods(function(a,b){if("$"!==b&&"init"!==b)return this.$(a)});_.onBefore(this,"destroy",this.beforeDestroy);
_.onAfter(this,"destroy",this.afterDestroy);var e=[],f={init:!0};_.each(d,function(a,b){if(void 0!==a){if(a.$observableProperty){var d=a.subject,l=b in c?c[b]:d,m=b+"Change",n=f[m]=this[m]=_.observable();n.context=this;n.postpones=a.$postpones;if(_.isPrototypeInstance(d)){var p=d.constructor;n.beforeWrite=function(a){return p.isTypeOf(a)?a:new p(a)}}a.$reference&&(n.trackReference=!0);_.defineProperty(this,b,{get:function(){return n.value},set:function(a){n.call(this,a)}});a.listeners&&_.each(a.listeners,
function(a){e.push([n,a])});_.isFunction(a.$observableProperty)&&e.push([n,a.$observableProperty]);void 0!==l&&n(l)}else if(Component.isStreamDefinition(a)){var q=f[b]=this[b]=_.extend((a.$trigger?_.trigger:a.$triggerOnce?_.triggerOnce:a.$observable?_.observable:a.$barrier?_.barrier:void 0)(a.subject),{context:this,postpones:a.$postpones});a.listeners&&_.each(a.listeners,function(a){e.push([q,a])});(d=c[b])&&e.push([q,d])}a.$listener&&(this[b].queuedBy=[]);a.$interlocked&&(this[b]=_.interlocked(this[b]));
a.$bindable&&(this[b]=_.extend(_.bindable(this[b],this),_.map2(a.$bindable.hooks||{},_.mapsWith(this.$.bind(this).arity1))));a.$debounce&&(d=this[b],l=_.coerceToObject(a.$debounce),this[b]=d.debounced(l.wait||500,l.immediate));a.$throttle&&(d=this[b],l=_.coerceToObject(a.$throttle),this[b]=_.throttle(d,l.wait||500,l));a.$memoize?this[b]=_.memoize(this[b]):a.$memoizeCPS&&(this[b]=_.cps.memoize(this[b]))}},this);_.intercept(this,"init",function(a){(_.hasArgs(this.constructor.prototype.init)?_.cps.sequence:
_.sequence)([this._beforeInit,a.bind(this),this._afterInit]).call(this)});_.each(c,function(a,b){b in f||(this[b]=_.isFunction(a)?this.$(a):a)},this);_.each(d,function(a,b){a&&a.$alias&&(this[b]=this[Tags.unwrap(a)])},this);_.hasAsserts&&_.each(this.constructor.$requires,function(a,b){$assertTypeMatches(_.object([[b,this[b]]]),_.object([[b,a]]))},this);_.each(e,function(a){a[0].call(this,a[1])},this);!1===c.init||this.constructor.$defaults&&!1===this.constructor.$defaults.init||this.init()}),callTraitsMethod:function(a,
b){_.isFunction(b)?_.cps.sequence(_.filter2(this.constructor.$traits||[],this.$(function(b){return(b=b.prototype[a])&&_.cps.arity0(_.noArgs(b)?b.asContinuation:b).bind(this)||!1})).concat(b.arity0))():_.sequence(_.filter2(this.constructor.$traits||[],this.$(function(b){return(b=b.prototype[a])&&(_.hasArgs(b)?b.bind(this,_.identity):b.bind(this))||!1})))()},_beforeInit:function(a){if(this.initialized.already)throw Error("Component: I am already initialized. Probably you're doing it wrong.");this.callTraitsMethod("beforeInit",
a)},init:function(){},_afterInit:function(a){var b=this.cfg;this.callTraitsMethod("afterInit",a);this.initialized(!0);_.each(this.constructor.$definition,function(a,d){if(a&&a.$observableProperty){d+="Change";var e=b[d];if(e)this[d](e)}},this)},initialized:$barrier(),beforeDestroy:function(){if(this.destroyed_)throw Error("Component: I am already destroyed. Probably you're doing it wrong.");if(this.destroying_)throw Error("Component: Recursive destroy() call detected. Probably you're doing it wrong.");
this.destroying_=!0;this.enumMethods(_.off);_.each(this.children_,_.method("destroy"));this.children_=[]},destroy:function(){},afterDestroy:function(){_.each(this.constructor.$traits,function(a){a.prototype.destroy&&a.prototype.destroy.call(this)},this);delete this.destroying_;this.parent_=void 0;this.destroyed_=!0},attachedTo:$property(function(){return this.parent_}),attachTo:function(a){if(a===this)throw Error("smells like time-travel paradox.. how else can I be parent of myself?");this.parent_!==
a&&(void 0!==this.parent_&&this.parent_.children_.remove(this),void 0!==(this.parent_=a)&&this.parent_.children_.push(this));return this},detach:function(){return this.attachTo(void 0)},attached:$property(function(){return this.children_}),attach:function(a){_.invoke(_.coerceToArray(a),"attachTo",this);return this},detachAll:function(){_.each(this.children_,function(a){a.parent_=void 0});this.children_=[];return this},destroyAll:function(){_.each(this.children_,function(a){a.parent_=void 0;a.destroy()});
this.children_=[];return this}});
...
_.extend(log,{indent:function(a){return log.config({indent:a})},stackOffset:function(a){return log.config({stackOffset:a})},color:_.extend(function(a){return(log.color[a]||{}).color},{none:log.config({color:{shell:"\u001b[0m",css:""}}),red:log.config({color:{shell:"\u001b[31m",css:"crimson"}}),blue:log.config({color:{shell:"\u001b[36m",css:"royalblue"}}),darkBlue:log.config({color:{shell:"\u001b[36m\u001b[2m",css:"rgba(65,105,225,0.5)"}}),orange:log.config({color:{shell:"\u001b[33m",css:"saddlebrown"}}),
green:log.config({color:{shell:"\u001b[32m",css:"forestgreen"}}),pink:log.config({color:{shell:"\u001b[35m",css:"magenta"}}),dark:log.config({color:{shell:"\u001b[0m\u001b[2m",css:"rgba(0,0,0,0.25)"}})}),boldLine:"======================================",line:"--------------------------------------",thinLine:"......................................",withWriteBackend:$scope(function(a,b,c,d){var e=log.writeBackend.value;log.writeBackend.value=b;c(function(b){a(function(){log.writeBackend.value=e;b&&
b();d&&d()})})}),writeUsingDefaultBackend:function(){var a=arguments;log.withWriteBackend(log.impl.defaultWriteBackend,function(b){log.write.apply(null,a);b()})},writeBackend:function(){return arguments.callee.value||log.impl.defaultWriteBackend},withConfig:function(a,b){log.impl.configStack.push(log.impl.configure([{stackOffset:-1},a]));var c=b();log.impl.configStack.pop();return c},currentConfig:function(){return log.impl.configure(log.impl.configStack)},impl:{configStack:[],numWrites:0,configure:function(a){return _.reduce2({stackOffset:0,
indent:0},_.nonempty(a),function(a,c){return _.extend(a,_.nonempty(c),{indent:a.indent+(c.indent||0),stackOffset:a.stackOffset+(c.stackOffset||0)})})},write:$restArg(function(){var a=log.writeBackend();log.impl.numWrites++;var b=_.asArray(arguments),c=log.impl.configure([{stackOffset:Platform.NodeJS?1:3,indent:a.indent||0}].concat(log.impl.configStack)),d=_.reduce2([],_.partition3(b,_.isTypeOf.$(log.Config)),function(a,b){return!0===b.label?(c=log.impl.configure([c].concat(b.items)),a):a.concat({config:c,
text:log.impl.stringifyArguments(b.items,c)})}),e=d.last&&d.last.text.reversed.match(/(\n*)([^]*)/),f=e&&e[1];e&&(d.last.text=e[2].reversed);var g={},e=_.pluck.with_("items",_.reject.with_(_.property("label"),_.partition3.with_(_.equals(g),_.scatter(d,function(a,b,c){_.each(a.text.split("\n"),function(b,d,e){c(_.extended(a,{text:b}));d!==e.lastIndex&&c(g)})})))),d=_.pluck(d,"text").join(""),h=c.where||$callStack[c.stackOffset]||{},k=_.times(c.indent,_.constant("\t")).join("");a({lines:e,config:c,
color:c.color,args:arguments,indentation:k,indentedText:e.map(_.seq(_.pluck.tails2("text"),_.joinsWith(""),_.prepends(k))).join("\n"),text:d,codeLocation:c.location&&log.impl.location(h)||"",trailNewlines:f||"",where:c.location&&h||void 0});return _.find(b,_.not(_.isTypeOf.$(log.Config)))}),defaultWriteBackend:function(a){var b=a.codeLocation,c=a.trailNewlines;Platform.NodeJS?console.log(_.map(a.lines,function(b){return _.map(b,function(b){return b.config.color?b.config.color.shell+a.indentation+
b.text+"\u001b[0m":a.indentation+b.text}).join("")}).join("\n"),log.color("dark").shell+b+"\u001b[0m",c):console.log.apply(console,_.reject.with_(_.equals(void 0),[].concat(_.map(a.lines,function(b,c){return a.indentation+_.reduce2("",b,function(a,b){return a+(b.text&&(b.config.color?"%c":"")+b.text||"")})}).join("\n")+(b&&"%c "+b||""),(_.scatter(a.lines,function(a,b,c){_.each(a,function(a){a.config.color&&c("color:"+a.config.color.css)})})||[]).concat(b?"color:rgba(0,0,0,0.25)":[]),c)))},location:function(a){return _.quoteWith("()",
_.nonempty([a.calleeShort,a.fileName+":"+a.line]).join(" @ "))},stringifyArguments:function(a,b){return _.map(a,log.impl.stringify.tails2(b)).join(" ")},stringify:function(a,b){b=b||{};if(_.isTypeOf(Error,a)){var c=log.impl.stringifyError(a);return a.originalError?c+"\n\n"+log.impl.stringify(a.originalError):c}return _.isTypeOf(CallStack,a)?log.impl.stringifyCallStack(a):"object"===typeof a?_.isArray(a)&&1<a.length&&_.isObject(a[0])&&b.table?log.asTable(a):_.stringify(a,b):"string"===typeof a?a:_.stringify(a)},
stringifyError:function(a){try{var b=CallStack.fromErrorWithAsync(a).clean.offset(a.stackOffset||0);return"[EXCEPTION] "+(a.message||"").replace(/\r|\n/g,"").trimmed.first(120)+"\n\n"+(a.notMatching&&_.map(_.coerceToArray(a.notMatching||[]),log.impl.stringify.then(_.prepends("\t"))).join("\n")+"\n\n"||"")+log.impl.stringifyCallStack(b)+"\n"}catch(c){return"YO DAWG I HEARD YOU LIKE EXCEPTIONS... SO WE THREW EXCEPTION WHILE PRINTING YOUR EXCEPTION:\n\n"+c.stack+"\n\nORIGINAL EXCEPTION:\n\n"+a.stack+
...
this.failed=0<this.failedTests.length;d(!this.failed);a()}))}))}),onException:function(a){if(this.currentAssertion)this.currentAssertion.onException(a);else throw a;},defineAssertions:function(a){_.each(a,function(a,c){this.defineAssertion(c,a)},this)},runTest:function(a,b,c){var d=this.runConfig;d.testStarted(a);a.verbose=d.verbose;a.timeout=d.timeout;a.startTime=Date.now();a.run(function(){d.testComplete(a);a.time=Date.now()-a.startTime;c()})},collectTests:function(){return _.map(_.tests,this.$(function(a,
b){return this.testSuite(b,a)}))},collectPrototypeTests:function(a){_.cps.map(this.prototypeTests,this.$(function(a,c){a.proto.$meta(this.$(function(d){c(this.testSuite(d.name,a.tests,void 0,a.proto))}))}),a)},testSuite:function(a,b,c,d){return{name:a||"",tests:_(_.pairs("function"===typeof b&&_.object([[a,b]])||b)).map(function(b){var f=new Test({proto:d,name:b[0],routine:b[1],suite:a,context:c});f.complete(function(){(f.hasLog=0<f.logCalls.length)||(f.failed?log.red("FAIL"):f.verbose&&log.green("PASS"))});
return f})}},defineAssertion:function(a,b){var c=this;_.deleteKeyword(a);_.defineKeyword(a,Tags.modify(b,function(d){return _.withSameArgs(d,function(){var e=$callStack.safeLocation(1);return c.currentAssertion?c.currentAssertion.babyAssertion(a,b,d,arguments,e):d.apply(c,arguments)})}))},printLog:function(a){if(!a.supressLog){var b=_.filter(this.runningTests,function(b){return b.failed||!a.silent&&b.hasLog}),c=_.filter(this.runningTests,_.property("failed"));_.invoke(a.verbose?this.runningTests:
b,"printLog");c.length?log.orange("\n"+log.boldLine+"\nSOME TESTS FAILED:",_.pluck(c,"name").join(", "),"\n\n"):!0!==a.silent&&log.green("\n"+log.boldLine+"\nALL TESTS PASS\n\n")}}});
...
name:b,shouldFail:c.$shouldFail||this.shouldFail,depth:this.depth+1,location:f,context:this.context,timeout:this.timeout/2,verbose:this.verbose,silent:this.silent,routine:Tags.modify(c,function(a){return function(b){if($async.is(e[0]))_.cps.apply(a,g.context,e,function(a,c){c&&c();b()});else try{a.apply(g.context,e),b()}catch(c){h.onException(c)}}})}),k=function(){h.failed&&g.canFail&&g.failedAssertions.push(h);a()};h.run(function(){Testosterone.currentAssertion=g;h.failed||h.verbose&&h.logCalls.notEmpty?
h.location.sourceReady(function(a){log.red(log.config({location:h.location,where:h.location}),a);h.evalLogCalls();k()}):k()})},canFail:$property(function(){return!this.failed&&!this.shouldFail}),fail:function(){this.failed=!0;this.finalize()},assertionStack:$property(function(){var a=[],b=this;do a.push(b),b=b.mother;while(b);return a}),onException:function(a){if(this.canFail||this.verbose){if(_.isAssertionError(a)){if("notMatching"in a){var b=_.coerceToArray(a.notMatching);if(a.asColumns)log.orange(log.columns(_.map(b,
function(a){return["\u2022 "+_.keys(a)[0],_.stringify(_.values(a)[0])]})).join("\n"));else{a=_.map(b,log.impl.stringify.arity1.then(_.bullet.$("\u2022 ")));var c=_.reduce2(a,_.longestCommonSubstring)||"";4>c.length&&(c=void 0);_.each(a,function(a){if(c){var b=a.indexOf(c);log.write(log.color.orange,a.substr(0,b),log.color.dark,c,log.color.orange,a.substr(b+c.length))}else log.orange(a)})}}}else 1<this.depth&&log.newline(),log.write(a);log.newline()}this.canFail?this.fail():this.finalize()},run:function(a){var b=
Testosterone.currentAssertion=this,c=Tags.unwrap(this.routine);this.shouldFail=$shouldFail.is(this.routine);this.hasLog=this.failed=!1;this.logCalls=[];this.failureLocations={};_.withTimeout({maxTime:b.timeout,expired:function(){b.canFail&&(log.error("TIMEOUT EXPIRED"),b.fail())}},b.complete);_.withUncaughtExceptionHandler(b.$(b.onException),b.complete);log.withWriteBackend(_.extendWith({indent:b.depth+(b.indent||0)},function(a){b.logCalls.push(a)}),function(d){b.complete(d.arity0);a&&b.complete(a);
0<c.length?c.call(b.context,b.$(b.finalize)):(c.call(b.context),b.finalize())})},printLog:function(){var a=this.suite&&this.suite!==this.name&&(this.suite||"").quote("[]")||"";log.write(log.color.blue,"\n"+log.boldLine,"\n"+_.nonempty([a,this.name]).join(" "),(this.index+" of "+Testosterone.runningTests.length).quote("()")+(this.failed?" FAILED":"")+":","\n");this.evalLogCalls()},evalLogCalls:function(){_.each(this.logCalls,log.writeBackend().arity1)}});_.defineTagKeyword("recursive");
_.limitRecursion=function(a,b,c){b||(b=a,a=0);var d=-1,e=!1;return function(){if(!e){if(d>a)throw e=!0,_.extendWith({notMatching:_.map(arguments,function(a,b){return"arg"+(b+1)+": "+_.stringify(a)})},Error(c+": max recursion depth reached ("+a+")"));var f=(++d,b.apply(this,arguments));d--;return f}}};
Testosterone.ValidatesRecursion=$trait({$test:function(){var a=new ($component({$traits:[Testosterone.ValidatesRecursion],foo:function(){},bar:function(){this.bar()},baz:$recursive({max:2},function(){this.baz()}),qux:$recursive(function(){this.quxCalled||(this.quxCalled=!0,this.qux())})}));a.foo();$assertThrows(a.bar,{message:"bar: max recursion depth reached (0)"});a.bar();$assertThrows(a.baz,{message:"baz: max recursion depth reached (2)"});a.qux()},$constructor:function(){_.each(this,function(a,
b){!_.isFunction($untag(a))||"constructor"===b||a.$recursive&&void 0===a.$recursive.max||(this[b]=Tags.modify(a,function(c){return _.limitRecursion(a&&a.$recursive&&a.$recursive.max||0,c,b)}))},this)}});
(function(){var a=["red","green","blue","orange","pink"];a.each(_.defineTagKeyword);Testosterone.LogsMethodCalls=$trait({$test:function(a){var c=$prototype({$traits:[Testosterone.LogsMethodCalls]}),c=$extends(c,{foo:$log($red(function(a){$assert(a,42);return 24}))}),d=new c,e=this;c.$meta(function(){$assert(d.foo(42),24);$assert(_.pluck(e.logCalls,"text"),["Compo.foo (42)","\u2192 24",""]);$assert(e.logCalls[0].color===log.color("red"));a()})},$macroTags:{log:function(b,c,d){var e=_.isBoolean(c.$log)?
void 0:c.$log,f="",g=_.find2(a,function(a){return log.color(c["$"+a]&&a)||!1}),h=_.template(e||"{{$proto}}");$untag(b.$meta)(function(a){f=a.name});return Tags.modify(c,function(a){return function(){var b=this,c=_.asArray(arguments),e=h(_.extend({$proto:f},_.map2(this,_.stringifyOneLine.arity1))),p=_.map(c,_.stringifyOneLine).join(", ").quote("()");log.write(log.config({color:g,location:!0}),_.nonempty([e,d]).join("."),p);return log.withConfig({indent:1,color:g,protoName:f},function(){var d=log.impl.numWrites,
e=a.apply(b,c);void 0!==e&&log.write("\u2192",_.stringifyOneLine(e));2>log.currentConfig().indent&&0<log.impl.numWrites-d&&log.newline();return e})}})}}})})();Platform.NodeJS&&(module.exports=Testosterone);_.measure=function(a,b){if(b){var c=_.now();a(function(){b(_.now()-c)})}else return c=_.now(),a(),_.now()-c};
