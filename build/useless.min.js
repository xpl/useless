...
_.stringifyImpl=function(a,b,c,d,e,g){if(a===$global)return"$global";var f=e.formatter&&e.formatter(a);if(f)return f;if(0<=b.indexOf(a))return e.pure?void 0:"<cyclic>";if(0<=c.indexOf(a))return e.pure?void 0:"<ref:"+c.indexOf(a)+">";if(void 0===a)return"undefined";if(null===a)return"null";if(_.isFunction(a))return e.pure?a.toString():_.isPrototypeConstructor(a)?"<prototype>":"<function>";if("string"===typeof a)return _.quoteWith('"',a);if(!_.isObject(a)||"undefined"!==typeof $atom&&$atom.is(a))return _.isDecimal(a)&&
0<e.precision?_.toFixed(a,e.precision):a+"";var h=_.isArray(a),f=e.pretty||!1;if("browser"===_.platform().engine){if(_.isTypeOf(Element,a))return"<"+a.tagName.lowercase+">";if(_.isTypeOf(Text,a))return"@"+a.wholeText}if(a.toJSON)return _.quoteWith('"',a.toJSON());if(!e.pure&&(d>(e.maxDepth||5)||h&&a.length>(e.maxArrayLength||30)))return h?"<array["+a.length+"]>":"<object>";var k=b.concat([a]);c.push(a);b=_.pairs(a);var l=!f||2>b.length,m=g+1,n=l?"":"\t".repeats(m);if(f&&!h){var p=_.reduce(_.map(_.keys(a),
_.count),_.largest,0);b=_.map(b,function(a){return[a[0],a[1]," ".repeats(p-a[0].length)]})}return _.quoteWith(h?l?"[]":"[\n  ]":l?"{  }":"{\n  }",_.joinWith(l?", ":",\n",_.map(b,function(a){return n+(h?"":a[0]+": "+(a[2]||""))+_.stringifyImpl(a[1],k,c,d+1,e,m)})))};_.toFixed=function(a,b){return a&&a.toFixed&&a.toFixed(b)||void 0};_.toFixed2=function(a){return _.toFixed(a,2)};_.toFixed3=function(a){return _.toFixed(a,3)};_.hasStdlib=!0;
...
_.extend(_.cps,{each:function(a,b,c,d,e,g){var f=arguments.callee,h=d||0,k=0===h?void 0===a.length?_.keys(a):void 0:g,l=0===h?k?k.length:a.length:e,m=2!==_.numArgs(b);if(!a||h>=(l||0))c&&c();else{var n=k?k[h]:h,p=function(){f(a,b,c,h+1,l,k)};m?b(a[n],n,p,c,a):b(a[n],p,c,a)}}});_.extend(_.cps,{map:function(a,b,c){var d=_.isArray(a)?[]:{};_.cps.each(a,2==_.numArgs(b)?function(a,c,f){b(a,function(a){d[c]=a;f()})}:function(a,c,f){b(a,c,function(a){d[c]=a;f()})},function(){c(d)})}});
...
arity0:_.arity0,arity1:_.arity1,arity2:_.arity2,arity3:_.arity3,or:_.or,and:_.and,not:_.not,applies:_.applies,memoized:_.memoize,throttled:_.throttle,debounced:function(a,b,c){var d,e,g,f,h,k=function(){var l=Date.now()-d;l<b&&0<l?e=setTimeout(k,b-l):(e=null,c||(g=a.apply(h,f),e||(h=f=null)))},l=function(){h=this;f=arguments;d=Date.now();var l=c&&!e;e||(e=setTimeout(k,b));l&&(g=a.apply(h,f),h=f=null);return g};l.callImmediately=function(){e&&(clearTimeout(e),e=null);a.apply(h,f)};return l},postpone:$method(function(a){var b=
_.rest(arguments);a._postponed||(a._postponed=!0,_.delay(function(){a._postponed=!1;a.apply(null,b)}))}),delay:_.delay,delayed:function(a,b){return function(){var c=arguments,d=this;_.delay(function(){a.apply(d,c)},b)}}});
...
(function(){var a=["onceBefore","onceAfter","onBefore","onAfter","intercept"],b=function(b){return _.extend({},b,{_bindable:!0,impl:b,_wrapped:b},_.object(_.map(a,function(a){return[a,function(b){if(!_.isBindable(this))throw Error("wrong this");return this["_"+a].push(b),this}]})),_.object(_.map(a,function(a){return["_"+a,[]]})))};_.extend(_,_.mapObject(_.invert(a),function(a){return function(b,e,g){var f=b[e];return(_.isBindable(f)?f:b[e]=_.bindable(f))["_"+a].push(g)}}.flip2),{off:function(b,d,
e){var g=b[d];_.isBindable(g)&&_.each(a,function(a){g["_"+a]=_.without(g["_"+a],e)})},isBindable:function(a){return a&&a._bindable?!0:!1},bindable:function(a,d){return _.withSameArgs(a,_.extendWith(b(a),function(){var b=arguments.callee,g=b._onceBefore,f=b._onceAfter,h=b._onBefore,k=b._onAfter,l=b._intercept,b=d||this,m,n=void 0;if(g.length){m=0;for(n=g.length;m<n;m++)g[m].apply(b,arguments);g.removeAll()}m=0;for(n=h.length;m<n;m++)h[m].apply(b,arguments);g=(l.length?_.cps.compose([a].concat(l)):
a).apply(b,arguments);if(k.length||f.length){h=_.asArray(arguments).concat(g);m=0;for(n=k.length;m<n;m++)k[m].apply(b,h);if(f.length){m=0;for(n=f.length;m<n;m++)f[m].apply(b,h);f.removeAll()}}return g}))}})})();
...
read:function(a){return function(d){b.hasValue&&d.call(this,b.value);a.call(this,d)}},write:function(a){return function(d){b.beforeWrite&&(d=b.beforeWrite(d));if(!b.hasValue||(b.trackReference?b.value!==d:!_.isEqual(b.value,d))){var e=b.value,g=b.hasValue;b.hasValue=!0;b.value=d;g?a.call(this,!1,b.value,e):a.call(this,!1,b.value)}}}});arguments.length&&b.apply(this,arguments);return _.extend(b,{force:function(a){b.hasValue=!1;b(a||b.value)},when:function(a,d){b(function(e){a(e)&&(b.off(arguments.callee),
...
arguments)}),off:function(a,b){a.queue&&(1===arguments.length?a.queue.off():a.queue.off(b));a.queuedBy&&(_.each(a.queuedBy,function(b){b.remove(a)}),delete a.queuedBy)},stream:function(a){a=a||{};var b=_.extend([],{off:function(a){this.length&&(0===arguments.length?(_.each(this,function(a){a.queuedBy.remove(this)},this),this.removeAll()):a.queuedBy&&(a.queuedBy.remove(this),this.remove(a)))}}),c=void 0,d=a.write(function(a,d){var e=_.rest(arguments),k=b.copy,l=c.context;a&&b.off();_.each(k,function(a){a.apply(this,
e)},l||this)}),e=a.read(function(a){0>b.indexOf(a)&&(a.queuedBy?a.queuedBy.push(b):a.queuedBy=[b],b.push(a))});return c=_.extend($restArg(function(a){_.isFunction(a)?e.call(this,a):d.apply(this,arguments);return arguments.callee}),a,{queue:b,once:function(a){e(function(b){_.off(c,arguments.callee);a(b)})},off:_.off.asMethod,read:e,write:d})}});_.hasOOP=!0;_("property static final alias memoized private builtin testArguments".split(" ")).each(_.defineTagKeyword);
...
Intersect={rayCircle:function(a,b,c,d){var e=a.sub(c);c=b.dot(b);var g=2*e.dot(b);d=e.dot(e)-d*d;e=g*g-4*c*d;if(!(0>e)){e=Math.sqrt(e);d=(-g-e)/(2*c);c=(-g+e)/(2*c);if(0<=d&&1>=d)return{time:d,where:a.add(b.scale(d))};if(0<=c&&1>=c)return{time:c,where:a.add(b.scale(c)),insideOut:!0}}}};
...
_.isNumber(a)?this.x=this.y=a:(this.x=a.x,this.y=a.y):(this.x=a,this.y=b)},length:$property(function(){return Math.sqrt(this.lengthSquared)}),lengthSquared:$property(function(){return this.x*this.x+this.y*this.y}),aspect:$property(function(){return this.x/this.y}),add:function(a,b){return void 0===b?"number"===typeof a?new Vec2(this.x+a,this.y+a):new Vec2(this.x+a.x,this.y+a.y):new Vec2(this.x+a,this.y+b)},dot:function(a){return this.x*a.x+this.y*a.y},sub:function(a){return new Vec2(this.x-a.x,this.y-
a.y)},scale:function(a,b){return new Vec2(this.x*a,this.y*(void 0===b?a:b))},mul:function(a){return new Vec2(this.x*a.x,this.y*a.y)},divide:function(a){return new Vec2(this.x/a.x,this.y/a.y)},normal:$property(function(){return this.scale(1/this.length)}),perp:$property(function(){return new Vec2(this.y,-this.x)}),half:$property(function(){return new Vec2(.5*this.x,.5*this.y)}),inverse:$property(function(){return new Vec2(-this.x,-this.y)}),asArray:$property(function(){return[this.x,this.y]}),asLeftTop:$property(function(){return{left:this.x,
top:this.y}}),asLeftTopMargin:$property(function(){return{marginLeft:this.x,marginTop:this.y}}),asWidthHeight:$property(function(){return{width:this.x,height:this.y}}),asTranslate:$property(function(){return"translate("+this.x+" "+this.y+")"}),separatedWith:function(a){return this.x+a+this.y},floor:$property(function(){return new Vec2(Math.floor(this.x),Math.floor(this.y))}),sum:$static(function(a){return _.reduce(_.isArray(a)&&a||_.asArray(arguments),function(a,c){return a.add(c||Vec2.zero)},Vec2.zero)}),
toString:function(){return"{"+this.x+","+this.y+"}"},projectOnCircle:function(a,b){return a.add(this.sub(a).normal.scale(b))},projectOnLineSegment:function(a,b){var c=b.sub(a),d=c.lengthSquared;if(0==d)return a;d=this.sub(a).dot(c)/d;return 0>d?a:1<d?b:a.add(c.scale(d))}});
Bezier={cubic:function(a,b,c,d,e){var g=a*a*a,f=a*a,h=3*(c.x-b.x),k=3*(c.y-b.y),l=3*(d.x-c.x)-h;c=3*(d.y-c.y)-k;return new Vec2((e.x-b.x-h-l)*g+l*f+h*a+b.x,(e.y-b.y-k-c)*g+c*f+k*a+b.y)},cubic1D:function(a,b,c,d,e){return Bezier.cubic(a,Vec2.zero,new Vec2(b,c),new Vec2(d,e),Vec2.one).y},make:{cubic:function(a,b,c,d){return function(e){return Bezier.cubic(e,a,b,c,d)}},cubic1D:function(a,b,c,d){return function(e){return Bezier.cubic1D(e,a,b,c,d)}}}};
...
_.extend(a.x>this.right?{right:!0}:{},a.x<this.left?{left:!0}:{},a.y>this.bottom?{bottom:!0}:{},a.y<this.top?{top:!0}:{});return _.extend(a,a.left||a.right||a.bottom||a.top?{}:{inside:!0})},classifyRay:function(a,b,c){var d=this.size.half,e,g,f,h,k,l;e=1/b.x;g=1/b.y;k=Math.sign(e);l=Math.sign(g);f=(this.x-k*d.x-a.x)*e;h=(this.y-l*d.y-a.y)*g;e*=this.x+k*d.x-a.x;d=(this.y+l*d.y-a.y)*g;if(!(f>d||h>e||(g=f>h?f:h,1<=g||0>=(e<d?e:d))))return e={time:_.clamp(g,0,1)},e.normal=f>h?new Vec2(-k,0):new Vec2(0,
-l),e.delta=b.scale(e.time),e.where=a.add(e.delta),c&&(f=this.grow(-c),e.where.x>f.right?e.where.y<f.top?e=Intersect.rayCircle(a,b,f.rightTop,c):e.where.y>f.bottom&&(e=Intersect.rayCircle(a,b,f.rightBottom,c)):e.where.x<f.left&&(e.where.y<f.top?e=Intersect.rayCircle(a,b,f.leftTop,c):e.where.y>f.bottom&&(e=Intersect.rayCircle(a,b,f.leftBottom,c))),e&&e.insideOut&&(e.where=a)),e},nearestPointTo:function(a,b){var c=b||0,d=new Vec2(this.left,this.top),e=new Vec2(this.right,this.top),g=new Vec2(this.right,
this.bottom),f=new Vec2(this.left,this.bottom),c=[a.projectOnLineSegment(d.add(c,0),e.add(-c,0)),a.projectOnLineSegment(e.add(0,c),g.add(0,-c)),a.projectOnLineSegment(g.add(-c,0),f.add(c,0)),a.projectOnLineSegment(f.add(0,-c),d.add(0,c)),a.projectOnCircle(d.add(c,c),c),a.projectOnCircle(e.add(-c,c),c),a.projectOnCircle(g.add(-c,-c),c),a.projectOnCircle(f.add(c,-c),c)];return _.min(c,function(b){return a.sub(b).length})},clone:$property(function(){return new BBox(this.x,this.y,this.width,this.height)}),
...
_.RGB2HSL=function(a,b){var c=a[0],d=a[1],e=a[2],g=void 0===b?a[3]:b,f=Math.max(c,d,e),h=Math.min(c,d,e),k,l=(f+h)/2;if(f==h)k=h=0;else{var m=f-h,h=.5<l?m/(2-f-h):m/(f+h);switch(f){case c:k=(d-e)/m+(d<e?6:0);break;case d:k=(e-c)/m+2;break;case e:k=(c-d)/m+4}k/=6}return void 0===g?[k,h,l]:[k,h,l,g]};
...
b.filename+":"+b.lineno+":"+b.colno})))});var d=function(b,d){return __supressErrorReporting=function(){var f={name:name,stack:Error().stack,asyncContext:c},h=_.asArray(arguments),k=h[d];k.__uncaughtJS_wrapper=h[d]=__supressErrorReporting=function(){c=f;try{return k.apply(this,arguments)}catch(b){a(_.extend(b,{asyncContext:f}))}};return b.apply(this,h)}};window.setTimeout=d(window.setTimeout,0);b(function(a){return d(a,1)},function(a){return function(b,c,d,k){return a.call(this,b,c.__uncaughtJS_wrapper||
...
SourceFiles=$singleton(Component,{apiConfig:{},line:function(a,b,c){SourceFiles.read(a,function(a){c((a.split("\n")[b]||"").trimmed)})},read:$memoizeCPS(function(a,b){if(0>a.indexOf("<"))try{Platform.NodeJS?b(require("fs").readFileSync(a,{encoding:"utf8"})||""):jQuery.get(a,b,"text")}catch(c){b("")}else b("")}),write:function(a,b,c){Platform.NodeJS?this.read(a,function(d){var e=require("fs"),g={encoding:"utf8"};try{e.mkdirSync(a+".backups")}catch(f){}e.writeFileSync(a+".backups/"+Date.now(),d,g);
e.writeFileSync(a,b,g);c()}):API.post("source/"+a,_.extend2({},this.apiConfig,{what:{text:b},failure:Panic,success:function(){log.ok(a,"\u2014 successfully saved");c&&c()}}))}});_.readSourceLine=SourceFiles.line;_.readSource=SourceFiles.read;_.writeSource=SourceFiles.write;
...
c=log.cleanArgs(b),d=_.extend({indent:0},a,log.readConfig(b)),e=Platform.NodeJS?3:2,g=(log.impl.writeBackend.indent||0)+d.indent,f=log.impl.stringifyArguments(c,d),g=_.times(g,_.constant("\t")).join(""),f=f.reversed.match(/(\n*)([^]*)/),d=d.location&&log.impl.location(d.where||$callStack[e+(d.stackOffset||0)])||"",b={color:log.readColor(b),indentedText:f[2].reversed.split("\n").map(_.prepends(g)).join("\n"),trailNewlines:f[1],codeLocation:d};log.impl.writeBackend(b);return c[0]})},defaultWriteBackend:function(a){var b=
...
$static($property($constant(a[c])));return a}));this.run=this.$(this.run)},run:$interlocked(function(a,b){var c=_.last(arguments),d=3===arguments.length?b:_.identity,e=this.runConfig=_.extend({silent:!0,verbose:!1,timeout:2E3,testStarted:function(a){},testComplete:function(a){}},a),g=_.map(e.suites||[],this.$(function(a){return this.testSuite(a.name,a.tests,e.context)}));(!1===e.codebase?_.cps.constant([]):this.$(this.collectPrototypeTests))(this.$(function(a){var b=!1===e.codebase?[]:this.collectTests();
a=_.flatten(_.pluck(b.concat(g).concat(a),"tests"));a=_.filter(a,e.shouldRun||_.constant(!0));this.runningTests=_.map(a,function(a,b){return _.extend(a,{index:b})});_.cps.each(a,this.$(this.runTest),this.$(function(){_.assert(!0!==e.done);e.done=!0;this.printLog(e);this.failedTests=_.filter(this.runningTests,_.property("failed"));this.failed=0<this.failedTests.length;d(!this.failed);c()}))}))}),defineAssertions:function(a){_.each(a,function(a,c){this.defineAssertion(c,a)},this)},runTest:function(a,
...
{name:a,async:b.$async,shouldFail:b.$shouldFail,depth:e.depth+e.assertionStack.value.length+1,location:b.$async?$callStack.safeLocation(2):void 0};this.waitUntilPreviousAssertionComplete(function(){if(g.async)g=new Test(_.extend(g,{context:e.context,timeout:e.timeout/2,routine:Tags.modifySubject(b,function(a){return function(b){_.cps.apply(a,e.context,d,function(a,c){!g.failed&&c&&c.apply(e.context,a);b()})}})})),e.beginAssertion(g),g.run(function(){g.failed&&e.fail()?g.location.sourceReady(function(a){log.red(a,
log.config({location:g.location,where:g.location}));g.evalLogCalls();e.endAssertion(g)}):e.endAssertion(g)});else{e.beginAssertion(g);try{var a=c.apply(e.context,d);e.endAssertion(g);return a}catch(h){e.onException(h),e.endAssertion(g)}}})},beginAssertion:function(a){a.async&&(Testosterone.currentTest=a);this.assertionStack([a].concat(this.assertionStack.value))},endAssertion:function(a){Testosterone.currentTest===a&&(Testosterone.currentTest=this);if(a.shouldFail&&!a.failed)this.onException(_.assertionError({notMatching:"not failed (as should)"}));
...
this.assertionStack([]);this.failureLocations={};var c=Tags.unwrap(this.routine),d=function(a){var d=function(){b.done=!0;a()};try{_.noArgs(c)?(c.call(b.context),d()):b.tryCatch(c,d)}catch(e){b.onException(e,a)}},e=function(a){b.assertionStack.when(_.isEmpty,a)},g=_.withTimeout.partial({maxTime:b.timeout,expired:function(a){b.failed=!0;log.error("TIMEOUT EXPIRED");a()}}),f=log.withCustomWriteBackend.partial(_.extendWith({indent:b.depth},function(a){b.logCalls.push(a)})),h=_.withUncaughtExceptionHandler.partial(b.$(b.onUnhandledException));
f(function(c){h(function(f){g(function(a){_.cps.sequence(d,e,a)()},function(){b.routine.$shouldFail&&(b.failed=!b.failed);(b.hasLog=0<b.logCalls.length)||(b.failed?log.red("FAIL"):b.verbose&&log.green("PASS"));f();c();a()})})})},printLog:function(){var a=this.suite&&this.suite!==this.name&&(this.suite||"").quote("[]")||"";log.write(log.color.blue,"\n"+log.boldLine,"\n"+_.nonempty([a,this.name]).join(" "),(this.index+" of "+Testosterone.runningTests.length).quote("()")+(this.failed?" FAILED":"")+":",
...
position:"fixed",top:0,right:0,bottom:0,left:0,zIndex:999999}).appendTo(document.body));var e=window.__globalDragOverlay,g=this.$(function(f){var g=d.relativeTo||this;if(Platform.touch||1===f.which){var k=g.offset(),l=void 0;if(!d.start||!1!==(l=d.start.call(this,new Vec2(f.pageX-k.left,f.pageY-k.top),f))){var m=void 0,n=void 0,p=void 0,l=_.clone(l),q=this.$(function(a){if(Platform.touch||1===a.which){a.preventDefault();a=b(a,this[0]);var e=g.offset();l=d.move.call(this,l,new Vec2(a.pageX-f.pageX,
a.pageY-f.pageY),new Vec2(a.pageX-e.left,a.pageY-e.top),a)||l}else m(a)}),n=function(){a(e||document.body).css(e?{display:"none"}:{}).off("mouseup touchend",p).off("mousemove touchmove",q)},p=this.$(function(a){n();d.end&&(a=b(a,this[0]),d.end.call(this,l,new Vec2(a.pageX-f.pageX,a.pageY-f.pageY),a))}),m=this.$(function(a){n();p(a)});a(e||document.body).css(e?{display:"",cursor:d.cursor||""}:{}).on("mousemove touchmove",q).one("mouseup touchend",p);d.callMoveAtStart&&d.move.call(this,l,Vec2.zero,
new Vec2(f.pageX-k.left,f.pageY-k.top),f)}}});return this.on(Platform.touch?"touchstart":"mousedown",_.$(this,function(a){var e=_.extend({},b(a,this[0]));if(Platform.touch&&d.longPress){var k=void 0,l=window.setTimeout(_.$(this,function(){this.off("touchmove touchend",k);g(e)}),300),k=this.$(function(){window.clearTimeout(l);this.off("touchmove touchend",k)});this.one("touchmove touchend",k)}else g(e),a.preventDefault(),a.stopPropagation()}))}}(),transform:function(a){return this.css("-webkit-transform",
(a.translate?"translate("+a.translate.x+"px,"+a.translate.y+"px) ":"")+(a.rotate?"rotate("+a.rotate+"rad) ":"")+(a.scale?"scale("+a.scale.x+","+a.scale.y+")":""))},translate:function(a){return this.attr("transform","translate("+a.x+","+a.y+")")},transformMatrix:function(a){a=a.components;return this.attr("transform","matrix("+a[0][0]+","+a[1][0]+","+a[0][1]+","+a[1][1]+","+a[0][2]+","+a[1][2]+")")},outerExtent:function(){return new Vec2(this.outerWidth(),this.outerHeight())},extent:function(){return new Vec2(this.width(),
