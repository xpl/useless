...
_.defineKeyword("component",function(a){return $extends(Component,a)});_("extendable trigger triggerOnce barrier observable bindable memoize interlocked memoizeCPS debounce throttle overrideThis listener postpones reference raw".split(" ")).each(_.defineTagKeyword);_.defineTagKeyword("observableProperty",_.flip);_.defineKeyword("observableRef",function(a){return $observableProperty($reference(a))});$prototype.macro("$depends",function(a,b,c){a.$depends=$builtin($const(_.coerceToArray(b)));return a});
