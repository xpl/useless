...
arguments)}),off:function(a,b){a.queue&&(1===arguments.length?a.queue.off():a.queue.off(b));a.queuedBy&&(_.each(a.queuedBy,function(b){b.remove(a)}),delete a.queuedBy)},stream:function(a){a=a||{};var b=!1,c=_.extend([],{off:function(a){this.length&&(0===arguments.length?(_.each(this,function(a){a.queuedBy.remove(this)},this),this.removeAll()):a.queuedBy&&(a.queuedBy.remove(this),this.remove(a)))}}),d=void 0,e=a.write(function(a,b){var e=_.rest(arguments),f=c.copy,l=d.context;a&&c.off();_.each(f,function(a){a.apply(this,
e)},l||this)}),f=a.read(function(a){0>c.indexOf(a)&&(a.queuedBy?a.queuedBy.push(c):a.queuedBy=[c],c.push(a))});a=$restArg(function(){b||(b=!0,_.delay(_.applies(e,d,arguments).arity0.then(function(){b=!1})))});return d=_.extend($restArg(function(a){_.isFunction(a)?f.call(this,a):b||e.apply(this,arguments);return arguments.callee}),{queue:c,once:function(a){f(function(b){_.off(d,arguments.callee);a(b)})},off:_.off.asMethod,postpone:a,read:f,write:e})}});_.hasOOP=!0;_("property static final alias memoized private builtin testArguments".split(" ")).each(_.defineTagKeyword);
...
this.enumMethods(function(a,b){"$"!==b&&"init"!==b&&(this[b]=this.$(a))});_.onBefore(this,"destroy",this.beforeDestroy);_.onAfter(this,"destroy",this.afterDestroy);_.extend(this,{parent_:void 0,children_:[]},_.omit(_.omit(c,"init","attachTo","attach"),function(a,b){return Component.isStreamDefinition(d[b])},this));_.each(d,function(a,b){if(a.$observableProperty){var d=this[b];defaultValue=b in c?c[b]:d;var h=this[b+"Change"]=_.observable();h.context=this;if(d&&_.isPrototypeInstance(d)){var k=d.constructor;
h.beforeWrite=function(a){return k.isTypeOf(a)?a:new k(a)}}_.defineProperty(this,b,{get:function(){return h.value},set:function(a){h.call(this,a)}});defaultValue&&h.write(defaultValue)}else if(Component.isStreamDefinition(a)){d=(a.$trigger?_.trigger:a.$triggerOnce?_.triggerOnce:a.$observable?_.observable:a.$barrier?_.barrier:void 0)(this[b]);this[b]=_.extend(d,{context:this});var m=c[b];m&&d(m)}a.$bindable&&(_.hasAsserts&&$assert(_.isFunction(this[b])),this[b]=_.bindable(this[b],this));a.$debounce&&
