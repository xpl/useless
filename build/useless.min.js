...
$extensionMethods(Array,{each:_.each,map:_.map,fold:_.reduce2,reduce:_.reduce,reduceRight:_.reduceRight,zip:_.zipWith,groupBy:_.groupBy,indexBy:_.indexBy,filter:_.filter,flat:_.flatten.tails2(!0),object:_.object,pluck:$method(_.pluck),join:function(a){return $forceOverride(function(b,c){c=2>arguments.length?"":c;return _.isString(c)?a.call(b,c):_.reduce2(b,function(a,b){return[a].concat([c,b])})})}(Array.prototype.join),contains:function(a,b){return 0<=a.indexOf(b)},top:function(a){return a[a.length-
