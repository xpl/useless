...
"",file:d[0]||"",line:(d[1]||"").integerValue,column:(d[2]||"").integerValue}})})});$prototype.macro(function(a,b){var c=CallStack.currentAsRawString;a.$sourceFile=$static($memoized($property(function(){return CallStack.fromRawString(c).safeLocation(5).fileShort||"unknown"})));return a});_.measure=function(a,b){if(b){var c=_.now();a(function(){b(_.now()-c)})}else return c=_.now(),a(),_.now()-c};
...
run:$interlocked(function(a,b){var c=_.last(arguments),d=3===arguments.length?b:_.identity,e=this.runConfig=_.extend({silent:!0,verbose:!1,timeout:2E3,testStarted:function(a){},testComplete:function(a){}},a),f=_.map(e.suites||[],this.$(function(a){return this.testSuite(a.name,a.tests,e.context)})),g=!1===e.codebase?[]:this.collectTests(),f=_.flatten(_.pluck(g.concat(f),"tests"));this.runningTests=f=_.filter(f,e.shouldRun||_.constant(!0));_.cps.each(f,this.$(this.runTest),this.$(function(){_.assert(!0!==
e.done);e.done=!0;this.printLog(e);this.failedTests=_.filter(this.runningTests,_.property("failed"));this.failed=0<this.failedTests.length;d(!this.failed);c()}))}),defineAssertions:function(a){_.each(a,function(a,c){this.defineAssertion(c,a)},this)},runTest:function(a,b,c){var d=this,e=this.runConfig;this.currentTest=a;e.testStarted(a);a.verbose=e.verbose;a.timeout=e.timeout;a.run(function(){e.testComplete(a);delete d.currentTest;c()})},collectTests:function(){return _.map(_.tests,this.$(function(a,
b){return this.testSuite(b,"function"===typeof a&&_.object([[b,a]])||a)}))},testSuite:function(a,b,c){return{name:a,tests:_(_.pairs(b)).map(function(b){return new Test({name:b[0],routine:b[1],suite:a,context:c})})}},defineAssertion:function(a,b){var c=this;_.deleteKeyword(a);_.defineKeyword(a,Tags.modifySubject(b,function(d){return _.withSameArgs(d,function(){return c.currentTest?c.currentTest.runAssertion(a,b,d,arguments):d.apply(c,arguments)})}))},printLog:function(a){var b=_.filter(this.runningTests,
function(b){return b.failed||!a.silent&&b.hasLog}),c=_.filter(this.runningTests,_.property("failed"));_.invoke(a.verbose?this.runningTests:b,"printLog");c.length?log.orange("\n"+log.boldLine+"\nSOME TESTS FAILED:",_.pluck(c,"name").join(", "),"\n\n"):!0!==a.silent&&log.green("\n"+log.boldLine+"\nALL TESTS PASS\n\n")}});
