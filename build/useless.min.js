...
_.each(_.keys(_.assertions),function(a){_.defineGlobalProperty("$"+a,_[a],{configurable:!0})});_.extend(_,{asArray:function(a){return void 0!==a.length?[].slice.call(a,0):[a]}});
...
_.extend(_.cps,{each:function(a,b,c,d,e,g){var f=arguments.callee,h=d||0,k=0===h?void 0===a.length?_.keys(a):void 0:g,l=0===h?k?k.length:a.length:e,n=2!==_.numArgs(b);if(!a||h>=(l||0))c&&c();else{var m=k?k[h]:h,p=function(){f(a,b,c,h+1,l,k)};n?b(a[m],m,p,c,a):b(a[m],p,c,a)}}});_.extend(_.cps,{map:function(a,b,c){var d=_.isArray(a)?[]:{};_.cps.each(a,2==_.numArgs(b)?function(a,c,f){b(a,function(a){d[c]=a;f()})}:function(a,c,f){b(a,c,function(a){d[c]=a;f()})},function(){c(d)})}});
...
k=b._onAfter,l=b._intercept,b=d||this,n,m=void 0;if(g.length){n=0;for(m=g.length;n<m;n++)g[n].apply(b,arguments);g.removeAll()}n=0;for(m=h.length;n<m;n++)h[n].apply(b,arguments);g=(l.length?_.cps.compose([a].concat(l)):a).apply(b,arguments);if(k.length||f.length){h=_.asArray(arguments).concat(g);n=0;for(m=k.length;n<m;n++)k[n].apply(b,h);if(f.length){n=0;for(m=f.length;n<m;n++)f[n].apply(b,h);f.removeAll()}}return g}))})})})();
...
top:0,right:0,bottom:0,left:0,zIndex:999999}).appendTo(document.body));var e=window.__globalDragOverlay,g=d.button||1,f=this.$(function(f){var h=d.relativeTo||this;this.addClass(d.cls||"");if(Platform.touch||f.which===g){var n=h.offset(),m=void 0;if(!d.start||!1!==(m=d.start.call(d.context||this,new Vec2(f.pageX-n.left,f.pageY-n.top),f))){var p=void 0,q=void 0,r=void 0,m=_.clone(m),t=this.$(function(a){if(Platform.touch||a.which===g){a.preventDefault();a=b(a,this[0]);var e=h.offset();m=d.move.call(d.context||
this,m,new Vec2(a.pageX-f.pageX,a.pageY-f.pageY),new Vec2(a.pageX-e.left,a.pageY-e.top),a)||m}else p(a)}),q=function(){a(e||document.body).css(e?{display:"none"}:{}).off("mouseup touchend",r).off("mousemove touchmove",t)},r=this.$(function(a){q();d.end&&(a=b(a,this[0]),d.end.call(d.context||this,m,new Vec2(a.pageX-f.pageX,a.pageY-f.pageY),a));this.removeClass(d.cls||"")}),p=this.$(function(a){q();r(a)});a(e||document.body).css(e?{display:"",cursor:d.cursor||""}:{}).on("mousemove touchmove",t).one("mouseup touchend",
r);d.callMoveAtStart&&d.move.call(d.context||this,m,Vec2.zero,new Vec2(f.pageX-n.left,f.pageY-n.top),f)}}}),h=_.$(this,function(a){var e=_.extend({},b(a,this[0]));if(Platform.touch&&d.longPress){var g=void 0,h=window.setTimeout(_.$(this,function(){this.off("touchmove touchend",g);f(e)}),300),g=this.$(function(){window.clearTimeout(h);this.off("touchmove touchend",g)});this.one("touchmove touchend",g)}else f(e),a.preventDefault(),a.stopPropagation()});this.on(Platform.touch?"touchstart":"mousedown",
