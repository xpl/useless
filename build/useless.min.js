var $jscomp={scope:{},getGlobal:function(a){return"undefined"!=typeof window&&window===a?a:"undefined"!=typeof global?global:a}};$jscomp.global=$jscomp.getGlobal(this);$jscomp.patches={};$jscomp.patch=function(a,b){($jscomp.patches[a]=$jscomp.patches[a]||[]).push(b);for(var c=$jscomp.global,d=a.split("."),e=0;e<d.length-1&&c;e++)c=c[d[e]];d=d[d.length-1];c&&c[d]instanceof Function&&(c[d]=b(c[d]))};
$jscomp.defineProperty="function"==typeof Object.defineProperties?Object.defineProperty:function(a,b,c){if(c.get||c.set)throw new TypeError("ES3 does not support getters and setters.");a!=Array.prototype&&a!=Object.prototype&&(a[b]=c.value)};$jscomp.SYMBOL_PREFIX="jscomp_symbol_";
$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};if(!$jscomp.global.Symbol){$jscomp.global.Symbol=$jscomp.Symbol;var a=[],b=function(b){return function(d){a=[];d=b(d);for(var e=[],f=0,g=d.length;f<g;f++){var h;a:if(h=d[f],h.length<$jscomp.SYMBOL_PREFIX.length)h=!1;else{for(var k=0;k<$jscomp.SYMBOL_PREFIX.length;k++)if(h[k]!=$jscomp.SYMBOL_PREFIX[k]){h=!1;break a}h=!0}h?a.push(d[f]):e.push(d[f])}return e}};$jscomp.patch("Object.keys",b);$jscomp.patch("Object.getOwnPropertyNames",b);$jscomp.patch("Object.getOwnPropertySymbols",
function(c){return function(d){b.unused=Object.getOwnPropertyNames(d);a.push.apply(c(d));return a}})}};$jscomp.symbolCounter_=0;$jscomp.Symbol=function(a){return $jscomp.SYMBOL_PREFIX+a+$jscomp.symbolCounter_++};
...
$jscomp.inherits=function(a,b){function c(){}c.prototype=b.prototype;a.prototype=new c;a.prototype.constructor=a;for(var d in b)if(Object.defineProperties){var e=Object.getOwnPropertyDescriptor(b,d);e&&Object.defineProperty(a,d,e)}else a[d]=b[d]};$uselessFile="useless.js";"undefined"!==typeof require&&(_=require("underscore"),$include=require);
_=function(){_.mixin({zipWith:function(a,b){return _.reduce(_.rest(a),function(a,d){return _.times(Math.max(a&&a.length||0,d&&d.length||0),function(e){return b(a&&a[e],d&&d[e])})},_.first(a))}});if("a1 b2 c3"!==_.zipWith([["a","b","c"],[1,2,3]],function(a,b){return a+b}).join(" "))throw Error("_.zipWith broken");return _}();
...
Base64={_keyStr:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",encode:function(a){var b="",c,d,e,f,g,h,k=0;for(a=Base64._utf8_encode(a);k<a.length;)c=a.charCodeAt(k++),d=a.charCodeAt(k++),e=a.charCodeAt(k++),f=c>>2,c=(c&3)<<4|d>>4,g=(d&15)<<2|e>>6,h=e&63,isNaN(d)?g=h=64:isNaN(e)&&(h=64),b=b+Base64._keyStr.charAt(f)+Base64._keyStr.charAt(c)+Base64._keyStr.charAt(g)+Base64._keyStr.charAt(h);return b},decode:function(a){var b="",c,d,e,f,g,h=0;for(a=a.replace(/[^A-Za-z0-9\+\/\=]/g,
"");h<a.length;)c=Base64._keyStr.indexOf(a.charAt(h++)),d=Base64._keyStr.indexOf(a.charAt(h++)),f=Base64._keyStr.indexOf(a.charAt(h++)),g=Base64._keyStr.indexOf(a.charAt(h++)),c=c<<2|d>>4,d=(d&15)<<4|f>>2,e=(f&3)<<6|g,b+=String.fromCharCode(c),64!=f&&(b+=String.fromCharCode(d)),64!=g&&(b+=String.fromCharCode(e));return b=Base64._utf8_decode(b)},_utf8_encode:function(a){a=a.replace(/\r\n/g,"\n");for(var b="",c=0;c<a.length;c++){var d=a.charCodeAt(c);128>d?b+=String.fromCharCode(d):(127<d&&2048>d?b+=
String.fromCharCode(d>>6|192):(b+=String.fromCharCode(d>>12|224),b+=String.fromCharCode(d>>6&63|128)),b+=String.fromCharCode(d&63|128))}return b},_utf8_decode:function(a){var b="",c=0,d;for(c1=c2=0;c<a.length;)d=a.charCodeAt(c),128>d?(b+=String.fromCharCode(d),c++):191<d&&224>d?(c2=a.charCodeAt(c+1),b+=String.fromCharCode((d&31)<<6|c2&63),c+=2):(c2=a.charCodeAt(c+1),c3=a.charCodeAt(c+2),b+=String.fromCharCode((d&15)<<12|(c2&63)<<6|c3&63),c+=3);return b}};
(function(){var a=function(){if("undefined"!==typeof window&&"undefined"!==typeof navigator&&navigator.platform&&navigator.platform.indexOf){var a=navigator.platform,b=navigator.userAgent,e=a+"\n"+b;return _.extend({engine:"browser",browserEngine:0<=b.indexOf("AppleWebKit")?"WebKit":void 0,browser:0<=b.indexOf("Firefox")?"Firefox":0<=b.indexOf("Chrome")?"Chrome":0<=b.indexOf("Safari")?"Safari":0<=b.indexOf("Trident")?"IE":void 0},0<=a.indexOf("Linux arm")||0<=e.indexOf("Android")?{touch:!0,system:"Android"}:
0<=e.indexOf("iPad")?{touch:!0,system:"iOS",device:"iPad"}:0<=e.indexOf("iPhone")||0<=e.indexOf("iPod")?{touch:!0,system:"iOS",device:"iPhone"}:{})}return"undefined"!==typeof global&&global._?{engine:"node"}:{}}(),b="browser"===a.engine?window:"node"===a.engine?global:void 0;b.define=function(a,d,e){if(a in b)throw Error("cannot define global "+a+": already there");return Object.defineProperty(b,a,_.extend(d&&d.get instanceof Function&&d.set instanceof Function&&d||d instanceof Function&&0===d.length&&
{get:d}||{value:d},{enumerable:!0},e))};b.define("$global",b);b.define("$platform",Object.defineProperties({},_.mapObject({engine:a.engine,system:a.system,device:a.device,touch:a.touch||!1,IE:"IE"===a.browser,Firefox:"Firefox"===a.browser,Safari:"Safari"===a.browser,Chrome:"Chrome"===a.browser,WebKit:"WebKit"===a.browserEngine,Browser:"browser"===a.engine,NodeJS:"node"===a.engine,iPad:"iPad"===a.device,iPhone:"iPhone"===a.device,iOS:"iOS"===a.system},function(a,b){return{enumerable:!0,value:a}})))})();
$overrideUnderscore=function(a,b){return _[a]=b(_[a])};$platform.NodeJS&&($global.alert=function(a){var b=$global.log&&_.partial(log.warn,log.config({stackOffset:2}))||console.log;b.apply(b,["ALERT:"].concat(_.asArray(arguments)))});$global.alert2=function(a){alert(_.map(arguments,_.stringify).join(", "));return arguments[0]};$global.log=function(){console.log.apply(console,arguments)};_.hasAsserts=!0;
...
(function(){var a=function(a){return function(b){var e=[].splice.call(arguments,0);1===e.length?a&&!0!==e[0]&&_.assertionFailed({notMatching:e}):a&&!0!==_.allEqual(e)&&_.assertionFailed({notMatching:e});return!0}};$overrideUnderscore("matches",function(a){return function(b){return _.isObject(b)?a(b):function(a){return b===a}}});_.extend(_,_.assertions={assert:a(!0),assertNot:a(!1),assertCPS:function(a,b,e){var f=b&&(_.isArray(b)?b:[b])||[];a(function(){$assert([].splice.call(arguments,0),f);if(e)return e(),
!0})},assertNotCalled:function(a){var b=!0;a(function(){b&&$fail});b=!1},assertEveryCalledOnce:function(a,b){return _.assertEveryCalled(_.hasTags?$once(a):(a.once=!0,a),b)},assertEveryCalled:function(a,b){var e=_.hasTags?$untag(a):a,f=_.hasTags?$async.is(a):a.async,g=(once=_.hasTags?$once.is(a):a.once)?null:e.toString().match(/.*function[^\(]\(([^\)]+)\)/),h=once?_.times(e.length,_.constant(1)):_.map(g[1].split(","),function(a){a=(a=a.trim().match(/^(.+)__(\d+)$/))&&parseInt(a[2],10);return _.isFinite(a)?
a||!1:!0}),k=_.times(e.length,_.constant(!1)),g=_.times(e.length,function(a){return function(){k[a]=_.isNumber(h[a])?(k[a]||0)+1:!0;f&&_.isEqual(k,h)&&b()}});e.apply(null,g);f||(_.assert(k,h),b&&b())},assertCalledWithArguments:function(a,b){return _.assert(_.arr(b),a)},assertCallOrder:function(a){var b=0,e=_.times(a.length,function(a){return function(){arguments.callee.callIndex=b++}});a.apply(null,e);return _.assert(_.pluck(e,"callIndex"),_.times(e.length,_.identity.arity1))},assertMatches:function(a,
b){try{return _.assert(_.matches.apply(null,_.rest(arguments))(a))}catch(e){throw _.isAssertionError(e)?_.extend(e,{notMatching:[a,b]}):e;}},assertNotMatches:function(a,b){try{return _.assert(!_.matches.apply(null,_.rest(arguments))(a))}catch(e){throw _.isAssertionError(e)?_.extend(e,{notMatching:[a,b]}):e;}},assertType:function(a,b){return _.assert(_.decideType(a),b)},assertTypeMatches:function(a,b){return _.isEmpty(mismatches=_.typeMismatches(b,a))?!0:_.assertionFailed({message:"provided value type not matches required contract",
asColumns:!0,notMatching:[{provided:a},{required:b},{mismatches:mismatches}]})},assertFails:function(a){return _.assertThrows.call(this,a,_.isAssertionError)},assertThrows:function(a,b){var e=void 0,f=!1;try{a.call(this)}catch(g){e=g,f=!0}_.assert.call(this,f);1<arguments.length&&_.assertMatches.call(this,e,b)},assertNotThrows:function(a){return _.assertEveryCalled(function(b){a();b()})},assertArguments:function(a,b,e){b=(b||a.callee).toString();var f=b.match(/.*function[^\(]\(([^\)]+)\)/);if(f){a=
_.asArray(a);var f=_.map(f[1].split(","),function(a){a="_"===a.trim()[0]?a.replace(/_/g," ").trim():void 0;var b=parseInt(a,10);return _.isFinite(b)?b:a}),g=_.zipWith([f,a],function(a,b){return void 0===a?!0:a===b});_.every(g)||_.assertionFailed({notMatching:_.nonempty([[e,b].join(": "),f,a])})}},fail:function(){_.assertionFailed()},fails:_.constant(function(){_.assertionFailed()}),stub:function(){_.assertionFailed()}});_.extend(_,{assertionError:function(a){return _.extend(Error(a&&a.message||"assertion failed"),
a,{assertion:!0})},assertionFailed:function(a){throw _.extend(_.assertionError(a),{stack:_.rest(Error().stack.split("\n"),3).join("\n")});},isAssertionError:function(a){return a&&!0===a.assertion}});_.extend(_,{allEqual:function(a){return _.reduce(a,function(b,e){return b&&_.isEqual(a[0],e)},!0)}});_.each(_.keys(_.assertions),function(a){$global.define("$"+a,_[a],{configurable:!0})});for(var b in _.assertions)$global["$"+b]=1;$assert})();
...
_.then=function(a,b){return function(c){var d=a.apply(this,arguments);return d instanceof Promise?d.then(b.bind(this)):b.call(this,d)}};_.asString=function(a){return a+""};_.typeOf=function(a){return typeof a};_.instanceOf=function(a){return function(b){return b instanceof a}};_.count=function(a){return a.length};_.array=_.tuple=function(){return _.asArray(arguments)};_.cons=function(a,b){return[a].concat(b||[])};_.atIndex=function(a){return function(b){return b[a]}};_.takesFirst=_.higherOrder(_.first);
_.takesLast=_.higherOrder(_.last);_.applies=function(a,b,c){return function(){return a.apply(b,c)}};_.prepends=function(a){return function(b){return a+b}};_.appends=function(a){return function(b){return b+a}};_.join=function(a,b){return a.join(b)};_.joinWith=_.flip2(_.join);_.joinsWith=_.higherOrder(_.joinWith);_.split=function(a,b){return a.split(b)};_.splitWith=_.flip2(_.split);_.splitsWith=_.higherOrder(_.splitWith);_.sum=function(a,b){return(a||0)+(b||0)};
_.subtract=function(a,b){return(a||0)-(b||0)};_.mul=function(a,b){return(a||0)*(b||0)};_.equal=function(a,b){return a===b};_.sums=_.plus=_.higherOrder(_.sum);_.subtracts=_.minus=_.higherOrder(_.subtract);_.muls=_.higherOrder(_.mul);_.equals=_.higherOrder(_.equal);_.less=function(a,b){return a<b};_.lessOrEqual=function(a,b){return a<=b};_.greater=function(a,b){return a>b};_.greaterOrEqual=function(a,b){return a>=b};_.isNegative=function(a){return 0>a};
_.largest=function(a,b){return isNaN(a)&&isNaN(b)?NaN:isNaN(a)?b:isNaN(b)?a:Math.max(a,b)};_.notZero=function(a){return 0!==a};_.propertyOf=function(a){return function(b){return a[b]}};_.oneOf=$restArg(function(){return _.propertyOf(_.index(_.asArray(arguments)))});_.isInstanceofSyntaxAvailable=function(){var a=Error();try{return a instanceof Error}catch(b){return!1}};_.isTypeOf_ES4=function(a,b){for(;b;){if(b.constructor===a)return!0;b=b.constructor.$base}return!1};
_.isTypeOf_ES5=function(a,b){return b instanceof a};_.isTypeOf=_.isInstanceofSyntaxAvailable()?_.isTypeOf_ES5:_.isTypeOf_ES4;_.isPrototypeInstance=function(a){return a&&a.constructor&&_.isPrototypeConstructor(a.constructor)};_.isPrototypeConstructor=function(a){return a&&void 0!==a.$definition||!1};_.coerceToNaN=function(a){return _.isFinite(a)?a:Number.NaN};_.coerceToArray=function(a){return void 0===a?[]:_.isArray(a)?a:[a]};_.coerceToFunction=function(a){return _.isFunction(a)?a:_.constant(a)};
_.isArrayLike=function(a){return a instanceof Array||$platform.Browser&&a instanceof NodeList};_.isArray=function(a){return a instanceof Array};
...
if(_.isStrictlyObject(a))return{}},coerceToUndefined:function(a){return void 0===a||null===a||a===Math.NaN||""===a||_.isPOD(a)&&(_.isEmptyObject(a)||0===a.length)?void 0:a}});_.hasStdlib=!0;_.throwsError=_.higherOrder(_.throwError=function(a){throw a instanceof Error?a:Error(a);});_["throws"]=_.higherOrder(_["throw"]=function(a){throw a;});_.overrideThis=_.throwsError("override this");_.notImplemented=_.throwsError("not implemented");
_.mixin({values2:function(a){return _.isArrayLike(a)?a:_.isStrictlyObject(a)?_.values(a):_.isEmpty(a)?[]:[a]}});_.mixin({map2:function(a,b,c){return _.isArrayLike(a)?_.map(a,b,c):a instanceof Set?_.mapSet(a,b,c):_.isStrictlyObject(a)?_.mapObject(a,b,c):b.call(c,a)}});_.mapSet=function(a,b,c){var d=new Set;a=$jscomp.makeIterator(a);for(var e=a.next();!e.done;e=a.next())d.add(b.call(c,e.value));return d};_.mapsWith=_.higherOrder(_.mapWith=_.flip2(_.map2));_.pluck2=function(a,b){return _.map2(a,_.property(b))};
_.mixin({scatter:function(a,b){var c=void 0;_.map2(a,function(a,e){b(a,e,function(a,b){2>arguments.length?(c=c||[]).push(a):(c=c||{})[b]=a})});return c}});_.obj=function(a){var b=void 0;a(function(a,d){(b=b||{})[d]=a});return b};_.arr=function(a){var b=void 0;a(function(a){(b=b||[]).push(2>arguments.length?a:_.asArray(arguments))});return b};
_.mapKeys=function(a,b){return _.isArrayLike(a)?_.map(a,_.tails2(_.mapKeys,b)):_.isStrictlyObject(a)?_.object(_.map(_.pairs(a),function(a){return[b(a[0]),_.mapKeys(a[1],b)]})):a};_.mapMap=_.hyperOperator(_.unary,_.map2);_.hyperMap=function(a,b){return _.hyperOperator(_.unary,function(a,d){return b(a)||_.map2(a,d)})(a,_.identity)};_.pairs2=function(a){return _.scatter(a,function(a,c,d){d([c,a])})};_.reject2=function(a,b){return _.filter2(a,_.not(b))};
_.filter2=function(a,b){if(_.isArrayLike(a)){for(var c=[],d=0,e=a.length;d<e;d++){var f=a[d],g=b(f,d);!0===g?c.push(f):!1!==g&&c.push(g)}return c}if(_.isStrictlyObject(a))return c={},_.each(Object.keys(a),function(d){var e=a[d],f=b(e,d);!0===f?c[d]=e:!1!==f&&(c[d]=f)}),c;g=b(a);if(!0===g)return a;if(!1!==g)return g};_.filterFilter=_.hyperOperator(_.unary,_.filter2);_.hyperFilter=function(a,b){return _.hyperOperator(_.unary,function(a,d){var e=b(a);return!0===e&&_.filter2(a,d)||e})(a,_.identity)};
_.hyperReject=function(a,b){return _.hyperFilter(a,function(a){a=b(a);return _.isBoolean(a)?!a:a})};_.each2=function(a,b){if(_.isArrayLike(a))for(var c=0,d=a.length;c<d;c++)b(a[c],c,d);else if(_.isStrictlyObject(a))for(var e=Object.keys(a),f,c=0,d=e.length;c<d;c++)b(a[f=e[c]],f,d);else b(a,void 0,1)};_.reduce2=function(a,b,c){var d=3>arguments.length,e=a,f=b,g=c;d&&(e=void 0,f=a,g=b);_.each2(f,function(a,b){e=d?a:g(e,a);d=!1});return e};
_.reduceReduce=function(a,b,c){var d=a,e=b,f=c;3>arguments.length&&(d={},e=a,f=b);return _.hyperOperator(_.binary,_.reduce2,_.goDeeperAlwaysIfPossible)(d,e,f)};_.concat=function(a,b){var c,d;1===arguments.length?(c=a[0],d=_.rest(a)):(c=a,d=_.rest(arguments));return _.isArrayLike(c)?c.concat.apply(c,d):_.reduce2(c,d,function(a,b){return _.isObject(a)&&_.isObject(b)?_.extend({},a,b):a+b})};
...
function(b,c){return $global[c]&&a instanceof $global[c]&&c+" "+_.stringifyOneLine(_.omitTypeMismatches(b,a))||!1}))return f;a instanceof Set&&(a=a.asArray);var g=_.isArray(a),f=e.pretty||!1;if($platform.Browser){if(_.isTypeOf(Element,a))return(a.tagName.lowercase+(a.id&&"#"+a.id||"")+(a.className&&"."+a.className||"")).quote("<>");if(_.isTypeOf(Text,a))return"@"+a.wholeText.limitedTo(20)}if(a.toJSON)return _.quoteWith('"',a.toJSON());if(!e.pure&&(d>(e.maxDepth||5)||g&&a.length>(e.maxArrayLength||
60)))return g?"<array["+a.length+"]>":"<object>";var h=b.concat([a]);c.push(a);var k=_.pairs(a),l=_.stringifyImpl.tails2(h,c,d+1,e),m=e.json?'""':"";if(f){k=_.values(a);d=_.alignStringsRight(_.keys(a).map(_.quotesWith(m).then(_.appends(": "))));e=k.map(l);var f=e.map(function(a,b){return"["===a[0]||"{"===a[0]?3:_.isString(k[b])?1:0}),n=_.max(f);e=[f,e].zip(function(a,b){return" ".repeats(n-a)+b});d=g?e:[d,e].zip(_.bullet);d=_.bullet(g?"[ ":"{ ",d.join(",\n"));e=d.split("\n");return d+(" ".repeats(_.max(e.map(_.count))-
_.count(e.last))+(g?" ]":" }"))}return _.quoteWith(g?"[]":"{  }",_.joinWith(", ",_.map(k,function(a){return(g?"":a[0].quote(m)+": ")+l(a[1])})))};_.toFixed=function(a,b){return a&&a.toFixed&&a.toFixed(b)||void 0};_.toFixed2=function(a){return _.toFixed(a,2)};_.toFixed3=function(a){return _.toFixed(a,3)};
Array.prototype.squash=function(a){a=a||{};var b=a.key||_.identity,c={key:null,next:{},depth:{}},d={};_.each(this,function(a){for(var e=0,f=a.length,g=c,n;e<f;e++,g=n){n=a[e];var p=b(n);n=d[p]||(d[p]={key:p,item:n,next:{},depth:{}});g&&(g.next[p]=n,g.depth[p]=0)}});var e=function(a,b,c,d){d=d||0;a[b.key]=!0;b.next=_.filter2(_.values(b.next),function(c){if(c.key in a)return!1;c=e(a,c,b);d=Math.max(d,b.depth[c.key]);return c});c&&(c.depth[b.key]=Math.max(c.depth[b.key]||0,d+1));delete a[b.key];return b},
...
_.cps=function(){return _.cps.sequence.apply(null,arguments)};_.cps.apply=function(a,b,c,d){c=_.asArray(c);var e=_.numArgs(a)-1,f=c[e];c[e]=function(){d.call(this,arguments,f)};return a.apply(b,c)};
_.extend(_.cps,{each:function(a,b,c,d,e,f){var g=c||_.noop,h=function(c,d,e){2===_.numArgs(b)?b(c,e,g,a):b(c,d,e,g,a)};if(_.isEmpty(a))g();else if(_.isScalar(a))h(a,void 0,g);else{var k=d||0,l=0===k?void 0===a.length?_.keys(a):void 0:f,m=0===k?l?l.length:a.length:e;if(k>=(m||0))g();else{var n=l?l[k]:k;h(a[n],n,arguments.callee.bind(this,a,b,c,k+1,m,l))}}}});
...
throttled:_.throttle,debounced:function(a,b,c){var d,e,f,g,h,k=function(){var l=Date.now()-d;l<b&&0<l?e=setTimeout(k,b-l):(e=null,c||(f=a.apply(h,g),e||(h=g=null)))},l=function(){h=this;g=arguments;d=Date.now();var l=c&&!e;e||(e=setTimeout(k,b));l&&(f=a.apply(h,g),h=g=null);return f};l.cancel=function(){e&&(clearTimeout(e),e=null)};l.callImmediately=function(){l.cancel();a.apply(h,g)};return l},postpone:$method(function(a){a.postponed.apply(null,arguments)}),postponed:function(a){return function(){var b=
!a._postponed;a._postponed=_.asArray(arguments);a._postponedThis=this;b&&_.delay(function(){var b=a._postponed,d=a._postponedThis;a._postponed=void 0;a._postponedThis=void 0;a.apply(d,b)})}},delay:_.delay,delayed:function(a,b){return function(){var c=arguments,d=this;_.delay(function(){a.apply(d,c)},b)}}});
...
$extensionMethods(String,{quote:_.quote,pluck:function(a,b){return _.pluck2(b,a)},contains:function(a,b){return 0<=a.indexOf(b)},startsWith:function(a,b){return 1===b.length?a[0]===b:a.substring(0,b.length)===b},endsWith:function(a,b){return 1===b.length?a[a.length-1]===b:a.substring(a.length-b.length)===b},pad:function(a,b,c){return a+(c||" ").repeats(Math.max(0,b-a.length))},cut:function(a,b){return a.substring(0,b-1)+a.substring(b,a.length)},insert:function(a,b,c){return a.substring(0,b)+c+a.substring(b,
a.length)},lowercase:function(a){return a.toLowerCase()},uppercase:function(a){return a.toUpperCase()},trimmed:function(a){return a.trim()},limitedTo:function(a,b){return a&&(a.length<=b?a:a.substr(0,b-1)+"\u2026")},escaped:function(a){return _.escape(a)},repeats:function(a,b){return _.times(b,_.constant(a)).join("")},prepend:function(a,b){return b+a},append:function(a,b){return a+b},first:function(a,b){return _.first(a,b).join("")},last:function(a,b){return _.last(a,b).join("")},reversed:function(a){return a.split("").reverse().join("")},
capitalized:function(a){return a.charAt(0).toUpperCase()+a.slice(1)},decapitalized:function(a){return a.charAt(0).toLowerCase()+a.slice(1)},latinAlphanumericValue:function(a){return a.replace(/[^a-z0-9]/gi,"")},alphanumericValue:function(a){return a.replace(unicode_hack(/[^0-9\p{L}|^0-9\p{N}|^0-9\p{Pc}|^0-9\p{M}]/g),"")},numericValue:function(a){return a.replace(/[^0-9]/g,"")},integerValue:function(a){return a.numericValue.parsedInt},parsedInt:function(a){a=parseInt(a,10);return _.isFinite(a)?a:void 0},
bytes:function(a){for(var b=new Uint8Array(a.length),c=0;c<a.length;++c)b[c]=a.charCodeAt(c);return b},hash:function(a){var b=0,c,d,e;if(0===a.length)return b;c=0;for(e=a.length;c<e;c++)d=a.charCodeAt(c),b=(b<<5)-b+d,b|=0;return b},transliterate:function(){var a=_.extend({"\u0430":"a","\u0431":"b","\u0432":"v","\u0433":"g","\u0434":"d","\u0435":"e","\u0451":"yo","\u0436":"zh","\u0437":"z","\u0438":"i","\u0439":"y","\u043a":"k","\u043b":"l","\u043c":"m","\u043d":"n","\u043e":"o","\u043f":"p","\u0440":"r",
"\u0441":"s","\u0442":"t","\u0443":"u","\u0444":"ph","\u0445":"h","\u0446":"ts","\u0447":"ch","\u0448":"sh","\u0449":"sch","\u044c":"","\u044a":"","\u044b":"y","\u044d":"e","\u044e":"yu","\u044f":"ya"},_.object(_.map("_-1234567890qwertyuiopasdfghjklzxcvbnm",function(a){return[a,a]})));return function(b){var c="";b=(b||"").toLowerCase();for(var d=0,e=b.length;d<e;d++)c+=a[b[d]]||"";return c}}()});
...
arguments.callee,f=b._onceBefore,g=b._onceAfter,h=b._onBefore,k=b._onAfter,l=b._intercept,b=d||this,m,n;if(f.length){m=0;for(n=f.length;m<n;m++)f[m].apply(b,arguments);f.removeAll()}m=0;for(n=h.length;m<n;m++)h[m].apply(b,arguments);f=(l.length?_.cps.compose([a].concat(l)):a).apply(b,arguments);if(k.length||g.length){h=_.asArray(arguments).concat(f);m=0;for(n=k.length;m<n;m++)k[m].apply(b,h);if(g.length)for(k=g.copy,g.removeAll(),m=0,n=k.length;m<n;m++)k[m].apply(b,h)}return f}))})})})();
...
void 0:a,read:function(a){return function(d){b.hasValue&&d.call(this,b.value);a.call(this,d)}},write:function(a){return function(d){b.beforeWrite&&(d=b.beforeWrite(d));if(!b.hasValue||(b.trackReference?b.value!==d:!_.isEqual(b.value,d))){var e=b.value,f=b.hasValue;b.hasValue=!0;b.value=d;f?a.call(this,!1,b.value,e):a.call(this,!1,b.value)}}}});arguments.length&&b.apply(this,arguments);return _.extend(b,{force:function(a){b.hasValue=!1;b(a||b.value)},then:function(a){var d=_.observable();d.beforeWrite=
a;b(d);return d},when:function(a,d){var e=_.isFunction(a)?a:_.equals(a),f=!1;b(function(a){e(a)&&!f&&(f=!0,b.off(arguments.callee),d.apply(this,arguments))})}})},barrier:function(a){var b=void 0;_.isFunction(a)&&(b=a,a=void 0);var c=_.stream({already:void 0!==a,value:a,reset:function(){c.already=!1;delete c.value},write:function(a){return function(b){c.already||(c.already=!0,c.value=b);a.call(this,!0,c.value)}},read:function(a){return function(b){c.already?(c.postpones||c.commitingReads?b.postponed:
b).call(this,c.value):a.call(this,b)}}});b&&c(b);_.defineProperty(c,"promise",function(){return new Promise(function(a){c(a)})});return c},triggerOnce:$restArg(function(){var a=_.stream({read:function(b){return function(c){0>a.queue.indexOf(c)&&b.call(this,c)}},write:function(a){return a.partial(!0)}}).apply(this,arguments);return a}),trigger:$restArg(function(){return _.stream({read:_.identity,write:function(a){return a.partial(!1)}}).apply(this,arguments)}),off:function(a,b){a.queue&&(1===arguments.length?
a.queue.off():a.queue.off(b));a.queuedBy&&(_.each(a.queuedBy,function(b){b.remove(a)}),delete a.queuedBy)},stream:function(a){a=a||{};var b=_.extend([],{off:function(a){this.length&&(0===arguments.length?(_.each(this,function(a){a.queuedBy.remove(this)},this),this.removeAll()):a.queuedBy&&(a.queuedBy.remove(this),this.remove(a)))}}),c=void 0,d=a.write(function(a,d){var e=_.rest(arguments),k=c.context||this,l=b.copy;a&&b.off();c.commitingReads=!0;for(var m=0,n=l.length;m<n;m++)(c.postpones?l[m].postponed:
l[m]).apply(k,e);delete c.commitingReads}),e=a.read(function(a){0>b.indexOf(a)&&(a.queuedBy?a.queuedBy.push(b):a.queuedBy=[b],b.push(a))});return c=_.extend($restArg(function(a){_.isFunction(a)?e.call(this,a):d.apply(this,arguments);return arguments.callee}),a,{queue:b,once:function(a){_.find(b,function(b){return b.onceWrapped_===a})||e(_.extend(function(b){_.off(c,arguments.callee);a(b)},{onceWrapped_:a}))},off:_.off.asMethod,read:e,write:d,postpone:function(){this.postponed.apply(c.context,arguments)}})}});
_.observable.map=function(a,b){b=b||_.identity;var c=_.isArray(a)?Array(a.length):{},d=_.observable(c);_.each(a,function(a,f){a(function(a){c[f]=b(a,f);d.force(c)})});return d};_.observable.all=_.observable.map;_.hasOOP=!0;_("property static final alias memoized private builtin hidden testArguments".split(" ")).each(_.defineTagKeyword);$prototype=function(a,b){return $prototype.impl.compile.apply($prototype.impl,1<arguments.length?_.asArray(arguments).reverse():arguments)};
$extends=function(a,b){return $prototype(a,b||{})};$mixin=function(a,b){return $prototype.impl.compileMixin(_.extend(b,{constructor:a}))};
...
assertRejected:function(a){var b=0<arguments.length;return this["catch"](function(c){b&&$assert(c,a);return c})}});
(function(){var a=$prototype({constructor:function(a){this.maxTime=a&&a.maxTime;this.pending=[];if(this.maxConcurrency=a&&a.maxConcurrency)this.numActive=0,this.queue=[]},run:function(a){var c=this;if(this.numActive>=this.maxConcurrency)return new Promise(function(d){c.queue.push(function(){return c.run(a).then(d)})});var d=__(a);void 0!==this.maxTime&&(d=d.timeout(this.maxTime));void 0!==this.maxConcurrency&&(c.numActive++,d=d.then(function(a){c.numActive--;return c.queue.length&&c.numActive<c.maxConcurrency?
c.queue.pop()():a}));this.pending.push(d);return d},all:$property(function(){return Promise.all(this.pending)})});__.scatter=function(b,c,d){return __.then(b,function(b){if(_.isStrictlyObject(b)){var f=_.coerceToEmpty(b),g=new a(d);_.each2(b,function(a,d){g.run(c.$(a,d,b)).then(function(a){a&&(1<a.length?f[a[1]]=a[0]:f instanceof Array?f.push(a[0]):f[d]=a[0])})});return g.all.then(_.constant(f))}return __(c,b,void 0,b).then(function(a){return a[0]})})}})();
__.map=function(a,b,c){return __.scatter(a,function(a,c,f){return __.then(b.$(a,c,f),function(a){return[a]})},c)};__.filter=function(a,b,c){return __.scatter(a,function(a,c,f){return __.then(b.$(a,c,f),function(b){return!1===b?void 0:!0===b?[a]:[b]})},c)};__.each=function(a,b){return __.then(a,function(a){return new Promise(function(d,e){_.cps.each(a,function(a,c,d){Promise.coerce(b(a,c)).then(d)["catch"](e)},d)})})};__.seq=function(a){return _.reduce2(a,__.then)};
__.all=function(a){return Promise.all(_.map(a,__))};__.race=function(a){return Promise.race(_.map(a,__))};
...
Parse={keyCodeAsString:function(a){return String.fromCharCode(96<=a&&105>=a?a-48:a)},fileName:function(a){return _.first(_.last(a.split(/\\|\//)).split("."))}};
Sort={Ascending:1,Descending:-1,strings:function(a,b){a=$.trim(a).toLowerCase();b=$.trim(b).toLowerCase();return 0==a.length&&0<b.length?1:0<a.length&&0==b.length?-1:a==b?0:a<b?-1:1},numbers:function(a,b){return isNaN(a)&&isNaN(b)?0:isNaN(a)?-1:isNaN(b)?1:a<b?-1:a>b?1:0},generic:function(a,b){return a||b?a?b?a<b?-1:a>b?1:0:1:-1:0},inverse:function(a){return function(b,c){return-a(b,c)}},field:function(a,b,c){return function(d,e){return b(d[a],e[a])*c}}};
...
_.interlocked=function(a){var b=new Lock;a=$untag(a);return _.extendWith({lock:b,wait:b.$(b.wait)},function(){var c=this,d=arguments;return new Promise(function(e){b.acquire(function(){__.then(a.apply(c,d),function(a){b.release();e(a)})})})})};
_.defineKeyword("scope",function(a){var b=void 0;return _.argumentPrependingWrapper(Tags.unwrap(a),function(a){var d={when:void 0};(b=b||[]).push(d);a(function(a){if(d.when)throw Error("$scope: release called twice");for(d.when=a;b&&b.last&&b.last.when;)a=b.last.when,(b=_.initial(b)).isEmpty&&(b=void 0),a()})})});$platform.NodeJS&&(module.exports=_);Math.clamp=_.clamp=function(a,b,c){return Math.max(b,Math.min(c,a))};Math.lerp=_.lerp=function(a,b,c){return b+(c-b)*a};
Math.rescale=_.rescale=function(a,b,c,d){a=(a-b[0])/(b[1]-b[0]);return _.lerp(d&&d.clamp?_.clamp(a,0,1):a,c[0],c[1])};Math.rescaleClamped=_.rescaleClamped=function(a,b,c){return _.rescale(a,b,c,{clamp:!0})};Math.sqr=_.sqr=function(a){return a*a};Math.sign||(Math.sign=function(a){return 0>a?-1:0<a?1:0});
...
marginTop:this.y}}),asWidthHeight:$property(function(){return{width:this.x,height:this.y}}),asTranslate:$property(function(){return"translate("+this.x+" "+this.y+")"}),separatedWith:function(a){return this.x+a+this.y},floor:$property(function(){return new Vec2(Math.floor(this.x),Math.floor(this.y))}),sum:$static(function(a){return _.reduce(_.isArray(a)&&a||_.asArray(arguments),function(a,c){return a.add(c||Vec2.zero)},Vec2.zero)}),toString:function(){return"{"+this.x+","+this.y+"}"},projectOnCircle:function(a,
b){return a.add(this.sub(a).normal.scale(b))},projectOnLineSegment:function(a,b){var c=b.sub(a),d=c.lengthSquared;if(0==d)return a;d=this.sub(a).dot(c)/d;return 0>d?a:1<d?b:a.add(c.scale(d))},projectOnRay:function(a,b){var c=b.lengthSquared;return 0==c?0:this.sub(a).dot(b)/c}});
...
BBox=$prototype({$static:{zero:$property(function(){return new BBox(0,0,0,0)}),unit:$property(function(){return new BBox(0,0,1,1)}),rect:$property(function(a){return new BBox(0,0,a,a)}),fromLeftTopAndSize:function(a,b){return BBox.fromLTWH({left:a.x,top:a.y,width:b.x,height:b.y})},fromLTWH:function(a,b,c,d){return 1===arguments.length?a&&BBox.fromLTWH(a.left,a.top,a.width,a.height):new BBox(a+c/2,b+d/2,c,d)},fromLTRB:function(a,b,c,d){return 1===arguments.length?a&&BBox.fromLTRB(a.left,a.top,a.right,
...
(this.x=a,this.y=b,this.width=c,this.height=d):_.extend(this,a)},classifyPoint:function(a){a=_.extend(a.x>this.right?{right:!0}:{},a.x<this.left?{left:!0}:{},a.y>this.bottom?{bottom:!0}:{},a.y<this.top?{top:!0}:{});return _.extend(a,a.left||a.right||a.bottom||a.top?{}:{inside:!0})},classifyRay:function(a,b,c){var d=this.size.half,e,f,g,h,k,l;e=1/b.x;f=1/b.y;k=Math.sign(e);l=Math.sign(f);g=(this.x-k*d.x-a.x)*e;h=(this.y-l*d.y-a.y)*f;e*=this.x+k*d.x-a.x;d=(this.y+l*d.y-a.y)*f;if(!(g>d||h>e||(f=g>h?
g:h,1<=f||0>=(e<d?e:d))))return e={time:_.clamp(f,0,1)},e.normal=g>h?new Vec2(-k,0):new Vec2(0,-l),e.delta=b.scale(e.time),e.where=a.add(e.delta),c&&(g=this.grow(-c),e.where.x>g.right?e.where.y<g.top?e=Intersect.rayCircle(a,b,g.rightTop,c):e.where.y>g.bottom&&(e=Intersect.rayCircle(a,b,g.rightBottom,c)):e.where.x<g.left&&(e.where.y<g.top?e=Intersect.rayCircle(a,b,g.leftTop,c):e.where.y>g.bottom&&(e=Intersect.rayCircle(a,b,g.leftBottom,c))),e&&e.insideOut&&(e.where=a)),e},nearestPointTo:function(a,
b){var c=b||0,d=new Vec2(this.left,this.top),e=new Vec2(this.right,this.top),f=new Vec2(this.right,this.bottom),g=new Vec2(this.left,this.bottom),c=[a.projectOnLineSegment(d.add(c,0),e.add(-c,0)),a.projectOnLineSegment(e.add(0,c),f.add(0,-c)),a.projectOnLineSegment(f.add(-c,0),g.add(c,0)),a.projectOnLineSegment(g.add(0,-c),d.add(0,c)),a.projectOnCircle(d.add(c,c),c),a.projectOnCircle(e.add(-c,c),c),a.projectOnCircle(f.add(-c,-c),c),a.projectOnCircle(g.add(c,-c),c)];return _.min(c,function(b){return a.sub(b).length})},
xywh:$property(function(){return{x:this.x,y:this.y,width:this.width,height:this.height}}),ltwh:$property(function(){return{left:this.left,top:this.top,width:this.width,height:this.height}}),union:function(a){return BBox.fromLTRB(Math.min(this.left,a.left),Math.min(this.top,a.top),Math.max(this.right,a.right),Math.max(this.bottom,a.bottom))},centerIn:function(a){return new BBox(a.x,a.y,this.width,this.height)},clone:$property(function(){return new BBox(this.x,this.y,this.width,this.height)}),floor:$property(function(){return new BBox.fromLTRB(Math.floor(this.left),
...
this.width/2}),right:$property(function(){return this.x+this.width/2}),top:$property(function(){return this.y-this.height/2}),bottom:$property(function(){return this.y+this.height/2}),center:$property(function(){return new Vec2(this.x,this.y)}),extent:$alias("size"),size:$property(function(){return new Vec2(this.width,this.height)}),offset:function(a){return new BBox(this.x+a.x,this.y+a.y,this.width,this.height)},newWidth:function(a){return new BBox(this.x-(a-this.width)/2,this.y,a,this.height)},
grow:function(a){return new BBox(this.x,this.y,this.width+2*a,this.height+2*a)},shrink:function(a){return this.grow(-a)},mul:function(a){return new BBox(this.x*a,this.y*a,this.width*a,this.height*a)},area:$property(function(){return Math.abs(this.width*this.height)}),intersects:function(a){return!(this.right<a.left||this.left>a.right||this.bottom<a.top||this.top>a.bottom)},toString:function(){return"{ "+this.left+","+this.top+" \u2190\u2192 "+this.right+","+this.bottom+" }"}});
...
_.defineKeyword("component",function(a){return $extends(Component,a)});_("extendable trigger triggerOnce barrier observable bindable memoize interlocked memoizeCPS debounce throttle overrideThis listener postpones reference raw binds observes".split(" ")).each(_.defineTagKeyword);_.defineTagKeyword("observableProperty",function(a){return function(b,c){return _.isFunction(b)&&1===arguments.length?a(b,c):a(c,b)}});_.defineKeyword("observableRef",function(a){return $observableProperty($reference(a))});
$prototype.macro("$depends",function(a,b,c){a.$depends=$builtin($const(_.coerceToArray(b)));return a});$prototype.macroTag("extendable",function(a,b,c){a[c]=$builtin($const(b));return a});$prototype.macro(function(a){a.$nonce=$static($builtin($property(String.randomHex(32))));return a});
...
c));this.mapMethods(function(a,b,c){if(!("$"===b||"init"===b||c&&c.$raw))return this.$(a)});_.onBefore(this,"destroy",this.beforeDestroy);_.onAfter(this,"destroy",this.afterDestroy);var e=[],f={init:!0};_.each(d,function(a,b){if(void 0!==a){if(a.$observableProperty){var d=a.subject,l=b in c?c[b]:d,m=b+"Change",n=f[m]=this[m]=_.observable();n.context=this;n.postpones=a.$postpones;if(_.isPrototypeInstance(d)){var p=d.constructor;n.beforeWrite=function(a){return p.isTypeOf(a)?a:new p(a)}}a.$reference&&
(n.trackReference=!0);_.defineProperty(this,b,{get:function(){return n.value},set:function(a){n.write.call(this,a)}});a.listeners&&_.each(a.listeners,function(a){e.push([n,a])});_.isFunction(a.$observableProperty)&&e.push([n,a.$observableProperty]);void 0!==l&&n(l)}else if(Component.isStreamDefinition(a)){var q=f[b]=this[b]=_.extend((a.$trigger?_.trigger:a.$triggerOnce?_.triggerOnce:a.$observable?_.observable:a.$barrier?_.barrier:void 0)(a.subject),{context:this,postpones:a.$postpones});a.listeners&&
_.each(a.listeners,function(a){e.push([q,a])});(d=c[b])&&e.push([q,d])}a.$listener&&(this[b].queuedBy=[]);a.$interlocked&&(this[b]=_.interlocked(this[b]));a.$bindable&&(this[b]=_.extend(_.bindable(this[b],this),_.map2(a.$bindable.hooks||{},_.mapsWith(this.$.bind(this).arity1))));a.$debounce&&(d=this[b],l=_.coerceToObject(a.$debounce),this[b]=d.debounced(l.wait||500,l.immediate));a.$throttle&&(d=this[b],l=_.coerceToObject(a.$throttle),this[b]=_.throttle(d,l.wait||500,l));a.$memoize?this[b]=_.memoize(this[b]):
...
d(function(){a.chain.remove(b)})};a.chain=[];switch($platform.engine){case "node":require("process").on("uncaughtException",a);break;case "browser":window.addEventListener("error",function(b){0>b.message.indexOf(" [re-thrown by a hook]")&&(b.error?a(b.error):a(_.extend(Error(b.message),{stub:!0,stack:"at "+b.filename+":"+b.lineno+":"+b.colno})))})}})();_.hasReflection=!0;_.defineKeyword("callStack",function(){return CallStack.fromRawString(CallStack.currentAsRawString).offset($platform.NodeJS?1:0)});
_.defineKeyword("currentFile",function(){return(CallStack.rawStringToArray(CallStack.currentAsRawString)[$platform.NodeJS?3:1]||{file:""}).file});_.defineKeyword("uselessPath",_.memoize(function(){return _.initial(__filename.split("/"),$platform.NodeJS?2:1).join("/")+"/"}));_.defineKeyword("sourcePath",_.memoize(function(){var a=($uselessPath.match(/(.+)\/node_modules\/(.+)/)||[])[1];return a?a+"/":$uselessPath}));$platform.Browser&&_.defineProperty(window,"__filename",function(){return $currentFile});
...
try{e.mkdirSync(a+".backups")}catch(g){}e.writeFileSync(a+".backups/"+Date.now(),d,f);e.writeFileSync(a,b,f);c()}):JSONAPI.post("source/"+a,_.extend2({},this.apiConfig,{what:{text:b}})).then(function(){log.ok(a,"\u2014 successfully saved");c&&c()})}});
...
thirdParty:CallStack.isThirdParty(a.file)&&!a.index})})},function(a){return CallStack.fromParsedArray(a)})),rawStringToArray:$static(function(a){a=(a||"").split("\n");return _.filter2(a,function(a){a=a.trimmed;var c,d,e=!1;if((d=a.match(/at (.+) \((.+)\)/))||(d=a.match(/(.*)@(.*)/)))c=d[1],e="native"===d[2],d=_.rest(d[2].match(/(.*):(.+):(.+)/)||[]);else if(d=a.match(/^(at\s+)*(.+):([0-9]+):([0-9]+)/))d=_.rest(d,2);else return!1;return 0<=(c||"").indexOf("__supressErrorReporting")?!1:{beforeParse:a,
callee:c||"",index:$platform.Browser&&d[0]===window.location.href,"native":e,file:d[0]||"",line:(d[1]||"").integerValue,column:(d[2]||"").integerValue}})})});$prototype.impl.findMeta=function(a){return function(b){_.cps.find(CallStack.fromRawString(a).reversed,function(a,b){a.sourceReady(function(e){e=(e||"").match(/([A-z]+)\s*=\s*\$(prototype|singleton|component|extends|trait|aspect)/);b(e&&{name:e[1],type:e[2],file:a.fileShort}||!1)})},function(a){b(a||{})})}};
$prototype.macro(function(a,b){if(!a.$meta){var c=_.cps.memoize($prototype.impl.findMeta(CallStack.currentAsRawString));_.defineMemoizedProperty(c,"promise",function(){return new Promise(c)});a.$meta=$static(c)}return a});_.hasLog=!0;_.extend(log=function(){return log.write.apply(this,[log.config({location:!0,stackOffset:1})].concat(_.asArray(arguments)))},{Config:$prototype(),config:function(a){return new log.Config(a)}});
...
1:3,indent:a.indent||0}].concat(log.impl.configStack)),d=_.reduce2([],_.partition3(b,_.isTypeOf.$(log.Config)),function(a,b){return!0===b.label?(c=log.impl.configure([c].concat(b.items)),a):a.concat({config:c,text:log.impl.stringifyArguments(b.items,c)})}),e=d.last&&d.last.text.reversed.match(/(\n*)([^]*)/),f=e&&e[1];e&&(d.last.text=e[2].reversed);var g={},e=_.pluck["with"]("items",_.reject["with"](_.property("label"),_.partition3["with"](_.equals(g),_.scatter(d,function(a,b,c){_.each(a.text.split("\n"),
function(b,d,e){c(_.extended(a,{text:b}));d!==e.lastIndex&&c(g)})})))),d=_.pluck(d,"text").join(""),h=c.where||log.impl.walkStack($callStack)||{},k=(c.indentPattern||"\t").repeats(c.indent);a({lines:e,config:c,color:c.color,when:Date.now(),args:_.reject(b,_.isTypeOf.$(log.Config)),indentation:k,indentedText:e.map(_.seq(_.pluck.tails2("text"),_.joinsWith(""),_.prepends(k))).join("\n"),text:d,codeLocation:c.location&&log.impl.location(h)||"",trailNewlines:f||"",where:c.location&&h||void 0});return _.find(b,
_.not(_.isTypeOf.$(log.Config)))})),walkStack:function(a){return _.find(a.clean.offset($platform.Browser?1:2),function(a){return 0>a.fileShort.indexOf("base/log.js")})||a[0]},defaultWriteBackend:function(a){var b=a.codeLocation;if($platform.NodeJS){var c=_.map(a.lines,function(b){return a.indentation+_.map(b,function(a){return a.config.color?a.config.color.shell+a.text+"\u001b[0m":a.text}).join("")}).join("\n");log.timestampEnabled&&(c=log.color("dark").shell+_.bullet(log.impl.timestamp(a.when)+" ",
log.color("none").shell+c));console.log(c,log.color("dark").shell+b+"\u001b[0m",a.trailNewlines)}else console.log.apply(console,_.reject["with"](_.equals(void 0),[].concat(_.map(a.lines,function(b,c){return a.indentation+_.reduce2("",b,function(a,b){return a+(b.text&&(b.config.color?"%c":"")+b.text||"")})}).join("\n")+(b&&"%c "+b||""),(_.scatter(a.lines,function(a,b,c){_.each(a,function(a){a.text&&a.config.color&&c(a.config.color.css)})})||[]).concat(b?"color:rgba(0,0,0,0.25)":[]),a.trailNewlines)))},
timestamp:function(a){a=new Date(a);return String.leadingZero(a.getDay())+"/"+String.leadingZero(a.getMonth()+1)+" "+String.leadingZero(a.getHours())+":"+String.leadingZero(a.getMonth())},location:function(a){return _.quoteWith("()",_.nonempty([a.calleeShort,_.nonempty([a.fileName,a.line]).join(":")]).join(" @ "))},stringifyArguments:function(a,b){return _.map(a,function(a){a=log.impl.stringify(a,b);return b.maxArgLength?a.limitedTo(b.maxArgLength):a}).join(" ")},stringify:function(a,b){b=b||{};if(_.isTypeOf(Error,
...
c,color:log.color(d.first),stackOffset:2}))]})))))))})();logs=_.mapWith(_.callsTo.compose(_.callsWith(log.stackOffset(1))),log.printAPI);
...
Test=$prototype({constructor:function(a){_.defaults(this,a,{name:"<< UNNAMED FOR UNKNOWN REASON >>",failed:!1,routine:void 0,verbose:!1,depth:1,indent:0,failedAssertions:[],context:this,complete:_.extend(_.barrier(),{context:this})});this.babyAssertion=_.interlocked(this.babyAssertion)},finalize:function(){this.babyAssertion.wait(this.$(function(){this.canFail&&this.failedAssertions.length&&(this.failed=!0);this.complete(!0)}))},babyAssertion:function(a,b,c,d,e){var f=this,g=new Test({mother:this,
name:a,shouldFail:b.$shouldFail||this.shouldFail,depth:this.depth+1,location:e,context:this.context,timeout:this.timeout/2,verbose:this.verbose,silent:this.silent,routine:Tags.modify(b,function(a){return function(c){if($async.is(d[0])||$async.is(b))_.cps.apply(a,f.context,d,function(a,b){b&&b.apply(this,a);c()});else try{a.apply(f.context,d),c()}catch(e){g.onException(e)}}})});return g.run()["finally"](function(a,b){Testosterone.currentAssertion=f;if(g.failed||g.verbose&&g.logCalls.notEmpty)return g.location.sourceReady.promise.then(function(a){log.red(log.config({location:g.location,
where:g.location}),a);g.evalLogCalls()})}).then(function(){g.failed&&f.canFail&&f.failedAssertions.push(g)})},canFail:$property(function(){return!this.failed&&!this.shouldFail}),fail:function(){this.failed=!0;this.finalize()},assertionStack:$property(function(){var a=[],b=this;do a.push(b),b=b.mother;while(b);return a}),onException:function(a){if(this.canFail||this.verbose){if(_.isAssertionError(a)){if("notMatching"in a){var b=_.coerceToArray(a.notMatching);if(a.asColumns)log.orange(log.columns(_.map(b,
...
Testosterone.currentAssertion=this,b=Tags.unwrap(this.routine);return new Promise(this.$(function(c){this.shouldFail=$shouldFail.is(this.routine);this.hasLog=this.failed=!1;this.logCalls=[];this.failureLocations={};_.withTimeout({maxTime:a.timeout,expired:function(){a.canFail&&(log.ee("TIMEOUT EXPIRED"),a.fail())}},a.complete);_.withUncaughtExceptionHandler(a.$(a.onException),a.complete);log.withWriteBackend(_.extendWith({indent:1},function(b){a.logCalls.push(b)}),function(d){a.complete(d.arity0);
...
a()})},$macroTags:{log:function(b,c,d){var e=(_.isBoolean(c.$log)?void 0:c.$log)||(c.$verbose?"{{$proto}}":""),f={},g=_.find2(a,function(a){return log.color(c["$"+a]&&a)||!1}),h=e&&_.template(e,{interpolate:/\{\{(.+?)\}\}/g});$untag(b.$meta)(function(a){f=a});return $prototype.impl.modifyMember(c,function(a,b){return function(){var e=this,n=_.asArray(arguments),p=h&&h.call(this,_.extend({$proto:f.name},_.map2(this,_.stringifyOneLine.arity1)))||this.desc||"",q=_.map(n,_.stringifyOneLine.arity1).join(", ").quote("()");
log.write(log.config({color:g,location:!0,where:c.$verbose?void 0:{calleeShort:f.name}}),_.nonempty([p,d,b]).join("."),q);return log.withConfig({indent:1,color:g,protoName:f.name},function(){var b=log.impl.numWrites,c=a.apply(e,n);void 0!==c&&log.write("\u2192",_.stringifyOneLine(c));2>log.currentConfig().indent&&0<log.impl.numWrites-b&&log.newline();return c})}})}}})})();$platform.NodeJS&&(module.exports=Testosterone);"use strict";
(function(){$mixin(Promise,{shouldBe:function(b){return this.then(function(c){if(b!==c)throw new a;})},shouldFail:$property(function(){return this.then(function(){throw new a;},function(){})})});var a=function(a){Error.call(this,a||"assertion failed")};$jscomp.inherits(a,Error);a.captureStackTrace=Error.captureStackTrace;var b=Promise;$global.AndrogeneProcessContext=$prototype({current:void 0,constructor:function(){this.eventLog=[];this.where=Error();this.state="pending";void 0!==(this.parent=AndrogeneProcessContext.current)&&
(this.parent.eventLog.push(this),this.env=this.parent.env)},root:$property(function(){return this.parent&&this.parent.root||this}),push:$static(function(a){var b=AndrogeneProcessContext.current;AndrogeneProcessContext.current=a;var c=Promise;Promise=AndrogenePromise;var g=function(){a.eventLog.push([log.config({where:$callStack.safeLocation(5)})].concat(_.initial(arguments)));return _.find(arguments,_.not(_.instanceOf(log.Config)))};log.impl.write.intercept(g);return function(){AndrogeneProcessContext.current=
b;Promise=c;log.impl.write.off(g)}}),within:function(a){var b=this;return function(){var c=AndrogeneProcessContext.push(b);try{var g=a.apply(this,arguments);c();return g}catch(h){throw c(),h;}}},numEvents:$memoized($property(function(){return _.reduce2({log:0,errors:0},this.eventLog,function(a,b){var c=b instanceof AndrogeneProcessContext?b.numEvents:b instanceof Error?{errors:1}:{log:1};a.all=(a.errors+=c.errors||0)+(a.log+=c.log||0);return a})})),printLog:function(a){a=a||{};if(a.verbose||0<this.numEvents.all)this.printWhere(a),
this.printEvents(a)},printWhere:function(a){a=a&&a.indent||0;var b=log.color[{fulfilled:"green",pending:"orange",rejected:"red","":"purple"}[this.state||""]];log.margin();for(var c=$jscomp.makeIterator(CallStack.fromError(this.where).offset(3).clean.reject(function(a){return a["native"]}).reversed),g=c.next();!g.done;g=c.next())g=g.value,log.write(b,log.config({indent:a,location:!0,where:g}),"\u00b7",g.source.trimmed);log.margin()},printEvents:function(a){a=a||{};var b=a.indent||0,c=a.visited||new Set;
if(a.verbose||0<this.numEvents.all){for(var g=$jscomp.makeIterator(this.eventLog),h=g.next();!h.done;h=g.next())h=h.value,h instanceof AndrogeneProcessContext?h.eventLog.length&&h.printLog({indent:b+1,visited:c,verbose:a.verbose}):h instanceof Error?c.has(h)||(c.add(h),log.boldRed(log.indent(b+1),h)):log.write.apply(null,[log.indent(b+1)].concat(h));log.margin()}return this.numEvents}});AndrogeneProcessContext.within=function(a){return AndrogeneProcessContext.current&&AndrogeneProcessContext.current.within(a)||
a};$global.AndrogenePromise=function(a){if(!0===AndrogenePromise.constructing)Promise.call(this,a);else{var b=new AndrogeneProcessContext,c,g;Promise.call(this,function(a,d){c=a;g=function(a){b.eventLog.push(a);d(a)}});this.processContext=b;try{b.within(a)(c,g)}catch(h){g(h)}AndrogenePromise.constructing=!0;Promise.prototype.then.call(this,function(a){b.state="fulfilled"},function(a){b.state="rejected"});delete AndrogenePromise.constructing}};$jscomp.inherits($global.AndrogenePromise,Promise);$global.AndrogenePromise.coerce=
Promise.coerce;$global.AndrogenePromise.all=Promise.all;$global.AndrogenePromise.reject=Promise.reject;$global.AndrogenePromise.resolve=Promise.resolve;$global.AndrogenePromise.prototype.then=function(a,c){var f=this.processContext.within(b.prototype.then,2).apply(this,_.map(arguments,function(a){return a&&function(b){return f.processContext.within(a,-3)(b)}}));return f};$global.AndrogenePromise.prototype.disarmAndrogene=function(){return new b(b.prototype.then.bind(this))};$global.AndrogenePromise.race=
function(a){return b.race(a)};$global.AndrogenePromise.eval=function(a){return a instanceof AndrogenePromise?a:a instanceof Function?new AndrogenePromise(function(b){b(a())}):AndrogenePromise.resolve(a)};var c=function(a){return function(){return AndrogenePromise.eval(a)}};c(function(b,c){if(b!==c)throw new a;});c(function(a){for(var b=[],c=[],g=0,h=a.length;g<h;g++)b.push(new Promise(function(a){c.push(a.$(!0))}));a.apply(this,c);return Promise.all(b)});c(function(){return __("foo").then(_.appends("bar")).shouldBe("foobr")});
c(function(){return(new Promise(function(a){log.i("example log message #1");(new Promise(function(a){log.i("example log message #2");a()})).then(function(){log.i("example log message #3");a()})})).then(function(){log.i("example log message #4");some_undefined_function()})});c(function(){var a=(new Promise(function(a){log.i("A");a("A")})).then(function(a){log.i("B");return"B"});return(new Promise(function(a){log.i("C");a("C")})).then(function(b){log.i("D");return a.then(function(a){log.i("E");return"E"})}).then(function(a){log.i("F");
return"F"})});c(function(){return __("foo").then(_.appends("bar")).delay(500).log.then(function(){dasdsad()}).timeout(600)});c(function(){throw Error("yo");});c(function(){return Promise.resolve().then(function(){return function(){}}).then(function(a){console.log(a)})});c(function(){return __.each([1,2,3],function(a){log.i(a)})})})();
...
a.parse(e),k=h.name&&h.name.decapitalized||e;if(h=h.how&&_["on"+h.how.capitalized]||_.intercept){var l=b[k];l&&_.isFunction(l)&&h(b,k,c);var l=b.prototype,m=l[k];m&&_.isFunction(m)&&h(l,k,c)}}});b.aspectAdded&&b.aspectAdded(d);return d})})();
...
{},e=void 0;c=new Promise(function(c,g){if($platform.Browser){var h=new XMLHttpRequest;h.open(a,(d.protocol||d.hostname||d.port?(d.protocol||window.location.protocol)+"//"+(d.hostname||window.location.hostname)+":"+(d.port||window.location.port):"")+b,!0);d.responseType&&(h.responseType=d.responseType);_.each(d.headers,function(a,b){h.setRequestHeader(b,a)});d.progress&&(h.onprogress=Http.progressCallbackWithSimulation(d.progress));h.onreadystatechange=function(){if(4===h.readyState){d.progress&&
d.progress(1);var a="arraybuffer"===h.responseType?h.response:h.responseText;200===h.status?c(a):g(_.extend(Error(h.statusText),{httpResponse:a,httpStatus:h.status}))}};e=function(){h.abort();g("aborted")};d.data?h.send(d.data):h.send()}else g("not implemented")});return _.extend(c,{abort:e})},progressCallbackWithSimulation:function(a){var b=0;a(0);return function(c){c.lengthComputable?a(c.loaded/c.total):a(b=1<(b+=.1)?0:b)}}});
JSONAPI=$singleton(Component,{$traits:[HttpMethods],request:function(a,b,c){c=_.extend2({headers:{"Cache-Control":"no-cache","Content-Type":"application/json; charset=utf-8"}},c);c.what&&(c.data=JSON.stringify(c.what));var d=_.hasReflection&&$callStack.offset((c.stackOffset||0)+1).asArray;return Http.request(a,"/api/"+b,c)["finally"](function(a,b){if(b)return JSON.parse(b);if(a){if(a.httpResponse)return JSON.parse(a.httpResponse);throw a;}throw Error("empty response");}).then(function(a){if(a.success)return a.value;
if(a.parsedStack)throw _.extend(Error("SERVER: "+a.error),{remote:!0,parsedStack:a.parsedStack.concat(d||[])});throw Error(a.error);})}});
$platform.Browser&&jQuery&&function(a){var b=_.clone(a.fn);_.extend(a,{svg:function(b){var d=document.createElementNS("http://www.w3.org/2000/svg",b);"svg"!==b||$platform.IE||d.setAttribute("xmlns","http://www.w3.org/2000/svg");return a(d)}}).fn.extend({on:function(a,d){var e=this;d=_.find(arguments,_.isFunction);d.queuedBy&&d.queuedBy.push({remove:function(){e.off(a,d)}});return b.on.apply(this,arguments)},item:function(a){return a?(this.length&&(this[0]._item=a),this):this.length?this[0]._item:
void 0},props:function(a){_.extend.apply(null,[this[0]].concat(arguments));return this},props2:function(a){_.extend2.apply(null,[this[0]].concat(arguments));return this},hasWait:function(){return this.hasClass("i-am-busy")},waitUntil:function(a,b){this.addClass("i-am-busy").attr("disabled",!0);a(this.$(function(){this.removeClass("i-am-busy").removeAttr("disabled");b&&b.apply(null,arguments)}));return this},hasParent:function(a){for(var b=this;0<b.length;){if(b[0]==(a[0]||a))return!0;b=b.parent()}return!1},
...
this.animationend(this.$(function(){this.removeClass(a);b&&b.call(this)})));return this},transitionWith:function(a,b){a&&(this.addClass(a),this.transitionend(this.$(function(){this.removeClass(a);b&&b.call(this)})));return this},drag:function(){var b=function(b,c){return b.originalEvent.touches&&_.find(b.originalEvent.touches,function(b){return a(b.target).hasParent(c)})||b};return function(d){this[0].dragConfig=d;$platform.touch||window.__globalDragOverlay||(window.__globalDragOverlay=a("<div>").css({display:"none",
position:"fixed",top:0,right:0,bottom:0,left:0,zIndex:999999}).appendTo(document.body));var e=window.__globalDragOverlay,f=d.button||1,g=this.$(function(g){var h=d.relativeTo||this;this.addClass(d.cls||"");if($platform.touch||g.which===f){var m=h.offset(),n=void 0;if(!d.start||!1!==(n=d.start.call(d.context||this,new Vec2(g.pageX-m.left,g.pageY-m.top),g))){var p=void 0,q=void 0,r=void 0,n=_.clone(n),t=this.$(function(a){if($platform.touch||a.which===f){a.preventDefault();a=b(a,this[0]);var e=h.offset();
n=d.move.call(d.context||this,n,new Vec2(a.pageX-g.pageX,a.pageY-g.pageY),new Vec2(a.pageX-e.left,a.pageY-e.top),a)||n}else p(a)}),q=function(){a(e||document.body).css(e?{display:"none"}:{}).off("mouseup touchend",r).off("mousemove touchmove",t)},r=this.$(function(a){q();d.end&&(a=b(a,this[0]),d.end.call(d.context||this,n,new Vec2(a.pageX-g.pageX,a.pageY-g.pageY),a));this.removeClass(d.cls||"")}),p=this.$(function(a){q();r(a)});a(e||document.body).css(e?{display:"",cursor:d.cursor||""}:{}).on("mousemove touchmove",
t).one("mouseup touchend",r);d.callMoveAtStart&&d.move.call(d.context||this,n,Vec2.zero,new Vec2(g.pageX-m.left,g.pageY-m.top),g)}}}),h=_.$(this,function(a){var e=_.extend({},b(a,this[0]));if($platform.touch&&d.longPress){var f=void 0,h=window.setTimeout(_.$(this,function(){this.off("touchmove touchend",f);g(e)}),300),f=this.$(function(){window.clearTimeout(h);this.off("touchmove touchend",f)});this.one("touchmove touchend",f)}else g(e),a.preventDefault(),a.stopPropagation()});this.on($platform.touch?
"touchstart":"mousedown",h);return _.extend(this,{cancel:this.$(function(){this.off($platform.touch?"touchstart":"mousedown",h)})})}}(),transform:function(a){if(0===arguments.length){var b=(this.css("transform")||"").match(/^matrix\((.+\))$/);return b?(b=b[1].split(",").map(parseFloat),new Transform({a:b[0],b:b[1],c:b[2],d:b[3],e:b[4],f:b[5]})):Transform.identity}return this.css("transform",_.isStrictlyObject(a)&&(a.translate?"translate("+a.translate.x+"px,"+a.translate.y+"px) ":"")+(a.rotate?"rotate("+
a.rotate+"rad) ":"")+(a.scale?"scale("+(new Vec2(a.scale)).separatedWith(",")+")":"")||"")},svgTranslate:function(a){return this.attr("transform","translate("+a.x+","+a.y+")")},svgTransformMatrix:function(a){a=a.components;return this.attr("transform","matrix("+a[0][0]+","+a[1][0]+","+a[0][1]+","+a[1][1]+","+a[0][2]+","+a[1][2]+")")},svgTransformToElement:function(a){return Transform.svgMatrix(this[0].getTransformToElement(a[0]))},svgBBox:function(a){return 0===arguments.length?new BBox(this[0].getBBox()):
