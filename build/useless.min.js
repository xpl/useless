...
c.indexOf(a)&&(a.queuedBy?a.queuedBy.push(c):a.queuedBy=[c],c.push(a))});a=$restArg(function(){b||(b=!0,_.delay(_.applies(e,d,arguments).arity0.then(function(){b=!1})))});return d=_.extend($restArg(function(a){_.isFunction(a)?f.call(this,a):b||e.apply(this,arguments);return arguments.callee}),{queue:c,off:_.off.asMethod,postpone:a,read:f,write:e})}});_.hasOOP=!0;_("property static final alias memoized private builtin testArguments".split(" ")).each(_.defineTagKeyword);
...
"",file:d[0]||"",line:(d[1]||"").integerValue,column:(d[2]||"").integerValue}})})});$prototype.macro(function(a,b){var c=CallStack.currentAsRawString;a.$meta||(a.$meta=$static(_.cps.memoize(function(a){_.cps.find(CallStack.fromRawString(c),function(a,b){a.sourceReady(function(c){c=(c||"").match(/([A-z]+)\s*=\s*\$(prototype|singleton|component|extends|trait|aspect)/);b(c&&{name:c[1],type:c[2],file:a.fileShort}||!1)})},function(b){a(b||{})})})));return a});
...
Testosterone=$singleton({prototypeTests:[],isRunning:$property(function(){return void 0!==this.currentTest}),constructor:function(){this.defineAssertion("assertFails",$shouldFail(function(a){a.call(this)}));_.each(_.omit(_.assertions,"assertFails"),function(a,b){this.defineAssertion(b,b in _.asyncAssertions?$async(a):a)},this);(function(a){$prototype.macro("$test",a);$prototype.macro("$tests",a)})(this.$(function(a,b,c){this.prototypeTests.push([Tags.unwrap(a.$meta),b]);return a}));this.run=this.$(this.run)},
run:$interlocked(function(a,b){var c=_.last(arguments),d=3===arguments.length?b:_.identity,e=this.runConfig=_.extend({silent:!0,verbose:!1,timeout:2E3,testStarted:function(a){},testComplete:function(a){}},a),f=_.map(e.suites||[],this.$(function(a){return this.testSuite(a.name,a.tests,e.context)}));this.collectPrototypeTests(function(a){var b=!1===e.codebase?[]:this.collectTests();a=_.flatten(_.pluck(b.concat(f).concat(a),"tests"));a=_.filter(a,e.shouldRun||_.constant(!0));this.runningTests=_.map(a,
function(a,b){return _.extend(a,{index:b})});_.cps.each(a,this.$(this.runTest),this.$(function(){_.assert(!0!==e.done);e.done=!0;this.printLog(e);this.failedTests=_.filter(this.runningTests,_.property("failed"));this.failed=0<this.failedTests.length;d(!this.failed);c()}))})}),defineAssertions:function(a){_.each(a,function(a,c){this.defineAssertion(c,a)},this)},runTest:function(a,b,c){var d=this,e=this.runConfig;this.currentTest=a;e.testStarted(a);a.verbose=e.verbose;a.timeout=e.timeout;a.run(function(){e.testComplete(a);
delete d.currentTest;c()})},collectTests:function(){return _.map(_.tests,this.$(function(a,b){return this.testSuite(b,a)}))},collectPrototypeTests:function(a){_.cps.map(this.prototypeTests,this.$(function(a,c){a[0](this.$(function(d){c(this.testSuite(d.name,a[1]))}))}),this.$(a))},testSuite:function(a,b,c){return{name:a,tests:_(_.pairs("function"===typeof b&&_.object([[a,b]])||b)).map(function(b){return new Test({name:b[0],routine:b[1],suite:a,context:c})})}},defineAssertion:function(a,b){var c=this;
...
g(function(c){h(function(g){f(function(a){_.cps.sequence(d,e,a)()},function(){b.routine.$shouldFail&&(b.failed=!b.failed);(b.hasLog=0<b.logCalls.length)||(b.failed?log.red("FAIL"):b.verbose&&log.green("PASS"));g();c();a()})})})},printLog:function(){log.write(log.color.blue,"\n"+log.boldLine,"\n"+_.nonempty([this.suite!==this.name&&this.suite.quote("[]")||"",this.name]).join(" "),(this.index+" of "+Testosterone.runningTests.length).quote("()")+(this.failed?" FAILED":"")+":","\n");this.evalLogCalls()},
