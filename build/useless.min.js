...
_.isPrototypeInstance=function(a){return a&&a.constructor&&_.isPrototypeConstructor(a.constructor)};_.isPrototypeConstructor=function(a){return a&&void 0!==a.$definition||!1};_.coerceToArray=function(a){return void 0===a?[]:_.isArray(a)?a:[a]};$overrideUnderscore("isArray",function(a){return function(b){return _.isTypeOf(Array,b)||a(b)}});
...
position:"fixed",top:0,right:0,bottom:0,left:0,zIndex:999999}).appendTo(document.body));var e=window.__globalDragOverlay,f=this.$(function(f){var g=d.relativeTo||this;if(Platform.touch||1===f.which){var m=g.offset(),l=void 0;if(!d.start||!1!==(l=d.start.call(d.context||this,new Vec2(f.pageX-m.left,f.pageY-m.top),f))){var n=void 0,p=void 0,q=void 0,l=_.clone(l),r=this.$(function(a){if(Platform.touch||1===a.which){a.preventDefault();a=b(a,this[0]);var e=g.offset();l=d.move.call(d.context||this,l,new Vec2(a.pageX-
f.pageX,a.pageY-f.pageY),new Vec2(a.pageX-e.left,a.pageY-e.top),a)||l}else n(a)}),p=function(){a(e||document.body).css(e?{display:"none"}:{}).off("mouseup touchend",q).off("mousemove touchmove",r)},q=this.$(function(a){p();d.end&&(a=b(a,this[0]),d.end.call(d.context||this,l,new Vec2(a.pageX-f.pageX,a.pageY-f.pageY),a))}),n=this.$(function(a){p();q(a)});a(e||document.body).css(e?{display:"",cursor:d.cursor||""}:{}).on("mousemove touchmove",r).one("mouseup touchend",q);d.callMoveAtStart&&d.move.call(d.context||
this,l,Vec2.zero,new Vec2(f.pageX-m.left,f.pageY-m.top),f)}}}),g=_.$(this,function(a){var e=_.extend({},b(a,this[0]));if(Platform.touch&&d.longPress){var g=void 0,l=window.setTimeout(_.$(this,function(){this.off("touchmove touchend",g);f(e)}),300),g=this.$(function(){window.clearTimeout(l);this.off("touchmove touchend",g)});this.one("touchmove touchend",g)}else f(e),a.preventDefault(),a.stopPropagation()});this.on(Platform.touch?"touchstart":"mousedown",g);d.context&&(this[0].dragContexts=this[0].dragContexts||
[]).push([d.context,g]);return this}}(),undrag:function(a){var b=this[0].dragContexts;b&&(a=_.find(b,_.takesFirst.then(_.equals(a))))&&(this.off(Platform.touch?"touchstart":"mousedown",a[1]),b.remove(a))},transform:function(a){return this.css("-webkit-transform",(a.translate?"translate("+a.translate.x+"px,"+a.translate.y+"px) ":"")+(a.rotate?"rotate("+a.rotate+"rad) ":"")+(a.scale?"scale("+a.scale.x+","+a.scale.y+")":""))},translate:function(a){return this.attr("transform","translate("+a.x+","+a.y+
")")},transformMatrix:function(a){a=a.components;return this.attr("transform","matrix("+a[0][0]+","+a[1][0]+","+a[0][1]+","+a[1][1]+","+a[0][2]+","+a[1][2]+")")},outerExtent:function(){return new Vec2(this.outerWidth(),this.outerHeight())},extent:function(){return new Vec2(this.width(),this.height())},innerExtent:function(){return new Vec2(this.innerWidth(),this.innerHeight())},outerBBox:function(){return BBox.fromLTWH(_.extend(this.offset(),this.outerExtent().asWidthHeight))},clientBBox:function(){var a=
this[0].getBoundingClientRect();return new BBox(a.left,a.top,a.width,a.height)},leftTop:function(){return new Vec2.fromLT(this.offset())},offsetInParent:function(){return Vec2.fromLeftTop(this.offset()).sub(Vec2.fromLeftTop(this.parent().offset()))},monitorInput:function(b){var d=function(){""===a.trim(a(this).val())?b.empty(!0):b.empty(!1)};return this.keyup(d).change(d).focus(_.bind(b.focus||_.noop,b,!0)).blur(_.bind(b.focus||_.noop,b,!1))},touchClick:function(a,b){var e=this;b=b||{};if(!b.disableTouch&&
Platform.touch){var f=function(b){a.apply(this,arguments);b.preventDefault();return!1},g=function(a){a.preventDefault();return!1};b.handler&&b.handler({unbind:function(){e.off("touchstart",f).off("click",g)}});return this.on("touchstart",f).on("click",g)}b.handler&&b.handler({unbind:function(){e.off("click",a)}});return this.click(a)},touchDoubleclick:function(a){if(Platform.touch){var b=Date.now();return this.on("touchend",function(){var e=Date.now();200>e-b&&a.apply(this,arguments);b=e})}return this.dblclick(a)},
nodoubletapzoom:function(){return a(this).bind("touchstart",function(b){var d=b.timeStamp,e=a(this).data("lastTouch")||d,e=d-e,f=b.originalEvent.touches.length;a(this).data("lastTouch",d);!e||500<e||1<f||(b.preventDefault(),a(b.target).trigger("click"))})}})}(jQuery);Platform.NodeJS&&(module.exports=_);
