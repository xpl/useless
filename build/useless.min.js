...
a instanceof $global[c]&&c+" "+_.stringifyOneLine(_.omitTypeMismatches(b,a))||!1}))return f;var g=_.isArray(a),f=e.pretty||!1;if("browser"===_.platform().engine){if(_.isTypeOf(Element,a))return a.tagName.lowercase.quote("<>");if(_.isTypeOf(Text,a))return"@"+a.wholeText}if(a.toJSON)return _.quoteWith('"',a.toJSON());if(!e.pure&&(d>(e.maxDepth||5)||g&&a.length>(e.maxArrayLength||30)))return g?"<array["+a.length+"]>":"<object>";var h=b.concat([a]);c.push(a);var k=_.pairs(a),l=_.stringifyImpl.tails2(h,
c,d+1,e);if(f){k=_.values(a);d=_.alignStringsRight(_.keys(a).map(_.appends(": ")));e=k.map(l);var f=e.map(function(a,b){return"["===a[0]||"{"===a[0]?3:_.isString(k[b])?1:0}),m=_.max(f);e=[f,e].zip(function(a,b){return" ".repeats(m-a)+b});d=g?e:[d,e].zip(_.bullet);d=_.bullet(g?"[ ":"{ ",d.join(",\n"));e=d.split("\n");return d+(" ".repeats(_.max(e.map(_.count))-_.count(e.last))+(g?" ]":" }"))}return _.quoteWith(g?"[]":"{  }",_.joinWith(", ",_.map(k,function(a){return(g?"":a[0]+": ")+l(a[1])})))};
...
_.extend(log,{indent:function(a){return log.config({indent:a})},stackOffset:function(a){return log.config({stackOffset:a})},color:_.extend(function(a){return(log.color[a]||{}).color},_.object(_.map([["none","0m",""],["bloody",["31m","1m"],"color:crimson;font-weight:bold"],["red","31m","color:crimson"],["darkRed",["31m","2m"],"color:crimson"],["blue","36m","color:royalblue"],["boldBlue",["36m","1m"],"color:royalblue"],["darkBlue",["36m","2m"],"color:rgba(65,105,225,0.5)"],["boldOrange",["33m","1m"],
"color:saddlebrown"],["orange","33m","color:saddlebrown"],["brown",["33m","2m"],"color:saddlebrown"],["green","32m","color:forestgreen"],["greener",["32m","1m"],"color:forestgreen;font-weight:bold"],["pink","35m","color:magenta"],["boldPink",["35m","1m"],"color:magenta"],["purple",["35m","2m"],"color:magenta"],["black","0m","color:black"],["bright",["0m","1m"],"color:rgba(0,0,0);font-weight:bold"],["dark",["0m","2m"],"color:rgba(0,0,0,0.25)"]],function(a){return[a[0],log.config({color:{shell:_.coerceToArray(_.map2(a[1],
_.prepends("\u001b["))).join(),css:a[2]}})]}))),boldLine:"======================================",line:"--------------------------------------",thinLine:"......................................",withWriteBackend:$scope(function(a,b,c,d){var e=log.writeBackend.value;log.writeBackend.value=b;c(function(b){a(function(){log.writeBackend.value=e;b&&b();d&&d()})})}),writeUsingDefaultBackend:function(){var a=arguments;log.withWriteBackend(log.impl.defaultWriteBackend,function(b){log.write.apply(null,a);b()})},
writeBackend:function(){return arguments.callee.value||log.impl.defaultWriteBackend},withConfig:function(a,b){log.impl.configStack.push(log.impl.configure([{stackOffset:-1},a]));var c=b();log.impl.configStack.pop();return c},currentConfig:function(){return log.impl.configure(log.impl.configStack)},impl:{configStack:[],numWrites:0,configure:function(a){return _.reduce2({stackOffset:0,indent:0},_.nonempty(a),function(a,c){return _.extend(a,_.nonempty(c),{indent:a.indent+(c.indent||0),stackOffset:a.stackOffset+
(c.stackOffset||0)})})},write:$restArg(function(){var a=log.writeBackend();log.impl.numWrites++;var b=_.asArray(arguments),c=log.impl.configure([{stackOffset:Platform.NodeJS?1:3,indent:a.indent||0}].concat(log.impl.configStack)),d=_.reduce2([],_.partition3(b,_.isTypeOf.$(log.Config)),function(a,b){return!0===b.label?(c=log.impl.configure([c].concat(b.items)),a):a.concat({config:c,text:log.impl.stringifyArguments(b.items,c)})}),e=d.last&&d.last.text.reversed.match(/(\n*)([^]*)/),f=e&&e[1];e&&(d.last.text=
e[2].reversed);var g={},e=_.pluck.with_("items",_.reject.with_(_.property("label"),_.partition3.with_(_.equals(g),_.scatter(d,function(a,b,c){_.each(a.text.split("\n"),function(b,d,e){c(_.extended(a,{text:b}));d!==e.lastIndex&&c(g)})})))),d=_.pluck(d,"text").join(""),h=c.where||log.impl.walkStack($callStack)||{},k=_.times(c.indent,_.constant("\t")).join("");a({lines:e,config:c,color:c.color,args:arguments,indentation:k,indentedText:e.map(_.seq(_.pluck.tails2("text"),_.joinsWith(""),_.prepends(k))).join("\n"),
text:d,codeLocation:c.location&&log.impl.location(h)||"",trailNewlines:f||"",where:c.location&&h||void 0});return _.find(b,_.not(_.isTypeOf.$(log.Config)))}),walkStack:function(a){return _.find(a.clean,function(a){return 0>a.fileShort.indexOf("base/log.js")})||a[0]},defaultWriteBackend:function(a){var b=a.codeLocation,c=a.trailNewlines;Platform.NodeJS?console.log(_.map(a.lines,function(b){return a.indentation+_.map(b,function(a){return a.config.color?a.config.color.shell+a.text+"\u001b[0m":a.text}).join("")}).join("\n"),
log.color("dark").shell+b+"\u001b[0m",c):console.log.apply(console,_.reject.with_(_.equals(void 0),[].concat(_.map(a.lines,function(b,c){return a.indentation+_.reduce2("",b,function(a,b){return a+(b.text&&(b.config.color?"%c":"")+b.text||"")})}).join("\n")+(b&&"%c "+b||""),(_.scatter(a.lines,function(a,b,c){_.each(a,function(a){a.config.color&&c(a.config.color.css)})})||[]).concat(b?"color:rgba(0,0,0,0.25)":[]),c)))},location:function(a){return _.quoteWith("()",_.nonempty([a.calleeShort,a.fileName+
":"+a.line]).join(" @ "))},stringifyArguments:function(a,b){return _.map(a,log.impl.stringify.tails2(b)).join(" ")},stringify:function(a,b){b=b||{};if(_.isTypeOf(Error,a)){var c=log.impl.stringifyError(a);return a.originalError?c+"\n\n"+log.impl.stringify(a.originalError):c}return _.isTypeOf(CallStack,a)?log.impl.stringifyCallStack(a):"object"===typeof a?_.isArray(a)&&1<a.length&&_.isObject(a[0])&&b.table?log.asTable(a):_.stringify(a,b):"string"===typeof a?a:_.stringify(a)},stringifyError:function(a){try{var b=
CallStack.fromErrorWithAsync(a).clean.offset(a.stackOffset||0);return"[EXCEPTION] "+(a.message||"").replace(/\r|\n/g,"").trimmed.first(120)+"\n\n"+(a.notMatching&&_.map(_.coerceToArray(a.notMatching||[]),log.impl.stringify.then(_.prepends("\t"))).join("\n")+"\n\n"||"")+log.impl.stringifyCallStack(b)+"\n"}catch(c){return"YO DAWG I HEARD YOU LIKE EXCEPTIONS... SO WE THREW EXCEPTION WHILE PRINTING YOUR EXCEPTION:\n\n"+c.stack+"\n\nORIGINAL EXCEPTION:\n\n"+a.stack+"\n\n"}},stringifyCallStack:function(a){return log.columns(a.map(function(a){return["\tat "+
a.calleeShort.first(30),_.nonempty([a.fileShort,":",a.line]).join(""),(a.source||"").first(80)]})).join("\n")}}});
(function(){var a=log.impl.write;_.extend(log,log.printAPI=_.object(_.concat([["newline",a.$(log.config({location:!1}),"")],["write",a]],_.flat(_.map("red failure error e;blue info i;darkBlue minor m;orange warning warn w;green success ok g;pink notice alert p;boldPink pp;dark hint d;greener gg;bright b;bloody bad ee;purple dp;brown br;boldOrange ww;darkRed er;boldBlue ii".split(";"),_.splitsWith(" ").then(_.mapsWith(function(b,c,d){return[b,a.$(log.config({location:0!==c,color:log.color(d.first),
