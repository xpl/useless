...
[];return this},destroyAll:function(){_.each(this.children_,function(a){a.parent_=void 0;a.destroy()});this.children_=[];return this}});TimeoutError=$extends(Error,{message:"timeout expired"});__=Promise.coerce=function(a){var b=this,c=_.rest(arguments);return a instanceof Promise?a:a instanceof Function?new Promise(function(d){d(a.apply(b,c))}):Promise.resolve(a)};__.noop=function(){return Promise.resolve()};__.identity=function(a){return Promise.resolve(a)};__.constant=function(a){return function(){return Promise.resolve(a)}};
__.reject=function(a){return Promise.reject(a)};__.rejects=function(a){return function(){return Promise.reject(a)}};__.scatter=function(a,b){return __.then(a,function(a){if(_.isStrictlyObject(a)){var d=_.coerceToEmpty(a),e=[];_.each2(a,function(f,g){e.push(__(b,f,g,a).then(function(a){a instanceof Array?d[a.second]=a.first:void 0!==a&&(d instanceof Array?d.push(a):d[g]=a)}))});return __.all(e).then(_.constant(d))}return __(b,a,void 0,a).then(function(a){return a instanceof Array?a.first:a})})};
__.map=function(a,b){return __.scatter(a,__.$(b))};__.filter=function(a,b){return __.scatter(a,function(a,d,e){return __(b,a,d,e).then(function(b){return!1===b?void 0:!0===b?a:b})})};__.each=function(a,b){return __.then(a,function(a){return new Promise(function(d,e){_.cps.each(a,function(a,c,d){__(b(a,c)).then(d)["catch"](e)},d)})})};__.then=function(a,b){return __(a).then(_.coerceToFunction(b))};__.seq=function(a){return __(_.reduce2(a,__.then))};__.all=function(a){return Promise.all(a)};
