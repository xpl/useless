...
_.stringifyPrototype=function(a){if(Platform.NodeJS){var b="";a.$meta(function(a){b=a.name});return b&&b+" ()"}return"<prototype>"};
...
e,f,a)||b)})});return b}},evalPrototypeSpecificMacros:function(a){return function(b){if(!b.isTraitOf){var c=$untag(b.$macroTags||a&&a.$macroTags);c&&_.each(b,function(a,e){_.each(c,function(c,g){a=b[e];g in a&&(b[e]=c(b,a,e)||a)})})}return b}},generateCustomCompilerImpl:function(a){return function(b){b.$impl?(b.$impl.__proto__=a&&a.$impl||this,b.$impl=$static($builtin($property(b.$impl)))):a&&a.$impl&&(b.$impl=$static($builtin($property(a.$impl))));return b}},generateArgumentContractsIfNeeded:function(a){return a.$testArguments?
$prototype.wrapMethods(a,function(a,c){return function(){var d=_.asArray(arguments);$assertArguments(d.copy,a.original,c);return a.apply(this,d)}}):a},contributeTraits:function(a){return function(b){if(b.$traits){var c=b.$traits;this.mergeTraitsMembers(b,c,a);b.$traits=$static($builtin($property(c)));b.hasTrait=$static($builtin(function(a){return 0<=c.indexOf(a)}))}return b}},mergeTraitsMembers:function(a,b,c){_.each(b,function(b){_.defaults(a,_.omit(b.$definition,_.or($builtin.matches,_.key(_.equals("constructor")))))})},
extendWithTags:function(a){return _.extendWith(Tags.unwrap(a),_.mapObject(Tags.get(a),$static.arity1))},callStaticConstructor:function(a){a.isTraitOf||(_.each($untag(a.$traits),function(b){b.$definition.$constructor&&$untag(b.$definition.$constructor).call(a)}),a.$constructor&&$untag(a.$constructor).call(a));return a},generateConstructor:function(a){return function(b){return _.extend(b,{constructor:Tags.modify(b.hasOwnProperty("constructor")?b.constructor:this.defaultConstructor(a),function(b){a&&
(b.prototype.__proto__=a.prototype);return b})})}},generateBuiltInMembers:function(a){return function(b){b.$constructor&&(b.$constructor=$builtin($static(b.$constructor)));return _.defaults(b,{$base:$builtin($static($property(_.constant(a&&a.prototype)))),$definition:$builtin($static($property(_.constant(_.extend({},a&&a.$definition,b))))),isTypeOf:$builtin($static(_.partial(_.isTypeOf,Tags.unwrap(b.constructor)))),isInstanceOf:$builtin(function(a){return _.isTypeOf(a,this)}),$:$builtin(function(a){return _.$.apply(null,
...
log.writeBackend(),b=_.asArray(arguments),c=log.cleanArgs(b),d=log.impl.configure(_.concat([{stackOffset:Platform.NodeJS?1:3}],log.impl.configStack,_.filter(b,log.Config.isTypeOf))),e=(a.indent||0)+(d.indent||0),f=log.impl.stringifyArguments(c,d),e=_.times(e,_.constant("\t")).join(""),f=f.reversed.match(/(\n*)([^]*)/),g=d.location&&log.impl.location(d.where||$callStack[d.stackOffset]||{})||"",b={color:d.color||log.readColor(b),indentation:e,indentedText:f[2].reversed.split("\n").map(_.prepends(e)).join("\n"),
trailNewlines:f[1],codeLocation:g,args:b,config:d};a(b);return c[0]}),defaultWriteBackend:function(a){var b=a.color,c=a.indentedText,d=a.codeLocation;a=a.trailNewlines;b=b&&(Platform.NodeJS?b.shell:b.css);Platform.NodeJS?b?console.log(b+c+"\u001b[0m",d,a):console.log(c,d,a):(c=c.split("\n"),c=[_.first(c)||""].concat(_.rest(c).map(_.prepends(" "))),console.log((b?"%c":"")+c.join("\n"),b?"color: "+b:"",d,a))},location:function(a){return _.quoteWith("()",_.nonempty([a.calleeShort,a.fileName+":"+a.line]).join(" @ "))},
...
Testosterone.LogsMethodCalls=$trait({$test:function(){var a=new ($prototype({$traits:[Testosterone.LogsMethodCalls],foo:$log(function(a){$assert(a,42);return 24})}));$assert(a.foo(42),24)},$macroTags:{$log:function(a,b,c){var d=_.isBoolean(b.$log)?void 0:log.color[b.$log];return Tags.modify(b,function(a){return function(){var b=this,g=arguments;log(c+_.map(arguments,_.stringifyOneLine).join(", ").quote(" ()"),log.config({stackOffset:2,location:!0}));return log.withConfig({indent:1,color:d},function(){var c=
a.apply(b,g);void 0!==c&&log("\u2192",_.stringifyOneLine(c),log.config({color:d}));2>log.currentConfig().indent&&log.newline();return c})}})}}});Platform.NodeJS&&(module.exports=Testosterone);_.measure=function(a,b){if(b){var c=_.now();a(function(){b(_.now()-c)})}else return c=_.now(),a(),_.now()-c};
...
log.withWriteBackend(this.$(function(b){_.isTypeOf(Error,b.args.first)&&console.log(b.args.first);c.append(_.isTypeOf(Error,b.args.first)?a("<div>").css({color:b.color.css,display:"inline-block"}).append([b.indentation,a('<div class="inline-exception">').append(this.printError(b.args.first))]):a("<div>").css({color:b.color.css}).append([_.escape(b.indentedText)+(b.codeLocation&&' <span class="location">'+_.escape(b.codeLocation)+"</span>"||"")+(b.trailNewlines||"").replace(/\n/g,"<br>")]))}),function(a){b.evalLogCalls();
...
a('<div class="not-matching" style="margin-top: 5px; padding-left: 10px;">').append(_.map(_.coerceToArray(b.notMatching||[]),function(b){return a("<pre>").text(log.impl.stringify(b))})),a('<ul class="callstack">').append(_.map(c,this.$(function(b){var c=a('<li class="callstack-entry">').toggleClass("third-party",b.thirdParty).toggleClass("native",b["native"]).append([a('<span class="file">').text(_.nonempty([b.index?"(index)":b.fileShort,b.line]).join(":")),a('<span class="callee">').text(b.calleeShort),
a('<span class="src i-am-busy">').click(this.$(function(f){var g=a(f.delegateTarget);g.waitUntil(_.readSource.partial((b.remote?"api/source/":"")+b.file),this.$(function(f){c.is(".full")?(c.removeClass("full"),c.transitionend(function(){c.is(".full")||b.sourceReady(g.$(a.fn.text))})):(c.addClass("full"),g.html(_.map(f.split("\n"),function(b){return a('<div class="line">').text(b)})),f=g.find(".line").eq(b.line-1).addClass("hili"),f.length&&(f=f.offset().top-g.offset().top,g.scrollTop(f-100)),_.delay(this.$(function(){var a=
g.outerBBox().bottom+242-this.modalBody.outerBBox().bottom;0<a&&this.modalBody.animate({scrollTop:this.modalBody.scrollTop()+a},250)})))}))}))]);b.sourceReady(function(a){c.find(".src").removeClass("i-am-busy").text(a)});return c})))]}});a.fn.extend({enableScrollFaders:function(b){var c=b&&b.horizontal,d,e;b=this.find(b&&b.scroller||".scroller");this.css({position:"relative"});this.append(d=a('<div class="scroll-fader scroll-fader-'+(c?"left":"top")+'"></div>')).append(e=a('<div class="scroll-fader scroll-fader-'+
(c?"right":"bottom")+'"></div>'));b.scroll(function(){var b=c?a(this).scrollLeft():a(this).scrollTop(),g=c?a(this).width():a(this).height(),h=(c?this.scrollWidth:this.scrollHeight)-1;d.css({opacity:0<b?1:0});e.css({opacity:b+g<h?1:0})}).scroll();return this}})})(jQuery);
