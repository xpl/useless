...
_.defineTagKeyword("observableProperty",function(a){return function(b,c){return _.isFunction(b)&&1===arguments.length?a(b,c):a(c,b)}});_.defineKeyword("observableRef",function(a){return $observableProperty($reference(a))});$prototype.macro("$depends",function(a,b,c){a.$depends=$builtin($const(_.coerceToArray(b)));return a});$prototype.macroTag("extendable",function(a,b,c){a[c]=$builtin($const(b));return a});
