...
this.constructor.$definition[c];if(!d||!d.$property){var e=this[c];b(d)&&_.isFunction(e)&&!_.isPrototypeConstructor(e)&&a.call(this,e,c)}}},constructor:$final(function(a,b){var c=this.cfg="object"===typeof a?a:{},d=this.constructor.$definition;this.constructor.$defaults&&_.extend(this,_.cloneDeep(this.constructor.$defaults));_.onBefore(this,"destroy",this.beforeDestroy);_.onAfter(this,"destroy",this.afterDestroy);_.extend(this,{parent_:void 0,children_:[]},_.omit(_.omit(c,"init","attachTo","attach"),
