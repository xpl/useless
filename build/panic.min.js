...
delayed:function(a,b){return function(){var c=arguments,d=this;_.delay(function(){a.apply(d,c)},b)}}});_.tests.Function.catches=function(){$assert("yo",_.constant("yo").catches($fails)(),_.identity.catches($fails)("yo"),_.throwsError("xx").catches("yo")());$assertMatches(_.throwError.catches()("yo"),{message:"yo"});$assert(_.catches(_.throwsError(42),$assertMatches.$({message:42}).returns("yo"))(),"yo");$assertCPS(_.constant("yo").catches($fails),"yo")};
$extensionMethods(Function,{catch_:function(a,b,c){return a.catches(b,c)()},catches:function(a,b,c){b=1<arguments.length?_.coerceToFunction(b):_.identity;c=2<arguments.length?_.coerceToFunction(c):_.identity;return function(){var d=void 0;try{d=a.apply(this,arguments)}catch(e){d=b(e)}return c(d)}}});
$extensionMethods(Array,{each:_.each,map:_.map,reduce:_.reduce,reduceRight:_.reduceRight,zip:_.zipWith,groupBy:_.groupBy,filter:_.filter,flat:_.flatten.tails2(!0),object:_.object,contains:function(a,b){return 0<=a.indexOf(b)},top:function(a){return a[a.length-1]},first:function(a){return a[0]},last:function(a){return a[a.length-1]},take:function(a,b){return a.slice(0,b)},before:function(a,b){var c=a.indexOf(b);return 0>c?a:a.slice(0,c-1)},after:function(a,b){var c=a.indexOf(b);return 0>c?a:a.slice(c+
1)},isEmpty:function(a){return 0===a.length},notEmpty:function(a){return 0<a.length},lastIndex:function(a){return a.length-1},random:function(a){return a[_.random(0,a.lastIndex)]},copy:function(a){return a.slice(0)},removeAll:$method(function(a){return a.splice(0,a.length),a}),remove:function(a,b){for(var c;-1!==(c=a.indexOf(b));)a.splice(c,1);return a},removeAt:function(a,b){a.splice(b,1);return a},insertAt:function(a,b,c){a.splice(c,0,b);return a},itemAtWrappedIndex:function(a,b){return a[b%a.length]},
reversed:function(a){return a.slice().reverse()},swap:$method(function(a,b,c){var d=a[b];a[b]=a[c];a[c]=d;return a})});_.zap=function(a){var b=_.last(arguments);return _.reduce(_.rest(_.initial(arguments)),function(a,d){return _.times(Math.max(a.length,d.length),function(e){return b(a[e],d[e])})},a)};
