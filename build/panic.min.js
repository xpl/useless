...
},defineAssertions:function(a){_.each(a,function(a,c){this.defineAssertion(c,a)},this)},runTest:function(a,b,c){var d=this.runConfig;d.testStarted(a);a.verbose=d.verbose;a.timeout=d.timeout;a.startTime=Date.now();a.run(function(){d.testComplete(a);a.time=Date.now()-a.startTime;c()})},collectTests:function(){return _.map(_.tests,this.$(function(a,b){return this.testSuite(b,a)}))},collectPrototypeTests:function(a){_.cps.map(this.prototypeTests,this.$(function(a,c){a.readPrototypeMeta(this.$(function(d){c(this.testSuite(d.name,
