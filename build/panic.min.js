...
__.reject=function(a){return Promise.reject(a)};__.rejects=function(a){return function(){return Promise.reject(a)}};__.map=function(a,b){return __(a).then(function(a){if(_.isStrictlyObject(a)){var d=_.coerceToEmpty(a),e=[];_.each2(a,function(a,c){e.push(__.identity(b(a,c)).then(function(a){d[c]=a}))});return __.all(e).then(_.constant(d))}return b(a)})};__.then=function(a,b){return __(a).then(_.coerceToFunction(b))};__.seq=function(a){return __(_.reduce2(a,__.then))};__.all=function(a){return Promise.all(a)};
