...
_.defineGlobalProperty("alert2",function(a){alert(_.map(arguments,_.stringify).join(", "));return arguments[0]});_.extend(_,{asArray:function(a){return[].slice.call(a,0)}});
...
(function(){var a=["onceBefore","onceAfter","onBefore","onAfter","intercept"],b=function(b){if("function"!==typeof b)throw Error("method should be a function");return _.extend({},b,{_bindable:!0,impl:b,_wrapped:b},_.object(_.map(a,function(a){var b="_"+a,c=0<=a.indexOf("once");return[a,function(a){if(!_.isBindable(this))throw Error("wrong this");var d=this[b];(!c||0>d.indexOf(a))&&this[b].push(a);return this}]})),_.object(_.map(a,function(a){return["_"+a,[]]})))};_.extend(_,_.mapObject(_.invert(a),
function(a){return function(b,e,g){var f=b[e];b=_.isBindable(f)?f:b[e]=_.bindable(f);return b[a].call(b,g)}}.flip2),{unbind:function(b,d,e){var g=b[d];_.isBindable(g)&&_.each(a,function(a){g["_"+a]=_.without(g["_"+a],e)})},isBindable:function(a){return a&&a._bindable?!0:!1},bindable:_.extendWith({hooks:a,hooksShort:["onceBefore","onceAfter","before","after",""]},function(a,d){return _.withSameArgs(a,_.extendWith(b(a),function(){var b=arguments.callee,g=b._onceBefore,f=b._onceAfter,h=b._onBefore,k=
b._onAfter,m=b._intercept,b=d||this,l,n=void 0;if(g.length){l=0;for(n=g.length;l<n;l++)g[l].apply(b,arguments);g.removeAll()}l=0;for(n=h.length;l<n;l++)h[l].apply(b,arguments);g=(m.length?_.cps.compose([a].concat(m)):a).apply(b,arguments);if(k.length||f.length){h=_.asArray(arguments).concat(g);l=0;for(n=k.length;l<n;l++)k[l].apply(b,h);if(f.length){l=0;for(n=f.length;l<n;l++)f[l].apply(b,h);f.removeAll()}}return g}))})})})();
...
$extends=function(a,b){return $prototype(a,b||{})};
