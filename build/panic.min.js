...
_.cons=function(a,b){return[a].concat(b||[])};_.atIndex=function(a){return function(b){return b[a]}};_.takesFirst=_.higherOrder(_.first);_.takesLast=_.higherOrder(_.last);_.applies=function(a,b,c){return function(){return a.apply(b,c)}};_.prepends=function(a){return function(b){return a+b}};_.appends=function(a){return function(b){return b+a}};_.join=function(a,b){return a.join(b)};_.joinWith=_.flip2(_.join);_.joinsWith=_.higherOrder(_.joinWith);_.split=function(a,b){return a.split(b)};
...
_.isTypeOf_ES4=function(a,b){for(;b;){if(b.constructor===a)return!0;b=b.constructor.$base}return!1};_.isTypeOf_ES5=function(a,b){return b instanceof a};_.isTypeOf=_.isInstanceofSyntaxAvailable()?_.isTypeOf_ES5:_.isTypeOf_ES4;_.isPrototypeInstance=function(a){return a&&a.constructor&&_.isPrototypeConstructor(a.constructor)};_.isPrototypeConstructor=function(a){return a&&void 0!==a.$definition||!1};_.coerceToNaN=function(a){return _.isFinite(a)?a:Number.NaN};
_.coerceToArray=function(a){return void 0===a?[]:_.isArray(a)?a:[a]};_.coerceToFunction=function(a){return _.isFunction(a)?a:_.constant(a)};$overrideUnderscore("isArray",function(a){return function(b){return _.isTypeOf(Array,b)||a(b)}});
...
_.mixin({map2:function(a,b,c){return _.isArray(a)?_.map(a,b,c):_.isStrictlyObject(a)?_.mapObject(a,b,c):b.call(c,a)}});_.mapsWith=_.higherOrder(_.mapWith=_.flip2(_.map2));_.mixin({scatter:function(a,b){var c=void 0;_.map2(a,function(a,e){b(a,e,function(a,b){2>arguments.length?(c=c||[]).push(a):(c=c||{})[b]=a})});return c}});_.obj=function(a){var b=void 0;a(function(a,d){(b=b||{})[d]=a});return b};
_.arr=function(a){var b=void 0;a(function(a){(b=b||[]).push(2>arguments.length?a:_.asArray(arguments))});return b};_.mapKeys=function(a,b){return _.isArray(a)?_.map(a,_.tails2(_.mapKeys,b)):_.isStrictlyObject(a)?_.object(_.map(_.pairs(a),function(a){return[b(a[0]),_.mapKeys(a[1],b)]})):a};_.mixin({mapMap:_.hyperOperator(_.unary,_.map2)});
...
_.linearMerge=function(a,b){b=b||{key:_.identity};var c={key:null,next:{}},d={};_.each(a,function(a){for(var e=0,f=a.length,g=c,m=void 0;e<f;e++,g=m){var m=a[e],p=b.key(m),m=d[p]||(d[p]={key:p,item:m,next:{}});g&&(g.next[p]=m)}});var e=function(a,b){a[b.key]=!0;b.next=_.chain(_.values(b.next)).filter(function(b){return!(b.key in a)}).map(_.partial(e,a)).value();delete a[b.key];return b},f=function(a,b){return a===b||_.some(a.next,function(a){return f(a,b)})},g=function(a){if(!a)return[];var c=b.sort?
...
{}},each:function(a,b){_.isTypeOf(Tags,a)&&_.each(a,function(a,d){"$"===d[0]&&b(d.slice(1))})},hasSubject:function(a){return _.isTypeOf(Tags,a)&&"subject"in a},matches:function(a){return function(b){return b&&void 0!==b[_.keyword(a)]}},unwrapAll:function(a){return _.map2(a,Tags.unwrap)},unwrap:function(a){return _.isTypeOf(Tags,a)?a.subject:a},wrap:function(a){return _.isTypeOf(Tags,a)?a:0===arguments.length?new Tags:new Tags(a)},modify:function(a,b){return _.isTypeOf(Tags,a)?a.clone().modify(b):
b(a)},map:function(a,b){return Tags.modify(a,function(a){return _.map2(a,function(a,c){return Tags.modify(a,function(f){return b(f,c,_.isTypeOf(Tags,a)?a:void 0)})})})},add:function(a,b,c){return Tags.wrap.apply(null,_.rest(arguments,1)).add(a,c)}});_.keyword=function(a){return"$"+a};_.isKeyword=function(a){return"$"==a[0]};_.keywordName=function(a){return _.isKeyword(a)?a.slice(1):a};_.keywords=function(a){return _.pick(a,_.keyIsKeyword)};_.tagKeywords={};
_.isTagKeyword=function(a){return _.keywordName(a)in _.tagKeywords};_.keyIsKeyword=function(a,b){return _.isKeyword(b[0])};_.defineKeyword=function(a,b){_.defineProperty(_.global(),_.keyword(a),b)};_.defineKeyword("global",_.global);_.defineKeyword("platform",_.platform);_.defineKeyword("untag",Tags.unwrap);
...
_.stringifyPrototype=function(a){if(Platform.NodeJS&&a.$meta){var b="";a.$meta(function(a){b=a.name});return b&&b+" ()"}return"<prototype>"};_.builtInTypes={Event:{target:$any},MutationEvent:{target:$any,attrName:$any,prevValue:$any},Range:{startContainer:$any,startOffset:$any,endContainer:$any,endOffset:$any}};
...
a instanceof $global[c]&&c+" "+_.stringifyOneLine(_.omitTypeMismatches(b,a))||!1}))return f;var g=_.isArray(a),f=e.pretty||!1;if("browser"===_.platform().engine){if(_.isTypeOf(Element,a))return(a.tagName.lowercase+(a.id&&"#"+a.id||"")+(a.className&&"."+a.className||"")).quote("<>");if(_.isTypeOf(Text,a))return"@"+a.wholeText}if(a.toJSON)return _.quoteWith('"',a.toJSON());if(!e.pure&&(d>(e.maxDepth||5)||g&&a.length>(e.maxArrayLength||30)))return g?"<array["+a.length+"]>":"<object>";var h=b.concat([a]);
c.push(a);var k=_.pairs(a),l=_.stringifyImpl.tails2(h,c,d+1,e);if(f){k=_.values(a);d=_.alignStringsRight(_.keys(a).map(_.appends(": ")));e=k.map(l);var f=e.map(function(a,b){return"["===a[0]||"{"===a[0]?3:_.isString(k[b])?1:0}),n=_.max(f);e=[f,e].zip(function(a,b){return" ".repeats(n-a)+b});d=g?e:[d,e].zip(_.bullet);d=_.bullet(g?"[ ":"{ ",d.join(",\n"));e=d.split("\n");return d+(" ".repeats(_.max(e.map(_.count))-_.count(e.last))+(g?" ]":" }"))}return _.quoteWith(g?"[]":"{  }",_.joinWith(", ",_.map(k,
function(a){return(g?"":a[0]+": ")+l(a[1])})))};_.toFixed=function(a,b){return a&&a.toFixed&&a.toFixed(b)||void 0};_.toFixed2=function(a){return _.toFixed(a,2)};_.toFixed3=function(a){return _.toFixed(a,3)};_.cps=function(){return _.cps.sequence.apply(null,arguments)};_.cps.apply=function(a,b,c,d){c=_.asArray(c);var e=_.numArgs(a)-1,f=c[e];c[e]=function(){d.call(this,arguments,f)};return a.apply(b,c)};
_.extend(_.cps,{each:function(a,b,c,d,e,f){var g=arguments.callee,h=d||0,k=0===h?void 0===a.length?_.keys(a):void 0:f,l=0===h?k?k.length:a.length:e,n=2!==_.numArgs(b);if(!a||h>=(l||0))c&&c();else{var m=k?k[h]:h,p=function(){g(a,b,c,h+1,l,k)};n?b(a[m],m,p,c,a):b(a[m],p,c,a)}}});_.extend(_.cps,{map:function(a,b,c){var d=_.isArray(a)?[]:{};_.cps.each(a,2==_.numArgs(b)?function(a,c,g){b(a,function(a){d[c]=a;g()})}:function(a,c,g){b(a,c,function(a){d[c]=a;g()})},function(){c(d)})}});
...
(b.off(arguments.callee),d.apply(this,arguments))})}})},barrier:function(a){var b=void 0;_.isFunction(a)&&(b=a,a=void 0);var c=_.stream({already:void 0!==a,value:a,reset:function(){c.already=!1;delete c.value},write:function(a){return function(b){c.already||(c.already=!0,c.value=b);a.call(this,!0,c.value)}},read:function(a){return function(b){c.already?b.call(this,c.value):a.call(this,b)}}});b&&c(b);return c},triggerOnce:$restArg(function(){var a=_.stream({read:function(b){return function(c){0>a.queue.indexOf(c)&&
b.call(this,c)}},write:function(a){return a.partial(!0)}}).apply(this,arguments);return a}),trigger:$restArg(function(){return _.stream({read:_.identity,write:function(a){return a.partial(!1)}}).apply(this,arguments)}),off:function(a,b){a.queue&&(1===arguments.length?a.queue.off():a.queue.off(b));a.queuedBy&&(_.each(a.queuedBy,function(b){b.remove(a)}),delete a.queuedBy)},stream:function(a){a=a||{};var b=_.extend([],{off:function(a){this.length&&(0===arguments.length?(_.each(this,function(a){a.queuedBy.remove(this)},
...
applyMacroTags:function(a,b){_.each(b,function(c,d){_.each(a,function(a,f){c=b[d];_.keyword(f)in c&&(b[d]=a.call(b,b,c,d)||c)})});return b},generateCustomCompilerImpl:function(a){return function(b){b.$impl?(b.$impl.__proto__=a&&a.$impl||this,b.$impl=$static($builtin($property(b.$impl)))):a&&a.$impl&&(b.$impl=$static($builtin($property(a.$impl))));return b}},generateArgumentContractsIfNeeded:function(a){return a.$testArguments?$prototype.wrapMethods(a,function(a,c){return function(){var d=_.asArray(arguments);
$assertArguments(d.copy,a.original,c);return a.apply(this,d)}}):a},contributeTraits:function(a){return function(b){if(b.$traits){var c=b.$traits;this.mergeTraitsMembers(b,c,a);b.$traits=$static($builtin($property(c)));b.hasTrait=$static($builtin(function(a){return 0<=c.indexOf(a)}))}return b}},mergeTraitsMembers:function(a,b,c){_.each(b,function(b){_.defaults(a,_.omit(b.$definition,_.or($builtin.matches,_.key(_.equals("constructor")))))})},extendWithTags:function(a){return _.extendWith(Tags.unwrap(a),
_.mapObject(Tags.get(a),$static.arity1))},callStaticConstructor:function(a){a.isTraitOf||(_.each($untag(a.$traits),function(b){b.$definition.$constructor&&$untag(b.$definition.$constructor).call(a)}),a.$constructor&&$untag(a.$constructor).call(a));return a},generateConstructor:function(a){return function(b){return _.extend(b,{constructor:Tags.modify(b.hasOwnProperty("constructor")?b.constructor:this.defaultConstructor(a),function(b){a&&(b.prototype.__proto__=a.prototype);return b})})}},generateBuiltInMembers:function(a){return function(b){b.$constructor&&
(b.$constructor=$builtin($static(b.$constructor)));return _.defaults(b,{$base:$builtin($static($property(_.constant(a&&a.prototype)))),$definition:$builtin($static($property(_.constant(_.extend({},a&&a.$definition,b))))),isTypeOf:$builtin($static(_.partial(_.isTypeOf,Tags.unwrap(b.constructor)))),isInstanceOf:$builtin(function(a){return _.isTypeOf(a,this)}),$:$builtin($prototype.impl.$)})}},$:function(a){return _.$.apply(null,[this].concat(_.asArray(arguments)))},defaultConstructor:function(a){return a?
function(){a.prototype.constructor.apply(this,arguments)}:function(a){_.extend(this,a||{})}},defineStaticMembers:function(a){this.defineMembers(Tags.unwrap(a.constructor),_.pick(a,$static.matches));return a},defineInstanceMembers:function(a){this.defineMembers(Tags.unwrap(a.constructor).prototype,_.omit(a,$static.matches));return a},defineMembers:function(a,b){_.each(b,function(c,d){"constructor"!==d&&b.hasOwnProperty(d)&&this.defineMember(a,c,d)},this)},defineMember:function(a,b,c){b&&b.$property?
b.$memoized?_.defineMemoizedProperty(a,c,b):_.defineProperty(a,c,b):(b=Tags.unwrap(b),a[c]=b)},ensureFinalContracts:function(a){return function(b){if(a){if(a.$final)throw Error("Cannot derive from $final-marked prototype");if(a.$definition){var c=_.intersection(_.keys(_.pick(a.$definition,$final.matches)),_.keys(b));if(c.length)throw Error("Cannot override $final "+c.join(", "));}}return b}},expandAliases:function(a){return _.mapObject(a,function(b){var c=Tags.unwrap(b);return $alias.is(b)?$property.is(b)?
$property({get:function(){return this[c]},set:function(a){this[c]=a}}):a[c]:b})},groupMembersByTagForFastEnumeration:function(a){var b={};_.each(a,function(a,d){Tags.each(a,function(e){(b[e]=b[e]||{})[d]=a})});a.$membersByTag=$static($builtin($property(b)));return a},isTagKeywordGroup:function(a,b){var c=Tags.unwrap(a);return _.isKeyword(b)&&_.isFunction($global[b])&&"object"===typeof c&&!_.isArray(c)},wrapMemberFunction:function(a,b){return $property.is(a)&&Tags.modify(a,function(a){return _.extend(a,
...
this.callStaticConstructor,this.expandAliases,this.groupMembersByTagForFastEnumeration,this.defineStaticMembers,this.defineInstanceMembers)},expandTraitsDependencies:function(a){if(a.$depends){var b=[],c=0,d=function(a,f){f.__tempId||(f.__tempId=c++);_.reduce2(a,function(a,c){b.push([c,a]);return c});_.each(a,function(a){b.push([f,a]);d(a.$depends||[],a)})};d($untag(a.$depends),{});_.each(a.$traits=_.reversed(_.rest(_.linearMerge(b,{key:_.property("__tempId")}))),function(a){delete a.__tempId})}return a},
mergeExtendables:function(a){return function(b){_.each(a.$definition,function(a,d){a&&a.$extendable&&(b[d]=Tags.modify(a,function(a){a=_.extendedDeep(a,$untag(b[d]||{}));_.each($untag(b.$traits),function(c){if(!c)throw log.e(b.$traits),Error("invalid $traits value");(c=c.$definition[d])&&(a=_.extendedDeep($untag(c),a))});return a}))});return b}},mergeTraitsMembers:function(a,b){var c={},d={},e={},f=$untag(a.$macroTags),g=_.pluck(b,"$definition").concat(_.clone(a));_.each(g,function(b){_.each(f&&this.applyMacroTags(f,
_.extend(_.clone(b),{constructor:a.constructor}))||b,function(b,g){$builtin.isNot(b)&&$builtin.isNot(a[g])&&"constructor"!==g&&($bindable.is(b)&&(d[g]=b),Component.isStreamDefinition(b)&&(e[g]=b),(c[g]||(c[g]=[])).push(b),a[g]=b)})},this);a.__bindables=d;a.__streams=e;a.__membersByName=c},mergeStreams:function(a){var b=a.__membersByName;_.each(a.__streams,function(c,d){var e=a[d]=Tags.clone(c);e.listeners=[];_.each(b[d],function(a){a!==c&&e.listeners.push($untag(a))})});return a},mergeBindables:function(a){var b=
a.__membersByName;_.each(a.__bindables,function(c,d){var e=_.filter2(_.bindable.hooks,function(a,c){var e=b[_.bindable.hooksShort[c]+d.capitalized];return e?[a,e]:!1});if(e.length){var f={};_.each(e,function(a){_.each(a[1],function(b){b=$untag(b);if(_.isFunction(b)){var c="_"+a[0];(f[c]||(f[c]=[])).push(b)}})});a[d]=$bindable({hooks:f},Tags.clone(a[d]))}});return a}},isStreamDefinition:$static(function(a){return _.isObject(a)&&(a.$trigger||a.$triggerOnce||a.$barrier||a.$observable||a.$observableProperty)}),
mapMethods:function(){var a=_.last(arguments),b=1===arguments.length?_.constant(!0):arguments[0],c;for(c in this){var d=this.constructor.$definition[c];if(!d||!d.$property){var e=this[c];_.isFunction(e)&&!_.isPrototypeConstructor(e)&&b(d)&&(this[c]=a.call(this,e,c,d)||e)}}},enumMethods:function(a,b){2===arguments.length?this.mapMethods(a,b.returns(void 0)):this.mapMethods(a.returns(void 0))},constructor:$final(function(a,b){this.parent_=void 0;this.children_=[];var c=this.cfg="object"===typeof a?
a:{},d=this.constructor.$definition;this.constructor.$defaults&&(c=this.cfg=_.extend(_.cloneDeep(this.constructor.$defaults),c));this.mapMethods(function(a,b){if("$"!==b&&"init"!==b)return this.$(a)});_.onBefore(this,"destroy",this.beforeDestroy);_.onAfter(this,"destroy",this.afterDestroy);var e=[],f={init:!0};_.each(d,function(a,b){if(void 0!==a){if(a.$observableProperty){var d=a.subject,l=b in c?c[b]:d,n=b+"Change",m=f[n]=this[n]=_.observable();m.context=this;m.postpones=a.$postpones;if(_.isPrototypeInstance(d)){var p=
d.constructor;m.beforeWrite=function(a){return p.isTypeOf(a)?a:new p(a)}}a.$reference&&(m.trackReference=!0);_.defineProperty(this,b,{get:function(){return m.value},set:function(a){m.call(this,a)}});a.listeners&&_.each(a.listeners,function(a){e.push([m,a])});_.isFunction(a.$observableProperty)&&e.push([m,a.$observableProperty]);void 0!==l&&m(l)}else if(Component.isStreamDefinition(a)){var q=f[b]=this[b]=_.extend((a.$trigger?_.trigger:a.$triggerOnce?_.triggerOnce:a.$observable?_.observable:a.$barrier?
_.barrier:void 0)(a.subject),{context:this,postpones:a.$postpones});a.listeners&&_.each(a.listeners,function(a){e.push([q,a])});(d=c[b])&&e.push([q,d])}a.$listener&&(this[b].queuedBy=[]);a.$interlocked&&(this[b]=_.interlocked(this[b]));a.$bindable&&(this[b]=_.extend(_.bindable(this[b],this),_.map2(a.$bindable.hooks||{},_.mapsWith(this.$.bind(this).arity1))));a.$debounce&&(d=this[b],l=_.coerceToObject(a.$debounce),this[b]=d.debounced(l.wait||500,l.immediate));a.$throttle&&(d=this[b],l=_.coerceToObject(a.$throttle),
this[b]=_.throttle(d,l.wait||500,l));a.$memoize?this[b]=_.memoize(this[b]):a.$memoizeCPS&&(this[b]=_.cps.memoize(this[b]))}},this);_.intercept(this,"init",function(a){(_.hasArgs(this.constructor.prototype.init)?_.cps.sequence:_.sequence)([this._beforeInit,a.bind(this),this._afterInit]).call(this)});_.each(c,function(a,b){b in f||(this[b]=_.isFunction(a)?this.$(a):a)},this);_.each(d,function(a,b){a&&a.$alias&&(this[b]=this[Tags.unwrap(a)])},this);_.hasAsserts&&_.each(this.constructor.$requires,function(a,
b){$assertTypeMatches(_.object([[b,this[b]]]),_.object([[b,a]]))},this);_.each(e,function(a){a[0].call(this,a[1])},this);!1===c.init||this.constructor.$defaults&&!1===this.constructor.$defaults.init||this.init()}),callTraitsMethod:function(a,b){_.isFunction(b)?_.cps.sequence(_.filter2(this.constructor.$traits||[],this.$(function(b){return(b=b.prototype[a])&&_.cps.arity0(_.noArgs(b)?b.asContinuation:b).bind(this)||!1})).concat(b.arity0))():_.sequence(_.filter2(this.constructor.$traits||[],this.$(function(b){return(b=
b.prototype[a])&&(_.hasArgs(b)?b.bind(this,_.identity):b.bind(this))||!1})))()},_beforeInit:function(a){if(this.initialized.already)throw Error("Component: I am already initialized. Probably you're doing it wrong.");this.callTraitsMethod("beforeInit",a)},init:function(){},_afterInit:function(a){var b=this.cfg;this.callTraitsMethod("afterInit",a);this.initialized(!0);_.each(this.constructor.$definition,function(a,d){if(a&&a.$observableProperty){d+="Change";var e=b[d];if(e)this[d](e)}},this)},initialized:$barrier(),
beforeDestroy:function(){if(this.destroyed_)throw Error("Component: I am already destroyed. Probably you're doing it wrong.");if(this.destroying_)throw Error("Component: Recursive destroy() call detected. Probably you're doing it wrong.");this.destroying_=!0;this.enumMethods(_.off);_.each(this.children_,_.method("destroy"));this.children_=[]},destroy:function(){},afterDestroy:function(){_.each(this.constructor.$traits,function(a){a.prototype.destroy&&a.prototype.destroy.call(this)},this);delete this.destroying_;
this.parent_=void 0;this.destroyed_=!0},attachedTo:$property(function(){return this.parent_}),attachTo:function(a){if(a===this)throw Error("smells like time-travel paradox.. how else can I be parent of myself?");this.parent_!==a&&(void 0!==this.parent_&&this.parent_.children_.remove(this),void 0!==(this.parent_=a)&&this.parent_.children_.push(this));return this},detach:function(){return this.attachTo(void 0)},attached:$property(function(){return this.children_}),attach:function(a){_.invoke(_.coerceToArray(a),
"attachTo",this);return this},detachAll:function(){_.each(this.children_,function(a){a.parent_=void 0});this.children_=[];return this},destroyAll:function(){_.each(this.children_,function(a){a.parent_=void 0;a.destroy()});this.children_=[];return this}});
...
b.handler&&b.handler({unbind:function(){e.off("touchstart",f).off("click",g)}});return this.on("touchstart",f).on("click",g)}b.handler&&b.handler({unbind:function(){e.off("click",a)}});return this.click(a)},touchDoubleclick:function(a){if(Platform.touch){var b=Date.now();return this.on("touchend",function(){var e=Date.now();200>e-b&&a.apply(this,arguments);b=e})}return this.dblclick(a)},nodoubletapzoom:function(){return a(this).bind("touchstart",function(b){var d=b.timeStamp,e=a(this).data("lastTouch")||
d,e=d-e,f=b.originalEvent.touches.length;a(this).data("lastTouch",d);!e||500<e||1<f||(b.preventDefault(),a(b.target).trigger("click"))})}})}(jQuery);$uselessFile="panic.js";_.hasAsserts=!0;
...
_.defineKeyword("callStack",function(){return CallStack.fromRawString(CallStack.currentAsRawString).offset(Platform.NodeJS?1:0)});_.defineKeyword("currentFile",function(){return(CallStack.rawStringToArray(CallStack.currentAsRawString)[Platform.NodeJS?3:1]||{file:""}).file});_.defineKeyword("uselessPath",_.memoize(function(){return _.initial($currentFile.split("/"),Platform.NodeJS?2:1).join("/")+"/"}));
_.defineKeyword("sourcePath",_.memoize(function(){var a=($uselessPath.match(/(.+)\/node_modules\/(.+)/)||[])[1];return a?a+"/":$uselessPath}));
...
["33m","1m"],"color:saddlebrown;font-weight:bold;"],["orange","33m","color:saddlebrown"],["brown",["33m","2m"],"color:saddlebrown"],["green","32m","color:forestgreen"],["greener",["32m","1m"],"color:forestgreen;font-weight:bold"],["pink","35m","color:magenta"],["boldPink",["35m","1m"],"color:magenta;font-weight:bold;"],["purple",["35m","2m"],"color:magenta"],["black","0m","color:black"],["bright",["0m","1m"],"color:rgba(0,0,0);font-weight:bold"],["dark",["0m","2m"],"color:rgba(0,0,0,0.25)"]],function(a){return[a[0],
log.config({color:{shell:_.coerceToArray(_.map2(a[1],_.prepends("\u001b["))).join(),css:a[2]}})]}))),boldLine:"======================================",line:"--------------------------------------",thinLine:"......................................",withWriteBackend:$scope(function(a,b,c,d){var e=log.writeBackend.value;log.writeBackend.value=b;c(function(b){a(function(){log.writeBackend.value=e;b&&b();d&&d()})})}),writeUsingDefaultBackend:function(){var a=arguments;log.withWriteBackend(log.impl.defaultWriteBackend,
...
f=e&&e[1];e&&(d.last.text=e[2].reversed);var g={},e=_.pluck.with_("items",_.reject.with_(_.property("label"),_.partition3.with_(_.equals(g),_.scatter(d,function(a,b,c){_.each(a.text.split("\n"),function(b,d,e){c(_.extended(a,{text:b}));d!==e.lastIndex&&c(g)})})))),d=_.pluck(d,"text").join(""),h=c.where||log.impl.walkStack($callStack)||{},k=_.times(c.indent,_.constant("\t")).join("");a({lines:e,config:c,color:c.color,args:_.reject(b,_.isTypeOf.$(log.Config)),indentation:k,indentedText:e.map(_.seq(_.pluck.tails2("text"),
_.joinsWith(""),_.prepends(k))).join("\n"),text:d,codeLocation:c.location&&log.impl.location(h)||"",trailNewlines:f||"",where:c.location&&h||void 0});return _.find(b,_.not(_.isTypeOf.$(log.Config)))}),walkStack:function(a){return _.find(a.clean,function(a){return 0>a.fileShort.indexOf("base/log.js")})||a[0]},defaultWriteBackend:function(a){var b=a.codeLocation,c=a.trailNewlines;Platform.NodeJS?console.log(_.map(a.lines,function(b){return a.indentation+_.map(b,function(a){return a.config.color?a.config.color.shell+
a.text+"\u001b[0m":a.text}).join("")}).join("\n"),log.color("dark").shell+b+"\u001b[0m",c):console.log.apply(console,_.reject.with_(_.equals(void 0),[].concat(_.map(a.lines,function(b,c){return a.indentation+_.reduce2("",b,function(a,b){return a+(b.text&&(b.config.color?"%c":"")+b.text||"")})}).join("\n")+(b&&"%c "+b||""),(_.scatter(a.lines,function(a,b,c){_.each(a,function(a){a.text&&a.config.color&&c(a.config.color.css)})})||[]).concat(b?"color:rgba(0,0,0,0.25)":[]),c)))},location:function(a){return _.quoteWith("()",
_.nonempty([a.calleeShort,_.nonempty([a.fileName,a.line]).join(":")]).join(" @ "))},stringifyArguments:function(a,b){return _.map(a,log.impl.stringify.tails2(b)).join(" ")},stringify:function(a,b){b=b||{};if(_.isTypeOf(Error,a)){var c=log.impl.stringifyError(a);return a.originalError?c+"\n\n"+log.impl.stringify(a.originalError):c}return _.isTypeOf(CallStack,a)?log.impl.stringifyCallStack(a):"object"===typeof a?_.isArray(a)&&1<a.length&&_.isObject(a[0])&&b.table?log.asTable(a):_.stringify(a,b):"string"===
typeof a?a:_.stringify(a)},stringifyError:function(a){try{var b=CallStack.fromErrorWithAsync(a).clean.offset(a.stackOffset||0);return"[EXCEPTION] "+(a.message||"").replace(/\r|\n/g,"").trimmed.first(120)+"\n\n"+(a.notMatching&&_.map(_.coerceToArray(a.notMatching||[]),log.impl.stringify.then(_.prepends("\t"))).join("\n")+"\n\n"||"")+log.impl.stringifyCallStack(b)+"\n"}catch(c){return"YO DAWG I HEARD YOU LIKE EXCEPTIONS... SO WE THREW EXCEPTION WHILE PRINTING YOUR EXCEPTION:\n\n"+c.stack+"\n\nORIGINAL EXCEPTION:\n\n"+
...
this.failed=0<this.failedTests.length;d(!this.failed);a()}))}))}),onException:function(a){if(this.currentAssertion)this.currentAssertion.onException(a);else throw a;},defineAssertions:function(a){_.each(a,function(a,c){this.defineAssertion(c,a)},this)},runTest:function(a,b,c){var d=this.runConfig;log.impl.configStack=[];d.testStarted(a);a.verbose=d.verbose;a.timeout=d.timeout;a.startTime=Date.now();a.run(function(){d.testComplete(a);a.time=Date.now()-a.startTime;c()})},collectTests:function(){return _.map(_.tests,
this.$(function(a,b){return this.testSuite(b,a)}))},collectPrototypeTests:function(a){_.cps.map(this.prototypeTests,this.$(function(a,c){a.proto.$meta(this.$(function(d){c(this.testSuite(d.name,a.tests,void 0,a.proto))}))}),a)},testSuite:function(a,b,c,d){return{name:a||"",tests:_(_.pairs("function"===typeof b&&_.object([[a,b]])||b)).map(function(b){var f=new Test({proto:d,name:b[0],routine:b[1],suite:a,context:c});f.complete(function(){(f.hasLog=0<f.logCalls.length)||(f.failed?log.red("FAIL"):f.verbose&&
log.green("PASS"))});return f})}},defineAssertion:function(a,b){var c=this;_.deleteKeyword(a);_.defineKeyword(a,Tags.modify(b,function(d){return _.withSameArgs(d,function(){var e=$callStack.safeLocation(1);return c.currentAssertion?c.currentAssertion.babyAssertion(a,b,d,arguments,e):d.apply(c,arguments)})}))},printLog:function(a){if(!a.supressLog){var b=_.filter(this.runningTests,function(b){return b.failed||!a.silent&&b.hasLog}),c=_.filter(this.runningTests,_.property("failed"));_.invoke(a.verbose?
this.runningTests:b,"printLog");c.length?log.orange("\n"+log.boldLine+"\nSOME TESTS FAILED:",_.pluck(c,"name").join(", "),"\n\n"):!0!==a.silent&&log.green("\n"+log.boldLine+"\nALL TESTS PASS\n\n")}}});
...
a()})},$macroTags:{log:function(b,c,d){var e=(_.isBoolean(c.$log)?void 0:c.$log)||(c.$verbose?"{{$proto}}":""),f={},g=_.find2(a,function(a){return log.color(c["$"+a]&&a)||!1}),h=e&&_.template(e);$untag(b.$meta)(function(a){f=a});return $prototype.impl.wrapMemberFunction(c,function(a,b){return function(){var e=this,m=_.asArray(arguments),p=h&&h.call(this,_.extend({$proto:f.name},_.map2(this,_.stringifyOneLine.arity1)))||this.desc||"",q=_.map(m,_.stringifyOneLine.arity1).join(", ").quote("()");log.write(log.config({color:g,
location:!0,where:c.$verbose?void 0:{calleeShort:f.name}}),_.nonempty([p,d,b]).join("."),q);return log.withConfig({indent:1,color:g,protoName:f.name},function(){var b=log.impl.numWrites,c=a.apply(e,m);void 0!==c&&log.write("\u2192",_.stringifyOneLine(c));2>log.currentConfig().indent&&0<log.impl.numWrites-b&&log.newline();return c})}})}}})})();Platform.NodeJS&&(module.exports=Testosterone);_.measure=function(a,b){if(b){var c=_.now();a(function(){b(_.now()-c)})}else return c=_.now(),a(),_.now()-c};
...
1):a('<div class="panic-alert-error">').attr("id",d).append('<span class="panic-alert-counter">').append(this.print(b,c)).insertAfter(this.el.find(".panic-modal-title"));this.toggleVisibility(!0);this.layout()},hash:function(a){return((_.isTypeOf(Error,a)?a&&a.stack:_.isTypeOf(Test,a)?a.suite+a.name:a)||"").hash},print:function(a,c){return _.isTypeOf(Error,a)?this.printError(a):_.isTypeOf(Test,a)?this.printFailedTest(a):this.printUnknownStuff(a,c)},printUnknownStuff:function(b,c){return c?b:a("<span>").text(log.impl.stringify(b))},
printLocation:function(b){return a('<span class="location">').append([a('<span class="callee">').text(b.calleeShort),a('<span class="file">').text(b.fileName),a('<span class="line">').text(b.line)])},printFailedTest:function(b){var c=a('<pre class="test-log" style="margin-top: 13px;">');log.withWriteBackend(this.$(function(b){_.isTypeOf(Error,b.args.first)&&console.log(b.args.first);c.append(_.isTypeOf(Error,b.args.first)?a('<div class="inline-exception-entry">').append([_.escape(b.indentation),a('<div class="panic-alert-error inline-exception">').append(this.printError(b.args.first))]):
a('<div class="log-entry">').append(_.map(b.lines,function(c,f,g){return a('<div class="line">').append(_.escape(b.indentation)).append(_.map(c,function(b){return a("<span>").attr("style",b.config.color&&b.config.color.css||"").text(b.text)})).append(f===g.lastIndex?[b.where&&this.printLocation(b.where),b.trailNewlines.replace(/\n/g,"<br>")]:[])},this)))}),function(a){b.evalLogCalls();a()});return[a('<div class="panic-alert-error-message" style="font-weight: bold;">').text(b.name).append('<span style="float:right; opacity: 0.25;">test failed</span>'),
