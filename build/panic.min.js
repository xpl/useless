...
Array.prototype.squash=function(a){a=a||{};var b=a.key||_.identity,c=a.sort||void 0,d={key:null,next:{}},e={};_.each(this,function(a){for(var c=0,f=a.length,g=d,h=void 0;c<f;c++,g=h){var h=a[c],p=b(h),h=e[p]||(e[p]={key:p,item:h,next:{}});g&&(g.next[p]=h)}});var f=function(a,b){a[b.key]=!0;b.next=_.chain(_.values(b.next)).filter(function(b){return!(b.key in a)}).map(_.partial(f,a)).value();delete a[b.key];return b},g=function(a,b){return a===b||_.some(a.next,function(a){return g(a,b)})},h=function(a){if(!a)return[];
var b=c?_.sortBy(a.next||[],c):a.next||[];return[a].concat(h(_.reduce(b,function(a,b){if(a===b)return a;if(g(b,a))return b.next.push(a),b;a.next.push(b);return a})))};return _.rest(_.pluck(h(f({},d)),"item"))};$global.define("DAG",{squash:function(a,b){b=b||{};var c=b.items||_.noop,d=function(a,b){b=b||[];(ix=c(a))&&ix.length&&(ix.reduce(function(a,c){b.push([c,a]);return c}),ix.forEach(function(c){b.push([a,c]);d(c,b)}));return b};return d(a).squash(b).remove(a).reverse()}});
_.cps=function(){return _.cps.sequence.apply(null,arguments)};_.cps.apply=function(a,b,c,d){c=_.asArray(c);var e=_.numArgs(a)-1,f=c[e];c[e]=function(){d.call(this,arguments,f)};return a.apply(b,c)};_.extend(_.cps,{each:function(a,b,c,d,e,f){var g=arguments.callee,h=d||0,k=0===h?void 0===a.length?_.keys(a):void 0:f,l=0===h?k?k.length:a.length:e,m=2!==_.numArgs(b);if(!a||h>=(l||0))c&&c();else{var n=k?k[h]:h,q=function(){g(a,b,c,h+1,l,k)};m?b(a[n],n,q,c,a):b(a[n],q,c,a)}}});
...
this.callStaticConstructor,this.expandAliases,this.groupMembersByTagForFastEnumeration,this.defineStaticMembers,this.defineInstanceMembers)},expandTraitsDependencies:function(a){_.isNonempty($untag(a.$depends))&&_.isEmpty($untag(a.$traits))&&(a.$traits=DAG.squash(a,{items:function(a){return $untag(a.$depends)},key:function(a){return $untag(a.$nonce)}}));return a},mergeExtendables:function(a){return function(b){_.each(a.$definition,function(a,d){a&&a.$extendable&&(b[d]=Tags.modify(a,function(a){a=
...
var e=window.__globalDragOverlay,f=d.button||1,g=this.$(function(g){var h=d.relativeTo||this;this.addClass(d.cls||"");if($platform.touch||g.which===f){var m=h.offset(),n=void 0;if(!d.start||!1!==(n=d.start.call(d.context||this,new Vec2(g.pageX-m.left,g.pageY-m.top),g))){var q=void 0,p=void 0,r=void 0,n=_.clone(n),t=this.$(function(a){if($platform.touch||a.which===f){a.preventDefault();a=b(a,this[0]);var e=h.offset();n=d.move.call(d.context||this,n,new Vec2(a.pageX-g.pageX,a.pageY-g.pageY),new Vec2(a.pageX-
e.left,a.pageY-e.top),a)||n}else q(a)}),p=function(){a(e||document.body).css(e?{display:"none"}:{}).off("mouseup touchend",r).off("mousemove touchmove",t)},r=this.$(function(a){p();d.end&&(a=b(a,this[0]),d.end.call(d.context||this,n,new Vec2(a.pageX-g.pageX,a.pageY-g.pageY),a));this.removeClass(d.cls||"")}),q=this.$(function(a){p();r(a)});a(e||document.body).css(e?{display:"",cursor:d.cursor||""}:{}).on("mousemove touchmove",t).one("mouseup touchend",r);d.callMoveAtStart&&d.move.call(d.context||this,
...
a()})},$macroTags:{log:function(b,c,d){var e=(_.isBoolean(c.$log)?void 0:c.$log)||(c.$verbose?"{{$proto}}":""),f={},g=_.find2(a,function(a){return log.color(c["$"+a]&&a)||!1}),h=e&&_.template(e,{interpolate:/\{\{(.+?)\}\}/g});$untag(b.$meta)(function(a){f=a});return $prototype.impl.modifyMember(c,function(a,b){return function(){var e=this,n=_.asArray(arguments),q=h&&h.call(this,_.extend({$proto:f.name},_.map2(this,_.stringifyOneLine.arity1)))||this.desc||"",p=_.map(n,_.stringifyOneLine.arity1).join(", ").quote("()");
log.write(log.config({color:g,location:!0,where:c.$verbose?void 0:{calleeShort:f.name}}),_.nonempty([q,d,b]).join("."),p);return log.withConfig({indent:1,color:g,protoName:f.name},function(){var b=log.impl.numWrites,c=a.apply(e,n);void 0!==c&&log.write("\u2192",_.stringifyOneLine(c));2>log.currentConfig().indent&&0<log.impl.numWrites-b&&log.newline();return c})}})}}})})();$platform.NodeJS&&(module.exports=Testosterone);
