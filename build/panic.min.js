...
_.concat=function(a,b){b=_.rest(arguments);return _.isArray(a)?a.concat.apply(a,b):_.reduce2(a,b,function(a,b){return _.isObject(a)&&_.isObject(b)?_.extend({},a,b):a+b})};
...
_.partition2=function(a,b){var c=void 0,d=[],e=[];_.each(a,function(a){var f=b(a);c!=f&&e.length&&(d.push(e),e=[]);e.push(a);c=f});e.length&&d.push(e);return d};
...
function(a){delete a.__tempId})}return a},mergeExtendables:function(a){return function(b){_.each(_.pick(a.$definition,$extendable.is),function(a,d){b[d]=Tags.modifySubject(a,function(a){a=_.extendedDeep(a,$untag(b[d]||{}));_.each($untag(b.$traits),function(c){if(!c)throw log.e(b.$traits),Error("invalid $traits value");(c=c.$definition[d])&&(a=_.extendedDeep($untag(c),a))});return a})});return b}},mergeTraitsMembers:function(a,b){var c={},d={};_.each([a].concat(_.pluck(b,"$definition")),function(a){_.each(_.omit(a,
_.or($builtin.matches,_.key(_.equals("constructor")))),function(a,b){$bindable.is(a)&&(d[b]=a);(c[b]||(c[b]=[])).push(a)})});_.each(c,function(b,d){var f=_.find(b,Component.isStreamDefinition);if(f){var h=a[d]=Tags.clone(f);h.listeners=[];_.each(b,function(a){a!==f&&h.listeners.push(a)})}else a[d]||(a[d]=c[d][0])});_.each(d,function(b,d){var f=_.nonempty(_.map(_.bindable.hooks,function(a,b){var e=c[_.bindable.hooksShort[b]+d.capitalized];return e&&[a,e]}));if(f.length){var h=(a[d]=Tags.clone(b,_.bindable($untag(b)))).subject;
_.each(f,function(a){_.each(a[1],function(b){b=$untag(b);if(_.isFunction(b))h[a[0]](b)})})}})}},isStreamDefinition:$static(function(a){return _.isObject(a)&&(a.$trigger||a.$triggerOnce||a.$barrier||a.$observable||a.$observableProperty)}),mapMethods:function(){var a=_.last(arguments),b=1===arguments.length?_.constant(!0):arguments[0],c;for(c in this){var d=this.constructor.$definition[c];if(!d||!d.$property){var e=this[c];_.isFunction(e)&&!_.isPrototypeConstructor(e)&&b(d)&&(this[c]=a.call(this,e,
...
this.cfg;this.callTraitsMethod("afterInit",a);this.initialized(!0);_.each(this.constructor.$definition,function(a,d){if(a&&a.$observableProperty){d+="Change";var e=b[d];if(e)this[d](e)}},this)},initialized:$barrier(),beforeDestroy:function(){if(this.destroyed_)throw Error("Component: I am already destroyed. Probably you're doing it wrong.");if(this.destroying_)throw Error("Component: Recursive destroy() call detected. Probably you're doing it wrong.");this.destroying_=!0;this.enumMethods(_.off);_.each(this.children_,
...
run:_.interlocked(function(a,b,c){var d=3===arguments.length?c:_.identity,e=this.runConfig=_.extend({silent:!0,verbose:!1,timeout:2E3,testStarted:function(a){},testComplete:function(a){}},b),g=_.isArray(e.suites||e.tests),f=_.map(e.suites||[],this.$(function(a,b){return this.testSuite(g?a.name:b,g?a.tests:a,e.context)}));(!1===e.codebase?_.cps.constant([]):this.$(this.collectPrototypeTests))(this.$(function(b){var c=!1===e.codebase?[]:this.collectTests();b=_.flatten(_.pluck(c.concat(f).concat(b),
...
b.thirdParty).toggleClass("native",b["native"]).append([a('<span class="file">').text(_.nonempty([b.index?"(index)":b.fileShort,b.line]).join(":")),a('<span class="callee">').text(b.calleeShort),a('<span class="src i-am-busy">').click(this.$(function(g){var f=a(g.delegateTarget);f.waitUntil(_.readSource.partial((b.remote?"api/source/":"")+b.file),this.$(function(g){c.is(".full")?(c.removeClass("full"),c.transitionend(function(){c.is(".full")||b.sourceReady(f.$(a.fn.text))})):(c.addClass("full"),f.html(_.map(g.split("\n"),
function(b){return a('<div class="line">').text(b)})),g=f.find(".line").eq(b.line-1).addClass("hili"),g.length&&(g=g.offset().top-f.offset().top,f.scrollTop(g-100)),_.delay(this.$(function(){var a=f.outerBBox().bottom+242-this.modalBody.outerBBox().bottom;0<a&&this.modalBody.animate({scrollTop:this.modalBody.scrollTop()+a},250)})))}))}))]);b.sourceReady(function(a){c.find(".src").removeClass("i-am-busy").text(a)});return c})))]}});a.fn.extend({enableScrollFaders:function(b){var c=b&&b.horizontal,
d,e;b=this.find(b&&b.scroller||".scroller");this.css({position:"relative"});this.append(d=a('<div class="scroll-fader scroll-fader-'+(c?"left":"top")+'"></div>')).append(e=a('<div class="scroll-fader scroll-fader-'+(c?"right":"bottom")+'"></div>'));b.scroll(function(){var b=c?a(this).scrollLeft():a(this).scrollTop(),f=c?a(this).width():a(this).height(),h=(c?this.scrollWidth:this.scrollHeight)-1;d.css({opacity:0<b?1:0});e.css({opacity:b+f<h?1:0})}).scroll();return this}})})(jQuery);
