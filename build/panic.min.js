...
applyMacroTags:function(a,b){_.each(b,function(c,d){_.each(a,function(a,f){c=b[d];_.keyword(f)in c&&(b[d]=a.call(b,b,c,d)||c)},this)},this);return b},generateCustomCompilerImpl:function(a){return function(b){b.$impl?(b.$impl.__proto__=a&&a.$impl||this,b.$impl=$static($builtin($property(b.$impl)))):a&&a.$impl&&(b.$impl=$static($builtin($property(a.$impl))));return b}},generateArgumentContractsIfNeeded:function(a){return a.$testArguments?$prototype.wrapMethods(a,function(a,c){return function(){var d=
...
function(){a.prototype.constructor.apply(this,arguments)}:function(a){_.extend(this,a||{})}},defineStaticMembers:function(a){this.defineMembers($untag(a.constructor),_.pick(a,$static.matches));return a},defineInstanceMembers:function(a){this.defineMembers($untag(a.constructor).prototype,_.omit(a,$static.matches));return a},defineMembers:function(a,b){_.each(b,function(c,d){"constructor"!==d&&b.hasOwnProperty(d)&&this.defineMember(a,c,d)},this)},defineMember:function(a,b,c){b&&b.$property?b.$memoized?
_.defineMemoizedProperty(a,c,b):_.defineProperty(a,c,b):(b=$untag(b),a[c]=b)},ensureFinalContracts:function(a){return function(b){if(a){if(a.$final)throw Error("Cannot derive from $final-marked prototype");if(a.$definition){var c=_.intersection(_.keys(_.pick(a.$definition,$final.matches)),_.keys(b));if(c.length)throw Error("Cannot override $final "+c.join(", "));}}return b}},expandAliases:function(a){_.each(a,function(b,c){a[c]=this.resolveMember(a,c,b)[1]},this);return a},resolveMember:function(a,
b,c){c=c||a[b];if($alias.is(c)){a=this.resolveMember(a,$untag(c));var d=a[0];a=a[1];return[d,$property.is(c)?$property({get:function(){return this[d]},set:function(a){this[d]=a}}):Tags.extend(a,Tags.omit(c,"$alias"))]}return[b,c]},groupMembersByTagForFastEnumeration:function(a){var b={};_.each(a,function(a,d){Tags.each(a,function(e){(b[e]=b[e]||{})[d]=a})});a.$membersByTag=$static($builtin($property(b)));return a},isTagKeywordGroup:function(a,b){var c=$untag(a);return _.isKeyword(b)&&_.isFunction($global[b])&&
"object"===typeof c&&!_.isArray(c)},modifyMember:function(a,b){return $property.is(a)&&Tags.modify(a,function(a){return _.extend(a,_.map2(_.pick(a,"get","set"),b))})||_.isFunction($untag(a))&&Tags.modify(a,b)||a}}});_.isTraitOf=function(a,b){var c=b&&b.constructor;return c&&c.hasTrait&&c.hasTrait(a)||!1};_.isTypeOf=_.or(_.isTypeOf,_.isTraitOf);
...
$prototype.macroTag("callableAsFreeFunction",function(a,b,c){a.constructor[c]=$untag(b).asFreeFunction;return a});$singleton=function(a,b){return new ($prototype.apply(null,arguments))};
...
a:{},d=this.constructor.$definition;this.constructor.$defaults&&(c=this.cfg=_.extend(_.cloneDeep(this.constructor.$defaults),c));this.$disableAutoThisBoundMethods||this.mapMethods(function(a,b){if("$"!==b&&"init"!==b)return this.$(a)});_.onBefore(this,"destroy",this.beforeDestroy);_.onAfter(this,"destroy",this.afterDestroy);var e=[],f={init:!0};_.each(d,function(a,b){if(void 0!==a){if(a.$observableProperty){var d=a.subject,l=b in c?c[b]:d,n=b+"Change",m=f[n]=this[n]=_.observable();m.context=this;
m.postpones=a.$postpones;if(_.isPrototypeInstance(d)){var p=d.constructor;m.beforeWrite=function(a){return p.isTypeOf(a)?a:new p(a)}}a.$reference&&(m.trackReference=!0);_.defineProperty(this,b,{get:function(){return m.value},set:function(a){m.call(this,a)}});a.listeners&&_.each(a.listeners,function(a){e.push([m,a])});_.isFunction(a.$observableProperty)&&e.push([m,a.$observableProperty]);void 0!==l&&m(l)}else if(Component.isStreamDefinition(a)){var q=f[b]=this[b]=_.extend((a.$trigger?_.trigger:a.$triggerOnce?
_.triggerOnce:a.$observable?_.observable:a.$barrier?_.barrier:void 0)(a.subject),{context:this,postpones:a.$postpones});a.listeners&&_.each(a.listeners,function(a){e.push([q,a])});(d=c[b])&&e.push([q,d])}a.$listener&&(this[b].queuedBy=[]);a.$interlocked&&(this[b]=_.interlocked(this[b]));a.$bindable&&(this[b]=_.extend(_.bindable(this[b],this),_.map2(a.$bindable.hooks||{},_.mapsWith(this.$.bind(this).arity1))));a.$debounce&&(d=this[b],l=_.coerceToObject(a.$debounce),this[b]=d.debounced(l.wait||500,
l.immediate));a.$throttle&&(d=this[b],l=_.coerceToObject(a.$throttle),this[b]=_.throttle(d,l.wait||500,l));a.$memoize?this[b]=_.memoize(this[b]):a.$memoizeCPS&&(this[b]=_.cps.memoize(this[b]))}},this);_.intercept(this,"init",function(a){(_.hasArgs(this.constructor.prototype.init)?_.cps.sequence:_.sequence)([this._beforeInit,a.bind(this),this._afterInit]).call(this)});_.each(c,function(a,b){b in f||(this[b]=_.isFunction(a)?this.$(a):a)},this);this.$disableAutoThisBoundMethods||_.each(d,function(a,
b){a&&a.$alias&&(this[b]=this[$untag(a)])},this);_.hasAsserts&&_.each(this.constructor.$requires,function(a,b){$assertTypeMatches(_.object([[b,this[b]]]),_.object([[b,a]]))},this);_.each(e,function(a){a[0].call(this,a[1])},this);!1===c.init||this.constructor.$defaults&&!1===this.constructor.$defaults.init||this.init()}),callTraitsMethod:function(a,b){_.isFunction(b)?_.cps.sequence(_.filter2(this.constructor.$traits||[],this.$(function(b){return(b=b.prototype[a])&&_.cps.arity0(_.noArgs(b)?b.asContinuation:
b).bind(this)||!1})).concat(b.arity0))():_.sequence(_.filter2(this.constructor.$traits||[],this.$(function(b){return(b=b.prototype[a])&&(_.hasArgs(b)?b.bind(this,_.identity):b.bind(this))||!1})))()},_beforeInit:function(a){if(this.initialized.already)throw Error("Component: I am already initialized. Probably you're doing it wrong.");this.callTraitsMethod("beforeInit",a)},init:function(){},_afterInit:function(a){var b=this.cfg;this.callTraitsMethod("afterInit",a);this.initialized(!0);_.each(this.constructor.$definition,
function(a,d){if(a&&a.$observableProperty){d+="Change";var e=b[d];if(e)this[d](e)}},this)},initialized:$barrier(),beforeDestroy:function(){if(this.destroyed_)throw Error("Component: I am already destroyed. Probably you're doing it wrong.");if(this.destroying_)throw Error("Component: Recursive destroy() call detected. Probably you're doing it wrong.");this.destroying_=!0;this.enumMethods(_.off);_.each(this.children_,_.method("destroy"));this.children_=[]},destroy:function(){},afterDestroy:function(){_.each(this.constructor.$traits,
function(a){a.prototype.destroy&&a.prototype.destroy.call(this)},this);delete this.destroying_;this.parent_=void 0;this.destroyed_=!0},attachedTo:$property(function(){return this.parent_}),attachTo:function(a){if(a===this)throw Error("smells like time-travel paradox.. how else can I be parent of myself?");this.parent_!==a&&(void 0!==this.parent_&&this.parent_.children_.remove(this),void 0!==(this.parent_=a)&&this.parent_.children_.push(this));return this},detach:function(){return this.attachTo(void 0)},
attached:$property(function(){return this.children_}),attach:function(a){_.invoke(_.coerceToArray(a),"attachTo",this);return this},detachAll:function(){_.each(this.children_,function(a){a.parent_=void 0});this.children_=[];return this},destroyAll:function(){_.each(this.children_,function(a){a.parent_=void 0;a.destroy()});this.children_=[];return this}});
...
a()})},$macroTags:{log:function(b,c,d){var e=(_.isBoolean(c.$log)?void 0:c.$log)||(c.$verbose?"{{$proto}}":""),f={},g=_.find2(a,function(a){return log.color(c["$"+a]&&a)||!1}),h=e&&_.template(e);$untag(b.$meta)(function(a){f=a});return $prototype.impl.modifyMember(c,function(a,b){return function(){var e=this,m=_.asArray(arguments),p=h&&h.call(this,_.extend({$proto:f.name},_.map2(this,_.stringifyOneLine.arity1)))||this.desc||"",q=_.map(m,_.stringifyOneLine.arity1).join(", ").quote("()");log.write(log.config({color:g,
