...
__.reject=function(a){return Promise.reject(a)};__.rejects=function(a){return function(){return Promise.reject(a)}};__.map=function(a,b){return __.then(a,function(a){if(_.isStrictlyObject(a)){var d=_.coerceToEmpty(a),e=[];_.each2(a,function(a,c){e.push(__.identity(b(a,c)).then(function(a){d[c]=a}))});return __.all(e).then(_.constant(d))}return b(a)})};__.each=function(a,b){return __.then(a,function(a){return new Promise(function(d,e){_.cps.each(a,function(a,c,d){__(b(a,c)).then(d)["catch"](e)},d)})})};
