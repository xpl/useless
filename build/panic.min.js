...
_.defineGlobalProperty("alert2",function(a){alert(_.map(arguments,_.stringify).join(", "));return arguments[0]});_.extend(_,{asArray:function(a){return void 0!==a.length?[].slice.call(a,0):[a]}});
...
_.bullet=function(a,b){var c=" ".repeats(a.length);return _.joinWith("\n",_.splitWith("\n",b).map(function(b,e){return 0===e?a+b:c+b}))};_.pretty=function(a,b){return _.stringify(a,_.extend({pretty:!0},b))};_.stringify=function(a,b){return _.stringifyImpl(a,[],[],0,b||{})};
...
_.extend(_,{index:function(a){for(var b={},c=0,d=a.length;c<d;c++)b[a[c]]=!0;return b}});_.quote=function(a,b){var c=b||'"',d=Math.floor(c.length/2+c.length%2),e=c.slice(0,d),c=c.slice(d)||e;return e+a+c};_.quoteWith=_.flip2(_.quote);_.quotesWith=_.higherOrder(_.quoteWith);_.partition2=function(a,b){var c=void 0,d=[],e=[];_.each(a,function(a){var f=b(a);c!=f&&e.length&&(d.push(e),e=[]);e.push(a);c=f});e.length&&d.push(e);return d};_.key=function(a){return function(b,c){return a(c)}};
_.filterKeys=function(a,b){return _.filter(a,function(a,d){return b(d)})};_.rejectKeys=function(a,b){return _.reject(a,function(a,d){return b(d)})};_.pickKeys=function(a,b){return _.pick(a,function(a,d){return b(d)})};_.omitKeys=function(a,b){return _.omit(a,function(a,d){return b(d)})};
...
Component=$prototype({$defaults:$extendable($static($builtin($property({})))),$requires:$extendable($static($builtin($property({})))),$impl:{contributeTraits:function(a){var b=$prototype.impl.contributeTraits(a);return function(c){c=b.call(this,c);_.each(_.pick(a.$definition,$extendable.is),function(a,b){c[b]=Tags.modifySubject(a,function(a){a=_.extendedDeep(a,$untag(c[b]||{}));_.each($untag(c.$traits),function(c){(c=c.$definition[b])&&(a=_.extendedDeep($untag(c),a))});return a})});return c}},mergeTraitsMembers:function(a,
b){var c={},d={};_.each([a].concat(_.pluck(b,"$definition")),function(a){_.each(_.omit(a,_.or($builtin.matches,_.key(_.equals("constructor")))),function(a,b){$bindable.is(a)&&(d[b]=a);(c[b]||(c[b]=[])).push(a)})});_.each(c,function(b,d){var f=_.find(b,Component.isStreamDefinition);if(f){var h=a[d]=Tags.clone(f);h.listeners=[];_.each(b,function(a){a!==f&&h.listeners.push(a)})}else a[d]||(a[d]=c[d][0])});_.each(d,function(b,d){var f=_.nonempty(_.map(_.bindable.hooks,function(a,b){var e=c[_.bindable.hooksShort[b]+
d.capitalized];return e&&[a,e]}));if(f.length){var h=(a[d]=Tags.clone(b,_.bindable($untag(b)))).subject;_.each(f,function(a){_.each(a[1],function(b){b=$untag(b);if(_.isFunction(b))h[a[0]](b)})})}})}},isStreamDefinition:$static(function(a){return _.isObject(a)&&(a.$trigger||a.$triggerOnce||a.$barrier||a.$observable||a.$observableProperty)}),mapMethods:function(){var a=_.last(arguments),b=1===arguments.length?_.constant(!0):arguments[0],c;for(c in this){var d=this.constructor.$definition[c];if(!d||
!d.$property){var e=this[c];b(d)&&_.isFunction(e)&&!_.isPrototypeConstructor(e)&&(this[c]=a.call(this,e,c,d)||e)}}},enumMethods:function(a,b){2===arguments.length?this.mapMethods(a,b.returns(void 0)):this.mapMethods(a.returns(void 0))},constructor:$final(function(a,b){this.parent_=void 0;this.children_=[];var c=this.cfg="object"===typeof a?a:{},d=this.constructor.$definition;this.constructor.$defaults&&(c=this.cfg=_.extend(_.cloneDeep(this.constructor.$defaults),c));this.mapMethods(function(a,b){if("$"!==
b&&"init"!==b)return this.$(a)});_.onBefore(this,"destroy",this.beforeDestroy);_.onAfter(this,"destroy",this.afterDestroy);var e=[],g={init:!0};_.each(d,function(a,b){if(void 0!==a){if(a.$observableProperty){var d=a.subject,m=b in c?c[b]:d,l=b+"Change",n=g[l]=this[l]=_.observable();n.context=this;n.postpones=a.$postpones;if(_.isPrototypeInstance(d)){var p=d.constructor;n.beforeWrite=function(a){return p.isTypeOf(a)?a:new p(a)}}a.$reference&&(n.trackReference=!0);_.defineProperty(this,b,{get:function(){return n.value},
set:function(a){n.call(this,a)}});a.listeners&&_.each(a.listeners,function(a){e.push([n,a])});_.isFunction(a.$observableProperty)&&e.push([n,a.$observableProperty]);void 0!==m&&n(m)}else if(Component.isStreamDefinition(a)){var q=g[b]=this[b]=_.extend((a.$trigger?_.trigger:a.$triggerOnce?_.triggerOnce:a.$observable?_.observable:a.$barrier?_.barrier:void 0)(a.subject),{context:this,postpones:a.$postpones});a.listeners&&_.each(a.listeners,function(a){e.push([q,a])});(d=c[b])&&e.push([q,d])}a.$listener&&
(this[b].queuedBy=[]);a.$interlocked&&(this[b]=_.interlocked(this[b]));a.$bindable&&(_.hasAsserts&&$assert(_.isFunction(this[b])),this[b]=_.extendWith(a.defaultHooks||{},_.bindable(this[b],this)));a.$debounce&&(d=this[b],m=_.coerceToObject(a.$debounce),this[b]=d.debounced(m.wait||500,m.immediate));a.$throttle&&(d=this[b],m=_.coerceToObject(a.$throttle),this[b]=_.throttle(d,m.wait||500,m));a.$memoize?this[b]=_.memoize(this[b]):a.$memoizeCPS&&(this[b]=_.cps.memoize(this[b]))}},this);_.intercept(this,
"init",function(a){(_.hasArgs(this.constructor.prototype.init)?_.cps.sequence:_.sequence)([this._beforeInit,a.bind(this),this._afterInit]).call(this)});_.each(c,function(a,b){b in g||(this[b]=_.isFunction(a)?this.$(a):a)},this);_.each(d,function(a,b){a&&a.$alias&&(this[b]=this[Tags.unwrap(a)])},this);_.hasAsserts&&_.each(this.constructor.$requires,function(a,b){$assertTypeMatches(this[b],a)},this);_.each(e,function(a){a[0].call(this,a[1])},this);!1===c.init||this.constructor.$defaults&&!1===this.constructor.$defaults.init||
