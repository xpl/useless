...
_.tests.Function.catches=function(){$assert("yo",_.constant("yo").catches($fails)(),_.identity.catches($fails)("yo"),_.throwsError("xx").catches("yo")());$assert(function(a){throw a;}.catches(_.appends("+error_case"),_.appends("+no_error_case"),_.appends("+finally"))("foo"),"foo+error_case+finally");$assertMatches(_.throwError.catches()("yo"),{message:"yo"});$assert(_.catches(_.throwsError(42),$assertMatches.$({message:42}).returns("yo"))(),"yo");$assertCPS(_.constant("yo").catches($fails),"yo")};
$extensionMethods(Function,{catch_:function(a,b,c,d){return a.catches(b,c)()},catches:function(a,b,c,d){var e=arguments.length;b=1<e?_.coerceToFunction(b):_.identity;c=2<e?_.coerceToFunction(c):_.identity;d=3<e?_.coerceToFunction(d):_.identity;return function(){var e=void 0;try{e=c(a.apply(this,arguments))}catch(f){e=b(f)}return d(e)}}});
