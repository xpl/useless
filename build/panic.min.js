...
_.sequence=function(a){var b=_.isArray(a)?a:_.asArray(arguments),c=b.length;return 0===c?_.identity:function(a){for(var e=0;e<c;e++)a=b[e].call(this,a);return a}};_.seq=_.sequence;_.then=function(a,b){return function(c){return b.call(this,a.apply(this,arguments))}};_.makes=function(a){return function(){switch(arguments.length){case 0:return new a;case 1:return new a(arguments[0]);case 2:return new a(arguments[0],arguments[1]);default:throw Error("not supported");}}};
_.asString=function(a){return a+""};_.typeOf=function(a){return typeof a};_.count=function(a){return a.length};_.array=_.tuple=function(){return _.asArray(arguments)};_.concat=function(a,b){return _.isArray(a)?a.concat([b]):a+b};_.atIndex=function(a){return function(b){return b[a]}};_.takesFirst=_.higherOrder(_.first);_.takesLast=_.higherOrder(_.last);_.applies=function(a,b,c){return function(){return a.apply(b,c)}};_.prepends=function(a){return function(b){return a+b}};
_.appends=function(a){return function(b){return b+a}};_.join=function(a,b){return a.join(b)};_.joinWith=_.flip2(_.join);_.joinsWith=_.higherOrder(_.joinWith);_.sum=function(a,b){return(a||0)+(b||0)};_.subtract=function(a,b){return(a||0)-(b||0)};_.mul=function(a,b){return(a||0)*(b||0)};_.equal=function(a,b){return a===b};_.sums=_.plus=_.higherOrder(_.sum);_.subtracts=_.minus=_.higherOrder(_.subtract);_.muls=_.higherOrder(_.mul);_.equals=_.higherOrder(_.equal);_.less=function(a,b){return a<b};
_.lessOrEqual=function(a,b){return a<=b};_.greater=function(a,b){return a>b};_.greaterOrEqual=function(a,b){return a>=b};_.isNegative=function(a){return 0>a};_.largest=function(a,b){return isNaN(a)&&isNaN(b)?NaN:isNaN(a)?b:isNaN(b)?a:Math.max(a,b)};_.notZero=function(a){return 0!==a};_.propertyOf=function(a){return function(b){return a[b]}};_.isInstanceofSyntaxAvailable=function(){var a=Error();try{return a instanceof Error}catch(b){return!1}};
...
_.stringifyImpl=function(a,b,c,d,e,f){if(a===$global)return"$global";var g=e.formatter&&e.formatter(a);if(g)return g;if(0<=b.indexOf(a))return e.pure?void 0:"<cyclic>";if(0<=c.indexOf(a))return e.pure?void 0:"<ref:"+c.indexOf(a)+">";if(void 0===a)return"undefined";if(null===a)return"null";if(_.isFunction(a))return e.pure?a.toString():_.isPrototypeConstructor(a)?"<prototype>":"<function>";if("string"===typeof a)return _.quoteWith('"',a);if(!_.isObject(a)||"undefined"!==typeof $atom&&$atom.is(a))return _.isDecimal(a)&&
0<e.precision?_.toFixed(a,e.precision):a+"";var h=_.isArray(a),g=e.pretty||!1;if("browser"===_.platform().engine){if(_.isTypeOf(Element,a))return"<"+a.tagName.lowercase+">";if(_.isTypeOf(Text,a))return"@"+a.wholeText}if(a.toJSON)return _.quoteWith('"',a.toJSON());if(!e.pure&&(d>(e.maxDepth||5)||h&&a.length>(e.maxArrayLength||30)))return h?"<array["+a.length+"]>":"<object>";var k=b.concat([a]);c.push(a);b=_.pairs(a);var m=!g||2>b.length,l=f+1,n=m?"":"\t".repeats(l);if(g&&!h){var p=_.reduce(_.map(_.keys(a),
_.count),_.largest,0);b=_.map(b,function(a){return[a[0],a[1]," ".repeats(p-a[0].length)]})}return _.quoteWith(h?m?"[]":"[\n  ]":m?"{  }":"{\n  }",_.joinWith(m?", ":",\n",_.map(b,function(a){return n+(h?"":a[0]+": "+(a[2]||""))+_.stringifyImpl(a[1],k,c,d+1,e,l)})))};_.toFixed=function(a,b){return a&&a.toFixed&&a.toFixed(b)||void 0};_.toFixed2=function(a){return _.toFixed(a,2)};_.toFixed3=function(a){return _.toFixed(a,3)};_.hasStdlib=!0;
_.extend(_,{throwsError:function(a){return function(){throw Error(a);}}});_.overrideThis=_.throwsError("override this");_.notImplemented=_.throwsError("not implemented");_.mixin({tryEval:function(a,b,c){var d=void 0;try{d=a()}catch(e){d=b&&b(e)}return c?c(d):d}});_.mixin({values2:function(a){return _.isArray(a)?a:_.isStrictlyObject(a)?_.values(a):_.isEmpty(a)?[]:[a]}});_.mixin({map2:function(a,b,c){return _.isArray(a)?_.map(a,b,c):_.isStrictlyObject(a)?_.mapObject(a,b,c):b.call(c,a)}});
...
_.quote=function(a,b){var c=b||'"',d=c.slice(0,Math.floor(c.length/2+c.length%2)),c=c.slice(c.length/2)||d;return d+a+c};_.quoteWith=_.flip2(_.quote);_.quotesWith=_.higherOrder(_.quoteWith);_.partition2=function(a,b){var c=void 0,d=[],e=[];_.each(a,function(a){var g=b(a);c!=g&&e.length&&(d.push(e),e=[]);e.push(a);c=g});e.length&&d.push(e);return d};_.key=function(a){return function(b,c){return a(c)}};_.filterKeys=function(a,b){return _.filter(a,function(a,d){return b(d)})};
...
_(["constant","get"]).each(_.defineTagKeyword);_.defineModifierKeyword=function(a,b){_.defineKeyword(a,function(a){return Tags.modifySubject(a,b)})};_.deleteKeyword=function(a){delete $global[_.keyword(a)]};_.cps=function(){return _.cps.sequence.apply(null,arguments)};_.cps.apply=function(a,b,c,d){c=_.asArray(c);var e=_.numArgs(a)-1,f=c[e];c[e]=function(){d.call(this,arguments,f)};return a.apply(b,c)};
_.extend(_.cps,{each:function(a,b,c,d,e,f){var g=arguments.callee,h=d||0,k=0===h?void 0===a.length?_.keys(a):void 0:f,m=0===h?k?k.length:a.length:e,l=2!==_.numArgs(b);if(!a||h>=(m||0))c&&c();else{var n=k?k[h]:h,p=function(){g(a,b,c,h+1,m,k)};l?b(a[n],n,p,c,a):b(a[n],p,c,a)}}});_.extend(_.cps,{map:function(a,b,c){var d=_.isArray(a)?[]:{};_.cps.each(a,2==_.numArgs(b)?function(a,c,g){b(a,function(a){d[c]=a;g()})}:function(a,c,g){b(a,c,function(a){d[c]=a;g()})},function(){c(d)})}});
...
arity0:_.arity0,arity1:_.arity1,arity2:_.arity2,arity3:_.arity3,or:_.or,and:_.and,not:_.not,applies:_.applies,oneShot:function(a){var b=!1;return function(){if(!b)return b=!0,a.apply(this,arguments)}},memoized:_.memoize,throttled:_.throttle,debounced:function(a,b,c){var d,e,f,g,h,k=function(){var l=Date.now()-d;l<b&&0<l?e=setTimeout(k,b-l):(e=null,c||(f=a.apply(h,g),e||(h=g=null)))},m=function(){h=this;g=arguments;d=Date.now();var l=c&&!e;e||(e=setTimeout(k,b));l&&(f=a.apply(h,g),h=g=null);return f};
m.callImmediately=function(){e&&(clearTimeout(e),e=null);a.apply(h,g)};return m},postpone:$method(function(a){a.postponed.apply(null,arguments)}),postponed:function(a){return function(){var b=arguments;a._postponed||(a._postponed=!0,_.delay(function(){a._postponed=!1;a.apply(this,b)}))}},delay:_.delay,delayed:function(a,b){return function(){var c=arguments,d=this;_.delay(function(){a.apply(d,c)},b)}}});
$extensionMethods(Array,{lastIndex:function(a){return a.length-1},last:function(a){return _.last(a)},random:function(a){return a[_.random(0,a.lastIndex)]},copy:function(a){return a.slice(0)},removeAll:$method(function(a){return a.splice(0,a.length),a}),remove:function(a,b){for(var c;-1!==(c=a.indexOf(b));)a.splice(c,1);return a},removeAt:function(a,b){a.splice(b,1);return a},insertAt:function(a,b,c){a.splice(c,0,b);return a},itemAtWrappedIndex:function(a,b){return a[b%a.length]},reversed:function(a){return a.slice().reverse()},
flat:function(a){return _.flatten(a,!0)},swap:$method(function(a,b,c){var d=a[b];a[b]=a[c];a[c]=d;return a}),zip:_.zipWith});_.zap=function(a){var b=_.last(arguments);return _.reduce(_.rest(_.initial(arguments)),function(a,d){return _.times(Math.max(a.length,d.length),function(e){return b(a[e],d[e])})},a)};
...
(function(){var a=["onceBefore","onceAfter","onBefore","onAfter","intercept"],b=function(b){return _.extend({},b,{_bindable:!0,impl:b,_wrapped:b},_.object(_.map(a,function(a){return[a,function(b){if(!_.isBindable(this))throw Error("wrong this");return this["_"+a].push(b),this}]})),_.object(_.map(a,function(a){return["_"+a,[]]})))};_.extend(_,_.mapObject(_.invert(a),function(a){return function(b,e,f){var g=b[e];return(_.isBindable(g)?g:b[e]=_.bindable(g))["_"+a].push(f)}}.flip2),{off:function(b,d,
e){var f=b[d];_.isBindable(f)&&_.each(a,function(a){f["_"+a]=_.without(f["_"+a],e)})},isBindable:function(a){return a&&a._bindable?!0:!1},bindable:_.extendWith({hooks:a,hooksShort:["onceBefore","onceAfter","before","after",""]},function(a,d){return _.withSameArgs(a,_.extendWith(b(a),function(){var b=arguments.callee,f=b._onceBefore,g=b._onceAfter,h=b._onBefore,k=b._onAfter,m=b._intercept,b=d||this,l,n=void 0;if(f.length){l=0;for(n=f.length;l<n;l++)f[l].apply(b,arguments);f.removeAll()}l=0;for(n=h.length;l<
n;l++)h[l].apply(b,arguments);f=(m.length?_.cps.compose([a].concat(m)):a).apply(b,arguments);if(k.length||g.length){h=_.asArray(arguments).concat(f);l=0;for(n=k.length;l<n;l++)k[l].apply(b,h);if(g.length){l=0;for(n=g.length;l<n;l++)g[l].apply(b,h);g.removeAll()}}return f}))})})})();
...
k=b.copy,m=c.context;a&&b.off();_.each(k,function(a){c.postpones?a.postponed.apply(this,e):a.apply(this,e)},m||this)}),e=a.read(function(a){0>b.indexOf(a)&&(a.queuedBy?a.queuedBy.push(b):a.queuedBy=[b],b.push(a))});return c=_.extend($restArg(function(a){_.isFunction(a)?e.call(this,a):d.apply(this,arguments);return arguments.callee}),a,{queue:b,once:function(a){e(function(b){_.off(c,arguments.callee);a(b)})},off:_.off.asMethod,read:e,write:d,postpone:function(){this.postponed.apply(c.context,arguments)}})}});
_.hasOOP=!0;_("property static final alias memoized private builtin testArguments".split(" ")).each(_.defineTagKeyword);$prototype=function(a,b){return $prototype.impl.compile.apply($prototype.impl,1<arguments.length?_.asArray(arguments).reverse():arguments)};$extends=function(a,b){return $prototype(a,b||{})};
_.extend($prototype,{isConstructor:function(a){return _.isPrototypeConstructor(a)},macro:function(a,b){1===arguments.length?$prototype.impl.alwaysTriggeredMacros.push(a):$prototype.impl.memberNameTriggeredMacros[a]=b},macroTag:function(a,b){$prototype.impl.tagTriggeredMacros[_.keyword(a)]=b},each:function(a){var b=$global,c;for(c in b)if(!_.isKeyword(c)){var d=b[c];$prototype.isConstructor(d)&&a(d,c)}},inheritanceChain:function(a){for(var b=[];a;)b.push(a),a=a.$base&&a.$base.constructor;return b},
wrapMethods:function(a,b){return Tags.map(a,function(a,d,e){return _.isFunction(a)?b(a,d,e).wraps(a):a})},impl:{alwaysTriggeredMacros:[],memberNameTriggeredMacros:{},tagTriggeredMacros:{},compile:function(a,b){return(b&&b.$impl||this)._compile(a,b)},_compile:function(a,b){return Tags.unwrap(_.sequence(this.extendWithTags,this.flatten,this.generateCustomCompilerImpl(b),this.generateArgumentContractsIfNeeded,this.ensureFinalContracts(b),this.generateConstructor(b),this.evalAlwaysTriggeredMacros(b),
this.evalMemberTriggeredMacros(b),this.contributeTraits,this.generateBuiltInMembers(b),this.expandAliases,this.defineStaticMembers,this.defineInstanceMembers).call(this,a||{}).constructor)},evalAlwaysTriggeredMacros:function(a){return function(b){for(var c=$prototype.impl.alwaysTriggeredMacros,d=0,e=c.length;d<e;d++)b=c[d](b,a);return b}},evalMemberTriggeredMacros:function(a){return function(b){var c=$prototype.impl.memberNameTriggeredMacros,d=$prototype.impl.tagTriggeredMacros;_.each(b,function(e,
f){c.hasOwnProperty(f)&&(b=c[f](b,e,f,a));_.each(_.keys(e),function(c){d.hasOwnProperty(c)&&(b=d[c](b,e,f,a))})});return b}},generateCustomCompilerImpl:function(a){return function(b){b.$impl?(b.$impl.__proto__=a&&a.$impl||this,b.$impl=$static($builtin($property(b.$impl)))):a&&a.$impl&&(b.$impl=$static($builtin($property(a.$impl))));return b}},generateArgumentContractsIfNeeded:function(a){return a.$testArguments?$prototype.wrapMethods(a,function(a,c){return function(){var d=_.asArray(arguments);$assertArguments(d.copy,
a.original,c);return a.apply(this,d)}}):a},contributeTraits:function(a){if(a.$traits){var b=a.$traits;this.mergeTraitsMembers(a,b);a.$traits=$static($builtin($property(b)));a.hasTrait=$static($builtin(function(a){return 0<=b.indexOf(a)}))}return a},mergeTraitsMembers:function(a,b){_.each(b,function(b){_.defaults(a,_.omit(b.$definition,_.or($builtin.matches,_.key(_.equals("constructor")))))})},extendWithTags:function(a){return _.extendWith(Tags.unwrap(a),_.mapObject(Tags.get(a),$static.arity1))},generateConstructor:function(a){return function(b){return _.extend(b,
{constructor:Tags.modifySubject(b.hasOwnProperty("constructor")?b.constructor:this.defaultConstructor(a),function(b){a&&(b.prototype.__proto__=a.prototype);return b})})}},generateBuiltInMembers:function(a){return function(b){return _.defaults(b,{$base:$builtin($static($property(_.constant(a&&a.prototype)))),$definition:$builtin($static($property(_.constant(_.extend({},a&&a.$definition,b))))),isTypeOf:$builtin($static(_.partial(_.isTypeOf,Tags.unwrap(b.constructor)))),isInstanceOf:$builtin(function(a){return _.isTypeOf(a,
...
"undefined"!==typeof jQuery&&jQuery.fn.extend({$:function(a){return _.$(this,a)}});_.defineKeyword("const",function(a){return $static($property(a))});$singleton=function(a,b){return new ($prototype.apply(null,arguments))};
Platform=$singleton({$property:{engine:_.platform().engine,system:_.platform().system,device:_.platform().device,touch:_.platform().touch||!1,Browser:"browser"===_.platform().engine,NodeJS:"node"===_.platform().engine,iPad:"iPad"===_.platform().device,iPhone:"iPhone"===_.platform().device,iOS:"iOS"===_.platform().system}});_.clamp=function(a,b,c){return Math.max(b,Math.min(c,a))};_.lerp=function(a,b,c){return b+(c-b)*a};
...
Vec2=$prototype({$static:{x:function(a){return new Vec2(a,a)},xy:function(a,b){return new Vec2(a,b)},zero:$property(function(){return new Vec2(0,0)}),unit:$property(function(){return new Vec2(1,1)}),one:$alias("unit"),lt:$alias("fromLT"),wh:$alias("fromWH"),fromLT:function(a){return new Vec2(a.left,a.top)},fromWH:function(a){return new Vec2(a.width,a.height)},fromLeftTop:$alias("fromLT"),fromWidthHeight:$alias("fromWH"),lerp:function(a,b,c){return new Vec2(_.lerp(a,b.x,c.x),_.lerp(a,b.y,c.y))},clamp:function(a,
b,c){return new Vec2(_.clamp(a.x,b.x,c.x),_.clamp(a.y,b.y,c.y))}},constructor:function(a,b){1===arguments.length?_.isNumber(a)?this.x=this.y=a:(this.x=a.x,this.y=a.y):(this.x=a,this.y=b)},length:$property(function(){return Math.sqrt(this.lengthSquared)}),lengthSquared:$property(function(){return this.x*this.x+this.y*this.y}),distance:function(a){return this.sub(a).length},aspect:$property(function(){return this.x/this.y}),add:function(a,b){return void 0===b?"number"===typeof a?new Vec2(this.x+a,this.y+
a):new Vec2(this.x+a.x,this.y+a.y):new Vec2(this.x+a,this.y+b)},dot:function(a){return this.x*a.x+this.y*a.y},sub:function(a){return new Vec2(this.x-a.x,this.y-a.y)},scale:function(a,b){return new Vec2(this.x*a,this.y*(void 0===b?a:b))},mul:function(a){return new Vec2(this.x*a.x,this.y*a.y)},divide:function(a){return new Vec2(this.x/a.x,this.y/a.y)},normal:$property(function(){return this.scale(1/this.length)}),perp:$property(function(){return new Vec2(this.y,-this.x)}),half:$property(function(){return new Vec2(.5*
...
Math.floor(this.y))}),sum:$static(function(a){return _.reduce(_.isArray(a)&&a||_.asArray(arguments),function(a,c){return a.add(c||Vec2.zero)},Vec2.zero)}),toString:function(){return"{"+this.x+","+this.y+"}"},projectOnCircle:function(a,b){return a.add(this.sub(a).normal.scale(b))},projectOnLineSegment:function(a,b){var c=b.sub(a),d=c.lengthSquared;if(0==d)return a;d=this.sub(a).dot(c)/d;return 0>d?a:1<d?b:a.add(c.scale(d))},projectOnRay:function(a,b){var c=b.lengthSquared;return 0==c?0:this.sub(a).dot(b)/
c}});Bezier={cubic:function(a,b,c,d,e){var f=a*a*a,g=a*a,h=3*(c.x-b.x),k=3*(c.y-b.y),m=3*(d.x-c.x)-h;c=3*(d.y-c.y)-k;return new Vec2((e.x-b.x-h-m)*f+m*g+h*a+b.x,(e.y-b.y-k-c)*f+c*g+k*a+b.y)},cubic1D:function(a,b,c,d,e){return Bezier.cubic(a,Vec2.zero,new Vec2(b,c),new Vec2(d,e),Vec2.one).y},make:{cubic:function(a,b,c,d){return function(e){return Bezier.cubic(e,a,b,c,d)}},cubic1D:function(a,b,c,d){return function(e){return Bezier.cubic1D(e,a,b,c,d)}}}};
...
_.extend(a.x>this.right?{right:!0}:{},a.x<this.left?{left:!0}:{},a.y>this.bottom?{bottom:!0}:{},a.y<this.top?{top:!0}:{});return _.extend(a,a.left||a.right||a.bottom||a.top?{}:{inside:!0})},classifyRay:function(a,b,c){var d=this.size.half,e,f,g,h,k,m;e=1/b.x;f=1/b.y;k=Math.sign(e);m=Math.sign(f);g=(this.x-k*d.x-a.x)*e;h=(this.y-m*d.y-a.y)*f;e*=this.x+k*d.x-a.x;d=(this.y+m*d.y-a.y)*f;if(!(g>d||h>e||(f=g>h?g:h,1<=f||0>=(e<d?e:d))))return e={time:_.clamp(f,0,1)},e.normal=g>h?new Vec2(-k,0):new Vec2(0,
-m),e.delta=b.scale(e.time),e.where=a.add(e.delta),c&&(g=this.grow(-c),e.where.x>g.right?e.where.y<g.top?e=Intersect.rayCircle(a,b,g.rightTop,c):e.where.y>g.bottom&&(e=Intersect.rayCircle(a,b,g.rightBottom,c)):e.where.x<g.left&&(e.where.y<g.top?e=Intersect.rayCircle(a,b,g.leftTop,c):e.where.y>g.bottom&&(e=Intersect.rayCircle(a,b,g.leftBottom,c))),e&&e.insideOut&&(e.where=a)),e},nearestPointTo:function(a,b){var c=b||0,d=new Vec2(this.left,this.top),e=new Vec2(this.right,this.top),f=new Vec2(this.right,
this.bottom),g=new Vec2(this.left,this.bottom),c=[a.projectOnLineSegment(d.add(c,0),e.add(-c,0)),a.projectOnLineSegment(e.add(0,c),f.add(0,-c)),a.projectOnLineSegment(f.add(-c,0),g.add(c,0)),a.projectOnLineSegment(g.add(0,-c),d.add(0,c)),a.projectOnCircle(d.add(c,c),c),a.projectOnCircle(e.add(-c,c),c),a.projectOnCircle(f.add(-c,-c),c),a.projectOnCircle(g.add(c,-c),c)];return _.min(c,function(b){return a.sub(b).length})},xywh:$property(function(){return{x:this.x,y:this.y,width:this.width,height:this.height}}),
clone:$property(function(){return new BBox(this.x,this.y,this.width,this.height)}),floor:$property(function(){return new Vec2(Math.floor(this.x),Math.floor(this.y))}),css:$property(function(){return{left:this.left,top:this.top,width:this.width,height:this.height}}),leftTop:$property(function(){return new Vec2(this.left,this.top)}),leftBottom:$property(function(){return new Vec2(this.left,this.bottom)}),rightBottom:$property(function(){return new Vec2(this.right,this.bottom)}),rightTop:$property(function(){return new Vec2(this.right,
this.top)}),left:$property(function(){return this.x-this.width/2}),right:$property(function(){return this.x+this.width/2}),top:$property(function(){return this.y-this.height/2}),bottom:$property(function(){return this.y+this.height/2}),center:$property(function(){return new Vec2(this.x,this.y)}),size:$property(function(){return new Vec2(this.width,this.height)}),offset:function(a){return new BBox(this.x+a.x,this.y+a.y,this.width,this.height)},newWidth:function(a){return new BBox(this.x-(a-this.width)/
2,this.y,a,this.height)},grow:function(a){return new BBox(this.x,this.y,this.width+2*a,this.height+2*a)},shrink:function(a){return this.grow(-a)},area:$property(function(){return Math.abs(this.width*this.height)}),toString:function(){return"{"+this.x+","+this.y+":"+this.width+"\u00d7"+this.height+"}"}});
...
_.defineKeyword("interlocked",function(a){var b=new Lock;return _.wrapper(Tags.unwrap(a),function(a){b.acquire(function(){a(b.$(b.release))})})});Platform.NodeJS&&(module.exports=_);_.defineKeyword("component",function(a){return $extends(Component,a)});_("trigger triggerOnce barrier observable bindable memoize memoizeCPS debounce throttle overrideThis listener postpones".split(" ")).each(_.defineTagKeyword);_.defineTagKeyword("observableProperty",_.flip);
...
Component=$prototype({$impl:{mergeTraitsMembers:function(a,b){var c={},d={};_.each([a].concat(_.pluck(b,"$definition")),function(a){_.each(_.omit(a,_.or($builtin.matches,_.key(_.equals("constructor")))),function(a,b){a.$bindable&&(d[b]=a);(c[b]||(c[b]=[])).push(a)})});_.each(c,function(b,d){var g=_.find(b,Component.isStreamDefinition);if(g){var h=a[d]=Tags.clone(g);h.listeners=[];_.each(b,function(a){a!==g&&h.listeners.push(a)})}else a[d]||(a[d]=c[d][0])});_.each(d,function(b,d){var g=_.nonempty(_.map(_.bindable.hooks,
function(a,b){var e=c[_.bindable.hooksShort[b]+d.capitalized];return e&&[a,e]}));if(g.length){var h=(a[d]=Tags.clone(b,_.bindable($untag(b)))).subject;_.each(g,function(a){_.each(a[1],function(b){b=$untag(b);if(_.isFunction(b))h[a[0]](b)})})}})}},isStreamDefinition:$static(function(a){return _.isObject(a)&&(a.$trigger||a.$triggerOnce||a.$barrier||a.$observable||a.$observableProperty)}),enumMethods:function(){var a=_.last(arguments),b=1===arguments.length?_.constant(!0):arguments[0],c;for(c in this){var d=
this.constructor.$definition[c];if(!d||!d.$property){var e=this[c];b(d)&&_.isFunction(e)&&!_.isPrototypeConstructor(e)&&a.call(this,e,c)}}},constructor:$final(function(a,b){var c=this.cfg="object"===typeof a?a:{},d=this.constructor.$definition;this.constructor.$defaults&&_.defaults(this,_.cloneDeep(this.constructor.$defaults));this.enumMethods(function(a,b){"$"!==b&&"init"!==b&&(this[b]=this.$(a))});_.onBefore(this,"destroy",this.beforeDestroy);_.onAfter(this,"destroy",this.afterDestroy);_.extend(this,
{parent_:void 0,children_:[]},_.omit(_.omit(c,"init","attachTo","attach"),function(a,b){return Component.isStreamDefinition(d[b])},this));var e=[];_.each(d,function(a,b){if(void 0!==a){if(a.$observableProperty){var d=this[b];defaultValue=b in c?c[b]:d;var k=this[b+"Change"]=_.observable();k.context=this;k.postpones=a.$postpones;if(_.isPrototypeInstance(d)){var m=d.constructor;k.beforeWrite=function(a){return m.isTypeOf(a)?a:new m(a)}}_.defineProperty(this,b,{get:function(){return k.value},set:function(a){k.call(this,
a)}});a.listeners&&_.each(a.listeners,function(a){e.push([k,a])});_.isFunction(a.$observableProperty)&&e.push([k,a.$observableProperty]);void 0!==defaultValue&&k(_.isFunction(defaultValue)?this.$(defaultValue):defaultValue)}else if(Component.isStreamDefinition(a)){var l=(a.$trigger?_.trigger:a.$triggerOnce?_.triggerOnce:a.$observable?_.observable:a.$barrier?_.barrier:void 0)(this[b]);this[b]=_.extend(l,{context:this,postpones:a.$postpones});a.listeners&&_.each(a.listeners,function(a){e.push([l,a])});
(d=c[b])&&e.push([l,d])}a.$listener&&(this[b].queuedBy=[]);a.$bindable&&(_.hasAsserts&&$assert(_.isFunction(this[b])),this[b]=_.extendWith(a.defaultHooks||{},_.bindable(this[b],this)));if(a.$debounce){var d=this[b],n=_.coerceToObject(a.$debounce);this[b]=_.debounce(d,n.wait||500,n)}a.$throttle&&(d=this[b],n=_.coerceToObject(a.$throttle),this[b]=_.throttle(d,n.wait||500,n));a.$memoize?this[b]=_.memoize(this[b]):a.$memoizeCPS&&(this[b]=_.cps.memoize(this[b]))}},this);_.intercept(this,"init",function(a){(_.hasArgs(this.constructor.prototype.init)?
_.cps.sequence:_.sequence)([this._beforeInit,a.bind(this),this._afterInit]).call(this)});_.each(d,function(a,b){a&&a.$alias&&(this[b]=this[Tags.unwrap(a)])},this);_.hasAsserts&&_.each(this.constructor.$requires,function(a,b){$assertTypeMatches(this[b],a)},this);_.each(e,function(a){a[0].call(this,a[1])},this);!1===c.init||this.constructor.$defaults&&!1===this.constructor.$defaults.init||this.init()}),callTraitsMethod:function(a,b){_.isFunction(b)?_.cps.sequence(_.filter2(this.constructor.$traits||
[],this.$(function(b){return(b=b.prototype[a])&&_.cps.arity0(_.noArgs(b)?b.asContinuation:b).bind(this)||!1})).concat(b.arity0))():_.sequence(_.filter2(this.constructor.$traits||[],this.$(function(b){return(b=b.prototype[a])&&(_.hasArgs(b)?b.bind(this,_.identity):b.bind(this))||!1})))()},_beforeInit:function(a){if(this.initialized.already)throw Error("Component: I am already initialized. Probably you're doing it wrong.");this.callTraitsMethod("beforeInit",a)},init:function(){},_afterInit:function(a){var b=
...
jQuery&&function(a){var b=_.clone(a.fn);_.extend(a,{svg:function(b){return a(document.createElementNS("http://www.w3.org/2000/svg",b))}}).fn.extend({on:function(a,d){var e=this;d=_.find(arguments,_.isFunction);d.queuedBy&&d.queuedBy.push({remove:function(){e.off(a,d)}});return b.on.apply(this,arguments)},item:function(a){return a?(this.length&&(this[0]._item=a),this):this.length?this[0]._item:void 0},hasWait:function(){return this.hasClass("i-am-busy")},waitUntil:function(a,b){this.addClass("i-am-busy").attr("disabled",
!0);a(this.$(function(){this.removeClass("i-am-busy").removeAttr("disabled");b&&b.apply(null,arguments)}));return this},hasParent:function(a){for(var b=this;0<b.length;){if(b[0]==(a[0]||a))return!0;b=b.parent()}return!1},nonemptyValue:function(){var b=a.trim(this.val());return 0==b.length?void 0:b},intValue:function(){var a=parseInt(this.nonemptyValue(),10);return isNaN(a)?void 0:a},hitTest:function(b){var d=this.offset(),e=b.clientX-d.left;b=b.clientY-d.top;return 0<=e&&0<=b&&e<a(this).width()&&
b<a(this).height()},attrs:function(){return _.object(_.map(arguments,function(a){return[a,this.attr(a)]},this))},belongsTo:function(a){return this.is(a)||this.parents(a).length},selectClass:function(a,b){return this.removeClass(_.values(b).join(" ")).addClass(b[a])},attrInt:function(a){return(this.attr(a)||"").integerValue},cssInt:function(a){return(this.css(a)||"").integerValue},eachChild:function(b,d){_.each(this.find(b),function(b){d(a(b))});return this},transitionend:function(a){return this.one("transitionend webkitTransitionEnd oTransitionEnd otransitionend MSTransitionEnd",
a.oneShot)},animationend:function(a){return this.one("animationend webkitAnimationEnd oAnimationEnd oanimation MSAnimationEnd",a.oneShot)},animateWith:function(a,b){this.addClass(a);this.animationend(this.$(function(){this.removeClass(a);b&&b.call(this)}));return this},drag:function(){var b=function(b,c){return b.originalEvent.touches&&_.find(b.originalEvent.touches,function(b){return a(b.target).hasParent(c)})||b};return function(d){Platform.touch||window.__globalDragOverlay||(window.__globalDragOverlay=
a("<div>").css({display:"none",position:"fixed",top:0,right:0,bottom:0,left:0,zIndex:999999}).appendTo(document.body));var e=window.__globalDragOverlay,f=d.button||1,g=this.$(function(g){var h=d.relativeTo||this;this.addClass(d.cls||"");if(Platform.touch||g.which===f){var l=h.offset(),n=void 0;if(!d.start||!1!==(n=d.start.call(d.context||this,new Vec2(g.pageX-l.left,g.pageY-l.top),g))){var p=void 0,r=void 0,q=void 0,n=_.clone(n),t=this.$(function(a){if(Platform.touch||a.which===f){a.preventDefault();
a=b(a,this[0]);var e=h.offset();n=d.move.call(d.context||this,n,new Vec2(a.pageX-g.pageX,a.pageY-g.pageY),new Vec2(a.pageX-e.left,a.pageY-e.top),a)||n}else p(a)}),r=function(){a(e||document.body).css(e?{display:"none"}:{}).off("mouseup touchend",q).off("mousemove touchmove",t)},q=this.$(function(a){r();d.end&&(a=b(a,this[0]),d.end.call(d.context||this,n,new Vec2(a.pageX-g.pageX,a.pageY-g.pageY),a));this.removeClass(d.cls||"")}),p=this.$(function(a){r();q(a)});a(e||document.body).css(e?{display:"",
cursor:d.cursor||""}:{}).on("mousemove touchmove",t).one("mouseup touchend",q);d.callMoveAtStart&&d.move.call(d.context||this,n,Vec2.zero,new Vec2(g.pageX-l.left,g.pageY-l.top),g)}}}),h=_.$(this,function(a){var e=_.extend({},b(a,this[0]));if(Platform.touch&&d.longPress){var f=void 0,h=window.setTimeout(_.$(this,function(){this.off("touchmove touchend",f);g(e)}),300),f=this.$(function(){window.clearTimeout(h);this.off("touchmove touchend",f)});this.one("touchmove touchend",f)}else g(e),a.preventDefault(),
...
d,e=d-e,f=b.originalEvent.touches.length;a(this).data("lastTouch",d);!e||500<e||1<f||(b.preventDefault(),a(b.target).trigger("click"))})}})}(jQuery);_.defineTagKeyword("required");_.defineTagKeyword("atom");_.defineKeyword("any",_.identity);
...
c=log.cleanArgs(b),d=_.extend({indent:0},a,log.readConfig(b)),e=Platform.NodeJS?3:2,f=(log.impl.writeBackend.indent||0)+d.indent,g=log.impl.stringifyArguments(c,d),f=_.times(f,_.constant("\t")).join(""),g=g.reversed.match(/(\n*)([^]*)/),d=d.location&&log.impl.location(d.where||$callStack[e+(d.stackOffset||0)])||"",b={color:log.readColor(b),indentedText:g[2].reversed.split("\n").map(_.prepends(f)).join("\n"),trailNewlines:g[1],codeLocation:d};log.impl.writeBackend(b);return c[0]})},defaultWriteBackend:function(a){var b=
