...
jQuery&&function(a){var b=_.clone(a.fn);_.extend(a,{svg:function(b){return a(document.createElementNS("http://www.w3.org/2000/svg",b))}}).fn.extend({on:function(a,d){var e=this;d=_.find(arguments,_.isFunction);d.queuedBy&&d.queuedBy.push({remove:function(){e.off(a,d)}});return b.on.apply(this,arguments)},item:function(a){return a?(this.length&&(this[0]._item=a),this):this.length?this[0]._item:void 0},extend:function(a){_.extend.apply(null,[this[0]].concat(arguments));return this},extend2:function(a){_.extend2.apply(null,
