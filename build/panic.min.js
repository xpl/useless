...
_.bullet=function(a,b){var c=" ".repeats(a.length);return _.joinWith("\n",_.splitWith("\n",b).map(function(b,e){return 0===e?a+b:c+b}))};_.pretty=function(a,b){return _.stringify(a,_.extend(b||{},{pretty:!0}))};_.stringify=function(a,b){b=b||{};var c=_.stringifyImpl(a,[],[],0,b);return 80>c.length||"pretty"in b?c:_.stringifyImpl(a,[],[],0,_.extend(b,{pretty:!0}))};_.stringifyPrototype=function(a){if(Platform.NodeJS){var b="";a.$meta(function(a){b=a.name});return b&&b+" ()"}return"<prototype>"};
_.stringifyImpl=function(a,b,c,d,e){var g=e.formatter&&e.formatter(a);if(g)return g;"undefined"!==typeof jQuery&&_.isTypeOf(jQuery,a)&&(a=_.asArray(a));if(a===$global)return"$global";if(0<=b.indexOf(a))return e.pure?void 0:"<cyclic>";if(0<=c.indexOf(a))return e.pure?void 0:"<ref:"+c.indexOf(a)+">";if(void 0===a)return"undefined";if(null===a)return"null";if(_.isFunction(a))return e.pure?a.toString():_.isPrototypeConstructor(a)&&_.stringifyPrototype(a)||"<function>";if("string"===typeof a)return _.quoteWith('"',
a);if(_.isTypeOf(Tags,a))return _.reduce(_.keys(Tags.get(a)),function(a,b){return b+" "+a.quote("()")},_.stringifyImpl($untag(a),b,c,d+1,e));if(!e.pure&&_.hasOOP&&_.isPrototypeInstance(a)&&$prototype.defines(a.constructor,"toString"))return a.toString();if(!_.isObject(a)||"undefined"!==typeof $atom&&$atom.is(a))return _.isDecimal(a)&&0<e.precision?_.toFixed(a,e.precision):a+"";var f=_.isArray(a),g=e.pretty||!1;if("browser"===_.platform().engine){if(_.isTypeOf(Element,a))return"<"+a.tagName.lowercase+
">";if(_.isTypeOf(Text,a))return"@"+a.wholeText}if(a.toJSON)return _.quoteWith('"',a.toJSON());if(!e.pure&&(d>(e.maxDepth||5)||f&&a.length>(e.maxArrayLength||30)))return f?"<array["+a.length+"]>":"<object>";b=b.concat([a]);c.push(a);var h=_.pairs(a),k=_.stringifyImpl.tails2(b,c,d+1,e);if(g){h=_.values(a);a=_.alignStringsRight(_.keys(a).map(_.appends(": ")));c=h.map(k);d=c.map(function(a,b){return"["===a[0]||"{"===a[0]?3:_.isString(h[b])?1:0});var n=_.max(d);c=[d,c].zip(function(a,b){return" ".repeats(n-
a)+b});a=f?c:[a,c].zip(_.bullet);a=_.bullet(f?"[ ":"{ ",a.join(",\n"));c=a.split("\n");return a+(" ".repeats(_.max(c.map(_.count))-_.count(c.last))+(f?" ]":" }"))}return _.quoteWith(f?"[]":"{  }",_.joinWith(", ",_.map(h,function(a){return(f?"":a[0]+": ")+k(a[1])})))};_.toFixed=function(a,b){return a&&a.toFixed&&a.toFixed(b)||void 0};_.toFixed2=function(a){return _.toFixed(a,2)};_.toFixed3=function(a){return _.toFixed(a,3)};_.hasStdlib=!0;
...
_.mapKeys=function(a,b){return _.isArray(a)?_.map(a,_.mapKeys.tails2(b)):_.isStrictlyObject(a)?_.object(_.map(_.pairs(a),function(a){return[b(a[0]),_.mapKeys(a[1],b)]})):a};_.mixin({mapMap:_.hyperOperator(_.unary,_.map2)});
...
_.each2=function(a,b){if(_.isArray(a))for(var c=0,d=a.length;c<d;c++)b(a[c],c,d);else if(_.isStrictlyObject(a))for(var e=Object.keys(a),g,c=0,d=e.length;c<d;c++)b(a[g=e[c]],g,d);else b(a,void 0,1)};_.reduce2=function(a,b,c){var d=3>arguments.length,e=a,g=b,f=c;d&&(e=void 0,g=a,f=b);_.each2(g,function(a){e=d?a:f(e,a);d=!1});return e};_.reduceReduce=function(a,b,c){var d=a,e=b,g=c;3>arguments.length&&(d={},e=a,g=b);return _.hyperOperator(_.binary,_.reduce2,_.goDeeperAlwaysIfPossible)(d,e,g)};
...
_.extendedDeep=_.tails3(_.zipZip,function(a,b){return void 0===b?a:b});_.extend2=$restArg(function(a){return _.extend(a,_.reduceRight(arguments,function(a,c){return _.object(_.map(_.union(_.keys(c),_.keys(a)),function(d){var e=c[d];return[d,d in a?"object"===typeof e?_.extend(e,a[d]):a[d]:e]}))},{}))});_.nonempty=function(a){return _.filter2(a,_.isNonempty)};_.extend(_,{cloneDeep:_.tails2(_.mapMap,function(a){return _.isStrictlyObject(a)&&!_.isPrototypeInstance(a)?_.clone(a):a})});
...
_.extend(_,{index:function(a){for(var b={},c=0,d=a.length;c<d;c++)b[a[c]]=!0;return b}});_.quote=function(a,b){var c=b||'"',d=Math.floor(c.length/2+c.length%2),e=c.slice(0,d),c=c.slice(d)||e;return e+a+c};_.quoteWith=_.flip2(_.quote);_.quotesWith=_.higherOrder(_.quoteWith);_.partition2=function(a,b){var c=void 0,d=[],e=[];_.each(a,function(a){var f=b(a);c!=f&&e.length&&(d.push(e),e=[]);e.push(a);c=f});e.length&&d.push(e);return d};
_.linearMerge=function(a,b){b=b||{key:_.identity};var c={key:null,next:{}},d={};_.each(a,function(a){for(var e=0,g=a.length,f=c,m=void 0;e<g;e++,f=m){var m=a[e],p=b.key(m),m=d[p]||(d[p]={key:p,item:m,next:{}});f&&(f.next[p]=m)}});var e=function(a,b){a[b.key]=!0;b.next=_.chain(_.values(b.next)).filter(function(b){return!(b.key in a)}).map(_.partial(e,a)).value();delete a[b.key];return b},g=function(a,b){return a===b||_.some(a.next,function(a){return g(a,b)})},f=function(a){if(!a)return[];var c=b.sort?
_.sortBy(a.next||[],b.sort):a.next||[];return[a].concat(f(_.reduce(c,function(a,b){if(a===b)return a;if(g(b,a))return b.next.push(a),b;a.next.push(b);return a})))};return _.rest(_.pluck(f(e({},c)),"item"))};_.key=function(a){return function(b,c){return a(c)}};_.filterKeys=function(a,b){return _.filter(a,function(a,d){return b(d)})};_.rejectKeys=function(a,b){return _.reject(a,function(a,d){return b(d)})};_.pickKeys=function(a,b){return _.pick(a,function(a,d){return b(d)})};
...
_.extend(_.cps,{each:function(a,b,c,d,e,g){var f=arguments.callee,h=d||0,k=0===h?void 0===a.length?_.keys(a):void 0:g,n=0===h?k?k.length:a.length:e,l=2!==_.numArgs(b);if(!a||h>=(n||0))c&&c();else{var m=k?k[h]:h,p=function(){f(a,b,c,h+1,n,k)};l?b(a[m],m,p,c,a):b(a[m],p,c,a)}}});_.extend(_.cps,{map:function(a,b,c){var d=_.isArray(a)?[]:{};_.cps.each(a,2==_.numArgs(b)?function(a,c,f){b(a,function(a){d[c]=a;f()})}:function(a,c,f){b(a,c,function(a){d[c]=a;f()})},function(){c(d)})}});
...
$assert(_.catches(_.throwsError(42),$assertMatches.$({message:42}).returns("yo"))(),"yo");$assertCPS(_.constant("yo").catches($fails),"yo")};$extensionMethods(Function,{catch_:function(a,b,c,d){return a.catches(b,c)()},catches:function(a,b,c,d){var e=arguments.length;b=1<e?_.coerceToFunction(b):_.identity;c=2<e?_.coerceToFunction(c):_.identity;d=3<e?_.coerceToFunction(d):_.identity;return function(){var e=void 0,f=!1;try{e=a.apply(this,arguments)}catch(h){e=b(h),f=!0}f||(e=c(e));return d(e)}}});
...
function(a){return function(b,e,g){var f=b[e];b=_.isBindable(f)?f:b[e]=_.bindable(f);return b[a].call(b,g)}}.flip2),{unbind:function(b,d,e){var g=b[d];_.isBindable(g)&&_.each(a,function(a){g["_"+a]=_.without(g["_"+a],e)})},isBindable:function(a){return a&&a._bindable?!0:!1},bindable:_.extendWith({hooks:a,hooksShort:["onceBefore","onceAfter","before","after",""]},function(a,d){return _.withSameArgs(a,_.extendWith(b(a,d),function(){var b=arguments.callee,g=b._onceBefore,f=b._onceAfter,h=b._onBefore,
k=b._onAfter,n=b._intercept,b=d||this,l,m=void 0;if(g.length){l=0;for(m=g.length;l<m;l++)g[l].apply(b,arguments);g.removeAll()}l=0;for(m=h.length;l<m;l++)h[l].apply(b,arguments);g=(n.length?_.cps.compose([a].concat(n)):a).apply(b,arguments);if(k.length||f.length){h=_.asArray(arguments).concat(g);l=0;for(m=k.length;l<m;l++)k[l].apply(b,h);if(f.length){l=0;for(m=f.length;l<m;l++)f[l].apply(b,h);f.removeAll()}}return g}))})})})();
...
this.generateArgumentContractsIfNeeded,this.ensureFinalContracts(b),this.generateConstructor(b),this.evalAlwaysTriggeredMacros(b),this.evalMemberTriggeredMacros(b),this.contributeTraits(b),this.generateBuiltInMembers(b),this.expandAliases,this.defineStaticMembers,this.defineInstanceMembers,this.callStaticConstructor).call(this,a||{}).constructor)},compileMixin:function(a){return _.sequence(this.flatten,this.contributeTraits(),this.expandAliases,this.evalMemberTriggeredMacros(),this.defineStaticMembers,
this.defineInstanceMembers).call(this,a||{}).constructor},evalAlwaysTriggeredMacros:function(a){return function(b){for(var c=$prototype.impl.alwaysTriggeredMacros,d=0,e=c.length;d<e;d++)b=c[d](b,a)||b;return b}},evalMemberTriggeredMacros:function(a){return function(b){var c=$prototype.impl.memberNameTriggeredMacros,d=$prototype.impl.tagTriggeredMacros;_.each(b,function(e,g){c.hasOwnProperty(g)&&(b=c[g](b,e,g,a)||b);_.each(_.keys(e),function(c){d.hasOwnProperty(c)&&(b=d[c](b,e,g,a)||b)})});return b}},
generateCustomCompilerImpl:function(a){return function(b){b.$impl?(b.$impl.__proto__=a&&a.$impl||this,b.$impl=$static($builtin($property(b.$impl)))):a&&a.$impl&&(b.$impl=$static($builtin($property(a.$impl))));return b}},generateArgumentContractsIfNeeded:function(a){return a.$testArguments?$prototype.wrapMethods(a,function(a,c){return function(){var d=_.asArray(arguments);$assertArguments(d.copy,a.original,c);return a.apply(this,d)}}):a},contributeTraits:function(a){return function(b){if(b.$traits){var c=
b.$traits;this.mergeTraitsMembers(b,c,a);b.$traits=$static($builtin($property(c)));b.hasTrait=$static($builtin(function(a){return 0<=c.indexOf(a)}))}return b}},mergeTraitsMembers:function(a,b,c){_.each(b,function(b){_.defaults(a,_.omit(b.$definition,_.or($builtin.matches,_.key(_.equals("constructor")))))})},extendWithTags:function(a){return _.extendWith(Tags.unwrap(a),_.mapObject(Tags.get(a),$static.arity1))},callStaticConstructor:function(a){a.$constructor&&Tags.unwrap(a.$constructor).call(a);return a},
...
$trait=function(a,b){var c=void 0,d=_.extend(1<arguments.length?b:a,{constructor:_.throwsError("Traits are not instantiable (what for?)"),isTraitOf:$static($builtin(function(a){return _.isTraitOf(c,a)}))});return c=$prototype.impl.compile(d,1<arguments.length?a:b)};_.$=function(a,b){return _.rest(arguments,2).length?_.bind.apply(void 0,[b,a].concat(_.rest(arguments,2))):_.withSameArgs(b,function(){return b.apply(a,arguments)})};
"undefined"!==typeof jQuery&&jQuery.fn.extend({$:function(){return _.$.apply(null,[this].concat(_.asArray(arguments)))}});_.defineKeyword("const",function(a){return $static($property(a))});_.defineTagKeyword("callableAsFreeFunction");$prototype.macroTag("callableAsFreeFunction",function(a,b,c){a.constructor[c]=Tags.unwrap(b).asFreeFunction;return a});$singleton=function(a,b){return new ($prototype.apply(null,arguments))};
...
Component=$prototype({$defaults:$extendable({}),$requires:$extendable({}),$impl:{contributeTraits:function(a){return _.sequence([this.expandTraitsDependencies,$prototype.impl.contributeTraits(a),this.mergeExtendables(a)]).bind(this)},expandTraitsDependencies:function(a){if(a.$depends){var b=[],c=0,d=function(a,g){g.__tempId||(g.__tempId=c++);_.each(a,function(a){b.push([g,a]);d(a.$depends||[],a)})};d($untag(a.$depends),{});_.each(a.$traits=_.reversed(_.rest(_.linearMerge(b,{key:_.property("__tempId")}))),
function(a){delete a.__tempId})}return a},mergeExtendables:function(a){return function(b){_.each(_.pick(a.$definition,$extendable.is),function(a,d){b[d]=Tags.modifySubject(a,function(a){a=_.extendedDeep(a,$untag(b[d]||{}));_.each($untag(b.$traits),function(b){(b=b.$definition[d])&&(a=_.extendedDeep($untag(b),a))});return a})});return b}},mergeTraitsMembers:function(a,b){var c={},d={};_.each([a].concat(_.pluck(b,"$definition")),function(a){_.each(_.omit(a,_.or($builtin.matches,_.key(_.equals("constructor")))),
function(a,b){$bindable.is(a)&&(d[b]=a);(c[b]||(c[b]=[])).push(a)})});_.each(c,function(b,d){var f=_.find(b,Component.isStreamDefinition);if(f){var h=a[d]=Tags.clone(f);h.listeners=[];_.each(b,function(a){a!==f&&h.listeners.push(a)})}else a[d]||(a[d]=c[d][0])});_.each(d,function(b,d){var f=_.nonempty(_.map(_.bindable.hooks,function(a,b){var e=c[_.bindable.hooksShort[b]+d.capitalized];return e&&[a,e]}));if(f.length){var h=(a[d]=Tags.clone(b,_.bindable($untag(b)))).subject;_.each(f,function(a){_.each(a[1],
function(b){b=$untag(b);if(_.isFunction(b))h[a[0]](b)})})}})}},isStreamDefinition:$static(function(a){return _.isObject(a)&&(a.$trigger||a.$triggerOnce||a.$barrier||a.$observable||a.$observableProperty)}),mapMethods:function(){var a=_.last(arguments),b=1===arguments.length?_.constant(!0):arguments[0],c;for(c in this){var d=this.constructor.$definition[c];if(!d||!d.$property){var e=this[c];b(d)&&_.isFunction(e)&&!_.isPrototypeConstructor(e)&&(this[c]=a.call(this,e,c,d)||e)}}},enumMethods:function(a,
b){2===arguments.length?this.mapMethods(a,b.returns(void 0)):this.mapMethods(a.returns(void 0))},constructor:$final(function(a,b){this.parent_=void 0;this.children_=[];var c=this.cfg="object"===typeof a?a:{},d=this.constructor.$definition;this.constructor.$defaults&&(c=this.cfg=_.extend(_.cloneDeep(this.constructor.$defaults),c));this.mapMethods(function(a,b){if("$"!==b&&"init"!==b)return this.$(a)});_.onBefore(this,"destroy",this.beforeDestroy);_.onAfter(this,"destroy",this.afterDestroy);var e=[],
g={init:!0};_.each(d,function(a,b){if(void 0!==a){if(a.$observableProperty){var d=a.subject,n=b in c?c[b]:d,l=b+"Change",m=g[l]=this[l]=_.observable();m.context=this;m.postpones=a.$postpones;if(_.isPrototypeInstance(d)){var p=d.constructor;m.beforeWrite=function(a){return p.isTypeOf(a)?a:new p(a)}}a.$reference&&(m.trackReference=!0);_.defineProperty(this,b,{get:function(){return m.value},set:function(a){m.call(this,a)}});a.listeners&&_.each(a.listeners,function(a){e.push([m,a])});_.isFunction(a.$observableProperty)&&
e.push([m,a.$observableProperty]);void 0!==n&&m(n)}else if(Component.isStreamDefinition(a)){var q=g[b]=this[b]=_.extend((a.$trigger?_.trigger:a.$triggerOnce?_.triggerOnce:a.$observable?_.observable:a.$barrier?_.barrier:void 0)(a.subject),{context:this,postpones:a.$postpones});a.listeners&&_.each(a.listeners,function(a){e.push([q,a])});(d=c[b])&&e.push([q,d])}a.$listener&&(this[b].queuedBy=[]);a.$interlocked&&(this[b]=_.interlocked(this[b]));a.$bindable&&(_.hasAsserts&&$assert(_.isFunction(this[b])),
this[b]=_.extendWith(a.defaultHooks||{},_.bindable(this[b],this)));a.$debounce&&(d=this[b],n=_.coerceToObject(a.$debounce),this[b]=d.debounced(n.wait||500,n.immediate));a.$throttle&&(d=this[b],n=_.coerceToObject(a.$throttle),this[b]=_.throttle(d,n.wait||500,n));a.$memoize?this[b]=_.memoize(this[b]):a.$memoizeCPS&&(this[b]=_.cps.memoize(this[b]))}},this);_.intercept(this,"init",function(a){(_.hasArgs(this.constructor.prototype.init)?_.cps.sequence:_.sequence)([this._beforeInit,a.bind(this),this._afterInit]).call(this)});
_.each(c,function(a,b){b in g||(this[b]=_.isFunction(a)?this.$(a):a)},this);_.each(d,function(a,b){a&&a.$alias&&(this[b]=this[Tags.unwrap(a)])},this);_.hasAsserts&&_.each(this.constructor.$requires,function(a,b){$assertTypeMatches(this[b],a)},this);_.each(e,function(a){a[0].call(this,a[1])},this);!1===c.init||this.constructor.$defaults&&!1===this.constructor.$defaults.init||this.init()}),callTraitsMethod:function(a,b){_.isFunction(b)?_.cps.sequence(_.filter2(this.constructor.$traits||[],this.$(function(b){return(b=
b.prototype[a])&&_.cps.arity0(_.noArgs(b)?b.asContinuation:b).bind(this)||!1})).concat(b.arity0))():_.sequence(_.filter2(this.constructor.$traits||[],this.$(function(b){return(b=b.prototype[a])&&(_.hasArgs(b)?b.bind(this,_.identity):b.bind(this))||!1})))()},_beforeInit:function(a){if(this.initialized.already)throw Error("Component: I am already initialized. Probably you're doing it wrong.");this.callTraitsMethod("beforeInit",a)},init:function(){},_afterInit:function(a){var b=this.cfg;this.callTraitsMethod("afterInit",
a);this.initialized(!0);_.each(this.constructor.$definition,function(a,d){if(a&&a.$observableProperty){d+="Change";var e=b[d];if(e)this[d](e)}},this)},initialized:$barrier(),beforeDestroy:function(){if(this.destroyed_)throw Error("Component: I am already destroyed. Probably you're doing it wrong.");if(this.destroying_)throw Error("Component: Recursive destroy() call detected. Probably you're doing it wrong.");this.destroying_=!0;this.enumMethods(_.off);_.each(this.children_,_.method("destroy"));this.children_=
[]},destroy:function(){},afterDestroy:function(){_.each(this.constructor.$traits,function(a){a.prototype.destroy&&a.prototype.destroy.call(this)},this);delete this.destroying_;this.parent_=void 0;this.destroyed_=!0},attachedTo:$property(function(){return this.parent_}),attachTo:function(a){if(a===this)throw Error("smells like time-travel paradox.. how else can I be parent of myself?");this.parent_!==a&&(void 0!==this.parent_&&this.parent_.children_.remove(this),void 0!==(this.parent_=a)&&this.parent_.children_.push(this));
...
var e=window.__globalDragOverlay,g=d.button||1,f=this.$(function(f){var h=d.relativeTo||this;this.addClass(d.cls||"");if(Platform.touch||f.which===g){var l=h.offset(),m=void 0;if(!d.start||!1!==(m=d.start.call(d.context||this,new Vec2(f.pageX-l.left,f.pageY-l.top),f))){var p=void 0,q=void 0,r=void 0,m=_.clone(m),t=this.$(function(a){if(Platform.touch||a.which===g){a.preventDefault();a=b(a,this[0]);var e=h.offset();m=d.move.call(d.context||this,m,new Vec2(a.pageX-f.pageX,a.pageY-f.pageY),new Vec2(a.pageX-
e.left,a.pageY-e.top),a)||m}else p(a)}),q=function(){a(e||document.body).css(e?{display:"none"}:{}).off("mouseup touchend",r).off("mousemove touchmove",t)},r=this.$(function(a){q();d.end&&(a=b(a,this[0]),d.end.call(d.context||this,m,new Vec2(a.pageX-f.pageX,a.pageY-f.pageY),a));this.removeClass(d.cls||"")}),p=this.$(function(a){q();r(a)});a(e||document.body).css(e?{display:"",cursor:d.cursor||""}:{}).on("mousemove touchmove",t).one("mouseup touchend",r);d.callMoveAtStart&&d.move.call(d.context||this,
m,Vec2.zero,new Vec2(f.pageX-l.left,f.pageY-l.top),f)}}}),h=_.$(this,function(a){var e=_.extend({},b(a,this[0]));if(Platform.touch&&d.longPress){var g=void 0,h=window.setTimeout(_.$(this,function(){this.off("touchmove touchend",g);f(e)}),300),g=this.$(function(){window.clearTimeout(h);this.off("touchmove touchend",g)});this.one("touchmove touchend",g)}else f(e),a.preventDefault(),a.stopPropagation()});this.on(Platform.touch?"touchstart":"mousedown",h);return _.extend(this,{cancel:this.$(function(){this.off(Platform.touch?
...
b]}):c;}},assertType:function(a,b){return _.assert(_.decideType(a),b)},assertTypeMatches:function(a,b){return _.isEmpty(_.typeMismatches(b,a))?!0:_.assertionFailed({asColumns:!0,notMatching:[{value:a},{type:_.decideType(a)},{contract:b},{mismatches:void 0}]})},assertFails:function(a){return _.assertThrows.call(this,a,_.isAssertionError)},assertThrows:function(a,b){var c=void 0,d=!1;try{a.call(this)}catch(e){c=e,d=!0}_.assert.call(this,d);1<arguments.length&&_.assertMatches.apply(this,[c].concat(_.rest(arguments)))},
assertNotThrows:function(a){return _.assertEveryCalled(function(b){a();b()})},assertArguments:function(a,b,c){b=(b||a.callee).toString();var d=b.match(/.*function[^\(]\(([^\)]+)\)/);if(d){a=_.asArray(a);var d=_.map(d[1].split(","),function(a){a="_"===a.trim()[0]?a.replace(/_/g," ").trim():void 0;var b=parseInt(a,10);return _.isFinite(b)?b:a}),e=_.zipWith([d,a],function(a,b){return void 0===a?!0:a===b});_.every(e)||_.assertionFailed({notMatching:_.nonempty([[c,b].join(": "),d,a])})}},fail:function(){_.assertionFailed()},
fails:_.constant(function(){_.assertionFailed()}),stub:function(){_.assertionFailed()}});_.extend(_,{assertionError:function(a){return _.extend(Error("assertion failed"),a,{assertion:!0})},assertionFailed:function(a){throw _.extend(_.assertionError(a),{stack:_.rest(Error().stack.split("\n"),3).join("\n")});},isAssertionError:function(a){return!0===a.assertion}});_.extend(_,{allEqual:function(a){return _.reduce(a,function(b,c){return b&&_.isEqual(a[0],c)},!0)}});
_.each(_.keys(_.assertions),function(a){_.defineGlobalProperty("$"+a,_[a],{configurable:!0})});
(function(){_.hasUncaught=!0;var a=_.globalUncaughtExceptionHandler=function(a){var c=arguments.callee.chain;arguments.callee.chain=_.reject(c,_.property("catchesOnce"));if(c.length)for(var d=0,e=c.length;d<e;d++)try{c[d](a);break}catch(g){console.log(g);if(d===e-1)throw g.message+=" [re-thrown by a hook]",g;g&&"object"===typeof g&&(g.originalError=a);a=g}else throw a.message+=" [re-thrown by a hook]",a;};_.withUncaughtExceptionHandler=function(b,c){var d=c||_.identity;c&&(b.catchesOnce=!0);a.chain.unshift(b);
...
log.impl.defaultWriteBackend},impl:{write:function(a){return $restArg(function(){var b=log.writeBackend(),c=_.asArray(arguments),d=log.cleanArgs(c),e=_.extend({indent:0},a,log.readConfig(c)),g=Platform.NodeJS?1:3,f=(b.indent||0)+e.indent,h=log.impl.stringifyArguments(d,e),f=_.times(f,_.constant("\t")).join(""),h=h.reversed.match(/(\n*)([^]*)/),g=e.location&&log.impl.location(e.where||$callStack[g+(e.stackOffset||0)])||"",c={color:e.color||log.readColor(c),indentedText:h[2].reversed.split("\n").map(_.prepends(f)).join("\n"),
trailNewlines:h[1],codeLocation:g,config:e};b(c);return d[0]})},defaultWriteBackend:function(a){var b=a.color,c=a.indentedText,d=a.codeLocation;a=a.trailNewlines;(b=b&&(Platform.NodeJS?b.shell:b.css))?Platform.NodeJS?console.log(b+c+"\u001b[0m",d,a):(c=c.split("\n"),c=[_.first(c)||""].concat(_.rest(c).map(_.prepends(" "))),console.log("%c"+c.join("\n"),"color: "+b,d,a)):console.log(c,d,a)},location:function(a){return _.quoteWith("()",_.nonempty([a.calleeShort,a.fileName+":"+a.line]).join(" @ "))},
...
log.withWriteBackend(function(b){c.append(a("<div>").css({color:b.color.css}).html(_.escape(b.indentedText)+(b.codeLocation&&' <span class="location">'+b.codeLocation+"</span>"||"")+(b.trailNewlines||"").replace(/\n/g,"<br>")))},function(a){b.evalLogCalls();a()});return[a('<div class="panic-alert-error-message" style="font-weight: bold;">').text(b.name).append('<span style="float:right; opacity: 0.25;">test failed</span>'),c]},printError:function(b){var c=CallStack.fromErrorWithAsync(b);return[a('<div class="panic-alert-error-message" style="font-weight: bold;">').text(b.message).append(_.any(c,
function(a,b){return(a.thirdParty||a["native"])&&0!==b})?'<a class="clean-toggle" href="javascript:{}"></a>':"").click(this.$(function(b){a(b.delegateTarget).parent().toggleClass("all").transitionend(this.$(function(){this.modalBody.scroll()}))})),a('<ul class="callstack">').append(_.map(c,this.$(function(b){var c=a('<li class="callstack-entry">').toggleClass("third-party",b.thirdParty).toggleClass("native",b["native"]).append([a('<span class="file">').text(_.nonempty([b.index?"(index)":b.fileShort,
b.line]).join(":")),a('<span class="callee">').text(b.calleeShort),a('<span class="src i-am-busy">').click(this.$(function(g){var f=a(g.delegateTarget);f.waitUntil(_.readSource.partial((b.remote?"api/source/":"")+b.file),this.$(function(g){c.is(".full")?(c.removeClass("full"),c.transitionend(function(){c.is(".full")||b.sourceReady(f.$(a.fn.text))})):(c.addClass("full"),f.html(_.map(g.split("\n"),function(b){return a('<div class="line">').text(b)})),g=f.find(".line").eq(b.line-1).addClass("hili"),
g.length&&(g=g.offset().top-f.offset().top,f.scrollTop(g-100)),_.delay(this.$(function(){var a=f.outerBBox().bottom+242-this.modalBody.outerBBox().bottom;0<a&&this.modalBody.animate({scrollTop:this.modalBody.scrollTop()+a},250)})))}))}))]);b.sourceReady(function(a){c.find(".src").removeClass("i-am-busy").text(a)});return c})))]}});a.fn.extend({enableScrollFaders:function(b){var c=b&&b.horizontal,d,e;b=this.find(b&&b.scroller||".scroller");this.css({position:"relative"});this.append(d=a('<div class="scroll-fader scroll-fader-'+
(c?"left":"top")+'"></div>')).append(e=a('<div class="scroll-fader scroll-fader-'+(c?"right":"bottom")+'"></div>'));b.scroll(function(){var b=c?a(this).scrollLeft():a(this).scrollTop(),f=c?a(this).width():a(this).height(),h=(c?this.scrollWidth:this.scrollHeight)-1;d.css({opacity:0<b?1:0});e.css({opacity:b+f<h?1:0})}).scroll();return this}})})(jQuery);
