...
_.atIndex=function(a){return function(b){return b[a]}};_.takesFirst=_.higherOrder(_.first);_.takesLast=_.higherOrder(_.last);_.call=function(a){return a()};_.applies=function(a,b,c){return function(){return a.apply(b,c)}};_.prepends=function(a){return function(b){return a+b}};_.appends=function(a){return function(b){return b+a}};_.join=function(a,b){return a.join(b)};_.joinWith=_.flip2(_.join);_.joinsWith=_.higherOrder(_.joinWith);_.sum=function(a,b){return(a||0)+(b||0)};
...
$extensionMethods(Function,{$:$method(_.partial),bind:_.bind,partial:_.partial,tails:_.tails,tails2:_.tails2,tails3:_.tails3,compose:_.compose,then:_.then,flip:_.flip,flip2:_.flip2,flip3:_.flip3,asFreeFunction:_.asFreeFunction,asMethod:_.asMethod,asPromise:function(a){return new Promise(a)},asContinuation:function(a){return $restArg(function(){_.last(arguments)(a.apply(this,_.initial(arguments)))})},wraps:function(a,b){a._wrapped=_.withSameArgs(a,b);return a},wrapped:function(a){return a._wrapped||
a},original:function(a){for(;a&&a._wrapped;)a=a._wrapped;return a},arity0:_.arity0,arity1:_.arity1,arity2:_.arity2,arity3:_.arity3,or:_.or,and:_.and,not:_.not,applies:_.applies,oneShot:function(a){var b=!1;return function(){if(!b)return b=!0,a.apply(this,arguments)}},memoized:_.memoize,throttled:_.throttle,debounced:function(a,b,c){var d,e,g,f,h,k=function(){var l=Date.now()-d;l<b&&0<l?e=setTimeout(k,b-l):(e=null,c||(g=a.apply(h,f),e||(h=f=null)))},m=function(){h=this;f=arguments;d=Date.now();var l=
...
generateCustomCompilerImpl:function(a){return function(b){b.$impl?(b.$impl.__proto__=a&&a.$impl||this,b.$impl=$static($builtin($property(b.$impl)))):a&&a.$impl&&(b.$impl=$static($builtin($property(a.$impl))));return b}},generateArgumentContractsIfNeeded:function(a){return a.$testArguments?$prototype.wrapMethods(a,function(a,c){return function(){var d=_.asArray(arguments);$assertArguments(d.copy,a.original,c);return a.apply(this,d)}}):a},contributeTraits:function(a){if(a.$traits){var b=a.$traits;this.mergeTraitsMembers(a,
b);a.$traits=$static($builtin($property(b)));a.hasTrait=$static($builtin(function(a){return 0<=b.indexOf(a)}))}return a},mergeTraitsMembers:function(a,b){_.each(b,function(b){_.defaults(a,_.omit(b.$definition,_.or($builtin.matches,_.key(_.equals("constructor")))))})},extendWithTags:function(a){return _.extendWith(Tags.unwrap(a),_.mapObject(Tags.get(a),$static.arity1))},callStaticConstructor:function(a){a.$constructor&&a.$constructor();return a},generateConstructor:function(a){return function(b){return _.extend(b,
...
Platform.NodeJS&&(module.exports=_);_.defineKeyword("component",function(a){return $extends(Component,a)});_("trigger triggerOnce barrier observable bindable memoize interlocked memoizeCPS debounce throttle overrideThis listener postpones reference".split(" ")).each(_.defineTagKeyword);_.defineTagKeyword("observableProperty",_.flip);_.defineKeyword("observableRef",function(a){return $observableProperty($reference(a))});
$prototype.inheritsBaseValues=function(a){$prototype.macro(a,function(b,c,d,e){c=_.extendedDeep(e&&e[a]||{},c);_.each(b.$traits,function(b){c=_.extendedDeep(b[a],c)});b[a]=$static($builtin($property(_.constant(c))));return b})};$prototype.inheritsBaseValues("$defaults");$prototype.inheritsBaseValues("$requires");
...
this.constructor.$definition[c];if(!d||!d.$property){var e=this[c];b(d)&&_.isFunction(e)&&!_.isPrototypeConstructor(e)&&a.call(this,e,c,d)}}},constructor:$final(function(a,b){this.parent_=void 0;this.children_=[];var c=this.cfg="object"===typeof a?a:{},d=this.constructor.$definition;this.constructor.$defaults&&(c=this.cfg=_.extend(_.cloneDeep(this.constructor.$defaults),c));this.enumMethods(function(a,b){"$"!==b&&"init"!==b&&(this[b]=this.$(a))});_.onBefore(this,"destroy",this.beforeDestroy);_.onAfter(this,
"destroy",this.afterDestroy);var e=[],g={init:!0};_.each(d,function(a,b){if(void 0!==a){if(a.$observableProperty){var d=a.subject,m=b in c?c[b]:d,l=b+"Change",n=g[l]=this[l]=_.observable();n.context=this;n.postpones=a.$postpones;if(_.isPrototypeInstance(d)){var p=d.constructor;n.beforeWrite=function(a){return p.isTypeOf(a)?a:new p(a)}}a.$reference&&(n.trackReference=!0);_.defineProperty(this,b,{get:function(){return n.value},set:function(a){n.call(this,a)}});a.listeners&&_.each(a.listeners,function(a){e.push([n,
...
i:log.impl.write({location:!0}).partial(log.color.blue),w:log.impl.write({location:!0}).partial(log.color.orange),warn:log.impl.write({location:!0}).partial(log.color.orange),warning:log.impl.write({location:!0}).partial(log.color.orange),success:log.impl.write({location:!0}).partial(log.color.green),ok:log.impl.write({location:!0}).partial(log.color.green),g:log.impl.write({location:!0}).partial(log.color.green)});log.writes=log.printAPI.writes=_.higherOrder(log.write);logs=_.map2(log.printAPI,_.higherOrder);
...
this.toggleVisibility(!0);this.layout()},hash:function(a){return((_.isTypeOf(Error,a)?a&&a.stack:_.isTypeOf(Test,a)?a.suite+a.name:a)||"").hash},print:function(a,c){return _.isTypeOf(Error,a)?this.printError(a):_.isTypeOf(Test,a)?this.printFailedTest(a):this.printUnknownStuff(a,c)},printUnknownStuff:function(b,c){return c?b:a("<span>").text(log.impl.stringify(b))},printFailedTest:function(b){var c=a('<pre class="test-log" style="margin-top: 13px;">');log.withWriteBackend(function(b){c.append(a("<div>").css({color:b.color.css}).html(_.escape(b.indentedText)+
(b.codeLocation&&' <span class="location">'+b.codeLocation+"</span>"||"")+(b.trailNewlines||"").replace(/\n/g,"<br>")))},function(a){b.evalLogCalls();a()});return[a('<div class="panic-alert-error-message" style="font-weight: bold;">').text(b.name).append('<span style="float:right; opacity: 0.25;">test failed</span>'),c]},printError:function(b){var c=CallStack.fromErrorWithAsync(b);return[a('<div class="panic-alert-error-message" style="font-weight: bold;">').text(b.message).append(_.any(c,function(a,
b){return(a.thirdParty||a["native"])&&0!==b})?'<a class="clean-toggle" href="javascript:{}"></a>':"").click(this.$(function(b){a(b.delegateTarget).parent().toggleClass("all").transitionend(this.$(function(){this.modalBody.scroll()}))})),a('<ul class="callstack">').append(_.map(c,this.$(function(b){var c=a('<li class="callstack-entry">').toggleClass("third-party",b.thirdParty).toggleClass("native",b["native"]).append([a('<span class="file">').text(_.nonempty([b.index?"(index)":b.fileShort,b.line]).join(":")),
a('<span class="callee">').text(b.calleeShort),a('<span class="src i-am-busy">').click(this.$(function(g){var f=a(g.delegateTarget);f.waitUntil(_.readSource.partial((b.remote?"api/source/":"")+b.file),this.$(function(g){c.is(".full")?(c.removeClass("full"),c.transitionend(function(){c.is(".full")||b.sourceReady(f.$(a.fn.text))})):(c.addClass("full"),f.html(_.map(g.split("\n"),function(b){return a('<div class="line">').text(b)})),g=f.find(".line").eq(b.line-1).addClass("hili"),g.length&&(g=g.offset().top-
