...
if("a1 b2 c3"!==_.zipWith([["a","b","c"],[1,2,3]],function(a,c){return a+c}).join(" "))throw Error("_.zipWith broken");return _}();_.tests={};_.deferTest=_.withTest=function(a,c,d){d()};a(3);a(4);a(5);a(6);a(7);a(8);a(9);a(10);a(11);a(12);a(13);a(14);a(15);a(16);a(17);a(18);a(19);a(20);a(21);a(22);a(23);a(24);a(25);a(26);a(27);a(28);a(29);a(30);a(31);a(32);a(33);a(34);a(35);a(36)},function(m,n,a){var b,c;(function(){function a(b){return function(a,c,d,e){c=T(c,e,4);var f=!U(a)&&h.keys(a),k=(f||a).length,
l=0<b?0:k-1;3>arguments.length&&(d=a[f?f[l]:l],l+=b);for(var p=c,t=d;0<=l&&l<k;l+=b)var G=f?f[l]:l,t=p(t,a[G],G,a);return t}}function e(a){return function(b,c,d){c=M(c,d);d=ha(b);for(var e=0<a?0:d-1;0<=e&&e<d;e+=a)if(c(b[e],e,b))return e;return-1}}function f(a,b,c){return function(d,e,f){var k=0,l=ha(d);if("number"==typeof f)0<a?k=0<=f?f:Math.max(f+l,k):l=0<=f?Math.min(f+1,l):f+l+1;else if(c&&f&&l)return f=c(d,e),d[f]===e?f:-1;if(e!==e)return f=b(F.call(d,k,l),h.isNaN),0<=f?f+k:-1;for(f=0<a?k:l-1;0<=
f&&f<l;f+=a)if(d[f]===e)return f;return-1}}function k(a,b){var c=Fa.length,d=a.constructor,d=h.isFunction(d)&&d.prototype||G,e="constructor";for(h.has(a,e)&&!h.contains(b,e)&&b.push(e);c--;)e=Fa[c],e in a&&a[e]!==d[e]&&!h.contains(b,e)&&b.push(e)}var l=this,p=l._,t=Array.prototype,G=Object.prototype,E=t.push,F=t.slice,K=G.toString,S=G.hasOwnProperty,ea=Array.isArray,J=Object.keys,fa=Function.prototype.bind,v=Object.create,V=function(){},h=function(a){if(a instanceof h)return a;if(!(this instanceof
h))return new h(a);this._wrapped=a};"undefined"!==typeof m&&m.exports&&(n=m.exports=h);n._=h;h.VERSION="1.8.3";var T=function(a,b,c){if(void 0===b)return a;switch(null==c?3:c){case 1:return function(c){return a.call(b,c)};case 2:return function(c,d){return a.call(b,c,d)};case 3:return function(c,d,e){return a.call(b,c,d,e)};case 4:return function(c,d,e,f){return a.call(b,c,d,e,f)}}return function(){return a.apply(b,arguments)}},M=function(a,b,c){return null==a?h.identity:h.isFunction(a)?T(a,b,c):
h.isObject(a)?h.matcher(a):h.property(a)};h.iteratee=function(a,b){return M(a,b,Infinity)};var O=function(a,b){return function(c){var d=arguments.length;if(2>d||null==c)return c;for(var e=1;e<d;e++)for(var f=arguments[e],k=a(f),h=k.length,l=0;l<h;l++){var p=k[l];b&&void 0!==c[p]||(c[p]=f[p])}return c}},ba=function(a){if(!h.isObject(a))return{};if(v)return v(a);V.prototype=a;a=new V;V.prototype=null;return a},ma=function(a){return function(b){return null==b?void 0:b[a]}},Ya=Math.pow(2,53)-1,ha=ma("length"),
U=function(a){a=ha(a);return"number"==typeof a&&0<=a&&a<=Ya};h.each=h.forEach=function(a,b,c){b=T(b,c);var d;if(U(a))for(c=0,d=a.length;c<d;c++)b(a[c],c,a);else{var e=h.keys(a);c=0;for(d=e.length;c<d;c++)b(a[e[c]],e[c],a)}return a};h.map=h.collect=function(a,b,c){b=M(b,c);c=!U(a)&&h.keys(a);for(var d=(c||a).length,e=Array(d),f=0;f<d;f++){var k=c?c[f]:f;e[f]=b(a[k],k,a)}return e};h.reduce=h.foldl=h.inject=a(1);h.reduceRight=h.foldr=a(-1);h.find=h.detect=function(a,b,c){b=U(a)?h.findIndex(a,b,c):h.findKey(a,
b,c);if(void 0!==b&&-1!==b)return a[b]};h.filter=h.select=function(a,b,c){var d=[];b=M(b,c);h.each(a,function(a,c,e){b(a,c,e)&&d.push(a)});return d};h.reject=function(a,b,c){return h.filter(a,h.negate(M(b)),c)};h.every=h.all=function(a,b,c){b=M(b,c);c=!U(a)&&h.keys(a);for(var d=(c||a).length,e=0;e<d;e++){var f=c?c[e]:e;if(!b(a[f],f,a))return!1}return!0};h.some=h.any=function(a,b,c){b=M(b,c);c=!U(a)&&h.keys(a);for(var d=(c||a).length,e=0;e<d;e++){var f=c?c[e]:e;if(b(a[f],f,a))return!0}return!1};h.contains=
h.includes=h.include=function(a,b,c,d){U(a)||(a=h.values(a));if("number"!=typeof c||d)c=0;return 0<=h.indexOf(a,b,c)};h.invoke=function(a,b){var c=F.call(arguments,2),d=h.isFunction(b);return h.map(a,function(a){var e=d?b:a[b];return null==e?e:e.apply(a,c)})};h.pluck=function(a,b){return h.map(a,h.property(b))};h.where=function(a,b){return h.filter(a,h.matcher(b))};h.findWhere=function(a,b){return h.find(a,h.matcher(b))};h.max=function(a,b,c){var d=-Infinity,e=-Infinity,f;if(null==b&&null!=a){a=U(a)?
a:h.values(a);for(var k=0,l=a.length;k<l;k++)c=a[k],c>d&&(d=c)}else b=M(b,c),h.each(a,function(a,c,k){f=b(a,c,k);if(f>e||-Infinity===f&&-Infinity===d)d=a,e=f});return d};h.min=function(a,b,c){var d=Infinity,e=Infinity,f;if(null==b&&null!=a){a=U(a)?a:h.values(a);for(var k=0,l=a.length;k<l;k++)c=a[k],c<d&&(d=c)}else b=M(b,c),h.each(a,function(a,c,k){f=b(a,c,k);if(f<e||Infinity===f&&Infinity===d)d=a,e=f});return d};h.shuffle=function(a){a=U(a)?a:h.values(a);for(var b=a.length,c=Array(b),d=0,e;d<b;d++)e=
h.random(0,d),e!==d&&(c[d]=c[e]),c[e]=a[d];return c};h.sample=function(a,b,c){return null==b||c?(U(a)||(a=h.values(a)),a[h.random(a.length-1)]):h.shuffle(a).slice(0,Math.max(0,b))};h.sortBy=function(a,b,c){b=M(b,c);return h.pluck(h.map(a,function(a,c,d){return{value:a,index:c,criteria:b(a,c,d)}}).sort(function(a,b){var c=a.criteria,d=b.criteria;if(c!==d){if(c>d||void 0===c)return 1;if(c<d||void 0===d)return-1}return a.index-b.index}),"value")};var ja=function(a){return function(b,c,d){var e={};c=
M(c,d);h.each(b,function(d,f){var k=c(d,f,b);a(e,d,k)});return e}};h.groupBy=ja(function(a,b,c){h.has(a,c)?a[c].push(b):a[c]=[b]});h.indexBy=ja(function(a,b,c){a[c]=b});h.countBy=ja(function(a,b,c){h.has(a,c)?a[c]++:a[c]=1});h.toArray=function(a){return a?h.isArray(a)?F.call(a):U(a)?h.map(a,h.identity):h.values(a):[]};h.size=function(a){return null==a?0:U(a)?a.length:h.keys(a).length};h.partition=function(a,b,c){b=M(b,c);var d=[],e=[];h.each(a,function(a,c,f){(b(a,c,f)?d:e).push(a)});return[d,e]};
h.first=h.head=h.take=function(a,b,c){return null==a?void 0:null==b||c?a[0]:h.initial(a,a.length-b)};h.initial=function(a,b,c){return F.call(a,0,Math.max(0,a.length-(null==b||c?1:b)))};h.last=function(a,b,c){return null==a?void 0:null==b||c?a[a.length-1]:h.rest(a,Math.max(0,a.length-b))};h.rest=h.tail=h.drop=function(a,b,c){return F.call(a,null==b||c?1:b)};h.compact=function(a){return h.filter(a,h.identity)};var na=function(a,b,c,d){var e=[],f=0;d=d||0;for(var k=ha(a);d<k;d++){var l=a[d];if(U(l)&&
(h.isArray(l)||h.isArguments(l))){b||(l=na(l,b,c));var p=0,t=l.length;for(e.length+=t;p<t;)e[f++]=l[p++]}else c||(e[f++]=l)}return e};h.flatten=function(a,b){return na(a,b,!1)};h.without=function(a){return h.difference(a,F.call(arguments,1))};h.uniq=h.unique=function(a,b,c,d){h.isBoolean(b)||(d=c,c=b,b=!1);null!=c&&(c=M(c,d));d=[];for(var e=[],f=0,k=ha(a);f<k;f++){var l=a[f],p=c?c(l,f,a):l;b?(f&&e===p||d.push(l),e=p):c?h.contains(e,p)||(e.push(p),d.push(l)):h.contains(d,l)||d.push(l)}return d};h.union=
...
e){if(!(d instanceof b))return a.apply(c,e);b=ba(a.prototype);a=a.apply(b,e);return h.isObject(a)?a:b};h.bind=function(a,b){if(fa&&a.bind===fa)return fa.apply(a,F.call(arguments,1));if(!h.isFunction(a))throw new TypeError("Bind must be called on a function");var c=F.call(arguments,2),d=function(){return ca(a,d,b,this,c.concat(F.call(arguments)))};return d};h.partial=function(a){var b=F.call(arguments,1),c=function(){for(var d=0,e=b.length,f=Array(e),k=0;k<e;k++)f[k]=b[k]===h?arguments[d++]:b[k];for(;d<
arguments.length;)f.push(arguments[d++]);return ca(a,c,this,this,f)};return c};h.bindAll=function(a){var b,c=arguments.length,d;if(1>=c)throw Error("bindAll must be passed function names");for(b=1;b<c;b++)d=arguments[b],a[d]=h.bind(a[d],a);return a};h.memoize=function(a,b){var c=function(d){var e=c.cache,f=""+(b?b.apply(this,arguments):d);h.has(e,f)||(e[f]=a.apply(this,arguments));return e[f]};c.cache={};return c};h.delay=function(a,b){var c=F.call(arguments,2);return setTimeout(function(){return a.apply(null,
c)},b)};h.defer=h.partial(h.delay,h,1);h.throttle=function(a,b,c){var d,e,f,k=null,l=0;c||(c={});var p=function(){l=!1===c.leading?0:h.now();k=null;f=a.apply(d,e);k||(d=e=null)};return function(){var t=h.now();l||!1!==c.leading||(l=t);var G=b-(t-l);d=this;e=arguments;0>=G||G>b?(k&&(clearTimeout(k),k=null),l=t,f=a.apply(d,e),k||(d=e=null)):k||!1===c.trailing||(k=setTimeout(p,G));return f}};h.debounce=function(a,b,c){var d,e,f,k,l,p=function(){var t=h.now()-k;t<b&&0<=t?d=setTimeout(p,b-t):(d=null,c||
(l=a.apply(f,e),d||(f=e=null)))};return function(){f=this;e=arguments;k=h.now();var t=c&&!d;d||(d=setTimeout(p,b));t&&(l=a.apply(f,e),f=e=null);return l}};h.wrap=function(a,b){return h.partial(b,a)};h.negate=function(a){return function(){return!a.apply(this,arguments)}};h.compose=function(){var a=arguments,b=a.length-1;return function(){for(var c=b,d=a[b].apply(this,arguments);c--;)d=a[c].call(this,d);return d}};h.after=function(a,b){return function(){if(1>--a)return b.apply(this,arguments)}};h.before=
function(a,b){var c;return function(){0<--a&&(c=b.apply(this,arguments));1>=a&&(b=null);return c}};h.once=h.partial(h.before,2);var sa=!{toString:null}.propertyIsEnumerable("toString"),Fa="valueOf isPrototypeOf toString propertyIsEnumerable hasOwnProperty toLocaleString".split(" ");h.keys=function(a){if(!h.isObject(a))return[];if(J)return J(a);var b=[],c;for(c in a)h.has(a,c)&&b.push(c);sa&&k(a,b);return b};h.allKeys=function(a){if(!h.isObject(a))return[];var b=[],c;for(c in a)b.push(c);sa&&k(a,b);
...
b.push(c);return b.sort()};h.extend=O(h.allKeys);h.extendOwn=h.assign=O(h.keys);h.findKey=function(a,b,c){b=M(b,c);c=h.keys(a);for(var d,e=0,f=c.length;e<f;e++)if(d=c[e],b(a[d],d,a))return d};h.pick=function(a,b,c){var d={},e=a,f,k;if(null==e)return d;h.isFunction(b)?(k=h.allKeys(e),f=T(b,c)):(k=na(arguments,!1,!1,1),f=function(a,b,c){return b in c},e=Object(e));for(var l=0,p=k.length;l<p;l++){var t=k[l],G=e[t];f(G,t,e)&&(d[t]=G)}return d};h.omit=function(a,b,c){if(h.isFunction(b))b=h.negate(b);else{var d=
h.map(na(arguments,!1,!1,1),String);b=function(a,b){return!h.contains(d,b)}}return h.pick(a,b,c)};h.defaults=O(h.allKeys,!0);h.create=function(a,b){var c=ba(a);b&&h.extendOwn(c,b);return c};h.clone=function(a){return h.isObject(a)?h.isArray(a)?a.slice():h.extend({},a):a};h.tap=function(a,b){b(a);return a};h.isMatch=function(a,b){var c=h.keys(b),d=c.length;if(null==a)return!d;for(var e=Object(a),f=0;f<d;f++){var k=c[f];if(b[k]!==e[k]||!(k in e))return!1}return!0};var ya=function(a,b,c,d){if(a===b)return 0!==
a||1/a===1/b;if(null==a||null==b)return a===b;a instanceof h&&(a=a._wrapped);b instanceof h&&(b=b._wrapped);var e=K.call(a);if(e!==K.call(b))return!1;switch(e){case "[object RegExp]":case "[object String]":return""+a===""+b;case "[object Number]":return+a!==+a?+b!==+b:0===+a?1/+a===1/b:+a===+b;case "[object Date]":case "[object Boolean]":return+a===+b}e="[object Array]"===e;if(!e){if("object"!=typeof a||"object"!=typeof b)return!1;var f=a.constructor,k=b.constructor;if(f!==k&&!(h.isFunction(f)&&f instanceof
f&&h.isFunction(k)&&k instanceof k)&&"constructor"in a&&"constructor"in b)return!1}c=c||[];d=d||[];for(f=c.length;f--;)if(c[f]===a)return d[f]===b;c.push(a);d.push(b);if(e){f=a.length;if(f!==b.length)return!1;for(;f--;)if(!ya(a[f],b[f],c,d))return!1}else{e=h.keys(a);f=e.length;if(h.keys(b).length!==f)return!1;for(;f--;)if(k=e[f],!h.has(b,k)||!ya(a[k],b[k],c,d))return!1}c.pop();d.pop();return!0};h.isEqual=function(a,b){return ya(a,b)};h.isEmpty=function(a){return null==a?!0:U(a)&&(h.isArray(a)||h.isString(a)||
h.isArguments(a))?0===a.length:0===h.keys(a).length};h.isElement=function(a){return!(!a||1!==a.nodeType)};h.isArray=ea||function(a){return"[object Array]"===K.call(a)};h.isObject=function(a){var b=typeof a;return"function"===b||"object"===b&&!!a};h.each("Arguments Function String Number Date RegExp Error".split(" "),function(a){h["is"+a]=function(b){return K.call(b)==="[object "+a+"]"}});h.isArguments(arguments)||(h.isArguments=function(a){return h.has(a,"callee")});"function"!=typeof/./&&"object"!=
...
h.noop=function(){};h.property=ma;h.propertyOf=function(a){return null==a?function(){}:function(b){return a[b]}};h.matcher=h.matches=function(a){a=h.extendOwn({},a);return function(b){return h.isMatch(b,a)}};h.times=function(a,b,c){var d=Array(Math.max(0,a));b=T(b,c,1);for(c=0;c<a;c++)d[c]=b(c);return d};h.random=function(a,b){null==b&&(b=a,a=0);return a+Math.floor(Math.random()*(b-a+1))};h.now=Date.now||function(){return(new Date).getTime()};ea={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#x27;",
"`":"&#x60;"};O=h.invert(ea);ma=function(a){var b=function(b){return a[b]},c="(?:"+h.keys(a).join("|")+")",d=RegExp(c),e=RegExp(c,"g");return function(a){a=null==a?"":""+a;return d.test(a)?a.replace(e,b):a}};h.escape=ma(ea);h.unescape=ma(O);h.result=function(a,b,c){b=null==a?void 0:a[b];void 0===b&&(b=c);return h.isFunction(b)?b.call(a):b};var Ka=0;h.uniqueId=function(a){var b=++Ka+"";return a?a+b:b};h.templateSettings={evaluate:/<%([\s\S]+?)%>/g,interpolate:/<%=([\s\S]+?)%>/g,escape:/<%-([\s\S]+?)%>/g};
var oa=/(.)^/,C={"'":"'","\\":"\\","\r":"r","\n":"n","\u2028":"u2028","\u2029":"u2029"},La=/\\|'|\r|\n|\u2028|\u2029/g,Ma=function(a){return"\\"+C[a]};h.template=function(a,b,c){!b&&c&&(b=c);b=h.defaults({},b,h.templateSettings);c=RegExp([(b.escape||oa).source,(b.interpolate||oa).source,(b.evaluate||oa).source].join("|")+"|$","g");var d=0,e="__p+='";a.replace(c,function(b,c,f,k,l){e+=a.slice(d,l).replace(La,Ma);d=l+b.length;c?e+="'+\n((__t=("+c+"))==null?'':_.escape(__t))+\n'":f?e+="'+\n((__t=("+
...
"")).quote("<>");if(_.isTypeOf(Text,a))return"@"+a.wholeText.limitedTo(20)}if(a.toJSON)return _.quoteWith('"',a.toJSON());if(!e.pure&&(d>(e.maxDepth||5)||k&&a.length>(e.maxArrayLength||60)))return k?"<array["+a.length+"]>":"<object>";var l=b.concat([a]);c.push(a);var p=_.pairs(a),t=_.stringifyImpl.tails2(l,c,d+1,e),G=e.json?'""':"";if(f){p=_.values(a);d=_.alignStringsRight(_.keys(a).map(_.quotesWith(G).then(_.appends(": "))));e=p.map(t);var f=e.map(function(a,b){return"["===a[0]||"{"===a[0]?3:_.isString(p[b])?
1:0}),m=_.max(f);e=[f,e].zip(function(a,b){return" ".repeats(m-a)+b});d=k?e:[d,e].zip(_.bullet);d=_.bullet(k?"[ ":"{ ",d.join(",\n"));e=d.split("\n");return d+(" ".repeats(_.max(e.map(_.count))-_.count(e.last))+(k?" ]":" }"))}return _.quoteWith(k?"[]":"{  }",_.joinWith(", ",_.map(p,function(a){return(k?"":a[0].quote(G)+": ")+t(a[1])})))}});_.toFixed=function(a,b){return a&&a.toFixed&&a.toFixed(b)||void 0};_.toFixed2=function(a){return _.toFixed(a,2)};_.toFixed3=function(a){return _.toFixed(a,3)}},
...
b,c){var d,e,f,k,l,p=function(){var t=Date.now()-d;t<b&&0<t?e=setTimeout(p,b-t):(e=null,c||(f=a.apply(l,k),e||(l=k=null)))},t=function(){l=this;k=arguments;d=Date.now();var t=c&&!e;e||(e=setTimeout(p,b));t&&(f=a.apply(l,k),l=k=null);return f};t.cancel=function(){e&&(clearTimeout(e),e=null)};t.callImmediately=function(){t.cancel();a.apply(l,k)};return t},postpone:$method(function(a){a.postponed.apply(null,arguments)}),postponed:function(a){return function(){var b=!a._postponed;a._postponed=_.asArray(arguments);
...
{unbind:function(a,b,e){(a=a[b])&&a.off&&a.off(e)},isBindable:function(a){return a&&a._bindable?!0:!1},bindable:_.extendWith({hooks:a,hooksShort:["onceBefore","onceAfter","before","after","intercept"]},function(a,d){return _.withSameArgs(a,_.extendWith(b(a,d),function(){var b=arguments.callee,f=b._onceBefore,k=b._onceAfter,l=b._onBefore,p=b._onAfter,t=b._intercept,b=d||this,m,n;if(f.length){m=0;for(n=f.length;m<n;m++)f[m].apply(b,arguments);f.removeAll()}m=0;for(n=l.length;m<n;m++)l[m].apply(b,arguments);
f=(t.length?_.cps.compose([a].concat(t)):a).apply(b,arguments);if(p.length||k.length){l=_.asArray(arguments).concat(f);m=0;for(n=p.length;m<n;m++)p[m].apply(b,l);if(k.length)for(p=k.copy,k.removeAll(),m=0,n=p.length;m<n;m++)p[m].apply(b,l)}return f}))})})})},function(m,n){_.tests.stream={triggerOnce:function(){$assertEveryCalledOnce(function(a){var b=_.triggerOnce(),c=function(b){$assert(321===b);a()};b(c);b(c);b(321);b(123)})},observable:function(){var a=_.observable(555);$assert(a.value,555);$assertEveryCalledOnce(function(a){var c=
...
_.isFunction(c)){var l=a.parse(e),m=l.name&&l.name.decapitalized||e;if(l=l.how&&_["on"+l.how.capitalized]||_.intercept){var n=b[m];n&&_.isFunction(n)&&l(b,m,c);var n=b.prototype,G=n[m];G&&_.isFunction(G)&&l(n,m,c)}}});b.aspectAdded&&b.aspectAdded(d);return d})})()},function(m,n){_.tests["Promise+"]={promisify:function(){var a={42:42,dontTouchMe:function(){$assert(0===arguments.length);return 42},dontTouchMe2:function(){$assert(0===arguments.length);return 42},readFileSync:function(){$assert(0===arguments.length);
...
b.filter(_.identity)));$assert(_.isTypeOf(CallStack,b.reject(_.identity)));$assertEveryCalled($async(function(a,c,k){b[0].sourceReady(function(b){$assert(typeof b,"string");a()});b.sourcesReady(function(){_.each(b,function(a){$assert(typeof a.source,"string")});c()});b.safeLocation(7777).sourceReady(function(a){$assert("??? WRONG LOCATION ???",a);k()})}),a)},"Prototype.$meta":function(a){$prototype().$meta(function(b){$assertMatches(b,{name:"Dummy",type:"prototype"});a()})},"Trait.$meta":function(a){$trait().$meta(function(b){$assertMatches(b,
{name:"Dummy",type:"trait"});a()})}};_.defineKeyword("callStack",function(){return CallStack.fromRawString(CallStack.currentAsRawString).offset($platform.NodeJS?1:0)});_.defineKeyword("currentFile",function(){return(CallStack.rawStringToArray(CallStack.currentAsRawString)[$platform.NodeJS?3:1]||{file:""}).file});_.defineKeyword("uselessPath",_.memoize(function(){return _.initial(b.split("/"),$platform.NodeJS?2:1).join("/")+"/"}));_.defineKeyword("sourcePath",_.memoize(function(){var a=($uselessPath.match(/(.+)\/node_modules\/(.+)/)||
[])[1];return a?a+"/":$uselessPath}));$platform.Browser&&_.defineProperty(window,"__filename",function(){return $currentFile});SourceFiles=$singleton(Component,{line:function(a,b,e){SourceFiles.read(a,function(a){e((a.split("\n")[b]||"").trimmed)})},read:$memoizeCPS(function(b,d){if(0>b.indexOf("<"))try{if($platform.NodeJS)d(a(!function(){var a=Error('Cannot find module "fs"');a.code="MODULE_NOT_FOUND";throw a;}()).readFileSync(b,{encoding:"utf8"})||"");else{var e=new XMLHttpRequest;e.open("GET",
b,!0);e.onreadystatechange=function(){4==e.readyState&&d(e.responseText)};e.send(null)}}catch(f){d("")}else d("")}),write:function(a,b,e){$platform.NodeJS?this.read(a,function(a){a=Error('Cannot find module "fs"');a.code="MODULE_NOT_FOUND";throw a;}):JSONAPI.post("source/"+a,_.extend2({},this.apiConfig,{what:{text:b}})).then(function(){log.ok(a,"\u2014 successfully saved");e&&e()})}});CallStack=$extends(Array,{current:$static($property(function(){return CallStack.fromRawString(CallStack.currentAsRawString).offset(1)})),
...
column:(c[2]||"").integerValue}})})});$prototype.impl.findMeta=function(a){return function(b){_.cps.find(CallStack.fromRawString(a).reversed,function(a,b){a.sourceReady(function(c){c=(c||"").match(/([A-z]+)\s*=\s*\$(prototype|singleton|component|extends|trait|aspect)/);b(c&&{name:c[1],type:c[2],file:a.fileShort}||!1)})},function(a){b(a||{})})}};$prototype.macro(function(a,b){if(!a.$meta){var e=_.cps.memoize($prototype.impl.findMeta(CallStack.currentAsRawString));_.defineMemoizedProperty(e,"promise",
function(){return new Promise(e)});a.$meta=$static(e)}return a})}).call(n,"/index.js")},function(m,n){_.hasLog=!0;_.tests.log={basic:function(){log("log (x)");log.green("log.green");log.boldGreen("log.boldGreen");log.darkGreen("log.darkGreen");log.blue("log.blue");log.boldBlue("log.boldBlue");log.darkBlue("log.darkBlue");log.orange("log.orange");log.boldOrange("log.boldOrange");log.darkOrange("log.darkOrange");log.red("log.red");log.boldRed("log.boldRed");log.darkRed("log.darkRed");log.pink("log.pink");
...
["boldGreen",["32m","1m"],"color:forestgreen;font-weight:bold"],["darkGreen",["32m","2m"],"color:forestgreen;opacity:0.5"],["pink","35m","color:magenta"],["boldPink",["35m","1m"],"color:magenta;font-weight:bold;"],["darkPink",["35m","2m"],"color:magenta"],["black","0m","color:black"],["bright",["0m","1m"],"color:rgba(0,0,0);font-weight:bold"],["dark",["0m","2m"],"color:rgba(0,0,0,0.25)"]],function(a){return[a[0],log.config({color:{shell:_.coerceToArray(_.map2(a[1],_.prepends("\u001b["))).join(),css:a[2]}})]}))),
...
d.last&&d.last.text.reversed.match(/(\n*)([^]*)/),f=e&&e[1];e&&(d.last.text=e[2].reversed);var k={},e=_.pluck["with"]("items",_.reject["with"](_.property("label"),_.partition3["with"](_.equals(k),_.scatter(d,function(a,b,c){_.each(a.text.split("\n"),function(b,d,e){c(_.extended(a,{text:b}));d!==e.lastIndex&&c(k)})})))),d=_.pluck(d,"text").join(""),l=c.where||log.impl.walkStack($callStack)||{},m=(c.indentPattern||"\t").repeats(c.indent);a({lines:e,config:c,color:c.color,when:(new Date).toISOString(),
args:_.reject(b,_.isTypeOf.$(log.Config)),indentation:m,indentedText:e.map(_.seq(_.pluck.tails2("text"),_.joinsWith(""),_.prepends(m))).join("\n"),text:d,codeLocation:c.location&&log.impl.location(l)||"",trailNewlines:f||"",where:c.location&&l||void 0});return _.find(b,_.not(_.isTypeOf.$(log.Config)))})),walkStack:function(a){return _.find(a.clean.offset($platform.Browser?1:2),function(a){return 0>a.fileShort.indexOf("base/log.js")})||a[0]},defaultWriteBackend:function(a){var b=a.codeLocation;if($platform.NodeJS){var c=
_.map(a.lines,function(b){return a.indentation+_.map(b,function(a){return a.config.color?a.config.color.shell+a.text+"\u001b[0m":a.text}).join("")}).join("\n");log.timestampEnabled&&(c=log.color("dark").shell+_.bullet(log.impl.timestamp(a.when)+" ",log.color("none").shell+c));console.log(c,log.color("dark").shell+b+"\u001b[0m",a.trailNewlines)}else console.log.apply(console,_.reject["with"](_.equals(void 0),[].concat([log.timestampEnabled?"%c"+log.impl.timestamp(a.when)+"%c":"",_.map(a.lines,function(b,
c){return a.indentation+_.reduce2("",b,function(a,b){return a+(b.text&&(b.config.color?"%c":"")+b.text||"")})}).join("\n"),b?"%c"+b:""].nonempty.join(" "),(log.timestampEnabled?["color:rgba(0,0,0,0.4)","color:black"]:[]).concat(_.scatter(a.lines,function(a,b,c){_.each(a,function(a){a.text&&a.config.color&&c(a.config.color.css)})})||[]).concat(b?"color:rgba(0,0,0,0.25)":[]),a.trailNewlines)))},timestamp:function(a){return a},location:function(a){return _.quoteWith("()",_.nonempty([a.calleeShort,_.nonempty([a.fileName,
a.line]).join(":")]).join(" @ "))},stringifyArguments:function(a,b){return _.map(a,function(a){a=log.impl.stringify(a,b);return b.maxArgLength?a.limitedTo(b.maxArgLength):a}).join(" ")},stringify:function(a,b){b=b||{};if(_.isTypeOf(Error,a)){var c=log.impl.stringifyError(a);return a.originalError?c+"\n\n"+log.impl.stringify(a.originalError):c}return _.isTypeOf(CallStack,a)?log.impl.stringifyCallStack(a):"object"===typeof a?_.isArray(a)&&1<a.length&&_.isObject(a[0])&&b.table?log.asTable(a):_.stringify(a,
b):"string"===typeof a?a:_.stringify(a)},stringifyError:function(a){try{var b=CallStack.fromErrorWithAsync(a).offset(a.stackOffset||0).clean;return"[EXCEPTION] "+(a.message||"").replace(/\r|\n/g,"").trimmed.limitedTo(120)+"\n\n"+(a.notMatching&&_.map(_.coerceToArray(a.notMatching||[]),log.impl.stringify.then(_.prepends("\t"))).join("\n")+"\n\n"||"")+log.impl.stringifyCallStack(b)+"\n"}catch(c){return"YO DAWG I HEARD YOU LIKE EXCEPTIONS... SO WE THREW EXCEPTION WHILE PRINTING YOUR EXCEPTION:\n\n"+
...
b){return 0<=b?a+" ".repeats(b):_.initial(a,-b).join("")}).then(_.joinsWith("  ")))}});$platform.NodeJS&&(m.exports=log)},function(m,n){_.defineTagKeyword("shouldFail");_.defineTagKeyword("async");_.tests.Testosterone={async:function(a){_.delay(function(){a()})},$tests:function(){DummyPrototypeWithTest=$prototype({$test:function(){}});DummyPrototypeWithTests=$prototype({$tests:{dummy:function(){}}});$assertTypeMatches(DummyPrototypeWithTests.$tests,[{"*":"function"}]);$assertThrows(function(){DummyPrototypeWithTests.$tests=
...
b.codebase?__([]):this.collectPrototypeTests()).then(this.$(function(a){var c=!1===b.codebase?[]:this.collectTests();a=_.flatten(_.pluck(c.concat(d).concat(a),"tests"));a=_.filter(a,b.shouldRun||_.constant(!0));this.runningTests=_.map(a,function(a,c){return _.extend(a,{indent:b.indent,index:c})});_.each(this.runningTests,function(a){if(!(a.routine instanceof Function))throw log.ee(a.suite,a.name,"\u2013 test routine is not a function:",a.routine),Error();});this.runningTests=_.filter(this.runningTests,
...
b){return function(){var e=this,m=_.asArray(arguments),n=l&&l.call(this,_.extend({$proto:f.name},_.map2(this,_.stringifyOneLine.arity1)))||this.desc||"",K=_.map(m,_.stringifyOneLine.arity1).join(", ").quote("()");log.write(log.config({color:k,location:!0,where:c.$verbose?void 0:{calleeShort:f.name}}),_.nonempty([n,d,b]).join("."),K);return log.withConfig({indent:1,color:k,protoName:f.name},function(){var b=log.impl.numWrites,c=a.apply(e,m);void 0!==c&&log.write("\u2192",_.stringifyOneLine(c));2>log.currentConfig().indent&&
...
a:9===a.nodeType&&a.defaultView}var ra=[],B=a.document,Kb=Object.getPrototypeOf,ta=ra.slice,kb=ra.concat,ab=ra.push,Na=ra.indexOf,Ra={},rb=Ra.toString,Sa=Ra.hasOwnProperty,sb=Sa.toString,Tb=sb.call(Object),P={},g=function(a,b){return new g.fn.init(a,b)},Ub=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,Vb=/^-ms-/,Wb=/-([a-z])/g,Xb=function(a,b){return b.toUpperCase()};g.fn=g.prototype={jquery:"3.1.0",constructor:g,length:0,toArray:function(){return ta.call(this)},get:function(a){return null!=a?0>a?this[a+this.length]:
...
a.length;g<d;g++)e=b(a[g],g,c),null!=e&&f.push(e);else for(g in a)e=b(a[g],g,c),null!=e&&f.push(e);return kb.apply([],f)},guid:1,proxy:function(a,b){var c,d;"string"===typeof b&&(c=a[b],b=a,a=c);if(g.isFunction(a))return d=ta.call(arguments,2),c=function(){return a.apply(b||this,d.concat(ta.call(arguments)))},c.guid=a.guid=a.guid||g.guid++,c},now:Date.now,support:P});$jscomp.initSymbol();"function"===typeof Symbol&&($jscomp.initSymbol(),$jscomp.initSymbolIterator(),$jscomp.initSymbol(),$jscomp.initSymbolIterator(),
g.fn[Symbol.iterator]=ra[Symbol.iterator]);g.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "),function(a,b){Ra["[object "+b+"]"]=b.toLowerCase()});var xa=function(a){function b(a,c,d,e){var q,g,y,f,u,A=c&&c.ownerDocument,h=c?c.nodeType:9;d=d||[];if("string"!==typeof a||!a||1!==h&&9!==h&&11!==h)return d;if(!e&&((c?c.ownerDocument||c:C)!==D&&F(c),c=c||D,pa)){if(11!==h&&(f=Fa.exec(a)))if(q=f[1])if(9===h)if(g=c.getElementById(q)){if(g.id===q)return d.push(g),d}else return d;
else{if(A&&(g=A.getElementById(q))&&Ja(c,g)&&g.id===q)return d.push(g),d}else{if(f[2])return X.apply(d,c.getElementsByTagName(a)),d;if((q=f[3])&&w.getElementsByClassName&&c.getElementsByClassName)return X.apply(d,c.getElementsByClassName(q)),d}if(!(!w.qsa||Z[a+" "]||aa&&aa.test(a))){if(1!==h)A=c,u=a;else if("object"!==c.nodeName.toLowerCase()){(y=c.getAttribute("id"))?y=y.replace(za,Da):c.setAttribute("id",y=L);g=E(a);for(q=g.length;q--;)g[q]="#"+y+" "+p(g[q]);u=g.join(",");A=sa.test(a)&&n(c.parentNode)||
c}if(u)try{return X.apply(d,A.querySelectorAll(u)),d}catch(k){}finally{y===L&&c.removeAttribute("id")}}}return P(a.replace(ia,"$1"),c,d,e)}function c(){function a(c,d){b.push(c+" ")>H.cacheLength&&delete a[b.shift()];return a[c+" "]=d}var b=[];return a}function d(a){a[L]=!0;return a}function e(a){var b=D.createElement("fieldset");try{return!!a(b)}catch(c){return!1}finally{b.parentNode&&b.parentNode.removeChild(b)}}function g(a,b){for(var c=a.split("|"),d=c.length;d--;)H.attrHandle[c[d]]=b}function f(a,
...
!a&&("label"in b||!Ga(b))!==a)}}function m(a){return d(function(b){b=+b;return d(function(c,d){for(var e,q=a([],c.length,b),g=q.length;g--;)c[e=q[g]]&&(c[e]=!(d[e]=c[e]))})})}function n(a){return a&&"undefined"!==typeof a.getElementsByTagName&&a}function r(){}function p(a){for(var b=0,c=a.length,d="";b<c;b++)d+=a[b].value;return d}function v(a,b,c){var d=b.dir,e=b.next,q=e||d,g=c&&"parentNode"===q,y=fa++;return b.first?function(b,c,e){for(;b=b[d];)if(1===b.nodeType||g)return a(b,c,e)}:function(b,
c,f){var u,A,h=[S,y];if(f)for(;b=b[d];){if((1===b.nodeType||g)&&a(b,c,f))return!0}else for(;b=b[d];)if(1===b.nodeType||g)if(A=b[L]||(b[L]={}),A=A[b.uniqueID]||(A[b.uniqueID]={}),e&&e===b.nodeName.toLowerCase())b=b[d]||b;else{if((u=A[q])&&u[0]===S&&u[1]===y)return h[2]=u[2];A[q]=h;if(h[2]=a(b,c,f))return!0}}}function t(a){return 1<a.length?function(b,c,d){for(var e=a.length;e--;)if(!a[e](b,c,d))return!1;return!0}:a[0]}function V(a,b,c,d,e){for(var q,g=[],y=0,f=a.length,u=null!=b;y<f;y++)if(q=a[y])if(!c||
c(q,d,e))g.push(q),u&&b.push(y);return g}function T(a,c,e,q,g,f){q&&!q[L]&&(q=T(q));g&&!g[L]&&(g=T(g,f));return d(function(d,f,u,A){var h,k,ga=[],l=[],Q=f.length,m;if(!(m=d)){m=c||"*";for(var I=u.nodeType?[u]:u,n=[],Ha=0,Oa=I.length;Ha<Oa;Ha++)b(m,I[Ha],n);m=n}m=!a||!d&&c?m:V(m,ga,a,u,A);I=e?g||(d?a:Q||q)?[]:f:m;e&&e(m,I,u,A);if(q)for(h=V(I,l),q(h,[],u,A),u=h.length;u--;)if(k=h[u])I[l[u]]=!(m[l[u]]=k);if(d){if(g||a){if(g){h=[];for(u=I.length;u--;)(k=I[u])&&h.push(m[u]=k);g(null,I=[],h,A)}for(u=I.length;u--;)(k=
I[u])&&-1<(h=g?ca(d,k):ga[u])&&(d[h]=!(f[h]=k))}}else I=V(I===f?I.splice(Q,I.length):I),g?g(null,f,I,A):X.apply(f,I)})}function M(a){var b,c,d,e=a.length,q=H.relative[a[0].type];c=q||H.relative[" "];for(var g=q?1:0,y=v(function(a){return a===b},c,!0),f=v(function(a){return-1<ca(b,a)},c,!0),u=[function(a,c,d){a=!q&&(d||c!==Ta)||((b=c).nodeType?y(a,c,d):f(a,c,d));b=null;return a}];g<e;g++)if(c=H.relative[a[g].type])u=[v(t(u),c)];else{c=H.filter[a[g].type].apply(null,a[g].matches);if(c[L]){for(d=++g;d<
e&&!H.relative[a[d].type];d++);return T(1<g&&t(u),1<g&&p(a.slice(0,g-1).concat({value:" "===a[g-2].type?"*":""})).replace(ia,"$1"),c,g<d&&M(a.slice(g,d)),d<e&&M(a=a.slice(d)),d<e&&p(a))}u.push(c)}return t(u)}function z(a,c){var e=0<c.length,q=0<a.length,g=function(d,g,f,u,A){var h,k,ga,l=0,Q="0",m=d&&[],I=[],n=Ta,Ha=d||q&&H.find.TAG("*",A),Oa=S+=null==n?1:Math.random()||.1,r=Ha.length;for(A&&(Ta=g===D||g||A);Q!==r&&null!=(h=Ha[Q]);Q++){if(q&&h){k=0;g||h.ownerDocument===D||(F(h),f=!pa);for(;ga=a[k++];)if(ga(h,
g||D,f)){u.push(h);break}A&&(S=Oa)}e&&((h=!ga&&h)&&l--,d&&m.push(h))}l+=Q;if(e&&Q!==l){for(k=0;ga=c[k++];)ga(m,I,g,f);if(d){if(0<l)for(;Q--;)m[Q]||I[Q]||(I[Q]=ja.call(u));I=V(I)}X.apply(u,I);A&&!d&&0<I.length&&1<l+c.length&&b.uniqueSort(u)}A&&(S=Oa,Ta=n);return m};return e?d(g):g}var G,w,H,O,B,E,J,P,Ta,Ca,K,F,D,ka,pa,aa,ba,U,Ja,L="sizzle"+1*new Date,C=a.document,S=0,fa=0,Y=c(),ea=c(),Z=c(),da=function(a,b){a===b&&(K=!0);return 0},ha={}.hasOwnProperty,W=[],ja=W.pop,na=W.push,X=W.push,ma=W.slice,ca=
...
/^[^{]+\{\s*\[native \w/,Fa=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,sa=/[+~]/,va=RegExp("\\\\([\\da-f]{1,6}[\\x20\\t\\r\\n\\f]?|([\\x20\\t\\r\\n\\f])|.)","ig"),wa=function(a,b,c){a="0x"+b-65536;return a!==a||c?b:0>a?String.fromCharCode(a+65536):String.fromCharCode(a>>10|55296,a&1023|56320)},za=/([\0-\x1f\x7f]|^-?\d)|^-$|[^\x80-\uFFFF\w-]/g,Da=function(a,b){return b?"\x00"===a?"\ufffd":a.slice(0,-1)+"\\"+a.charCodeAt(a.length-1).toString(16)+" ":"\\"+a},Ea=function(){F()},Ga=v(function(a){return!0===a.disabled},
{dir:"parentNode",next:"legend"});try{X.apply(W=ma.call(C.childNodes),C.childNodes),W[C.childNodes.length].nodeType}catch(yc){X={apply:W.length?function(a,b){na.apply(a,ma.call(b))}:function(a,b){for(var c=a.length,d=0;a[c++]=b[d++];);a.length=c-1}}}w=b.support={};B=b.isXML=function(a){return(a=a&&(a.ownerDocument||a).documentElement)?"HTML"!==a.nodeName:!1};F=b.setDocument=function(a){var b;a=a?a.ownerDocument||a:C;if(a===D||9!==a.nodeType||!a.documentElement)return D;D=a;ka=D.documentElement;pa=
!B(D);C!==D&&(b=D.defaultView)&&b.top!==b&&(b.addEventListener?b.addEventListener("unload",Ea,!1):b.attachEvent&&b.attachEvent("onunload",Ea));w.attributes=e(function(a){a.className="i";return!a.getAttribute("className")});w.getElementsByTagName=e(function(a){a.appendChild(D.createComment(""));return!a.getElementsByTagName("*").length});w.getElementsByClassName=la.test(D.getElementsByClassName);w.getById=e(function(a){ka.appendChild(a).id=L;return!D.getElementsByName||!D.getElementsByName(L).length});
w.getById?(H.find.ID=function(a,b){if("undefined"!==typeof b.getElementById&&pa){var c=b.getElementById(a);return c?[c]:[]}},H.filter.ID=function(a){var b=a.replace(va,wa);return function(a){return a.getAttribute("id")===b}}):(delete H.find.ID,H.filter.ID=function(a){var b=a.replace(va,wa);return function(a){return(a="undefined"!==typeof a.getAttributeNode&&a.getAttributeNode("id"))&&a.value===b}});H.find.TAG=w.getElementsByTagName?function(a,b){if("undefined"!==typeof b.getElementsByTagName)return b.getElementsByTagName(a);
if(w.qsa)return b.querySelectorAll(a)}:function(a,b){var c,d=[],e=0,q=b.getElementsByTagName(a);if("*"===a){for(;c=q[e++];)1===c.nodeType&&d.push(c);return d}return q};H.find.CLASS=w.getElementsByClassName&&function(a,b){if("undefined"!==typeof b.getElementsByClassName&&pa)return b.getElementsByClassName(a)};ba=[];aa=[];if(w.qsa=la.test(D.querySelectorAll))e(function(a){ka.appendChild(a).innerHTML="<a id='"+L+"'></a><select id='"+L+"-\r\\' msallowcapture=''><option selected=''></option></select>";
a.querySelectorAll("[msallowcapture^='']").length&&aa.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:''|\"\")");a.querySelectorAll("[selected]").length||aa.push("\\[[\\x20\\t\\r\\n\\f]*(?:value|checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)");a.querySelectorAll("[id~="+L+"-]").length||aa.push("~=");a.querySelectorAll(":checked").length||aa.push(":checked");a.querySelectorAll("a#"+L+"+*").length||aa.push(".#.+[+~]")}),e(function(a){a.innerHTML=
"<a href='' disabled='disabled'></a><select disabled='disabled'><option/></select>";var b=D.createElement("input");b.setAttribute("type","hidden");a.appendChild(b).setAttribute("name","D");a.querySelectorAll("[name=d]").length&&aa.push("name[\\x20\\t\\r\\n\\f]*[*^$|!~]?=");2!==a.querySelectorAll(":enabled").length&&aa.push(":enabled",":disabled");ka.appendChild(a).disabled=!0;2!==a.querySelectorAll(":disabled").length&&aa.push(":enabled",":disabled");a.querySelectorAll("*,:x");aa.push(",.*:")});(w.matchesSelector=
la.test(U=ka.matches||ka.webkitMatchesSelector||ka.mozMatchesSelector||ka.oMatchesSelector||ka.msMatchesSelector))&&e(function(a){w.disconnectedMatch=U.call(a,"*");U.call(a,"[s!='']:x");ba.push("!=",":((?:\\\\.|[\\w-]|[^\x00-\\xa0])+)(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\x00-\\xa0])+)(?:[\\x20\\t\\r\\n\\f]*([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|((?:\\\\.|[\\w-]|[^\x00-\\xa0])+))|)[\\x20\\t\\r\\n\\f]*\\])*)|.*)\\)|)")});
aa=aa.length&&new RegExp(aa.join("|"));ba=ba.length&&new RegExp(ba.join("|"));Ja=(b=la.test(ka.compareDocumentPosition))||la.test(ka.contains)?function(a,b){var c=9===a.nodeType?a.documentElement:a,d=b&&b.parentNode;return a===d||!!(d&&1===d.nodeType&&(c.contains?c.contains(d):a.compareDocumentPosition&&a.compareDocumentPosition(d)&16))}:function(a,b){if(b)for(;b=b.parentNode;)if(b===a)return!0;return!1};da=b?function(a,b){if(a===b)return K=!0,0;var c=!a.compareDocumentPosition-!b.compareDocumentPosition;
if(c)return c;c=(a.ownerDocument||a)===(b.ownerDocument||b)?a.compareDocumentPosition(b):1;return c&1||!w.sortDetached&&b.compareDocumentPosition(a)===c?a===D||a.ownerDocument===C&&Ja(C,a)?-1:b===D||b.ownerDocument===C&&Ja(C,b)?1:Ca?ca(Ca,a)-ca(Ca,b):0:c&4?-1:1}:function(a,b){if(a===b)return K=!0,0;var c,d=0;c=a.parentNode;var e=b.parentNode,q=[a],g=[b];if(!c||!e)return a===D?-1:b===D?1:c?-1:e?1:Ca?ca(Ca,a)-ca(Ca,b):0;if(c===e)return f(a,b);for(c=a;c=c.parentNode;)q.unshift(c);for(c=b;c=c.parentNode;)g.unshift(c);
for(;q[d]===g[d];)d++;return d?f(q[d],g[d]):q[d]===C?-1:g[d]===C?1:0};return D};b.matches=function(a,c){return b(a,null,null,c)};b.matchesSelector=function(a,c){(a.ownerDocument||a)!==D&&F(a);c=c.replace(ua,"='$1']");if(!(!w.matchesSelector||!pa||Z[c+" "]||ba&&ba.test(c)||aa&&aa.test(c)))try{var d=U.call(a,c);if(d||w.disconnectedMatch||a.document&&11!==a.document.nodeType)return d}catch(e){}return 0<b(c,D,null,[a]).length};b.contains=function(a,b){(a.ownerDocument||a)!==D&&F(a);return Ja(a,b)};b.attr=
function(a,b){(a.ownerDocument||a)!==D&&F(a);var c=H.attrHandle[b.toLowerCase()],c=c&&ha.call(H.attrHandle,b.toLowerCase())?c(a,b,!pa):void 0;return void 0!==c?c:w.attributes||!pa?a.getAttribute(b):(c=a.getAttributeNode(b))&&c.specified?c.value:null};b.escape=function(a){return(a+"").replace(za,Da)};b.error=function(a){throw Error("Syntax error, unrecognized expression: "+a);};b.uniqueSort=function(a){var b,c=[],d=0,e=0;K=!w.detectDuplicates;Ca=!w.sortStable&&a.slice(0);a.sort(da);if(K){for(;b=a[e++];)b===
...
(b=E(c,!0))&&(b=c.indexOf(")",c.length-b)-c.length)&&(a[0]=a[0].slice(0,b),a[2]=c.slice(0,b));return a.slice(0,3)}},filter:{TAG:function(a){var b=a.replace(va,wa).toLowerCase();return"*"===a?function(){return!0}:function(a){return a.nodeName&&a.nodeName.toLowerCase()===b}},CLASS:function(a){var b=Y[a+" "];return b||(b=new RegExp("(^|[\\x20\\t\\r\\n\\f])"+a+"([\\x20\\t\\r\\n\\f]|$)"),Y(a,function(a){return b.test("string"===typeof a.className&&a.className||"undefined"!==typeof a.getAttribute&&a.getAttribute("class")||
"")}))},ATTR:function(a,c,d){return function(e){e=b.attr(e,a);if(null==e)return"!="===c;if(!c)return!0;e+="";return"="===c?e===d:"!="===c?e!==d:"^="===c?d&&0===e.indexOf(d):"*="===c?d&&-1<e.indexOf(d):"$="===c?d&&e.slice(-d.length)===d:"~="===c?-1<(" "+e.replace(qa," ")+" ").indexOf(d):"|="===c?e===d||e.slice(0,d.length+1)===d+"-":!1}},CHILD:function(a,b,c,d,e){var q="nth"!==a.slice(0,3),g="last"!==a.slice(-4),y="of-type"===b;return 1===d&&0===e?function(a){return!!a.parentNode}:function(b,c,f){var u,
A,h,k,ga;c=q!==g?"nextSibling":"previousSibling";var l=b.parentNode,Q=y&&b.nodeName.toLowerCase();f=!f&&!y;u=!1;if(l){if(q){for(;c;){for(h=b;h=h[c];)if(y?h.nodeName.toLowerCase()===Q:1===h.nodeType)return!1;ga=c="only"===a&&!ga&&"nextSibling"}return!0}ga=[g?l.firstChild:l.lastChild];if(g&&f)for(h=l,A=h[L]||(h[L]={}),A=A[h.uniqueID]||(A[h.uniqueID]={}),u=A[a]||[],u=(k=u[0]===S&&u[1])&&u[2],h=k&&l.childNodes[k];h=++k&&h&&h[c]||(u=k=0)||ga.pop();){if(1===h.nodeType&&++u&&h===b){A[a]=[S,k,u];break}}else if(f&&
(h=b,A=h[L]||(h[L]={}),A=A[h.uniqueID]||(A[h.uniqueID]={}),u=A[a]||[],u=k=u[0]===S&&u[1]),!1===u)for(;(h=++k&&h&&h[c]||(u=k=0)||ga.pop())&&((y?h.nodeName.toLowerCase()!==Q:1!==h.nodeType)||!++u||(f&&(A=h[L]||(h[L]={}),A=A[h.uniqueID]||(A[h.uniqueID]={}),A[a]=[S,u]),h!==b)););u-=e;return u===d||0===u%d&&0<=u/d}}},PSEUDO:function(a,c){var e,q=H.pseudos[a]||H.setFilters[a.toLowerCase()]||b.error("unsupported pseudo: "+a);return q[L]?q(c):1<q.length?(e=[a,a,"",c],H.setFilters.hasOwnProperty(a.toLowerCase())?
d(function(a,b){for(var d,e=q(a,c),g=e.length;g--;)d=ca(a,e[g]),a[d]=!(b[d]=e[g])}):function(a){return q(a,0,e)}):q}},pseudos:{not:d(function(a){var b=[],c=[],e=J(a.replace(ia,"$1"));return e[L]?d(function(a,b,c,d){d=e(a,null,d,[]);for(var q=a.length;q--;)if(c=d[q])a[q]=!(b[q]=c)}):function(a,d,q){b[0]=a;e(b,null,q,c);b[0]=null;return!c.pop()}}),has:d(function(a){return function(c){return 0<b(a,c).length}}),contains:d(function(a){a=a.replace(va,wa);return function(b){return-1<(b.textContent||b.innerText||
O(b)).indexOf(a)}}),lang:d(function(a){ya.test(a||"")||b.error("unsupported lang: "+a);a=a.replace(va,wa).toLowerCase();return function(b){var c;do if(c=pa?b.lang:b.getAttribute("xml:lang")||b.getAttribute("lang"))return c=c.toLowerCase(),c===a||0===c.indexOf(a+"-");while((b=b.parentNode)&&1===b.nodeType);return!1}}),target:function(b){var c=a.location&&a.location.hash;return c&&c.slice(1)===b.id},root:function(a){return a===ka},focus:function(a){return a===D.activeElement&&(!D.hasFocus||D.hasFocus())&&
!!(a.type||a.href||~a.tabIndex)},enabled:l(!1),disabled:l(!0),checked:function(a){var b=a.nodeName.toLowerCase();return"input"===b&&!!a.checked||"option"===b&&!!a.selected},selected:function(a){a.parentNode&&a.parentNode.selectedIndex;return!0===a.selected},empty:function(a){for(a=a.firstChild;a;a=a.nextSibling)if(6>a.nodeType)return!1;return!0},parent:function(a){return!H.pseudos.empty(a)},header:function(a){return Ba.test(a.nodeName)},input:function(a){return Aa.test(a.nodeName)},button:function(a){var b=
...
return a}),gt:m(function(a,b,c){for(c=0>c?c+b:c;++c<b;)a.push(c);return a})}};H.pseudos.nth=H.pseudos.eq;for(G in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})H.pseudos[G]=h(G);for(G in{submit:!0,reset:!0})H.pseudos[G]=k(G);r.prototype=H.filters=H.pseudos;H.setFilters=new r;E=b.tokenize=function(a,c){var d,e,q,g,f,u,h;if(f=ea[a+" "])return c?0:f.slice(0);f=a;u=[];for(h=H.preFilter;f;){if(!d||(e=ra.exec(f)))e&&(f=f.slice(e[0].length)||f),u.push(q=[]);d=!1;if(e=ta.exec(f))d=e.shift(),q.push({value:d,
type:e[0].replace(ia," ")}),f=f.slice(d.length);for(g in H.filter)!(e=oa[g].exec(f))||h[g]&&!(e=h[g](e))||(d=e.shift(),q.push({value:d,type:g,matches:e}),f=f.slice(d.length));if(!d)break}return c?f.length:f?b.error(a):ea(a,u).slice(0)};J=b.compile=function(a,b){var c,d=[],e=[],q=Z[a+" "];if(!q){b||(b=E(a));for(c=b.length;c--;)q=M(b[c]),q[L]?d.push(q):e.push(q);q=Z(a,z(e,d));q.selector=a}return q};P=b.select=function(a,b,c,d){var e,q,g,y,f="function"===typeof a&&a,u=!d&&E(a=f.selector||a);c=c||[];
if(1===u.length){q=u[0]=u[0].slice(0);if(2<q.length&&"ID"===(g=q[0]).type&&w.getById&&9===b.nodeType&&pa&&H.relative[q[1].type]){b=(H.find.ID(g.matches[0].replace(va,wa),b)||[])[0];if(!b)return c;f&&(b=b.parentNode);a=a.slice(q.shift().value.length)}for(e=oa.needsContext.test(a)?0:q.length;e--;){g=q[e];if(H.relative[y=g.type])break;if(y=H.find[y])if(d=y(g.matches[0].replace(va,wa),sa.test(q[0].type)&&n(b.parentNode)||b)){q.splice(e,1);a=d.length&&p(q);if(!a)return X.apply(c,d),c;break}}}(f||J(a,u))(d,
b,!pa,c,!b||sa.test(a)&&n(b.parentNode)||b);return c};w.sortStable=L.split("").sort(da).join("")===L;w.detectDuplicates=!!K;F();w.sortDetached=e(function(a){return a.compareDocumentPosition(D.createElement("fieldset"))&1});e(function(a){a.innerHTML="<a href='#'></a>";return"#"===a.firstChild.getAttribute("href")})||g("type|href|height|width",function(a,b,c){if(!c)return a.getAttribute(b,"type"===b.toLowerCase()?1:2)});w.attributes&&e(function(a){a.innerHTML="<input/>";a.firstChild.setAttribute("value",
...
function(c,d){var e=g.isFunction(a[d[4]])&&a[d[4]];h[d[1]](function(){var a=e&&e.apply(this,arguments);if(a&&g.isFunction(a.promise))a.promise().progress(b.notify).done(b.resolve).fail(b.reject);else b[d[0]+"With"](this,e?[a]:arguments)})});a=null}).promise()},then:function(b,e,q){function f(b,c,e,q){return function(){var y=this,u=arguments,k=function(){var a,d;if(!(b<h)){a=e.apply(y,u);if(a===c.promise())throw new TypeError("Thenable self-resolution");d=a&&("object"===typeof a||"function"===typeof a)&&
a.then;g.isFunction(d)?q?d.call(a,f(h,c,G,q),f(h,c,E,q)):(h++,d.call(a,f(h,c,G,q),f(h,c,E,q),f(h,c,G,c.notifyWith))):(e!==G&&(y=void 0,u=[a]),(q||c.resolveWith)(y,u))}},A=q?k:function(){try{k()}catch(a){g.Deferred.exceptionHook&&g.Deferred.exceptionHook(a,A.stackTrace),b+1>=h&&(e!==E&&(y=void 0,u=[a]),c.rejectWith(y,u))}};b?A():(g.Deferred.getStackHook&&(A.stackTrace=g.Deferred.getStackHook()),a.setTimeout(A))}}var h=0;return g.Deferred(function(a){c[0][3].add(f(0,a,g.isFunction(q)?q:G,a.notifyWith));
c[1][3].add(f(0,a,g.isFunction(b)?b:G));c[2][3].add(f(0,a,g.isFunction(e)?e:E))}).promise()},promise:function(a){return null!=a?g.extend(a,f):f}},h={};g.each(c,function(a,b){var d=b[2],q=b[5];f[b[1]]=d.add;q&&d.add(function(){e=q},c[3-a][2].disable,c[0][2].lock);d.add(b[3].fire);h[b[0]]=function(){h[b[0]+"With"](this===h?void 0:this,arguments);return this};h[b[0]+"With"]=d.fireWith});f.promise(h);b&&b.call(h,h);return h},when:function(a){var b=arguments.length,c=b,d=Array(c),e=ta.call(arguments),
f=g.Deferred(),h=function(a){return function(c){d[a]=this;e[a]=1<arguments.length?ta.call(arguments):c;--b||f.resolveWith(d,e)}};if(1>=b&&(F(a,f.done(h(c)).resolve,f.reject),"pending"===f.state()||g.isFunction(e[c]&&e[c].then)))return f.then();for(;c--;)F(e[c],h(c),f.reject);return f.promise()}});var ac=/^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/;g.Deferred.exceptionHook=function(b,c){a.console&&a.console.warn&&b&&ac.test(b.name)&&a.console.warn("jQuery.Deferred exception: "+b.message,
b.stack,c)};g.readyException=function(b){a.setTimeout(function(){throw b;})};var bb=g.Deferred();g.fn.ready=function(a){bb.then(a)["catch"](function(a){g.readyException(a)});return this};g.extend({isReady:!1,readyWait:1,holdReady:function(a){a?g.readyWait++:g.ready(!0)},ready:function(a){(!0===a?--g.readyWait:g.isReady)||(g.isReady=!0,!0!==a&&0<--g.readyWait||bb.resolveWith(B,[g]))}});g.ready.then=bb.then;"complete"===B.readyState||"loading"!==B.readyState&&!B.documentElement.doScroll?a.setTimeout(g.ready):
(B.addEventListener("DOMContentLoaded",K),a.addEventListener("load",K));var X=function(a,b,c,d,e,f,h){var k=0,l=a.length,m=null==c;if("object"===g.type(c))for(k in e=!0,c)X(a,b,k,c[k],!0,f,h);else if(void 0!==d&&(e=!0,g.isFunction(d)||(h=!0),m&&(h?(b.call(a,d),b=null):(m=b,b=function(a,b,c){return m.call(g(a),c)})),b))for(;k<l;k++)b(a[k],c,h?d:d.call(a[k],k,b(a[k],c)));return e?a:m?b.call(a):l?b(a[0],c):f},Ua=function(a){return 1===a.nodeType||9===a.nodeType||!+a.nodeType};S.uid=1;S.prototype={cache:function(a){var b=
...
b},remove:function(a,b){var c,d=a[this.expando];if(void 0!==d){if(void 0!==b)for(g.isArray(b)?b=b.map(g.camelCase):(b=g.camelCase(b),b=b in d?[b]:b.match(W)||[]),c=b.length;c--;)delete d[b[c]];if(void 0===b||g.isEmptyObject(d))a.nodeType?a[this.expando]=void 0:delete a[this.expando]}},hasData:function(a){a=a[this.expando];return void 0!==a&&!g.isEmptyObject(a)}};var z=new S,Y=new S,Nb=/^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,Mb=/[A-Z]/g;g.extend({hasData:function(a){return Y.hasData(a)||z.hasData(a)},data:function(a,
b,c){return Y.access(a,b,c)},removeData:function(a,b){Y.remove(a,b)},_data:function(a,b,c){return z.access(a,b,c)},_removeData:function(a,b){z.remove(a,b)}});g.fn.extend({data:function(a,b){var c,d,e,f=this[0],h=f&&f.attributes;if(void 0===a){if(this.length&&(e=Y.get(f),1===f.nodeType&&!z.get(f,"hasDataAttrs"))){for(c=h.length;c--;)h[c]&&(d=h[c].name,0===d.indexOf("data-")&&(d=g.camelCase(d.slice(5)),ea(f,d,e[d])));z.set(f,"hasDataAttrs",!0)}return e}return"object"===typeof a?this.each(function(){Y.set(this,
a)}):X(this,function(b){var c;if(f&&void 0===b){c=Y.get(f,a);if(void 0!==c)return c;c=ea(f,a);if(void 0!==c)return c}else this.each(function(){Y.set(this,a,b)})},null,b,1<arguments.length,null,!0)},removeData:function(a){return this.each(function(){Y.remove(this,a)})}});g.extend({queue:function(a,b,c){var d;if(a)return b=(b||"fx")+"queue",d=z.get(a,b),c&&(!d||g.isArray(c)?d=z.access(a,b,g.makeArray(c)):d.push(c)),d||[]},dequeue:function(a,b){b=b||"fx";var c=g.queue(a,b),d=c.length,e=c.shift(),f=g._queueHooks(a,
...
typeof a){for(d in a)this.off(d,b,a[d]);return this}if(!1===b||"function"===typeof b)c=b,b=void 0;!1===c&&(c=M);return this.each(function(){g.event.remove(this,a,c,b)})}});var dc=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi,ec=/<script|<style|<link/i,Qb=/checked\s*(?:[^=]|=\s*.checked.)/i,Pb=/^true\/(.*)/,Rb=/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;g.extend({htmlPrefilter:function(a){return a.replace(dc,"<$1></$2>")},clone:function(a,b,c){var d,e,
f,h,k=a.cloneNode(!0),l=g.contains(a.ownerDocument,a);if(!(P.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||g.isXMLDoc(a)))for(h=v(k),f=v(a),d=0,e=f.length;d<e;d++){var m=f[d],n=h[d],p=n.nodeName.toLowerCase();if("input"===p&&zb.test(m.type))n.checked=m.checked;else if("input"===p||"textarea"===p)n.defaultValue=m.defaultValue}if(b)if(c)for(f=f||v(a),h=h||v(k),d=0,e=f.length;d<e;d++)U(f[d],h[d]);else U(a,k);h=v(k,"script");0<h.length&&V(h,!l&&v(a,"script"));return k},cleanData:function(a){for(var b,
c,d,e=g.event.special,f=0;void 0!==(c=a[f]);f++)if(Ua(c)){if(b=c[z.expando]){if(b.events)for(d in b.events)e[d]?g.event.remove(c,d):g.removeEvent(c,d,b.handle);c[z.expando]=void 0}c[Y.expando]&&(c[Y.expando]=void 0)}}});g.fn.extend({detach:function(a){return na(this,a,!0)},remove:function(a){return na(this,a)},text:function(a){return X(this,function(a){return void 0===a?g.text(this):this.empty().each(function(){if(1===this.nodeType||11===this.nodeType||9===this.nodeType)this.textContent=a})},null,
...
f=0;f<=e;f++)a=f===e?this:this.clone(!0),g(d[f])[b](a),ab.apply(c,a.get());return this.pushStack(c)}});var ob=/^margin/,Za=new RegExp("^("+xb+")(?!px)[a-z%]+$","i"),Qa=function(b){var c=b.ownerDocument.defaultView;c&&c.opener||(c=a);return c.getComputedStyle(b)};(function(){function b(){if(l){l.style.cssText="box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;width:50%";l.innerHTML="";Va.appendChild(k);var g=a.getComputedStyle(l);c="1%"!==g.top;h="2px"===
g.marginLeft;e="4px"===g.width;l.style.marginRight="50%";f="4px"===g.marginRight;Va.removeChild(k);l=null}}var c,e,f,h,k=B.createElement("div"),l=B.createElement("div");l.style&&(l.style.backgroundClip="content-box",l.cloneNode(!0).style.backgroundClip="",P.clearCloneStyle="content-box"===l.style.backgroundClip,k.style.cssText="border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute",k.appendChild(l),g.extend(P,{pixelPosition:function(){b();return c},boxSizingReliable:function(){b();
return e},pixelMarginRight:function(){b();return f},reliableMarginLeft:function(){b();return h}}))})();var fc=/^(none|table(?!-c[ea]).+)/,gc={position:"absolute",visibility:"hidden",display:"block"},Bb={letterSpacing:"0",fontWeight:"400"},qb=["Webkit","Moz","ms"],pb=B.createElement("div").style;g.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=ca(a,"opacity");return""===c?"1":c}}}},cssNumber:{animationIterationCount:!0,columnCount:!0,fillOpacity:!0,flexGrow:!0,flexShrink:!0,fontWeight:!0,
lineHeight:!0,opacity:!0,order:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":"cssFloat"},style:function(a,b,c,d){if(a&&3!==a.nodeType&&8!==a.nodeType&&a.style){var e,f,h,k=g.camelCase(b),l=a.style;b=g.cssProps[k]||(g.cssProps[k]=Fa(k)||k);h=g.cssHooks[b]||g.cssHooks[k];if(void 0!==c)f=typeof c,"string"===f&&(e=za.exec(c))&&e[1]&&(c=J(a,b,e),f="number"),null!=c&&c===c&&("number"===f&&(c+=e&&e[3]||(g.cssNumber[k]?"":"px")),P.clearCloneStyle||""!==c||0!==b.indexOf("background")||(l[b]=
...
"display"))||a.getClientRects().length&&a.getBoundingClientRect().width?oa(a,b,d):yb(a,gc,function(){return oa(a,b,d)})},set:function(a,c,d){var e,f=d&&Qa(a);(d=d&&Ka(a,b,d,"border-box"===g.css(a,"boxSizing",!1,f),f))&&(e=za.exec(c))&&"px"!==(e[3]||"px")&&(a.style[b]=c,c=g.css(a,b));return ya(a,c,d)}}});g.cssHooks.marginLeft=sa(P.reliableMarginLeft,function(a,b){if(b)return(parseFloat(ca(a,"marginLeft"))||a.getBoundingClientRect().left-yb(a,{marginLeft:0},function(){return a.getBoundingClientRect().left}))+
"px"});g.each({margin:"",padding:"",border:"Width"},function(a,b){g.cssHooks[a+b]={expand:function(c){var d=0,e={};for(c="string"===typeof c?c.split(" "):[c];4>d;d++)e[a+ua[d]+b]=c[d]||c[d-2]||c[0];return e}};ob.test(a)||(g.cssHooks[a+b].set=ya)});g.fn.extend({css:function(a,b){return X(this,function(a,b,c){var d,e={},f=0;if(g.isArray(b)){c=Qa(a);for(d=b.length;f<d;f++)e[b[f]]=g.css(a,b[f],!1,c);return e}return void 0!==c?g.style(a,b,c):g.css(a,b)},a,b,1<arguments.length)}});g.Tween=C;C.prototype=
...
a.now:g.style(a.elem,a.prop,a.now+a.unit)}}};C.propHooks.scrollTop=C.propHooks.scrollLeft={set:function(a){a.elem.nodeType&&a.elem.parentNode&&(a.elem[a.prop]=a.now)}};g.easing={linear:function(a){return a},swing:function(a){return.5-Math.cos(a*Math.PI)/2},_default:"swing"};g.fx=C.prototype.init;g.fx.step={};var Ba,Aa,hc=/^(?:toggle|show|hide)$/,ic=/queueHooks$/;g.Animation=g.extend(da,{tweeners:{"*":[function(a,b){var c=this.createTween(a,b);J(c.elem,a,za.exec(b),c);return c}]},tweener:function(a,
b){g.isFunction(a)?(b=a,a=["*"]):a=a.match(W);for(var c,d=0,e=a.length;d<e;d++)c=a[d],da.tweeners[c]=da.tweeners[c]||[],da.tweeners[c].unshift(b)},prefilters:[function(a,b,c){var d,e,f,h,k,l,m;m="width"in b||"height"in b;var n=this,p={},r=a.style,v=a.nodeType&&Pa(a),t=z.get(a,"fxshow");c.queue||(h=g._queueHooks(a,"fx"),null==h.unqueued&&(h.unqueued=0,k=h.empty.fire,h.empty.fire=function(){h.unqueued||k()}),h.unqueued++,n.always(function(){n.always(function(){h.unqueued--;g.queue(a,"fx").length||h.empty.fire()})}));
for(d in b)if(e=b[d],hc.test(e)){delete b[d];f=f||"toggle"===e;if(e===(v?"hide":"show"))if("show"===e&&t&&void 0!==t[d])v=!0;else continue;p[d]=t&&t[d]||g.style(a,d)}if((b=!g.isEmptyObject(b))||!g.isEmptyObject(p))for(d in m&&1===a.nodeType&&(c.overflow=[r.overflow,r.overflowX,r.overflowY],l=t&&t.display,null==l&&(l=z.get(a,"display")),m=g.css(a,"display"),"none"===m&&(l?m=l:(fa([a],!0),l=a.style.display||l,m=g.css(a,"display"),fa([a]))),("inline"===m||"inline-block"===m&&null!=l)&&"none"===g.css(a,
"float")&&(b||(n.done(function(){r.display=l}),null==l&&(m=r.display,l="none"===m?"":m)),r.display="inline-block")),c.overflow&&(r.overflow="hidden",n.always(function(){r.overflow=c.overflow[0];r.overflowX=c.overflow[1];r.overflowY=c.overflow[2]})),b=!1,p)b||(t?"hidden"in t&&(v=t.hidden):t=z.access(a,"fxshow",{display:l}),f&&(t.hidden=!v),v&&fa([a],!0),n.done(function(){v||fa([a]);z.remove(a,"fxshow");for(d in p)g.style(a,d,p[d])})),b=gb(v?t[d]:0,d,n),d in t||(t[d]=b.start,v&&(b.end=b.start,b.start=
0))}],prefilter:function(a,b){b?da.prefilters.unshift(a):da.prefilters.push(a)}});g.speed=function(a,b,c){var d=a&&"object"===typeof a?g.extend({},a):{complete:c||!c&&b||g.isFunction(a)&&a,duration:a,easing:c&&b||b&&!g.isFunction(b)&&b};d.duration=g.fx.off||B.hidden?0:"number"===typeof d.duration?d.duration:d.duration in g.fx.speeds?g.fx.speeds[d.duration]:g.fx.speeds._default;if(null==d.queue||!0===d.queue)d.queue="fx";d.old=d.complete;d.complete=function(){g.isFunction(d.old)&&d.old.call(this);
...
a.cancelAnimationFrame(Aa):a.clearInterval(Aa);Aa=null};g.fx.speeds={slow:600,fast:200,_default:400};g.fn.delay=function(b,c){b=g.fx?g.fx.speeds[b]||b:b;return this.queue(c||"fx",function(c,e){var f=a.setTimeout(c,b);e.stop=function(){a.clearTimeout(f)}})};(function(){var a=B.createElement("input"),b=B.createElement("select").appendChild(B.createElement("option"));a.type="checkbox";P.checkOn=""!==a.value;P.optSelected=b.selected;a=B.createElement("input");a.value="t";a.type="radio";P.radioValue="t"===
a.value})();var Cb,Da=g.expr.attrHandle;g.fn.extend({attr:function(a,b){return X(this,g.attr,a,b,1<arguments.length)},removeAttr:function(a){return this.each(function(){g.removeAttr(this,a)})}});g.extend({attr:function(a,b,c){var d,e,f=a.nodeType;if(3!==f&&8!==f&&2!==f){if("undefined"===typeof a.getAttribute)return g.prop(a,b,c);1===f&&g.isXMLDoc(a)||(e=g.attrHooks[b.toLowerCase()]||(g.expr.match.bool.test(b)?Cb:void 0));if(void 0!==c){if(null===c){g.removeAttr(a,b);return}if(e&&"set"in e&&void 0!==
(d=e.set(a,c,b)))return d;a.setAttribute(b,c+"");return c}if(e&&"get"in e&&null!==(d=e.get(a,b)))return d;d=g.find.attr(a,b);return null==d?void 0:d}},attrHooks:{type:{set:function(a,b){if(!P.radioValue&&"radio"===b&&g.nodeName(a,"input")){var c=a.value;a.setAttribute("type",b);c&&(a.value=c);return b}}}},removeAttr:function(a,b){var c,d=0,e=b&&b.match(W);if(e&&1===a.nodeType)for(;c=e[d++];)a.removeAttribute(c)}});Cb={set:function(a,b,c){!1===b?g.removeAttr(a,c):a.setAttribute(c,c);return c}};g.each(g.expr.match.bool.source.match(/\w+/g),
...
a.parentNode.selectedIndex}});g.each("tabIndex readOnly maxLength cellSpacing cellPadding rowSpan colSpan useMap frameBorder contentEditable".split(" "),function(){g.propFix[this.toLowerCase()]=this});var cb=/[\t\r\n\f]/g;g.fn.extend({addClass:function(a){var b,c,d,e,f,h,k=0;if(g.isFunction(a))return this.each(function(b){g(this).addClass(a.call(this,b,ia(this)))});if("string"===typeof a&&a)for(b=a.match(W)||[];c=this[k++];)if(e=ia(c),d=1===c.nodeType&&(" "+e+" ").replace(cb," ")){for(h=0;f=b[h++];)0>
d.indexOf(" "+f+" ")&&(d+=f+" ");d=g.trim(d);e!==d&&c.setAttribute("class",d)}return this},removeClass:function(a){var b,c,d,e,f,h,k=0;if(g.isFunction(a))return this.each(function(b){g(this).removeClass(a.call(this,b,ia(this)))});if(!arguments.length)return this.attr("class","");if("string"===typeof a&&a)for(b=a.match(W)||[];c=this[k++];)if(e=ia(c),d=1===c.nodeType&&(" "+e+" ").replace(cb," ")){for(h=0;f=b[h++];)for(;-1<d.indexOf(" "+f+" ");)d=d.replace(" "+f+" "," ");d=g.trim(d);e!==d&&c.setAttribute("class",
...
b)}};P.checkOn||(g.valHooks[this].get=function(a){return null===a.getAttribute("value")?"on":a.value})});var Db=/^(?:focusinfocus|focusoutblur)$/;g.extend(g.event,{trigger:function(b,c,e,f){var h,k,l,m,n,p,v=[e||B],t=Sa.call(b,"type")?b.type:b;p=Sa.call(b,"namespace")?b.namespace.split("."):[];k=h=e=e||B;if(3!==e.nodeType&&8!==e.nodeType&&!Db.test(t+g.event.triggered)&&(-1<t.indexOf(".")&&(p=t.split("."),t=p.shift(),p.sort()),m=0>t.indexOf(":")&&"on"+t,b=b[g.expando]?b:new g.Event(t,"object"===typeof b&&
b),b.isTrigger=f?2:3,b.namespace=p.join("."),b.rnamespace=b.namespace?new RegExp("(^|\\.)"+p.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,b.result=void 0,b.target||(b.target=e),c=null==c?[b]:g.makeArray(c,[b]),p=g.event.special[t]||{},f||!p.trigger||!1!==p.trigger.apply(e,c))){if(!f&&!p.noBubble&&!g.isWindow(e)){l=p.delegateType||t;Db.test(l+t)||(k=k.parentNode);for(;k;k=k.parentNode)v.push(k),h=k;h===(e.ownerDocument||B)&&v.push(h.defaultView||h.parentWindow||a)}for(h=0;(k=v[h++])&&!b.isPropagationStopped();)b.type=
1<h?l:p.bindType||t,(n=(z.get(k,"events")||{})[b.type]&&z.get(k,"handle"))&&n.apply(k,c),(n=m&&k[m])&&n.apply&&Ua(k)&&(b.result=n.apply(k,c),!1===b.result&&b.preventDefault());b.type=t;f||b.isDefaultPrevented()||p._default&&!1!==p._default.apply(v.pop(),c)||!Ua(e)||!m||!g.isFunction(e[t])||g.isWindow(e)||((h=e[m])&&(e[m]=null),g.event.triggered=t,e[t](),g.event.triggered=void 0,h&&(e[m]=h));return b.result}},simulate:function(a,b,c){a=g.extend(new g.Event,c,{type:a,isSimulated:!0});g.event.trigger(a,
...
b){return this.mouseenter(a).mouseleave(b||a)}});P.focusin="onfocusin"in a;P.focusin||g.each({focus:"focusin",blur:"focusout"},function(a,b){var c=function(a){g.event.simulate(b,a.target,g.event.fix(a))};g.event.special[b]={setup:function(){var d=this.ownerDocument||this,e=z.access(d,b);e||d.addEventListener(a,c,!0);z.access(d,b,(e||0)+1)},teardown:function(){var d=this.ownerDocument||this,e=z.access(d,b)-1;e?z.access(d,b,e):(d.removeEventListener(a,c,!0),z.remove(d,b))}}});var Ea=a.location,Eb=g.now(),
db=/\?/;g.parseXML=function(b){var c;if(!b||"string"!==typeof b)return null;try{c=(new a.DOMParser).parseFromString(b,"text/xml")}catch(e){c=void 0}c&&!c.getElementsByTagName("parsererror").length||g.error("Invalid XML: "+b);return c};var Sb=/\[\]$/,Fb=/\r?\n/g,nc=/^(?:submit|button|image|reset|file)$/i,oc=/^(?:input|select|textarea|keygen)/i;g.param=function(a,b){var c,d=[],e=function(a,b){var c=g.isFunction(b)?b():b;d[d.length]=encodeURIComponent(a)+"="+encodeURIComponent(null==c?"":c)};if(g.isArray(a)||
a.jquery&&!g.isPlainObject(a))g.each(a,function(){e(this.name,this.value)});else for(c in a)Wa(c,a[c],b,e);return d.join("&")};g.fn.extend({serialize:function(){return g.param(this.serializeArray())},serializeArray:function(){return this.map(function(){var a=g.prop(this,"elements");return a?g.makeArray(a):this}).filter(function(){var a=this.type;return this.name&&!g(this).is(":disabled")&&oc.test(this.nodeName)&&!nc.test(a)&&(this.checked||!zb.test(a))}).map(function(a,b){var c=g(this).val();return null==
c?null:g.isArray(c)?g.map(c,function(a){return{name:b.name,value:a.replace(Fb,"\r\n")}}):{name:b.name,value:c.replace(Fb,"\r\n")}}).get()}});var pc=/%20/g,qc=/#.*$/,rc=/([?&])_=[^&]*/,sc=/^(.*?):[ \t]*([^\r\n]*)$/gm,tc=/^(?:GET|HEAD)$/,uc=/^\/\//,Gb={},$a={},Hb="*/".concat("*"),eb=B.createElement("a");eb.href=Ea.href;g.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:Ea.href,type:"GET",isLocal:/^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(Ea.protocol),global:!0,processData:!0,
async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",accepts:{"*":Hb,text:"text/plain",html:"text/html",xml:"application/xml, text/xml",json:"application/json, text/javascript"},contents:{xml:/\bxml\b/,html:/\bhtml/,json:/\bjson\b/},responseFields:{xml:"responseXML",text:"responseText",json:"responseJSON"},converters:{"* text":String,"text html":!0,"text json":JSON.parse,"text xml":g.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(a,b){return b?Xa(Xa(a,g.ajaxSettings),
b):Xa(g.ajaxSettings,a)},ajaxPrefilter:hb(Gb),ajaxTransport:hb($a),ajax:function(b,c){function e(b,c,l,q){var n,u,y,v;v=c;if(!p){p=!0;m&&a.clearTimeout(m);f=void 0;k=q||"";w.readyState=0<b?4:0;q=200<=b&&300>b||304===b;if(l){y=r;for(var I=w,O,D,E,J,B=y.contents,F=y.dataTypes;"*"===F[0];)F.shift(),void 0===O&&(O=y.mimeType||I.getResponseHeader("Content-Type"));if(O)for(D in B)if(B[D]&&B[D].test(O)){F.unshift(D);break}if(F[0]in l)E=F[0];else{for(D in l){if(!F[0]||y.converters[D+" "+F[0]]){E=D;break}J||
(J=D)}E=E||J}E?(E!==F[0]&&F.unshift(E),y=l[E]):y=void 0}a:{l=r;O=y;D=w;E=q;var K,C,L,I={},B=l.dataTypes.slice();if(B[1])for(C in l.converters)I[C.toLowerCase()]=l.converters[C];for(J=B.shift();J;)if(l.responseFields[J]&&(D[l.responseFields[J]]=O),!L&&E&&l.dataFilter&&(O=l.dataFilter(O,l.dataType)),L=J,J=B.shift())if("*"===J)J=L;else if("*"!==L&&L!==J){C=I[L+" "+J]||I["* "+J];if(!C)for(K in I)if(y=K.split(" "),y[1]===J&&(C=I[L+" "+y[0]]||I["* "+y[0]])){!0===C?C=I[K]:!0!==I[K]&&(J=y[0],B.unshift(y[1]));
break}if(!0!==C)if(C&&l["throws"])O=C(O);else try{O=C(O)}catch(ba){y={state:"parsererror",error:C?ba:"No conversion from "+L+" to "+J};break a}}y={state:"success",data:O}}if(q)r.ifModified&&((v=w.getResponseHeader("Last-Modified"))&&(g.lastModified[h]=v),(v=w.getResponseHeader("etag"))&&(g.etag[h]=v)),204===b||"HEAD"===r.type?v="nocontent":304===b?v="notmodified":(v=y.state,n=y.data,u=y.error,q=!u);else if(u=v,b||!v)v="error",0>b&&(b=0);w.status=b;w.statusText=(c||v)+"";q?M.resolveWith(V,[n,v,w]):
M.rejectWith(V,[w,v,u]);w.statusCode(z);z=void 0;t&&T.trigger(q?"ajaxSuccess":"ajaxError",[w,r,q?n:u]);G.fireWith(V,[w,v]);t&&(T.trigger("ajaxComplete",[w,r]),--g.active||g.event.trigger("ajaxStop"))}}"object"===typeof b&&(c=b,b=void 0);c=c||{};var f,h,k,l,m,n,p,t,v,r=g.ajaxSetup({},c),V=r.context||r,T=r.context&&(V.nodeType||V.jquery)?g(V):g.event,M=g.Deferred(),G=g.Callbacks("once memory"),z=r.statusCode||{},O={},E={},J="canceled",w={readyState:0,getResponseHeader:function(a){var b;if(p){if(!l)for(l=
{};b=sc.exec(k);)l[b[1].toLowerCase()]=b[2];b=l[a.toLowerCase()]}return null==b?null:b},getAllResponseHeaders:function(){return p?k:null},setRequestHeader:function(a,b){null==p&&(a=E[a.toLowerCase()]=E[a.toLowerCase()]||a,O[a]=b);return this},overrideMimeType:function(a){null==p&&(r.mimeType=a);return this},statusCode:function(a){var b;if(a)if(p)w.always(a[w.status]);else for(b in a)z[b]=[z[b],a[b]];return this},abort:function(a){a=a||J;f&&f.abort(a);e(0,a);return this}};M.promise(w);r.url=((b||r.url||
Ea.href)+"").replace(uc,Ea.protocol+"//");r.type=c.method||c.type||r.method||r.type;r.dataTypes=(r.dataType||"*").toLowerCase().match(W)||[""];if(null==r.crossDomain){n=B.createElement("a");try{n.href=r.url,n.href=n.href,r.crossDomain=eb.protocol+"//"+eb.host!==n.protocol+"//"+n.host}catch(H){r.crossDomain=!0}}r.data&&r.processData&&"string"!==typeof r.data&&(r.data=g.param(r.data,r.traditional));ib(Gb,r,c,w);if(p)return w;(t=g.event&&r.global)&&0===g.active++&&g.event.trigger("ajaxStart");r.type=
r.type.toUpperCase();r.hasContent=!tc.test(r.type);h=r.url.replace(qc,"");r.hasContent?r.data&&r.processData&&0===(r.contentType||"").indexOf("application/x-www-form-urlencoded")&&(r.data=r.data.replace(pc,"+")):(n=r.url.slice(h.length),r.data&&(h+=(db.test(h)?"&":"?")+r.data,delete r.data),!1===r.cache&&(h=h.replace(rc,""),n=(db.test(h)?"&":"?")+"_="+Eb++ +n),r.url=h+n);r.ifModified&&(g.lastModified[h]&&w.setRequestHeader("If-Modified-Since",g.lastModified[h]),g.etag[h]&&w.setRequestHeader("If-None-Match",
g.etag[h]));(r.data&&r.hasContent&&!1!==r.contentType||c.contentType)&&w.setRequestHeader("Content-Type",r.contentType);w.setRequestHeader("Accept",r.dataTypes[0]&&r.accepts[r.dataTypes[0]]?r.accepts[r.dataTypes[0]]+("*"!==r.dataTypes[0]?", "+Hb+"; q=0.01":""):r.accepts["*"]);for(v in r.headers)w.setRequestHeader(v,r.headers[v]);if(r.beforeSend&&(!1===r.beforeSend.call(V,w,r)||p))return w.abort();J="abort";G.add(r.complete);w.done(r.success);w.fail(r.error);if(f=ib($a,r,c,w)){w.readyState=1;t&&T.trigger("ajaxSend",
[w,r]);if(p)return w;r.async&&0<r.timeout&&(m=a.setTimeout(function(){w.abort("timeout")},r.timeout));try{p=!1,f.send(O,e)}catch(H){if(p)throw H;e(-1,H)}}else e(-1,"No Transport");return w},getJSON:function(a,b,c){return g.get(a,b,c,"json")},getScript:function(a,b){return g.get(a,void 0,b,"script")}});g.each(["get","post"],function(a,b){g[b]=function(a,c,d,e){g.isFunction(c)&&(e=e||d,d=c,c=void 0);return g.ajax(g.extend({url:a,type:b,dataType:e,data:c,success:d},g.isPlainObject(a)&&a))}});g._evalUrl=
...
var vc={0:200,1223:204},Ga=g.ajaxSettings.xhr();P.cors=!!Ga&&"withCredentials"in Ga;P.ajax=Ga=!!Ga;g.ajaxTransport(function(b){var c,e;if(P.cors||Ga&&!b.crossDomain)return{send:function(f,g){var h,k=b.xhr();k.open(b.type,b.url,b.async,b.username,b.password);if(b.xhrFields)for(h in b.xhrFields)k[h]=b.xhrFields[h];b.mimeType&&k.overrideMimeType&&k.overrideMimeType(b.mimeType);b.crossDomain||f["X-Requested-With"]||(f["X-Requested-With"]="XMLHttpRequest");for(h in f)k.setRequestHeader(h,f[h]);c=function(a){return function(){c&&
...
function(a){if(a.crossDomain){var b,c;return{send:function(d,e){b=g("<script>").prop({charset:a.scriptCharset,src:a.url}).on("load error",c=function(a){b.remove();c=null;a&&e("error"===a.type?404:200,a.type)});B.head.appendChild(b[0])},abort:function(){c&&c()}}}});var Ib=[],fb=/(=)\?(?=&|$)|\?\?/;g.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var a=Ib.pop()||g.expando+"_"+Eb++;this[a]=!0;return a}});g.ajaxPrefilter("json jsonp",function(b,c,e){var f,h,k,l=!1!==b.jsonp&&(fb.test(b.url)?"url":
"string"===typeof b.data&&0===(b.contentType||"").indexOf("application/x-www-form-urlencoded")&&fb.test(b.data)&&"data");if(l||"jsonp"===b.dataTypes[0])return f=b.jsonpCallback=g.isFunction(b.jsonpCallback)?b.jsonpCallback():b.jsonpCallback,l?b[l]=b[l].replace(fb,"$1"+f):!1!==b.jsonp&&(b.url+=(db.test(b.url)?"&":"?")+b.jsonp+"="+f),b.converters["script json"]=function(){k||g.error(f+" was not called");return k[0]},b.dataTypes[0]="json",h=a[f],a[f]=function(){k=arguments},e.always(function(){void 0===
h?g(a).removeProp(f):a[f]=h;b[f]&&(b.jsonpCallback=c.jsonpCallback,Ib.push(f));k&&g.isFunction(h)&&h(k[0]);k=h=void 0}),"script"});P.createHTMLDocument=function(){var a=B.implementation.createHTMLDocument("").body;a.innerHTML="<form></form><form></form>";return 2===a.childNodes.length}();g.parseHTML=function(a,b,c){if("string"!==typeof a)return[];"boolean"===typeof b&&(c=b,b=!1);var d;b||(P.createHTMLDocument?(b=B.implementation.createHTMLDocument(""),d=b.createElement("base"),d.href=B.location.href,
b.head.appendChild(d)):b=B);d=vb.exec(a);c=!c&&[];if(d)return[b.createElement(d[1])];d=h([a],b,c);c&&c.length&&g(c).remove();return g.merge([],d.childNodes)};g.fn.load=function(a,b,c){var d,e,f,h=this,k=a.indexOf(" ");-1<k&&(d=g.trim(a.slice(k)),a=a.slice(0,k));g.isFunction(b)?(c=b,b=void 0):b&&"object"===typeof b&&(e="POST");0<h.length&&g.ajax({url:a,type:e||"GET",dataType:"html",data:b}).done(function(a){f=arguments;h.html(d?g("<div>").append(g.parseHTML(a)).find(d):a)}).always(c&&function(a,b){h.each(function(){c.apply(this,
...
c=jb(b),b=b.documentElement,{top:d.top+c.pageYOffset-b.clientTop,left:d.left+c.pageXOffset-b.clientLeft}):d}},position:function(){if(this[0]){var a,b,c=this[0],d={top:0,left:0};"fixed"===g.css(c,"position")?b=c.getBoundingClientRect():(a=this.offsetParent(),b=this.offset(),g.nodeName(a[0],"html")||(d=a.offset()),d={top:d.top+g.css(a[0],"borderTopWidth",!0),left:d.left+g.css(a[0],"borderLeftWidth",!0)});return{top:b.top-d.top-g.css(c,"marginTop",!0),left:b.left-d.left-g.css(c,"marginLeft",!0)}}},offsetParent:function(){return this.map(function(){for(var a=
this.offsetParent;a&&"static"===g.css(a,"position");)a=a.offsetParent;return a||Va})}});g.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(a,b){var c="pageYOffset"===b;g.fn[a]=function(d){return X(this,function(a,d,e){var f=jb(a);if(void 0===e)return f?f[b]:a[d];f?f.scrollTo(c?f.pageXOffset:e,c?e:f.pageYOffset):a[d]=e},a,d,arguments.length)}});g.each(["top","left"],function(a,b){g.cssHooks[b]=sa(P.pixelPosition,function(a,c){if(c)return c=ca(a,b),Za.test(c)?g(a).position()[b]+"px":
