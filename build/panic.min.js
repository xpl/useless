...
_.takesFirst=_.higherOrder(_.first);_.takesLast=_.higherOrder(_.last);_.call=function(a){return a()};_.applies=function(a,b,c){return function(){return a.apply(b,c)}};_.prepends=function(a){return function(b){return a+b}};_.appends=function(a){return function(b){return b+a}};_.join=function(a,b){return a.join(b)};_.joinWith=_.flip2(_.join);_.joinsWith=_.higherOrder(_.joinWith);_.split=function(a,b){return a.split(b)};_.splitWith=_.flip2(_.split);_.splitsWith=_.higherOrder(_.splitWith);
_.sum=function(a,b){return(a||0)+(b||0)};_.subtract=function(a,b){return(a||0)-(b||0)};_.mul=function(a,b){return(a||0)*(b||0)};_.equal=function(a,b){return a===b};_.sums=_.plus=_.higherOrder(_.sum);_.subtracts=_.minus=_.higherOrder(_.subtract);_.muls=_.higherOrder(_.mul);_.equals=_.higherOrder(_.equal);_.less=function(a,b){return a<b};_.lessOrEqual=function(a,b){return a<=b};_.greater=function(a,b){return a>b};_.greaterOrEqual=function(a,b){return a>=b};_.isNegative=function(a){return 0>a};
...
_.isTypeOf_ES5=function(a,b){return b instanceof a};_.isTypeOf=_.isInstanceofSyntaxAvailable()?_.isTypeOf_ES5:_.isTypeOf_ES4;_.isPrototypeInstance=function(a){return a&&a.constructor&&_.isPrototypeConstructor(a.constructor)};_.isPrototypeConstructor=function(a){return a&&void 0!==a.$definition||!1};_.coerceToArray=function(a){return void 0===a?[]:_.isArray(a)?a:[a]};_.coerceToFunction=function(a){return _.isFunction(a)?a:_.constant(a)};
...
if(_.isStrictlyObject(a))return{}},coerceToUndefined:function(a){return void 0===a||null===a||a===Math.NaN||""===a||_.isPOD(a)&&(_.isEmptyObject(a)||0===a.length)?void 0:a}});_.json=function(a){if("string"===typeof a)try{return JSON.parse(a)}catch(b){return{}}else return JSON.stringify(a)};_.alignStringsRight=function(a){var b=a.map(_.count),c=_.max(b);return[b,a].zip(function(a,b){return" ".repeats(c-a)+b})};
...
_.stringifyPrototype=function(a){if(Platform.NodeJS&&a.$meta){var b="";a.$meta(function(a){b=a.name});return b&&b+" ()"}return"<prototype>"};
...
a);if(_.isTypeOf(Tags,a))return _.reduce(Tags.get(a),function(a,d,e){return _.isBoolean(d)?e+" "+a.quote("()"):e+" ("+_.stringifyImpl(d,b,c,0,{pretty:!1})+", "+a+")"},_.stringifyImpl($untag(a),b,c,d+1,e));if(!e.pure&&_.hasOOP&&_.isPrototypeInstance(a)&&$prototype.defines(a.constructor,"toString"))return a.toString();if(!_.isObject(a)||"undefined"!==typeof $atom&&$atom.is(a))return _.isDecimal(a)&&0<e.precision?_.toFixed(a,e.precision):a+"";var g=_.isArray(a),f=e.pretty||!1;if("browser"===_.platform().engine){if(_.isTypeOf(Element,
a))return"<"+a.tagName.lowercase+">";if(_.isTypeOf(Text,a))return"@"+a.wholeText}if(a.toJSON)return _.quoteWith('"',a.toJSON());if(!e.pure&&(d>(e.maxDepth||5)||g&&a.length>(e.maxArrayLength||30)))return g?"<array["+a.length+"]>":"<object>";var h=b.concat([a]);c.push(a);var k=_.pairs(a),n=_.stringifyImpl.tails2(h,c,d+1,e);if(f){k=_.values(a);a=_.alignStringsRight(_.keys(a).map(_.appends(": ")));d=k.map(n);e=d.map(function(a,b){return"["===a[0]||"{"===a[0]?3:_.isString(k[b])?1:0});var l=_.max(e);d=
[e,d].zip(function(a,b){return" ".repeats(l-a)+b});a=g?d:[a,d].zip(_.bullet);a=_.bullet(g?"[ ":"{ ",a.join(",\n"));d=a.split("\n");return a+(" ".repeats(_.max(d.map(_.count))-_.count(d.last))+(g?" ]":" }"))}return _.quoteWith(g?"[]":"{  }",_.joinWith(", ",_.map(k,function(a){return(g?"":a[0]+": ")+n(a[1])})))};_.toFixed=function(a,b){return a&&a.toFixed&&a.toFixed(b)||void 0};_.toFixed2=function(a){return _.toFixed(a,2)};_.toFixed3=function(a){return _.toFixed(a,3)};_.hasStdlib=!0;
_.throwsError=_.higherOrder(_.throwError=function(a){throw Error(a);});_.overrideThis=_.throwsError("override this");_.notImplemented=_.throwsError("not implemented");_.mixin({values2:function(a){return _.isArray(a)?a:_.isStrictlyObject(a)?_.values(a):_.isEmpty(a)?[]:[a]}});_.mixin({map2:function(a,b,c){return _.isArray(a)?_.map(a,b,c):_.isStrictlyObject(a)?_.mapObject(a,b,c):b.call(c,a)}});_.mapsWith=_.higherOrder(_.mapWith=_.flip2(_.map));
_.mapKeys=function(a,b){return _.isArray(a)?_.map(a,_.tails2(_.mapKeys,b)):_.isStrictlyObject(a)?_.object(_.map(_.pairs(a),function(a){return[b(a[0]),_.mapKeys(a[1],b)]})):a};_.mixin({mapMap:_.hyperOperator(_.unary,_.map2)});
...
_.extend=$restArg(_.extend);_.extended=_.partial(_.extend,{});_.extendWith=_.flip(_.extend);_.extendsWith=_.flip(_.partial(_.partial,_.flip(_.extend)));_.extendedDeep=_.tails3(_.zipZip,function(a,b){return void 0===b?a:b});_.extend2=$restArg(function(a){return _.extend(a,_.reduceRight(arguments,function(a,c){return _.object(_.map(_.union(_.keys(c),_.keys(a)),function(d){var e=c[d];return[d,d in a?"object"===typeof e?_.extend(e,a[d]):a[d]:e]}))},{}))});
_.find2=function(a,b){for(var c=0,d=a.length;c<d;c++){var e=b(a[c],c,a);if("boolean"!==typeof e)return e;if(!0===e)return a[c]}};
...
_.partition2=function(a,b){var c=void 0,d=[],e=[];_.each(a,function(a){var g=b(a);c!=g&&e.length&&(d.push(e),e=[]);e.push(a);c=g});e.length&&d.push(e);return d};
...
_.sortBy(a.next||[],b.sort):a.next||[];return[a].concat(g(_.reduce(c,function(a,b){if(a===b)return a;if(f(b,a))return b.next.push(a),b;a.next.push(b);return a})))};return _.rest(_.pluck(g(e({},c)),"item"))};_.key=function(a){return function(b,c){return a(c)}};_.filterKeys=function(a,b){return _.filter(a,function(a,d){return b(d)})};_.rejectKeys=function(a,b){return _.reject(a,function(a,d){return b(d)})};_.pickKeys=function(a,b){return _.pick(a,function(a,d){return b(d)})};
_.omitKeys=function(a,b){return _.omit(a,function(a,d){return b(d)})};
...
_(["constant","get","once","async"]).each(_.defineTagKeyword);_.defineModifierKeyword=function(a,b){_.defineKeyword(a,function(a){return Tags.modify(a,b)})};_.deleteKeyword=function(a){delete $global[_.keyword(a)]};_.cps=function(){return _.cps.sequence.apply(null,arguments)};_.cps.apply=function(a,b,c,d){c=_.asArray(c);var e=_.numArgs(a)-1,f=c[e];c[e]=function(){d.call(this,arguments,f)};return a.apply(b,c)};
_.extend(_.cps,{each:function(a,b,c,d,e,f){var g=arguments.callee,h=d||0,k=0===h?void 0===a.length?_.keys(a):void 0:f,n=0===h?k?k.length:a.length:e,l=2!==_.numArgs(b);if(!a||h>=(n||0))c&&c();else{var m=k?k[h]:h,p=function(){g(a,b,c,h+1,n,k)};l?b(a[m],m,p,c,a):b(a[m],p,c,a)}}});_.extend(_.cps,{map:function(a,b,c){var d=_.isArray(a)?[]:{};_.cps.each(a,2==_.numArgs(b)?function(a,c,g){b(a,function(a){d[c]=a;g()})}:function(a,c,g){b(a,c,function(a){d[c]=a;g()})},function(){c(d)})}});
...
_.cps.trySequence=function(a,b,c){_.reduceRight(a,function(a,e){return function(f){if(_.isTypeOf(Error,f))return(c||b)(f);try{return e.apply(this,_.asArray(arguments).concat(a))}catch(g){return(c||b)(g)}}},b)()};_(["method","property","flipped"]).each(_.defineTagKeyword);
...
$extensionMethods(Function,{$:$method(_.partial),bind:_.bind,partial:_.partial,tails:_.tails,tails2:_.tails2,tails3:_.tails3,compose:_.compose,then:_.then,flip:_.flip,flip2:_.flip2,flip3:_.flip3,asFreeFunction:_.asFreeFunction,asMethod:_.asMethod,calls:function(a){return _.higherOrder(a)},returns:function(a,b){return function(){a.apply(this,arguments);return b}},asPromise:function(a){return new Promise(a)},asContinuation:function(a){return $restArg(function(){_.last(arguments)(a.apply(this,_.initial(arguments)))})},
wraps:function(a,b){a._wrapped=_.withSameArgs(a,b);return a},wrapped:function(a){return a._wrapped||a},original:function(a){for(;a&&a._wrapped;)a=a._wrapped;return a},arity0:_.arity0,arity1:_.arity1,arity2:_.arity2,arity3:_.arity3,or:_.or,and:_.and,not:_.not,applies:_.applies,oneShot:function(a){var b=!1;return function(){if(!b)return b=!0,a.apply(this,arguments)}},memoized:_.memoize,throttled:_.throttle,debounced:function(a,b,c){var d,e,f,g,h,k=function(){var l=Date.now()-d;l<b&&0<l?e=setTimeout(k,
b-l):(e=null,c||(f=a.apply(h,g),e||(h=g=null)))},n=function(){h=this;g=arguments;d=Date.now();var l=c&&!e;e||(e=setTimeout(k,b));l&&(f=a.apply(h,g),h=g=null);return f};n.cancel=function(){e&&(clearTimeout(e),e=null)};n.callImmediately=function(){n.cancel();a.apply(h,g)};return n},postpone:$method(function(a){a.postponed.apply(null,arguments)}),postponed:function(a){return function(){var b=arguments;a._postponed||(a._postponed=!0,_.delay(function(){a._postponed=!1;a.apply(this,b)}))}},delay:_.delay,
delayed:function(a,b){return function(){var c=arguments,d=this;_.delay(function(){a.apply(d,c)},b)}}});
_.tests.Function.catches=function(){$assert("yo",_.constant("yo").catches($fails)(),_.identity.catches($fails)("yo"),_.throwsError("xx").catches("yo")());$assertThrows(function(){_.constant("yo").catches(function(){$assert("catch handler shoudnt work on passed continuations")},_.throwsError("xx"))()});$assert(function(a){throw a;}.catches(_.appends("+error_case"),_.appends("+no_error_case"),_.appends("+finally"))("foo"),"foo+error_case+finally");$assertMatches(_.throwError.catches()("yo"),{message:"yo"});
$assert(_.catches(_.throwsError(42),$assertMatches.$({message:42}).returns("yo"))(),"yo");$assertCPS(_.constant("yo").catches($fails),"yo")};$extensionMethods(Function,{catch_:function(a,b,c,d){return a.catches(b,c)()},catches:function(a,b,c,d){var e=arguments.length;b=1<e?_.coerceToFunction(b):_.identity;c=2<e?_.coerceToFunction(c):_.identity;d=3<e?_.coerceToFunction(d):_.identity;return function(){var e=void 0,g=!1;try{e=a.apply(this,arguments)}catch(h){e=b(h),g=!0}g||(e=c(e));return d(e)}}});
...
$extensionMethods(Array,{each:_.each,map:_.map,reduce:_.reduce,reduceRight:_.reduceRight,zip:_.zipWith,groupBy:_.groupBy,indexBy:_.indexBy,filter:_.filter,flat:_.flatten.tails2(!0),object:_.object,contains:function(a,b){return 0<=a.indexOf(b)},top:function(a){return a[a.length-1]},first:function(a){return a[0]},last:function(a){return a[a.length-1]},take:function(a,b){return a.slice(0,b)},before:function(a,b){var c=a.indexOf(b);return 0>c?a:a.slice(0,c-1)},after:function(a,b){var c=a.indexOf(b);return 0>
c?a:a.slice(c+1)},isEmpty:function(a){return 0===a.length},notEmpty:function(a){return 0<a.length},lastIndex:function(a){return a.length-1},random:function(a){return a[_.random(0,a.lastIndex)]},copy:function(a){return a.slice(0)},removeAll:$method(function(a){return a.splice(0,a.length),a}),remove:function(a,b){for(var c;-1!==(c=a.indexOf(b));)a.splice(c,1);return a},removeAt:function(a,b){a.splice(b,1);return a},insertAt:function(a,b,c){a.splice(c,0,b);return a},itemAtWrappedIndex:function(a,b){return a[b%
a.length]},reversed:function(a){return a.slice().reverse()},swap:$method(function(a,b,c){var d=a[b];a[b]=a[c];a[c]=d;return a})});_.zap=function(a){var b=_.last(arguments);return _.reduce(_.rest(_.initial(arguments)),function(a,d){return _.times(Math.max(a.length,d.length),function(e){return b(a[e],d[e])})},a)};
...
k=b._onAfter,n=b._intercept,b=d||this,l,m=void 0;if(f.length){l=0;for(m=f.length;l<m;l++)f[l].apply(b,arguments);f.removeAll()}l=0;for(m=h.length;l<m;l++)h[l].apply(b,arguments);f=(n.length?_.cps.compose([a].concat(n)):a).apply(b,arguments);if(k.length||g.length){h=_.asArray(arguments).concat(f);l=0;for(m=k.length;l<m;l++)k[l].apply(b,h);if(g.length){l=0;for(m=g.length;l<m;l++)g[l].apply(b,h);g.removeAll()}}return f}))})})})();
...
this),this.removeAll()):a.queuedBy&&(a.queuedBy.remove(this),this.remove(a)))}}),c=void 0,d=a.write(function(a,d){var e=_.rest(arguments),k=b.copy,n=c.context;a&&b.off();_.each(k,function(a){c.postpones?a.postponed.apply(this,e):a.apply(this,e)},n||this)}),e=a.read(function(a){0>b.indexOf(a)&&(a.queuedBy?a.queuedBy.push(b):a.queuedBy=[b],b.push(a))});return c=_.extend($restArg(function(a){_.isFunction(a)?e.call(this,a):d.apply(this,arguments);return arguments.callee}),a,{queue:b,once:function(a){_.find(b,
...
e,f,a)||b)})});return b}},evalPrototypeSpecificMacros:function(a){return function(b){if(!b.isTraitOf){var c=$untag(b.$macroTags||a&&a.$definition&&a.$definition.$macroTags);c&&_.each(b,function(a,e){_.each(c,function(c,g){a=b[e];_.keyword(g)in a&&(b[e]=c(b,a,e)||a)})})}return b}},generateCustomCompilerImpl:function(a){return function(b){b.$impl?(b.$impl.__proto__=a&&a.$impl||this,b.$impl=$static($builtin($property(b.$impl)))):a&&a.$impl&&(b.$impl=$static($builtin($property(a.$impl))));return b}},
...
}}return b}},expandAliases:function(a){return _.mapObject(a,function(b){var c=Tags.unwrap(b);return $alias.is(b)?$property.is(b)?$property({get:function(){return this[c]},set:function(a){this[c]=a}}):a[c]:b})},flatten:function(a){var b=_.pick(a,this.isTagKeywordGroup),b=_.object(_.flatten(_.map(b,function(a,b){return _.map(a,function(a,c){return[c,$global[b](a)]})}),!0));a=_.omit(a,this.isTagKeywordGroup);return _.extend(a,b)},isTagKeywordGroup:function(a,b){var c=Tags.unwrap(a);return _.isKeyword(b)&&
...
_.interlocked=function(a){var b=new Lock;return _.extendWith({wait:b.$(b.wait)},_.prependsArguments(Tags.unwrap(a),function(a){b.acquire(function(){a(b.$(b.release))})}))};_.defineKeyword("scope",function(a){var b=void 0;return _.prependsArguments(Tags.unwrap(a),function(a){var d={when:void 0};(b=b||[]).push(d);a(function(a){if(d.when)throw Error("$scope: release called twice");for(d.when=a;b&&b.last&&b.last.when;)a=b.last.when,(b=_.initial(b)).isEmpty&&(b=void 0),a()})})});
...
_.onAfter(this,"destroy",this.afterDestroy);var e=[],f={init:!0};_.each(d,function(a,b){if(void 0!==a){if(a.$observableProperty){var d=a.subject,n=b in c?c[b]:d,l=b+"Change",m=f[l]=this[l]=_.observable();m.context=this;m.postpones=a.$postpones;if(_.isPrototypeInstance(d)){var p=d.constructor;m.beforeWrite=function(a){return p.isTypeOf(a)?a:new p(a)}}a.$reference&&(m.trackReference=!0);_.defineProperty(this,b,{get:function(){return m.value},set:function(a){m.call(this,a)}});a.listeners&&_.each(a.listeners,
function(a){e.push([m,a])});_.isFunction(a.$observableProperty)&&e.push([m,a.$observableProperty]);void 0!==n&&m(n)}else if(Component.isStreamDefinition(a)){var q=f[b]=this[b]=_.extend((a.$trigger?_.trigger:a.$triggerOnce?_.triggerOnce:a.$observable?_.observable:a.$barrier?_.barrier:void 0)(a.subject),{context:this,postpones:a.$postpones});a.listeners&&_.each(a.listeners,function(a){e.push([q,a])});(d=c[b])&&e.push([q,d])}a.$listener&&(this[b].queuedBy=[]);a.$interlocked&&(this[b]=_.interlocked(this[b]));
a.$bindable&&(this[b]=_.extend(_.bindable(this[b],this),_.map2(a.$bindable.hooks||{},_.mapsWith(this.$.bind(this).arity1))));a.$debounce&&(d=this[b],n=_.coerceToObject(a.$debounce),this[b]=d.debounced(n.wait||500,n.immediate));a.$throttle&&(d=this[b],n=_.coerceToObject(a.$throttle),this[b]=_.throttle(d,n.wait||500,n));a.$memoize?this[b]=_.memoize(this[b]):a.$memoizeCPS&&(this[b]=_.cps.memoize(this[b]))}},this);_.intercept(this,"init",function(a){(_.hasArgs(this.constructor.prototype.init)?_.cps.sequence:
...
_.extend(log=function(){return log.write.apply(this,[log.config({location:!0,stackOffset:1})].concat(_.asArray(arguments)))},{Color:$prototype(),Config:$prototype(),cleanArgs:function(a){return _.reject(a,_.or(log.Color.isTypeOf,log.Config.isTypeOf))},read:function(a,b){return _.find(b,a.isTypeOf)||new a({})},modify:function(a,b,c){return _.reject(b,a.isTypeOf).concat(c(log.read(a,b)))}});
...
log.impl.defaultWriteBackend},withConfig:function(a,b){log.impl.configStack.push(log.impl.configure([{stackOffset:-1},a]));var c=b();log.impl.configStack.pop();return c},currentConfig:function(){return log.impl.configure(log.impl.configStack)},impl:{configStack:[],configure:function(a){return _.reduce2({stackOffset:0,indent:0},_.nonempty(a),function(a,c){return _.extend(a,_.nonempty(c),{indent:a.indent+(c.indent||0),stackOffset:a.stackOffset+(c.stackOffset||0)})})},write:$restArg(function(){var a=
log.writeBackend(),b=_.asArray(arguments),c=log.cleanArgs(b),d=log.impl.configure(_.concat([{stackOffset:Platform.NodeJS?1:3}],log.impl.configStack,_.filter(b,log.Config.isTypeOf))),e=(a.indent||0)+(d.indent||0),f=log.impl.stringifyArguments(c,d),e=_.times(e,_.constant("\t")).join(""),f=f.reversed.match(/(\n*)([^]*)/),g=d.where||$callStack[d.stackOffset]||{},b={color:d.color||log.readColor(b),indentation:e,indentedText:f[2].reversed.split("\n").map(_.prepends(e)).join("\n"),trailNewlines:f[1],codeLocation:d.location&&
log.impl.location(g)||"",where:d.location&&g||void 0,args:b,config:d};a(b);return c[0]}),defaultWriteBackend:function(a){var b=a.color,c=a.indentedText,d=a.codeLocation;a=a.trailNewlines;b=b&&(Platform.NodeJS?b.shell:b.css);Platform.NodeJS?b?console.log(b+c+"\u001b[0m",d,a):console.log(c,d,a):(c=c.split("\n"),c=[_.first(c)||""].concat(_.rest(c).map(_.prepends(" "))),console.log((b?"%c":"")+c.join("\n"),b?"color: "+b:"",d,a))},location:function(a){return _.quoteWith("()",_.nonempty([a.calleeShort,
a.fileName+":"+a.line]).join(" @ "))},stringifyArguments:function(a,b){return _.map(a,log.impl.stringify.tails2(b)).join(" ")},stringify:function(a,b){b=b||{};if(_.isTypeOf(Error,a)){var c=log.impl.stringifyError(a);return a.originalError?c+"\n\n"+log.impl.stringify(a.originalError):c}return _.isTypeOf(CallStack,a)?log.impl.stringifyCallStack(a):"object"===typeof a?_.isArray(a)&&1<a.length&&_.isObject(a[0])&&b.table?log.asTable(a):_.stringify(a,b):"string"===typeof a?a:_.stringify(a)},stringifyError:function(a){try{var b=
...
maxTotalWidth:0},g=_.reduce(e,_.sum,0),h=_.map(e,_.muls(1/g)),k=Math.max(0,g-f.maxTotalWidth),n=_.map(e,function(a,b){return Math.max(f.minColumnWidths[b],Math.floor(a-k*h[b]))}),d=d.map(function(a){return[n,a].zip(_.subtract)});return[c,d].zip(_.zap.tails(function(a,b){return 0<=b?a+" ".repeats(b):_.initial(a,-b).join("")}).then(_.joinsWith("  ")))}});Platform.NodeJS&&(module.exports=log);_.defineTagKeyword("shouldFail");_.defineTagKeyword("async");_.defineTagKeyword("assertion");
...
Testosterone.LogsMethodCalls=$trait({$test:function(){var a=$prototype({$traits:[Testosterone.LogsMethodCalls]}),a=new ($extends(a,{foo:$log(function(a){$assert(a,42);return 24})}));$assert(a.foo(42),24);$assert(_.pluck(this.logCalls,"indentedText"),["\tfoo","\t\t\u2192 24","\t\t"])},$macroTags:{log:function(a,b,c){var d=_.isBoolean(b.$log)?void 0:log.color[b.$log],e="";$untag(a.$meta)(function(a){e=a.name});return Tags.modify(b,function(a){return function(){var b=this,h=arguments,k=log.currentConfig().protoName===
e;log.write(k?c:_.nonempty([e,c]).join(".")+_.map(arguments,_.stringifyOneLine).join(", ").quote(" ()"),log.config({location:!0}));return log.withConfig({indent:1,color:d,protoName:e},function(){var c=a.apply(b,h);void 0!==c&&log.write("\u2192",_.stringifyOneLine(c),log.config({color:d}));2>log.currentConfig().indent&&log.newline();return c})}})}}});Platform.NodeJS&&(module.exports=Testosterone);
...
a('<span class="file">').text(b.fileName),a('<span class="line">').text(b.line)])},printFailedTest:function(b){var c=a('<pre class="test-log" style="margin-top: 13px;">');log.withWriteBackend(this.$(function(b){_.isTypeOf(Error,b.args.first)&&console.log(b.args.first);c.append(_.isTypeOf(Error,b.args.first)?a("<div>").css({color:b.color.css,display:"inline-block"}).append([b.indentation,a('<div class="inline-exception">').append(this.printError(b.args.first))]):a("<div>").css({color:b.color.css}).text(b.indentedText).append(b.where&&
this.printLocation(b.where)).append((b.trailNewlines||"").replace(/\n/g,"<br>")))}),function(a){b.evalLogCalls();a()});return[a('<div class="panic-alert-error-message" style="font-weight: bold;">').text(b.name).append('<span style="float:right; opacity: 0.25;">test failed</span>'),c]},printError:function(b){var c=CallStack.fromErrorWithAsync(b);return[a('<div class="panic-alert-error-message" style="font-weight: bold;">').text(b.message).append(_.any(c,function(a,b){return(a.thirdParty||a["native"])&&
0!==b})?'<a class="clean-toggle" href="javascript:{}"></a>':"").click(this.$(function(b){a(b.delegateTarget).parent().toggleClass("all").transitionend(this.$(function(){this.modalBody.scroll()}))})),a('<div class="not-matching" style="margin-top: 5px; padding-left: 10px;">').append(_.map(_.coerceToArray(b.notMatching||[]),function(b){return a("<pre>").text(log.impl.stringify(b))})),a('<ul class="callstack">').append(_.map(c,this.$(function(b){var c=a('<li class="callstack-entry">').toggleClass("third-party",
