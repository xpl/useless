...
0<=navigator.userAgent.indexOf("Android")?{touch:!0,system:"Android"}:0<=navigator.platform.indexOf("iPad")?{touch:!0,system:"iOS",device:"iPad"}:0<=navigator.platform.indexOf("iPhone")||0<=navigator.platform.indexOf("iPod")?{touch:!0,system:"iOS",device:"iPhone"}:{}):"undefined"!==typeof global&&global._?{engine:"node"}:{},b="browser"===a.engine?window:"node"===a.engine?global:void 0;b.define=function(a,d,e){if(a in b)throw Error("cannot define global "+a+": already there");Object.defineProperty(b,
a,_.extend("function"===typeof d&&0===d.length?{get:d}:{value:d},{enumerable:!0},e))};b.define("$global",b);b.define("$platform",Object.defineProperties({},_.mapObject({engine:a.engine,system:a.system,device:a.device,touch:a.touch||!1,IE:"IE"===a.browser,Firefox:"Firefox"===a.browser,Safari:"Safari"===a.browser,Chrome:"Chrome"===a.browser,WebKit:"WebKit"===a.browserEngine,Browser:"browser"===a.engine,NodeJS:"node"===a.engine,iPad:"iPad"===a.device,iPhone:"iPhone"===a.device,iOS:"iOS"===a.system},
function(a,b){return{enumerable:!0,value:a}})))})();$overrideUnderscore=function(a,b){return _[a]=b(_[a])};$platform.NodeJS&&($global.alert=function(a){var b=$global.log&&_.partial(log.warn,log.config({stackOffset:2}))||console.log;b.apply(b,["ALERT:"].concat(_.asArray(arguments)))});$global.alert2=function(a){alert(_.map(arguments,_.stringify).join(", "));return arguments[0]};$global.log=function(){console.log.call(console.log,arguments)};
...
$extensionMethods(Function,{$:$method(_.partial),$$:$method(_.tails),bind:_.bind,partial:_.partial,tails:_.tails,tails2:_.tails2,tails3:_.tails3,compose:_.compose,then:_.then,flip:_.flip,"with":_.flipN,flip2:_.flip2,flip3:_.flip3,asFreeFunction:_.asFreeFunction,asMethod:_.asMethod,callsWith:_.callsTo,tailsWith:_.tailsTo,higherOrder:_.higherOrder,returns:function(a,b){return function(){a.apply(this,arguments);return b}},asPromise:function(a){return new Promise(a)},asContinuation:function(a){return $restArg(function(){_.last(arguments)(a.apply(this,
...
$extensionMethods(String,{quote:_.quote,contains:function(a,b){return 0<=a.indexOf(b)},startsWith:function(a,b){return a[0]===b},cut:function(a,b){return a.substring(0,b-1)+a.substring(b,a.length)},insert:function(a,b,c){return a.substring(0,b)+c+a.substring(b,a.length)},lowercase:function(a){return a.toLowerCase()},uppercase:function(a){return a.toUpperCase()},trimmed:function(a){return a.trim()},limitedTo:function(a,b){return a&&(a.length<=b?a:a.substr(0,b-1)+"\u2026")},escaped:function(a){return _.escape(a)},
repeats:function(a,b){return _.times(b,_.constant(a)).join("")},prepend:function(a,b){return b+a},append:function(a,b){return a+b},first:function(a,b){return _.first(a,b).join("")},last:function(a,b){return _.last(a,b).join("")},reversed:function(a){return a.split("").reverse().join("")},capitalized:function(a){return a.charAt(0).toUpperCase()+a.slice(1)},decapitalized:function(a){return a.charAt(0).toLowerCase()+a.slice(1)},latinAlphanumericValue:function(a){return a.replace(/[^a-z0-9]/gi,"")},alphanumericValue:function(a){return a.replace(unicode_hack(/[^0-9\p{L}|^0-9\p{N}|^0-9\p{Pc}|^0-9\p{M}]/g),
...
_.dashesToCamelCase=function(a){return a.replace(/(-.)/g,function(a){return a[1].uppercase})};_.loDashesToCamelCase=function(a){return a.replace(/(_.)/g,function(a){return a[1].uppercase})};_.defineHiddenProperty(Object.prototype,"extend",{get:_.constant(_.extend.asMethod)});
