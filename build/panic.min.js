...
function(a,b){return{enumerable:!0,value:a}})))})();$overrideUnderscore=function(a,b){return _[a]=b(_[a])};$platform.Browser&&($global.alert=function(a){var b=$global.log&&_.partial(log.warn,log.config({stackOffset:2}))||console.log;b.apply(b,["ALERT:"].concat(_.asArray(arguments)))});$global.alert2=function(a){alert(_.map(arguments,_.stringify).join(", "));return arguments[0]};$global.log=function(){console.log.call(console.log,arguments)};
