...
a);if(_.isTypeOf(Tags,a))return _.reduce(_.keys(Tags.get(a)),function(a,b){return b+" "+a.quote("()")},_.stringifyImpl($untag(a),b,c,d+1,e,l));if(!e.pure&&_.hasOOP&&_.isPrototypeInstance(a)&&$prototype.defines(a,"toString"))return a.toString();if(!_.isObject(a)||"undefined"!==typeof $atom&&$atom.is(a))return _.isDecimal(a)&&0<e.precision?_.toFixed(a,e.precision):a+"";var h=_.isArray(a),g=e.pretty||!1;if("browser"===_.platform().engine){if(_.isTypeOf(Element,a))return"<"+a.tagName.lowercase+">";if(_.isTypeOf(Text,
a))return"@"+a.wholeText}if(a.toJSON)return _.quoteWith('"',a.toJSON());if(!e.pure&&(d>(e.maxDepth||5)||h&&a.length>(e.maxArrayLength||30)))return h?"<array["+a.length+"]>":"<object>";var k=b.concat([a]);c.push(a);b=_.pairs(a);var m=!g||2>b.length,l=f+1,n=m?"":"\t".repeats(l);if(g&&!h){var p=_.reduce(_.map(_.keys(a),_.count),_.largest,0);b=_.map(b,function(a){return[a[0],a[1]," ".repeats(p-a[0].length)]})}return _.quoteWith(h?m?"[]":"[\n  ]":m?"{  }":"{\n  }",_.joinWith(m?", ":",\n",_.map(b,function(a){return n+
(h?"":a[0]+": "+(a[2]||""))+_.stringifyImpl(a[1],k,c,d+1,e,l)})))};_.toFixed=function(a,b){return a&&a.toFixed&&a.toFixed(b)||void 0};_.toFixed2=function(a){return _.toFixed(a,2)};_.toFixed3=function(a){return _.toFixed(a,3)};_.hasStdlib=!0;_.extend(_,{throwsError:function(a){return function(){throw Error(a);}}});_.overrideThis=_.throwsError("override this");_.notImplemented=_.throwsError("not implemented");_.mixin({tryEval:function(a,b,c){var d=void 0;try{d=a()}catch(e){d=b&&b(e)}return c?c(d):d}});
_.mixin({values2:function(a){return _.isArray(a)?a:_.isStrictlyObject(a)?_.values(a):_.isEmpty(a)?[]:[a]}});_.mixin({map2:function(a,b,c){return _.isArray(a)?_.map(a,b,c):_.isStrictlyObject(a)?_.mapObject(a,b,c):b.call(c,a)}});_.mixin({mapMap:_.hyperOperator(_.unary,_.map2)});
...
(function(){var a=["onceBefore","onceAfter","onBefore","onAfter","intercept"],b=function(b){return _.extend({},b,{_bindable:!0,impl:b,_wrapped:b},_.object(_.map(a,function(a){var b="_"+a,c=0<=a.indexOf("once");return[a,function(a){if(!_.isBindable(this))throw Error("wrong this");var d=this[b];(!c||0>d.indexOf(a))&&this[b].push(a);return this}]})),_.object(_.map(a,function(a){return["_"+a,[]]})))};_.extend(_,_.mapObject(_.invert(a),function(a){return function(b,e,f){var g=b[e];b=_.isBindable(g)?g:
b[e]=_.bindable(g);return b[a].call(b,f)}}.flip2),{off:function(b,d,e){var f=b[d];_.isBindable(f)&&_.each(a,function(a){f["_"+a]=_.without(f["_"+a],e)})},isBindable:function(a){return a&&a._bindable?!0:!1},bindable:_.extendWith({hooks:a,hooksShort:["onceBefore","onceAfter","before","after",""]},function(a,d){return _.withSameArgs(a,_.extendWith(b(a),function(){var b=arguments.callee,f=b._onceBefore,g=b._onceAfter,h=b._onBefore,k=b._onAfter,m=b._intercept,b=d||this,l,n=void 0;if(f.length){l=0;for(n=
f.length;l<n;l++)f[l].apply(b,arguments);f.removeAll()}l=0;for(n=h.length;l<n;l++)h[l].apply(b,arguments);f=(m.length?_.cps.compose([a].concat(m)):a).apply(b,arguments);if(k.length||g.length){h=_.asArray(arguments).concat(f);l=0;for(n=k.length;l<n;l++)k[l].apply(b,h);if(g.length){l=0;for(n=g.length;l<n;l++)g[l].apply(b,h);g.removeAll()}}return f}))})})})();
...
ltwh:$alias("css"),clone:$property(function(){return new BBox(this.x,this.y,this.width,this.height)}),floor:$property(function(){return new Vec2(Math.floor(this.x),Math.floor(this.y))}),css:$property(function(){return{left:this.left,top:this.top,width:this.width,height:this.height}}),leftTop:$property(function(){return new Vec2(this.left,this.top)}),leftBottom:$property(function(){return new Vec2(this.left,this.bottom)}),rightBottom:$property(function(){return new Vec2(this.right,this.bottom)}),rightTop:$property(function(){return new Vec2(this.right,
...
jQuery&&function(a){var b=_.clone(a.fn);_.extend(a,{svg:function(b){return a(document.createElementNS("http://www.w3.org/2000/svg",b))}}).fn.extend({on:function(a,d){var e=this;d=_.find(arguments,_.isFunction);d.queuedBy&&d.queuedBy.push({remove:function(){e.off(a,d)}});return b.on.apply(this,arguments)},item:function(a){return a?(this.length&&(this[0]._item=a),this):this.length?this[0]._item:void 0},props:function(a){_.extend.apply(null,[this[0]].concat(arguments));return this},props2:function(a){_.extend2.apply(null,
[this[0]].concat(arguments));return this},hasWait:function(){return this.hasClass("i-am-busy")},waitUntil:function(a,b){this.addClass("i-am-busy").attr("disabled",!0);a(this.$(function(){this.removeClass("i-am-busy").removeAttr("disabled");b&&b.apply(null,arguments)}));return this},hasParent:function(a){for(var b=this;0<b.length;){if(b[0]==(a[0]||a))return!0;b=b.parent()}return!1},nonemptyValue:function(){var b=a.trim(this.val());return 0==b.length?void 0:b},intValue:function(){var a=parseInt(this.nonemptyValue(),
10);return isNaN(a)?void 0:a},hitTest:function(b){var d=this.offset(),e=b.clientX-d.left;b=b.clientY-d.top;return 0<=e&&0<=b&&e<a(this).width()&&b<a(this).height()},attrs:function(){return _.object(_.map(arguments,function(a){return[a,this.attr(a)]},this))},belongsTo:function(a){return this.is(a)||this.parents(a).length},selectClass:function(a,b){return this.removeClass(_.values(b).join(" ")).addClass(b[a])},attrInt:function(a){return(this.attr(a)||"").integerValue},cssInt:function(a){return(this.css(a)||
"").integerValue},eachChild:function(b,d){_.each(this.find(b),function(b){d(a(b))});return this},transitionend:function(a){return this.one("transitionend webkitTransitionEnd oTransitionEnd otransitionend MSTransitionEnd",a.oneShot)},animationend:function(a){return this.one("animationend webkitAnimationEnd oAnimationEnd oanimation MSAnimationEnd",a.oneShot)},animateWith:function(a,b){a&&(this.addClass(a),this.animationend(this.$(function(){this.removeClass(a);b&&b.call(this)})));return this},drag:function(){var b=
function(b,c){return b.originalEvent.touches&&_.find(b.originalEvent.touches,function(b){return a(b.target).hasParent(c)})||b};return function(d){Platform.touch||window.__globalDragOverlay||(window.__globalDragOverlay=a("<div>").css({display:"none",position:"fixed",top:0,right:0,bottom:0,left:0,zIndex:999999}).appendTo(document.body));var e=window.__globalDragOverlay,f=d.button||1,g=this.$(function(g){var h=d.relativeTo||this;this.addClass(d.cls||"");if(Platform.touch||g.which===f){var l=h.offset(),
n=void 0;if(!d.start||!1!==(n=d.start.call(d.context||this,new Vec2(g.pageX-l.left,g.pageY-l.top),g))){var p=void 0,r=void 0,q=void 0,n=_.clone(n),t=this.$(function(a){if(Platform.touch||a.which===f){a.preventDefault();a=b(a,this[0]);var e=h.offset();n=d.move.call(d.context||this,n,new Vec2(a.pageX-g.pageX,a.pageY-g.pageY),new Vec2(a.pageX-e.left,a.pageY-e.top),a)||n}else p(a)}),r=function(){a(e||document.body).css(e?{display:"none"}:{}).off("mouseup touchend",q).off("mousemove touchmove",t)},q=this.$(function(a){r();
d.end&&(a=b(a,this[0]),d.end.call(d.context||this,n,new Vec2(a.pageX-g.pageX,a.pageY-g.pageY),a));this.removeClass(d.cls||"")}),p=this.$(function(a){r();q(a)});a(e||document.body).css(e?{display:"",cursor:d.cursor||""}:{}).on("mousemove touchmove",t).one("mouseup touchend",q);d.callMoveAtStart&&d.move.call(d.context||this,n,Vec2.zero,new Vec2(g.pageX-l.left,g.pageY-l.top),g)}}}),h=_.$(this,function(a){var e=_.extend({},b(a,this[0]));if(Platform.touch&&d.longPress){var f=void 0,h=window.setTimeout(_.$(this,
...
new Transform({a:b[0],b:b[1],c:b[2],d:b[3],e:b[4],f:b[5]})):Transform.identity}return this.css("transform",_.isStrictlyObject(a)&&(a.translate?"translate("+a.translate.x+"px,"+a.translate.y+"px) ":"")+(a.rotate?"rotate("+a.rotate+"rad) ":"")+(a.scale?"scale("+(new Vec2(a.scale)).separatedWith(",")+")":"")||"")},svgTranslate:function(a){return this.attr("transform","translate("+a.x+","+a.y+")")},svgTransformMatrix:function(a){a=a.components;return this.attr("transform","matrix("+a[0][0]+","+a[1][0]+
","+a[0][1]+","+a[1][1]+","+a[0][2]+","+a[1][2]+")")},svgTransformToElement:function(a){return Transform.svgMatrix(this[0].getTransformToElement(a[0]))},svgBBox:function(a){return 0===arguments.length?new BBox(this[0].getBBox()):this.attr(a.xywh)},outerExtent:function(){return new Vec2(this.outerWidth(),this.outerHeight())},extent:function(){return new Vec2(this.width(),this.height())},innerExtent:function(){return new Vec2(this.innerWidth(),this.innerHeight())},outerBBox:function(){return BBox.fromLTWH(_.extend(this.offset(),
this.outerExtent().asWidthHeight))},clientBBox:function(){return BBox.fromLTWH(this[0].getBoundingClientRect())},leftTop:function(){return new Vec2.fromLT(this.offset())},offsetInParent:function(){return Vec2.fromLeftTop(this.offset()).sub(Vec2.fromLeftTop(this.parent().offset()))},monitorInput:function(b){var d=function(){""===a.trim(a(this).val())?b.empty(!0):b.empty(!1)};return this.keyup(d).change(d).focus(_.bind(b.focus||_.noop,b,!0)).blur(_.bind(b.focus||_.noop,b,!1))},touchClick:function(a,
b){var e=this;b=b||{};if(!b.disableTouch&&Platform.touch){var f=function(b){a.apply(this,arguments);b.preventDefault();return!1},g=function(a){a.preventDefault();return!1};b.handler&&b.handler({unbind:function(){e.off("touchstart",f).off("click",g)}});return this.on("touchstart",f).on("click",g)}b.handler&&b.handler({unbind:function(){e.off("click",a)}});return this.click(a)},touchDoubleclick:function(a){if(Platform.touch){var b=Date.now();return this.on("touchend",function(){var e=Date.now();200>
e-b&&a.apply(this,arguments);b=e})}return this.dblclick(a)},nodoubletapzoom:function(){return a(this).bind("touchstart",function(b){var d=b.timeStamp,e=a(this).data("lastTouch")||d,e=d-e,f=b.originalEvent.touches.length;a(this).data("lastTouch",d);!e||500<e||1<f||(b.preventDefault(),a(b.target).trigger("click"))})}})}(jQuery);$uselessFile="panic.js";_.defineTagKeyword("required");_.defineTagKeyword("atom");_.defineKeyword("any",_.identity);
...
_.extend(_,_.assertions=_.extend({},_.asyncAssertions,{assert:function(a){var b=[].splice.call(arguments,0);1===b.length?!0!==b[0]&&_.assertionFailed({notMatching:b}):_.allEqual(b)||_.assertionFailed({notMatching:b});return!0},assertEveryCalled:function(a){var b=_.times(a.length,function(){return function(){arguments.callee.called=!0}});a.apply(null,b);return _.assert(_.pluck(b,"called"),_.times(b.length,_.constant(!0)))},assertEveryCalledOnce:function(a){var b=_.times(a.length,function(){return function(){arguments.callee.called=
(arguments.callee.called||0)+1}});a.apply(null,b);return _.assert(_.pluck(b,"called"),_.times(b.length,_.constant(1)))},assertCallOrder:function(a){var b=0,c=_.times(a.length,function(a){return function(){arguments.callee.callIndex=b++}});a.apply(null,c);return _.assert(_.pluck(c,"callIndex"),_.times(c.length,_.identity.arity1))},assertMatches:function(a,b){try{return _.assert(_.matches.apply(null,_.rest(arguments))(a))}catch(c){throw _.isAssertionError(c)?_.extend(c,{notMatching:[a,b]}):c;}},assertNotMatches:function(a,
b){try{return _.assert(!_.matches.apply(null,_.rest(arguments))(a))}catch(c){throw _.isAssertionError(c)?_.extend(c,{notMatching:[a,b]}):c;}},assertType:function(a,b){return _.assert(_.decideType(a),b)},assertTypeMatches:function(a,b){return _.isEmpty(_.typeMismatches(b,a))?!0:_.assertionFailed({asColumns:!0,notMatching:[{value:a},{type:_.decideType(a)},{contract:b},{mismatches:void 0}]})},assertFails:function(a){_.assertThrows.call(this,a,_.isAssertionError)},assertThrows:function(a,b){var c=void 0,
d=!1;try{a.call(this)}catch(e){c=e,d=!0}_.assert.call(this,d);1===arguments.length&&_.assertMatches.apply(this,[c].concat(_.rest(arguments)))},assertNotThrows:function(a){_.assertCalls.call(this,0,function(){a()})},assertArguments:function(a,b,c){b=(b||a.callee).toString();var d=b.match(/.*function[^\(]\(([^\)]+)\)/);if(d){a=_.asArray(a);var d=_.map(d[1].split(","),function(a){a="_"===a.trim()[0]?a.replace(/_/g," ").trim():void 0;var b=parseInt(a,10);return _.isFinite(b)?b:a}),e=_.zipWith([d,a],function(a,
b){return void 0===a?!0:a===b});_.every(e)||_.assertionFailed({notMatching:_.nonempty([[c,b].join(": "),d,a])})}},fail:function(){_.assertionFailed()},fails:_.constant(function(){_.assertionFailed()}),stub:function(){_.assertionFailed()}}));
...
c=log.cleanArgs(b),d=_.extend({indent:0},a,log.readConfig(b)),e=(log.impl.writeBackend.indent||0)+d.indent,f=log.impl.stringifyArguments(c,d),e=_.times(e,_.constant("\t")).join(""),f=f.reversed.match(/(\n*)([^]*)/),g=d.location&&log.impl.location(d.where||$callStack[3+(d.stackOffset||0)])||"",b={color:log.readColor(b),indentedText:f[2].reversed.split("\n").map(_.prepends(e)).join("\n"),trailNewlines:f[1],codeLocation:g,config:d};log.impl.writeBackend(b);return c[0]})},defaultWriteBackend:function(a){var b=
...
a=_.flatten(_.pluck(b.concat(f).concat(a),"tests"));a=_.filter(a,e.shouldRun||_.constant(!0));this.runningTests=_.map(a,function(a,b){return _.extend(a,{indent:e.indent,index:b})});_.cps.each(a,this.$(this.runTest),this.$(function(){_.assert(!0!==e.done);e.done=!0;this.printLog(e);this.failedTests=_.filter(this.runningTests,_.property("failed"));this.failed=0<this.failedTests.length;d(!this.failed);c()}))}))}),defineAssertions:function(a){_.each(a,function(a,c){this.defineAssertion(c,a)},this)},runTest:function(a,
...
typeof b&&_.object([[a,b]])||b)).map(function(b){return new Test({name:b[0],routine:b[1],suite:a,context:c})})}},defineAssertion:function(a,b){var c=this;_.deleteKeyword(a);_.defineKeyword(a,Tags.modifySubject(b,function(d){return _.withSameArgs(d,function(){return c.currentTest?c.currentTest.runAssertion(a,b,d,arguments):d.apply(c,arguments)})}))},printLog:function(a){if(!a.supressLog){var b=_.filter(this.runningTests,function(b){return b.failed||!a.silent&&b.hasLog}),c=_.filter(this.runningTests,
...
this.closeTriggered()},_clean:function(){this.modalBody.find(".panic-alert-error").remove();this.modalBody.scroll();this.btnRetry.hide();this.btnClose.hide()},append:function(b,c){var d="panic"+this.hash(b),e=a("#"+d+" .panic-alert-counter");e.length?e.text((e.text()||"1").parsedInt+1):a('<div class="panic-alert-error">').attr("id",d).append('<span class="panic-alert-counter">').append(this.print(b,c)).insertAfter(this.el.find(".panic-modal-title"));this.toggleVisibility(!0);this.layout()},hash:function(a){return((_.isTypeOf(Error,
a)?a&&a.stack:_.isTypeOf(Test,a)?a.suite+a.name:a)||"").hash},print:function(a,c){return _.isTypeOf(Error,a)?this.printError(a):_.isTypeOf(Test,a)?this.printFailedTest(a):this.printUnknownStuff(a,c)},printUnknownStuff:function(b,c){return c?b:a("<span>").text(log.impl.stringify(b))},printFailedTest:function(b){var c=a('<div class="test-log" style="margin-top: 13px;">');log.withCustomWriteBackend(function(b){c.append(a("<pre>").css({color:b.color.css}).html(_.escape(b.indentedText)+(b.codeLocation&&
' <span class="location">'+b.codeLocation+"</span>"||"")+(b.trailNewlines||"").replace(/\n/g,"<br>")))},function(a){b.evalLogCalls();a()});return[a('<div class="panic-alert-error-message" style="font-weight: bold;">').text(b.name).append('<span style="float:right; opacity: 0.25;">test failed</span>'),c]},printError:function(b){for(var c=CallStack.fromError(b),d=b.asyncContext;d;)c=c.concat(CallStack.fromRawString(d.stack)),d=d.asyncContext;c=c.mergeDuplicateLines;return[a('<div class="panic-alert-error-message" style="font-weight: bold;">').text(b.message).append(_.any(c,
...
b.line]).join(":")),a('<span class="callee">').text(b.calleeShort),a('<span class="src i-am-busy">').click(this.$(function(d){var h=a(d.delegateTarget);h.waitUntil(_.readSource.partial((b.remote?"api/source/":"")+b.file),this.$(function(d){c.is(".full")?(c.removeClass("full"),c.transitionend(function(){c.is(".full")||b.sourceReady(h.$(a.fn.text))})):(c.addClass("full"),h.html(_.map(d.split("\n"),function(b){return a('<div class="line">').text(b)})),d=h.find(".line").eq(b.line-1).addClass("hili"),
d.length&&(d=d.offset().top-h.offset().top,h.scrollTop(d-100)),_.delay(this.$(function(){var a=h.outerBBox().bottom+242-this.modalBody.outerBBox().bottom;0<a&&this.modalBody.animate({scrollTop:this.modalBody.scrollTop()+a},250)})))}))}))]);b.sourceReady(function(a){c.find(".src").removeClass("i-am-busy").text(a)});return c})))]}});a.fn.extend({enableScrollFaders:function(b){var c=b&&b.horizontal,d,e;b=this.find(b&&b.scroller||".scroller");this.css({position:"relative"});this.append(d=a('<div class="scroll-fader scroll-fader-'+
(c?"left":"top")+'"></div>')).append(e=a('<div class="scroll-fader scroll-fader-'+(c?"right":"bottom")+'"></div>'));b.scroll(function(){var b=c?a(this).scrollLeft():a(this).scrollTop(),g=c?a(this).width():a(this).height(),h=(c?this.scrollWidth:this.scrollHeight)-1;d.css({opacity:0<b?1:0});e.css({opacity:b+g<h?1:0})}).scroll();return this}})})(jQuery);
(function(a){LogOverlay=$singleton(Component,{$defaults:{opaque:!1,init:!1},init:function(){log.impl.writeBackend=this.write;a(document).keydown(this.$(function(a){192===a.keyCode&&this.toggle()}))},el:$memoized($property(function(){return a('<div class="useless-log-overlay" style="display: none;">').appendTo(document.body)})),toggle:function(a){this.el.toggle(a)},write:function(b){this.toggle(!0);b.config.clear&&this.el.empty();this.el.append(a('<div class="ulo-line">').css("color",b.color.css).append(a('<span class="ulo-line-text">').text(b.indentedText+
" ")).append(a('<span class="ulo-line-where">').text(b.codeLocation+" ")).append(a('<span class="ulo-line-trail">').text(b.trailNewlines)));this.opaque||log.impl.defaultWriteBackend.apply(log.impl,arguments)}})})(jQuery);
