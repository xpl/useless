_.hasAsserts=!0;
_.extend(_,{tests:{},withTest:function(a,b,c){c();_.runTest(a,b);_.publishToTestsNamespace(a,b)},deferTest:function(a,b,c){c();_.publishToTestsNamespace(a,b)},runTest:function(a,b){try{_.isFunction(b)?b():_.each(b,function(a){a()})}catch(e){if(_.isAssertionError(e)){var c=(_.isArray(a)&&a||[a]).join(".");console.log(c+":",e.message,"\n"+_.times(c.length,_.constant("~")).join("")+"\n");_.each(e.notMatching,function(a){console.log("  \u2022",a)})}throw e;}},publishToTestsNamespace:function(a,b){_.isArray(a)?
(_.tests[a[0]]||(_.tests[a[0]]={}))[a[1]]=b:_.tests[a]=b}});
(function(){var a=function(a){return function(b){var d=[].splice.call(arguments,0);1===d.length?a&&!0!==d[0]&&_.assertionFailed({notMatching:d}):a&&!0!==_.allEqual(d)&&_.assertionFailed({notMatching:d});return!0}};$overrideUnderscore("matches",function(a){return function(b){return _.isObject(b)?a(b):function(a){return b===a}}});_.extend(_,_.assertions={assert:a(!0),assertNot:a(!1),assertCPS:function(a,b,d){var f=b&&(_.isArray(b)?b:[b])||[];a(function(){$assert([].splice.call(arguments,0),f);if(d)return d(),
!0})},assertNotCalled:function(a){var b=!0;a(function(){b&&$fail});b=!1},assertEveryCalledOnce:function(a,b){return _.assertEveryCalled(_.hasTags?$once(a):(a.once=!0,a),b)},assertEveryCalled:function(a,b){var d=_.hasTags?$untag(a):a,f=_.hasTags?$async.is(a):a.async,g=(once=_.hasTags?$once.is(a):a.once)?null:d.toString().match(/.*function[^\(]\(([^\)]+)\)/),h=once?_.times(d.length,_.constant(1)):_.map(g[1].split(","),function(a){a=(a=a.trim().match(/^(.+)__(\d+)$/))&&parseInt(a[2],10);return _.isFinite(a)?
a||!1:!0}),k=_.times(d.length,_.constant(!1)),g=_.times(d.length,function(a){return function(){k[a]=_.isNumber(h[a])?(k[a]||0)+1:!0;f&&_.isEqual(k,h)&&b()}});d.apply(null,g);f||(_.assert(k,h),b&&b())},assertCalledWithArguments:function(a,b){return _.assert(_.arr(b),a)},assertCallOrder:function(a){var b=0,d=_.times(a.length,function(a){return function(){arguments.callee.callIndex=b++}});a.apply(null,d);return _.assert(_.pluck(d,"callIndex"),_.times(d.length,_.identity.arity1))},assertMatches:function(a,
b){try{return _.assert(_.matches.apply(null,_.rest(arguments))(a))}catch(d){throw _.isAssertionError(d)?_.extend(d,{notMatching:[a,b]}):d;}},assertNotMatches:function(a,b){try{return _.assert(!_.matches.apply(null,_.rest(arguments))(a))}catch(d){throw _.isAssertionError(d)?_.extend(d,{notMatching:[a,b]}):d;}},assertType:function(a,b){return _.assert(_.decideType(a),b)},assertTypeMatches:function(a,b){return _.isEmpty(mismatches=_.typeMismatches(b,a))?!0:_.assertionFailed({message:"provided value type not matches required contract",
asColumns:!0,notMatching:[{provided:a},{required:b},{mismatches:mismatches}]})},assertFails:function(a){return _.assertThrows.call(this,a,_.isAssertionError)},assertThrows:function(a,b){var d=void 0,f=!1;try{a.call(this)}catch(g){d=g,f=!0}_.assert.call(this,f);1<arguments.length&&_.assertMatches.call(this,d,b)},assertNotThrows:function(a){return _.assertEveryCalled(function(b){a();b()})},assertArguments:function(a,b,d){b=(b||a.callee).toString();var f=b.match(/.*function[^\(]\(([^\)]+)\)/);if(f){a=
_.asArray(a);var f=_.map(f[1].split(","),function(a){a="_"===a.trim()[0]?a.replace(/_/g," ").trim():void 0;var b=parseInt(a,10);return _.isFinite(b)?b:a}),g=_.zipWith([f,a],function(a,b){return void 0===a?!0:a===b});_.every(g)||_.assertionFailed({notMatching:_.nonempty([[d,b].join(": "),f,a])})}},fail:function(){_.assertionFailed()},fails:_.constant(function(){_.assertionFailed()}),stub:function(){_.assertionFailed()}});_.extend(_,{assertionError:function(a){return _.extend(Error(a&&a.message||"assertion failed"),
a,{assertion:!0})},assertionFailed:function(a){throw _.extend(_.assertionError(a),{stack:_.rest(Error().stack.split("\n"),3).join("\n")});},isAssertionError:function(a){return a&&!0===a.assertion}});_.extend(_,{allEqual:function(a){return _.reduce(a,function(b,d){return b&&_.isEqual(a[0],d)},!0)}});_.each(_.keys(_.assertions),function(a){$global.define("$"+a,_[a],{configurable:!0})});for(var b in _.assertions)$global["$"+b]=1;$assert})();
(function(){_.hasUncaught=!0;var a=_.globalUncaughtExceptionHandler=function(a){var c=arguments.callee.chain;arguments.callee.chain=_.reject(c,_.property("catchesOnce"));if(c.length)for(var e=0,d=c.length;e<d;e++)try{c[e](a);break}catch(f){console.log(f);if(e===d-1)throw f.message+=" [re-thrown by a hook]",f;f&&"object"===typeof f&&(f.originalError=a);a=f}else throw a.message+=" [re-thrown by a hook]",a;};_.withUncaughtExceptionHandler=function(b,c){var e=c||_.identity;c&&(b.catchesOnce=!0);a.chain.unshift(b);
e(function(){a.chain.remove(b)})};a.chain=[];switch($platform.engine){case "node":require("process").on("uncaughtException",a);break;case "browser":window.addEventListener("error",function(b){0>b.message.indexOf(" [re-thrown by a hook]")&&(b.error?a(b.error):a(_.extend(Error(b.message),{stub:!0,stack:"at "+b.filename+":"+b.lineno+":"+b.colno})))})}})();
(function(){if($platform.Browser){_.hasUncaughtAsync=!0;var a=void 0,b=function(b,e){return __supressErrorReporting=function(){var d={name:name,stack:Error().stack,asyncContext:a},f=_.asArray(arguments),g=f[e];if(!_.isFunction(g))throw Error("[uncaughtAsync.js] callback should be a function");g.__uncaughtJS_wrapper=f[e]=__supressErrorReporting=function(){a=d;try{return g.apply(this,arguments)}catch(b){_.globalUncaughtExceptionHandler(_.extend(b,{asyncContext:d}))}};return b.apply(this,f)}};window.setTimeout=
b(window.setTimeout,0);(function(a,b){var d=function(d){d.addEventListener=a(d.addEventListener);d.removeEventListener=b(d.removeEventListener)};window.EventTarget?d(window.EventTarget.prototype):(d(Node.prototype),d(XMLHttpRequest.prototype))})(function(a){return b(a,1)},function(a){return function(b,d,f,g){return a.call(this,b,d.__uncaughtJS_wrapper||d,f)}})}})();_.hasReflection=!0;
...
thirdParty:CallStack.isThirdParty(a.file)&&!a.index})})},function(a){return CallStack.fromParsedArray(a)})),rawStringToArray:$static(function(a){a=(a||"").split("\n");return _.filter2(a,function(a){a=a.trimmed;var c,e,d=!1;if((e=a.match(/at (.+) \((.+)\)/))||(e=a.match(/(.*)@(.*)/)))c=e[1],d="native"===e[2],e=_.rest(e[2].match(/(.*):(.+):(.+)/)||[]);else if(e=a.match(/^(at\s+)*(.+):([0-9]+):([0-9]+)/))e=_.rest(e,2);else return!1;return 0<=(c||"").indexOf("__supressErrorReporting")?!1:{beforeParse:a,
callee:c||"",index:$platform.Browser&&e[0]===window.location.href,"native":d,file:e[0]||"",line:(e[1]||"").integerValue,column:(e[2]||"").integerValue}})})});$prototype.impl.findMeta=function(a){return function(b){_.cps.find(CallStack.fromRawString(a).reversed,function(a,b){a.sourceReady(function(d){d=(d||"").match(/([A-z]+)\s*=\s*\$(prototype|singleton|component|extends|trait|aspect)/);b(d&&{name:d[1],type:d[2],file:a.fileShort}||!1)})},function(a){b(a||{})})}};
...
log.writeBackend.value;log.writeBackend.value=b;c(function(b){a(function(){log.writeBackend.value=d;b&&b();e&&e()})})}),writeUsingDefaultBackend:function(){var a=arguments;log.withWriteBackend(log.impl.defaultWriteBackend,function(b){log.write.apply(null,a);b()})},writeBackend:function(){return arguments.callee.value||log.impl.defaultWriteBackend},withConfig:function(a,b){log.impl.configStack.push(log.impl.configure([{stackOffset:-1},a]));var c=b();log.impl.configStack.pop();return c},currentConfig:function(){return log.impl.configure(log.impl.configStack)},
...
1:3,indent:a.indent||0}].concat(log.impl.configStack)),e=_.reduce2([],_.partition3(b,_.isTypeOf.$(log.Config)),function(a,b){return!0===b.label?(c=log.impl.configure([c].concat(b.items)),a):a.concat({config:c,text:log.impl.stringifyArguments(b.items,c)})}),d=e.last&&e.last.text.reversed.match(/(\n*)([^]*)/),f=d&&d[1];d&&(e.last.text=d[2].reversed);var g={},d=_.pluck["with"]("items",_.reject["with"](_.property("label"),_.partition3["with"](_.equals(g),_.scatter(e,function(a,b,c){_.each(a.text.split("\n"),
function(b,d,e){c(_.extended(a,{text:b}));d!==e.lastIndex&&c(g)})})))),e=_.pluck(e,"text").join(""),h=c.where||log.impl.walkStack($callStack)||{},k=(c.indentPattern||"\t").repeats(c.indent);a({lines:d,config:c,color:c.color,when:Date.now(),args:_.reject(b,_.isTypeOf.$(log.Config)),indentation:k,indentedText:d.map(_.seq(_.pluck.tails2("text"),_.joinsWith(""),_.prepends(k))).join("\n"),text:e,codeLocation:c.location&&log.impl.location(h)||"",trailNewlines:f||"",where:c.location&&h||void 0});return _.find(b,
...
return a}));this.run=this.$(this.run)},run:_.interlocked(function(a){var b=this.runConfig=_.extend({suites:[],silent:!0,verbose:!1,timeout:2E3,filter:_.identity,testStarted:function(a){},testComplete:function(a){}},a),c=_.isArray(b.suites),e=_.map(b.suites,this.$(function(a,e){return this.testSuite(c?a.name:e,c?a.tests:a,b.context,a.proto)}));return(!1===b.codebase?__([]):this.collectPrototypeTests()).then(this.$(function(a){var c=!1===b.codebase?[]:this.collectTests();a=_.flatten(_.pluck(c.concat(e).concat(a),
...
function(){a.verbose=c.verbose;a.timeout=c.timeout;a.startTime=Date.now();return a.run().then(function(){a.time=Date.now()-a.startTime;return c.testComplete(a)})})},collectTests:function(){return _.map(_.tests,this.$(function(a,b){return this.testSuite(b,a)}))},collectPrototypeTests:function(){var a=this;return __.map(this.prototypeTests,function(b,c){return b.proto.$meta.promise.then(function(c){return a.testSuite(c.name,b.tests,void 0,b.proto)})})},testSuite:function(a,b,c,e){return{name:a||"",
tests:_(_.pairs("function"===typeof b&&_.object([[a,b]])||b)).map(function(b){var f=new Test({proto:e,name:b[0],routine:b[1],suite:a,context:c});f.complete(function(){(f.hasLog=0<f.logCalls.length)||(f.failed?log.red("FAIL"):f.verbose&&log.green("PASS"))});return f})}},defineAssertion:function(a,b){var c=this;_.deleteKeyword(a);_.defineKeyword(a,Tags.modify(b,function(e){return _.withSameArgs(e,function(){var d=$callStack.safeLocation($platform.Browser&&!$platform.Chrome?0:1);return c.currentAssertion?
c.currentAssertion.babyAssertion(a,b,e,arguments,d):e.apply(c,arguments)})}))},printLog:function(a){if(!a.supressLog){var b=_.filter(this.runningTests,function(b){return b.failed||!a.silent&&b.hasLog}),c=_.filter(this.runningTests,_.property("failed"));_.invoke(a.verbose?this.runningTests:b,"printLog");c.length?log.orange("\n"+log.boldLine+"\nSOME TESTS FAILED:",_.pluck(c,"name").join(", "),"\n\n"):!0!==a.silent&&log.green("\n"+log.boldLine+"\nALL TESTS PASS\n\n")}}});
Test=$prototype({constructor:function(a){_.defaults(this,a,{name:"<< UNNAMED FOR UNKNOWN REASON >>",failed:!1,routine:void 0,verbose:!1,depth:1,indent:0,failedAssertions:[],context:this,complete:_.extend(_.barrier(),{context:this})});this.babyAssertion=_.interlocked(this.babyAssertion)},finalize:function(){this.babyAssertion.wait(this.$(function(){this.canFail&&this.failedAssertions.length&&(this.failed=!0);this.complete(!0)}))},babyAssertion:function(a,b,c,e,d){var f=this,g=new Test({mother:this,
name:a,shouldFail:b.$shouldFail||this.shouldFail,depth:this.depth+1,location:d,context:this.context,timeout:this.timeout/2,verbose:this.verbose,silent:this.silent,routine:Tags.modify(b,function(a){return function(c){if($async.is(e[0])||$async.is(b))_.cps.apply(a,f.context,e,function(a,b){b&&b.apply(this,a);c()});else try{a.apply(f.context,e),c()}catch(d){g.onException(d)}}})});return g.run()["finally"](function(a,b){Testosterone.currentAssertion=f;if(g.failed||g.verbose&&g.logCalls.notEmpty)return g.location.sourceReady.promise.then(function(a){log.red(log.config({location:g.location,
...
Testosterone.currentAssertion=this,b=Tags.unwrap(this.routine);return new Promise(this.$(function(c){this.shouldFail=$shouldFail.is(this.routine);this.hasLog=this.failed=!1;this.logCalls=[];this.failureLocations={};_.withTimeout({maxTime:a.timeout,expired:function(){a.canFail&&(log.ee("TIMEOUT EXPIRED"),a.fail())}},a.complete);_.withUncaughtExceptionHandler(a.$(a.onException),a.complete);log.withWriteBackend(_.extendWith({indent:1},function(b){a.logCalls.push(b)}),function(e){a.complete(e.arity0);
c&&a.complete(c);if(0<b.length)b.call(a.context,a.$(a.finalize));else{e=void 0;try{e=b.call(a.context)}catch(d){a.onException(d)}_.isArrayLike(e)&&e[0]instanceof Promise&&(e=__.all(e));e instanceof Promise?e.then(function(b){a.finalize()}.postponed,function(b){a.onException(b)}):a.finalize()}})}))},printLog:function(){var a=this.suite&&this.suite!==this.name&&(this.suite||"").quote("[]")||"";log.write(log.color.blue,"\n"+log.boldLine,"\n"+_.nonempty([a,this.name]).join(" "),(this.index+" of "+Testosterone.runningTests.length).quote("()")+
(this.failed?" FAILED":"")+":","\n");this.evalLogCalls()},evalLogCalls:function(){_.each(this.logCalls,log.writeBackend().arity1)}});_.defineTagKeyword("allowsRecursion");_.limitRecursion=function(a,b,c){b||(b=a,a=0);var e=-1,d=!1;return function(){if(!d){if(e>a)throw d=!0,_.extendWith({notMatching:_.map(arguments,function(a,b){return"arg"+(b+1)+": "+_.stringify(a)})},Error(c+": max recursion depth reached ("+a+")"));var f=(++e,b.apply(this,arguments));e--;return f}}};
...
(function(){var a=_.keys(_.omit(log.color,"none"));a.each(_.defineTagKeyword);_.defineTagKeyword("verbose");Testosterone.LogsMethodCalls=$trait({$test:$platform.Browser?function(){}:function(a){var c=$prototype({$traits:[Testosterone.LogsMethodCalls]}),c=$extends(c,{foo:$log($pink($verbose(function(a){$assert(a,42);return 24})))}),e=new c,d=this;c.$meta(function(){$assert(e.foo(42),24);$assert(_.pluck(d.logCalls,"text"),["Compo.foo (42)","\u2192 24",""]);$assert(d.logCalls[0].color===log.color("pink"));
a()})},$macroTags:{log:function(b,c,e){var d=(_.isBoolean(c.$log)?void 0:c.$log)||(c.$verbose?"{{$proto}}":""),f={},g=_.find2(a,function(a){return log.color(c["$"+a]&&a)||!1}),h=d&&_.template(d,{interpolate:/\{\{(.+?)\}\}/g});$untag(b.$meta)(function(a){f=a});return $prototype.impl.modifyMember(c,function(a,b){return function(){var d=this,l=_.asArray(arguments),n=h&&h.call(this,_.extend({$proto:f.name},_.map2(this,_.stringifyOneLine.arity1)))||this.desc||"",p=_.map(l,_.stringifyOneLine.arity1).join(", ").quote("()");
log.write(log.config({color:g,location:!0,where:c.$verbose?void 0:{calleeShort:f.name}}),_.nonempty([n,e,b]).join("."),p);return log.withConfig({indent:1,color:g,protoName:f.name},function(){var b=log.impl.numWrites,c=a.apply(d,l);void 0!==c&&log.write("\u2192",_.stringifyOneLine(c));2>log.currentConfig().indent&&0<log.impl.numWrites-b&&log.newline();return c})}})}}})})();$platform.NodeJS&&(module.exports=Testosterone);
_.measure=function(a,b){if(b){var c=_.now();a(function(){b(_.now()-c)})}else return c=_.now(),a(),_.now()-c};_.perfTest=function(a,b){var c=_.isFunction(a)?{test:a}:a,e={};_.cps.each(c,function(a,b,c){var h=[],k=function(){for(var c=0;500>c;c++)h.push(a());console.log(b,h)};k();_.delay(function(){e[b]=_.measure(k)/500;c()},100)},function(){b(e)})};
...
0<a&&this.modalBody.animate({scrollTop:this.modalBody.scrollTop()+a},250)})))}))}))]);b.sourceReady(function(a){c.find(".src").removeClass("i-am-busy").text(a)});return c})))]}});a.fn.extend({enableScrollFaders:function(b){var c=b&&b.horizontal,e,d;b=this.find(b&&b.scroller||".scroller");this.css({position:"relative"});this.append(e=a('<div class="scroll-fader scroll-fader-'+(c?"left":"top")+'"></div>')).append(d=a('<div class="scroll-fader scroll-fader-'+(c?"right":"bottom")+'"></div>'));b.scroll(function(){var b=
c?a(this).scrollLeft():a(this).scrollTop(),g=c?a(this).width():a(this).height(),h=(c?this.scrollWidth:this.scrollHeight)-1;e.css({opacity:0<b?1:0});d.css({opacity:b+g<h?1:0})}).scroll();return this}})})(jQuery);
