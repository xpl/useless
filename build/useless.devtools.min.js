...
function(){var h={name:name,stack:Error().stack,asyncContext:c},f=_.asArray(arguments),k=f[d];k.__uncaughtJS_wrapper=f[d]=__supressErrorReporting=function(){c=h;try{return k.apply(this,arguments)}catch(b){a(_.extend(b,{asyncContext:h}))}};return b.apply(this,f)}};window.setTimeout=d(window.setTimeout,0);b(function(a){return d(a,1)},function(a){return function(b,c,d,k){return a.call(this,b,c.__uncaughtJS_wrapper||c,d)}})}})();_.hasReflection=!0;
