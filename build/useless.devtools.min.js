...
_.perfTest=function(a,b){var c=_.isFunction(a)?{test:a}:a,d={};_.cps.each(c,function(a,b,c){var f=[],k=function(){for(var c=0;500>c;c++)f.push(a());console.log(b,f)};k();_.delay(function(){d[b]=_.measure(k)/500;c()},100)},function(){b(d)})};
