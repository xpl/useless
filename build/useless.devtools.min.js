...
(function(){if(Platform.Browser){_.hasUncaughtAsync=!0;var a=void 0,b=function(b,d){return __supressErrorReporting=function(){var e={name:name,stack:Error().stack,asyncContext:a},f=_.asArray(arguments),h=f[d];h.__uncaughtJS_wrapper=f[d]=__supressErrorReporting=function(){a=e;try{return h.apply(this,arguments)}catch(b){_.globalUncaughtExceptionHandler(_.extend(b,{asyncContext:e}))}};return b.apply(this,f)}};window.setTimeout=b(window.setTimeout,0);(function(a,b){var e=function(e){e.addEventListener=
...
log.impl.defaultWriteBackend},impl:{write:function(a){return $restArg(function(){var b=log.writeBackend(),c=_.asArray(arguments),d=log.cleanArgs(c),e=_.extend({indent:0},a,log.readConfig(c)),f=(b.indent||0)+e.indent,h=log.impl.stringifyArguments(d,e),f=_.times(f,_.constant("\t")).join(""),h=h.reversed.match(/(\n*)([^]*)/),g=e.location&&log.impl.location(e.where||$callStack[3+(e.stackOffset||0)])||"",c={color:log.readColor(c),indentedText:h[2].reversed.split("\n").map(_.prepends(f)).join("\n"),trailNewlines:h[1],
codeLocation:g,config:e};b(c);return d[0]})},defaultWriteBackend:function(a){var b=a.color,c=a.indentedText,d=a.codeLocation;a=a.trailNewlines;(b=b&&(Platform.NodeJS?b.shell:b.css))?Platform.NodeJS?console.log(b+c+"\u001b[0m",d,a):(c=c.split("\n"),c=[_.first(c)||""].concat(_.rest(c).map(_.prepends(" "))),console.log("%c"+c.join("\n"),"color: "+b,d,a)):console.log(c,d,a)},location:function(a){return _.quoteWith("()",_.nonempty([a.calleeShort,a.fileName+":"+a.line]).join(" @ "))},stringifyArguments:function(a,
...
this.assertionStack([]);this.failureLocations={};var c=Tags.unwrap(this.routine),d=function(a){var d=function(){b.done=!0;a()};try{_.noArgs(c)?(c.call(b.context),d()):b.tryCatch(c,d)}catch(e){b.onException(e,a)}},e=function(a){b.assertionStack.when(_.isEmpty,a)},f=_.withTimeout.partial({maxTime:b.timeout,expired:function(a){b.failed=!0;log.error("TIMEOUT EXPIRED");a()}}),h=log.withWriteBackend.partial(_.extendWith({indent:b.depth+(b.indent||0)},function(a){b.logCalls.push(a)})),g=_.withUncaughtExceptionHandler.partial(b.$(b.onUnhandledException));
h(function(a){g(function(c){f(function(a){_.cps.sequence(d,e,a)()},function(){b.routine.$shouldFail&&(b.failed=!b.failed);(b.hasLog=0<b.logCalls.length)||(b.failed?log.red("FAIL"):b.verbose&&log.green("PASS"));c();a()})})},a)},printLog:function(){var a=this.suite&&this.suite!==this.name&&(this.suite||"").quote("[]")||"";log.write(log.color.blue,"\n"+log.boldLine,"\n"+_.nonempty([a,this.name]).join(" "),(this.index+" of "+Testosterone.runningTests.length).quote("()")+(this.failed?" FAILED":"")+":",
...
b.line]).join(":")),a('<span class="callee">').text(b.calleeShort),a('<span class="src i-am-busy">').click(this.$(function(d){var g=a(d.delegateTarget);g.waitUntil(_.readSource.partial((b.remote?"api/source/":"")+b.file),this.$(function(d){c.is(".full")?(c.removeClass("full"),c.transitionend(function(){c.is(".full")||b.sourceReady(g.$(a.fn.text))})):(c.addClass("full"),g.html(_.map(d.split("\n"),function(b){return a('<div class="line">').text(b)})),d=g.find(".line").eq(b.line-1).addClass("hili"),
d.length&&(d=d.offset().top-g.offset().top,g.scrollTop(d-100)),_.delay(this.$(function(){var a=g.outerBBox().bottom+242-this.modalBody.outerBBox().bottom;0<a&&this.modalBody.animate({scrollTop:this.modalBody.scrollTop()+a},250)})))}))}))]);b.sourceReady(function(a){c.find(".src").removeClass("i-am-busy").text(a)});return c})))]}});a.fn.extend({enableScrollFaders:function(b){var c=b&&b.horizontal,d,e;b=this.find(b&&b.scroller||".scroller");this.css({position:"relative"});this.append(d=a('<div class="scroll-fader scroll-fader-'+
(c?"left":"top")+'"></div>')).append(e=a('<div class="scroll-fader scroll-fader-'+(c?"right":"bottom")+'"></div>'));b.scroll(function(){var b=c?a(this).scrollLeft():a(this).scrollTop(),h=c?a(this).width():a(this).height(),g=(c?this.scrollWidth:this.scrollHeight)-1;d.css({opacity:0<b?1:0});e.css({opacity:b+h<g?1:0})}).scroll();return this}})})(jQuery);
