_.hasAsserts=!0;
_.extend(_,{tests:{},withTest:function(a,b,c){c();_.runTest(a,b);_.publishToTestsNamespace(a,b)},deferTest:function(a,b,c){c();_.publishToTestsNamespace(a,b)},runTest:function(a,b){try{_.isFunction(b)?b():_.each(b,function(b){b()})}catch(d){if(_.isAssertionError(d)){var c=(_.isArray(a)&&a||[a]).join(".");console.log(c+":",d.message,"\n"+_.times(c.length,_.constant("~")).join("")+"\n");_.each(d.notMatching,function(b){console.log("  \u2022",b)})}throw d;}},publishToTestsNamespace:function(a,b){_.isArray(a)?
(_.tests[a[0]]||(_.tests[a[0]]={}))[a[1]]=b:_.tests[a]=b}});
(function(){var a=function(b){return function(a){var d=[].splice.call(arguments,0);1===d.length?b&&!0!==d[0]&&_.assertionFailed({notMatching:d}):b&&!0!==_.allEqual(d)&&_.assertionFailed({notMatching:d});return!0}};$overrideUnderscore("matches",function(b){return function(a){return _.isObject(a)?b(a):function(b){return a===b}}});_.extend(_,_.assertions={assert:a(!0),assertNot:a(!1),assertCPS:function(b,a,d){var e=a&&(_.isArray(a)?a:[a])||[];b(function(){$assert([].splice.call(arguments,0),e);if(d)return d(),
