...
g={encoding:"utf8"};try{e.mkdirSync(a+".backups")}catch(k){}e.writeFileSync(a+".backups/"+Date.now(),d,g);e.writeFileSync(a,b,g);c()}):API.post("source/"+a,_.extend2({},this.apiConfig,{what:{text:b},failure:Panic,success:function(){log.ok(a,"\u2014 successfully saved");c&&c()}}))}});_.readSourceLine=SourceFiles.line;_.readSource=SourceFiles.read;_.writeSource=SourceFiles.write;
