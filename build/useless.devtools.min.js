...
(function(){if(Platform.Browser){var a=void 0,b=function(b,d){return __supressErrorReporting=function(){var e={name:name,stack:Error().stack,asyncContext:a},f=_.asArray(arguments),h=f[d];h.__uncaughtJS_wrapper=f[d]=__supressErrorReporting=function(){a=e;try{return h.apply(this,arguments)}catch(b){globalUncaughtExceptionHandler(_.extend(b,{asyncContext:e}))}};return b.apply(this,f)}};window.setTimeout=b(window.setTimeout,0);(function(a,b){var e=function(e){e.addEventListener=a(e.addEventListener);
