...
run:_.interlocked(function(a,b,c){var d=3===arguments.length?c:_.identity,e=this.runConfig=_.extend({silent:!0,verbose:!1,timeout:2E3,testStarted:function(a){},testComplete:function(a){}},b),g=_.isArray(e.suites),h=_.map(e.suites||[],this.$(function(a,b){return this.testSuite(g?a.name:b,g?a.tests:a,e.context)}));(!1===e.codebase?_.cps.constant([]):this.$(this.collectPrototypeTests))(this.$(function(b){var c=!1===e.codebase?[]:this.collectTests();b=_.flatten(_.pluck(c.concat(h).concat(b),"tests"));
...
this.shouldFail,depth:this.depth+1,location:g,context:this.context,timeout:this.timeout/2,verbose:this.verbose,silent:this.silent,routine:Tags.modifySubject(c,function(a){return function(b){if($async.is(e[0]))_.cps.apply(a,h.context,e,function(a,c){c&&c();b()});else try{a.apply(h.context,e),b()}catch(c){f.onException(c)}}})}),k=function(){f.failed&&h.canFail&&h.failedAssertions.push(f);a()};f.run(function(){Testosterone.currentAssertion=h;f.failed||f.verbose&&f.logCalls.notEmpty?f.location.sourceReady(function(a){log.red(a,
